...
.. conda:recipe:: bioconductor-rama
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/rama.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-rama
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.72.0-2</code>,  <code>1.72.0-1</code>,  <code>1.72.0-0</code>,  <code>1.68.0-2</code>,  <code>1.68.0-1</code>,  <code>1.68.0-0</code>,  <code>1.66.0-0</code>,  <code>1.64.0-1</code>,  <code>1.64.0-0</code>,  </span></summary>
      

      ``1.72.0-2``,  ``1.72.0-1``,  ``1.72.0-0``,  ``1.68.0-2``,  ``1.68.0-1``,  ``1.68.0-0``,  ``1.66.0-0``,  ``1.64.0-1``,  ``1.64.0-0``,  ``1.62.0-0``,  ``1.60.0-0``,  ``1.58.0-1``,  ``1.58.0-0``,  ``1.56.0-1``,  ``1.56.0-0``,  ``1.54.0-0``,  ``1.52.0-0``,  ``1.50.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-rama";
        var versions = ["1.72.0","1.72.0","1.72.0","1.68.0","1.68.0"];
    </script>
