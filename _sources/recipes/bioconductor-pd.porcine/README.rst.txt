...
.. conda:recipe:: bioconductor-pd.porcine
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/pd.porcine.html
...
.. conda:package:: bioconductor-pd.porcine
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.porcine

   and update with::

      mamba update bioconductor-pd.porcine

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.porcine
