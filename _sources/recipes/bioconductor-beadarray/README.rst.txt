...
.. conda:recipe:: bioconductor-beadarray
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/beadarray.html
...
.. conda:package:: bioconductor-beadarray
   ...
   :depends bioconductor-beaddatapackr: ``>=1.58.0,<1.59.0``
   :depends bioconductor-beaddatapackr: ``>=1.58.0,<1.59.0a0``
