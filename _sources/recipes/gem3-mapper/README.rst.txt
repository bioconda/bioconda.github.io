...
.. conda:package:: gem3-mapper
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.6.1-13</code>,  <code>3.6.1-12</code>,  <code>3.6.1-11</code>,  <code>3.6.1-10</code>,  <code>3.6.1-9</code>,  <code>3.6.1-8</code>,  <code>3.6.1-7</code>,  <code>3.6.1-6</code>,  <code>3.6.1-5</code>,  </span></summary>
      

      ``3.6.1-13``,  ``3.6.1-12``,  ``3.6.1-11``,  ``3.6.1-10``,  ``3.6.1-9``,  ``3.6.1-8``,  ``3.6.1-7``,  ``3.6.1-6``,  ``3.6.1-5``,  ``3.6.1-4``,  ``3.6.1-3``,  ``3.6.1-2``,  ``3.6.1-1``,  ``3.6.1-0``
...
to install globally, run::
    ...
    pixi global install gem3-mapper

to add into an existing workspace instead, run::

    pixi add gem3-mapper
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname gem3-mapper
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_gem3-mapper"></div>
   <div style="width: 100%" id="platform_plot_gem3-mapper"></div>
   <div style="width: 100%" id="cdf_plot_gem3-mapper"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for gem3-mapper
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/gem3-mapper/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_gem3-mapper', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for gem3-mapper
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/gem3-mapper/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_gem3-mapper', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for gem3-mapper
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/gem3-mapper/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_gem3-mapper', spec);
            } catch (err) {
