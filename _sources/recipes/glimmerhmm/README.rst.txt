...
.. conda:package:: glimmerhmm
   ...
   :versions:
      ...
      ``3.0.4-10``,  ``3.0.4-9``,  ``3.0.4-8``,  ``3.0.4-7``,  ``3.0.4-5``,  ``3.0.4-3``,  ``3.0.4-2``,  ``3.0.4-1``,  ``3.0.4-0``
...
to install globally, run::
    ...
    pixi global install glimmerhmm
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname glimmerhmm
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_glimmerhmm"></div>
   <div style="width: 100%" id="platform_plot_glimmerhmm"></div>
   <div style="width: 100%" id="cdf_plot_glimmerhmm"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/glimmerhmm/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_glimmerhmm', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for glimmerhmm
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/glimmerhmm/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_glimmerhmm', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for glimmerhmm
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/glimmerhmm/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_glimmerhmm', spec);
            } catch (err) {
