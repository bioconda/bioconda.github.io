...
.. conda:package:: bioconductor-translatome
   ...
   :versions: 1.20.0, 1.18.5, 1.16.0

   :depends: :conda:package:`bioconductor-anota` >=1.30.0,<1.31.0 :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`bioconductor-deseq` >=1.34.0,<1.35.0 :conda:package:`bioconductor-edger` >=3.24.0,<3.25.0 :conda:package:`bioconductor-gosemsim` >=2.8.0,<2.9.0 :conda:package:`bioconductor-heatplus` >=2.28.0,<2.29.0 :conda:package:`bioconductor-limma` >=3.38.0,<3.39.0 :conda:package:`bioconductor-org.hs.eg.db` >=3.7.0,<3.8.0 :conda:package:`bioconductor-rankprod` >=3.8.0,<3.9.0 :conda:package:`bioconductor-sigpathway` >=1.50.0,<1.51.0 :conda:package:`bioconductor-topgo` >=2.34.0,<2.35.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-gplots`  :conda:package:`r-plotrix`  

   :required~by: |required_by_bioconductor-translatome|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-translatome


.. |required_by_bioconductor-translatome| conda:required_by:: bioconductor-translatome
