...
.. conda:recipe:: bioconductor-mpedbarray.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/mpedbarray.db.html
...
.. conda:package:: bioconductor-mpedbarray.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mpedbarray.db

   and update with::

      mamba update bioconductor-mpedbarray.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mpedbarray.db
