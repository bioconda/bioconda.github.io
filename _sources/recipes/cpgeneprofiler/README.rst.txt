...
.. conda:package:: cpgeneprofiler
   ...
   :versions:
      ...
      ``2.1.1-5``,  ``2.1.1-4``,  ``2.1.1-3``,  ``2.1.1-2``,  ``2.1.1-1``,  ``2.1.1-0``
...
to install globally, run::
    ...
    pixi global install cpgeneprofiler

to add into an existing workspace instead, run::

    pixi add cpgeneprofiler
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname cpgeneprofiler
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_cpgeneprofiler"></div>
   <div style="width: 100%" id="platform_plot_cpgeneprofiler"></div>
   <div style="width: 100%" id="cdf_plot_cpgeneprofiler"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for cpgeneprofiler
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/cpgeneprofiler/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_cpgeneprofiler', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for cpgeneprofiler
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/cpgeneprofiler/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_cpgeneprofiler', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for cpgeneprofiler
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/cpgeneprofiler/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_cpgeneprofiler', spec);
            } catch (err) {
