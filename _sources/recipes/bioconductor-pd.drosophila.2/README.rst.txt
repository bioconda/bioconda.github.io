...
.. conda:recipe:: bioconductor-pd.drosophila.2
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/pd.drosophila.2.html
...
.. conda:package:: bioconductor-pd.drosophila.2
   ...
   :required~by: |required_by_bioconductor-pd.drosophila.2|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-pd.drosophila.2


.. |required_by_bioconductor-pd.drosophila.2| conda:required_by:: bioconductor-pd.drosophila.2
