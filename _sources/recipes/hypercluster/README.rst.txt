...
.. conda:package:: hypercluster
   ...
   :depends on hdbscan: ``>=0.8.24``
   :depends on igraph: ``>=0.7.1``
   :depends on leidenalg: ``>=0.7.0``
   :depends on louvain: ``>=0.6.1``
   :depends on matplotlib: ``>=3.1.0``
...
to install globally, run::
    ...
    pixi global install hypercluster

to add into an existing workspace instead, run::

    pixi add hypercluster
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname hypercluster
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_hypercluster"></div>
   <div style="width: 100%" id="platform_plot_hypercluster"></div>
   <div style="width: 100%" id="cdf_plot_hypercluster"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for hypercluster
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/hypercluster/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_hypercluster', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for hypercluster
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/hypercluster/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_hypercluster', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for hypercluster
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/hypercluster/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_hypercluster', spec);
            } catch (err) {
