...
.. conda:recipe:: bioconductor-hgu95b.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/hgu95b.db.html
...
.. conda:package:: bioconductor-hgu95b.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hgu95b.db

   and update with::

      mamba update bioconductor-hgu95b.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hgu95b.db
