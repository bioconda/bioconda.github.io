...
.. conda:package:: snakemake
   ...
   :depends pygments: 
   :depends slack_sdk: 
   :depends snakemake-minimal: ``9.10.1.*``
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["9.10.1","9.10.0","9.9.0","9.8.2","9.8.1"];
    </script>
...
.. conda:package:: snakemake-minimal
   ...
   :depends jsonschema: 
   :depends nbformat: 
   :depends packaging: ``>=24.0,<26.0``
   :depends psutil: 
   :depends pulp: ``>=2.3.1,<3.1``
   ...
   :depends snakemake-interface-logger-plugins: ``>=1.1.0,<2.0.0``
   :depends snakemake-interface-report-plugins: ``>=1.1.0,<2.0.0``
   :depends snakemake-interface-scheduler-plugins: ``>=2.0.0,<3.0.0``
   :depends snakemake-interface-storage-plugins: ``>=4.1.0,<5.0``
   :depends tabulate: 
   :depends throttler: 
   :depends wrapt: 
