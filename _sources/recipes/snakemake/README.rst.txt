...
.. conda:package:: snakemake
   ...
   :depends slacker: 
   :depends snakemake-minimal: ``6.9.0.*``
   :depends xorg-libxau: 
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["6.9.0","6.8.2","6.8.1","6.8.0","6.7.0"];
    </script>
