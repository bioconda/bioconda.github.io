...
.. conda:package:: snakemake
   ...
   :depends pygments: 
   :depends slack_sdk: 
   :depends snakemake-minimal: ``9.4.1.*``
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["9.4.1","9.4.0","9.3.5","9.3.4","9.3.3"];
    </script>
