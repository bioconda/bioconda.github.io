...
.. conda:package:: snakemake
   ...
   :depends slacker: 
   :depends snakemake-minimal: ``7.31.0.*``
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["7.31.0","7.31.0","7.31.0","7.30.2","7.30.2"];
    </script>
