...
.. conda:package:: snakemake
   ...
   :depends slacker: 
   :depends snakemake-minimal: ``6.15.0.*``
   :depends xorg-libxau: 
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["6.15.0","6.14.0","6.13.1","6.13.0","6.12.3"];
    </script>
