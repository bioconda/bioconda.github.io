...
.. conda:package:: snakemake
   ...
   :depends pygments: 
   :depends slack_sdk: 
   :depends snakemake-minimal: ``9.1.1.*``
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["9.1.1","9.0.1","8.30.0","8.29.3","8.29.2"];
    </script>
...
.. conda:package:: snakemake-minimal
   ...
   :depends snakemake-interface-executor-plugins: ``>=9.3.2,<10.0.0``
   :depends snakemake-interface-logger-plugins: 
   :depends snakemake-interface-report-plugins: ``>=1.1.0,<2.0.0``
   :depends snakemake-interface-storage-plugins: ``>=3.2.3,<4.0``
   :depends tabulate: 
   :depends throttler: 
   :depends wrapt: 
