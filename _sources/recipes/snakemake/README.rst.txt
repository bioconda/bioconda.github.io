...
.. conda:package:: snakemake
   ...
   :depends ftputil: ``>=3.2``
   :depends google-api-python-client: ``1.9.1.*``
   :depends google-cloud-storage: ``1.28.1.*``
   ...
   :depends slacker: 
   :depends snakemake-minimal: ``5.21.0.*``
   :requirements:
