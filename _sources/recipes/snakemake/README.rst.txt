...
.. conda:package:: snakemake
   ...
   :depends slacker: 
   :depends snakemake-minimal: ``6.8.1.*``
   :depends xorg-libxau: 
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["6.8.1","6.8.0","6.7.0","6.6.1","6.6.0"];
    </script>
