...
.. conda:package:: snakemake
   ...
   :depends pygments: 
   :depends slack_sdk: 
   :depends snakemake-minimal: ``8.11.3.*``
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["8.11.3","8.11.2","8.11.1","8.11.0","8.10.8"];
    </script>
...
.. raw:: html
    ...
    <script>
        var package = "snakemake";
        var versions = ["8.11.3","8.11.1","8.11.0","8.10.8","8.10.8"];
    </script>
