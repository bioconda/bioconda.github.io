...
.. conda:package:: snakemake
   ...
   :depends pygments: 
   :depends slack_sdk: 
   :depends snakemake-minimal: ``8.10.0.*``
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["8.10.0","8.9.0","8.8.0","8.7.0","8.6.0"];
    </script>
...
.. conda:package:: snakemake-minimal
   ...
   :depends snakemake-interface-executor-plugins: ``>=9.0.2,<10.0.0``
