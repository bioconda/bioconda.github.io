...
.. conda:package:: snakemake
   ...
   :depends slacker: 
   :depends snakemake-minimal: ``6.13.1.*``
   :depends xorg-libxau: 
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["6.13.1","6.13.0","6.12.3","6.12.2","6.12.1"];
    </script>
