...
.. conda:package:: snakemake
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>7.8.1-0</code>,  <code>7.8.0-0</code>,  <code>7.7.0-0</code>,  <code>7.6.2-0</code>,  <code>7.6.1-1</code>,  <code>7.6.1-0</code>,  <code>7.6.0-0</code>,  <code>7.5.0-0</code>,  <code>7.3.8-0</code>,  </span></summary>
   ...
   :depends slacker: 
   :depends snakemake-minimal: ``7.8.1.*``
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["7.8.1","7.8.0","7.7.0","7.6.2","7.6.1"];
    </script>
