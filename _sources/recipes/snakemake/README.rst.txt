...
.. conda:package:: snakemake
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>7.9.0-0</code>,  <code>7.8.5-0</code>,  <code>7.8.3-0</code>,  <code>7.8.2-0</code>,  <code>7.8.1-0</code>,  <code>7.8.0-0</code>,  <code>7.7.0-0</code>,  <code>7.6.2-0</code>,  <code>7.6.1-1</code>,  </span></summary>
   ...
   :depends slacker: 
   :depends snakemake-minimal: ``7.9.0.*``
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["7.9.0","7.8.5","7.8.3","7.8.2","7.8.1"];
    </script>
