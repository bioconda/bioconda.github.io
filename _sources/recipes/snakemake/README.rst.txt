...
.. conda:package:: snakemake
   ...
   :depends pygments: 
   :depends slack_sdk: 
   :depends snakemake-minimal: ``9.6.1.*``
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["9.6.1","9.6.0","9.5.1","9.5.0","9.4.1"];
    </script>
