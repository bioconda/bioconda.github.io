...
.. conda:package:: snakemake
   ...
   :depends pygments: 
   :depends slack_sdk: 
   :depends snakemake-minimal: ``8.1.0.*``
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["8.1.0","8.0.1","8.0.0","7.32.4","7.32.4"];
    </script>
