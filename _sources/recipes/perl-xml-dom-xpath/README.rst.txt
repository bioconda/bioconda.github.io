...
to install globally, run::
    ...
    pixi global install perl-xml-dom-xpath

to add into an existing workspace instead, run::

    pixi add perl-xml-dom-xpath
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname perl-xml-dom-xpath
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_perl-xml-dom-xpath"></div>
   <div style="width: 100%" id="platform_plot_perl-xml-dom-xpath"></div>
   <div style="width: 100%" id="cdf_plot_perl-xml-dom-xpath"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for perl-xml-dom-xpath
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-xml-dom-xpath/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_perl-xml-dom-xpath', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for perl-xml-dom-xpath
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-xml-dom-xpath/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_perl-xml-dom-xpath', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for perl-xml-dom-xpath
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-xml-dom-xpath/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_perl-xml-dom-xpath', spec);
            } catch (err) {
