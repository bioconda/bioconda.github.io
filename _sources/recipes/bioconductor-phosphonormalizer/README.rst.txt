...
.. conda:recipe:: bioconductor-phosphonormalizer
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/phosphonormalizer.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-phosphonormalizer
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-phosphonormalizer

   and update with::

      mamba update bioconductor-phosphonormalizer

  To create a new environment, run::

      mamba create --name myenvname bioconductor-phosphonormalizer
