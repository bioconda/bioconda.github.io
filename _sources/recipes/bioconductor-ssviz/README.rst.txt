...
.. conda:recipe:: bioconductor-ssviz
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/ssviz.html
   :license: GPL-2
...
.. conda:package:: bioconductor-ssviz
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ssviz

   and update with::

      mamba update bioconductor-ssviz

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ssviz
