...
License       GPL (>= 2)
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes//r-traminer/meta.yaml
...
A Docker container is available at https://quay.io/repository/biocontainers/r-traminer.
...
Render an |badge| badge with the following Markdown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square)](http://bioconda.github.io/recipes/r-traminer/README.html)

.. |badge| image:: https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square
           :target: http://bioconda.github.io/recipes/r-traminer/README.html
.. |downloads| image:: https://anaconda.org/bioconda/r-traminer/badges/downloads.svg
               :target: https://anaconda.org/bioconda/r-traminer
.. |docker| image:: https://quay.io/repository/biocontainers/r-traminer/status
