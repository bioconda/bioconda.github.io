...
.. conda:recipe:: bioconductor-chromhmmdata
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/chromhmmData.html
   :license: GPL-3
...
.. conda:package:: bioconductor-chromhmmdata
   ...
   :versions:
      ...
      ``0.99.2-6``,  ``0.99.2-5``,  ``0.99.2-4``,  ``0.99.2-3``,  ``0.99.2-2``,  ``0.99.2-1``,  ``0.99.2-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-chromhmmdata

to add into an existing workspace instead, run::

    pixi add bioconductor-chromhmmdata
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-chromhmmdata
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-chromhmmdata"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-chromhmmdata"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-chromhmmdata"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-chromhmmdata
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-chromhmmdata/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-chromhmmdata', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-chromhmmdata
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-chromhmmdata/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-chromhmmdata', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-chromhmmdata
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-chromhmmdata/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-chromhmmdata', spec);
            } catch (err) {
