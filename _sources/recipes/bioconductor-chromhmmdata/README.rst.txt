...
.. conda:recipe:: bioconductor-chromhmmdata
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/chromhmmData.html
   :license: GPL-3
...
.. conda:package:: bioconductor-chromhmmdata
   ...
   :versions:
      ...
      ``0.99.2-3``,  ``0.99.2-2``,  ``0.99.2-1``,  ``0.99.2-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.99.2","0.99.2","0.99.2","0.99.2"];
    </script>
