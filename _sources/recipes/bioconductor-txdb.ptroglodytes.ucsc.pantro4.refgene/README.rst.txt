...
.. conda:recipe:: bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/TxDb.Ptroglodytes.UCSC.panTro4.refGene.html
...
.. conda:package:: bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene
   ...
   :versions:
      ...
      ``3.12.0-9``,  ``3.12.0-8``,  ``3.12.0-7``,  ``3.12.0-6``,  ``3.12.0-5``,  ``3.12.0-4``,  ``3.12.0-3``,  ``3.12.0-2``,  ``3.12.0-1``,  ``3.12.0-0``,  ``3.11.0-0``,  ``3.10.0-0``,  ``3.4.6-1``,  ``3.4.4-1``,  ``3.4.4-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene

to add into an existing workspace instead, run::

    pixi add bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-txdb.ptroglodytes.ucsc.pantro4.refgene', spec);
            } catch (err) {
