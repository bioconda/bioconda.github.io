...
.. conda:package:: perl-class-accessor
   ...
   :required~by: |required_by_perl-class-accessor|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/perl-class-accessor


.. |required_by_perl-class-accessor| conda:required_by:: perl-class-accessor
