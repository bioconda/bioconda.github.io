...
.. conda:recipe:: bioconductor-microbiotaprocess
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/MicrobiotaProcess.html
   :license: GPL (>= 3.0)
...
.. conda:package:: bioconductor-microbiotaprocess
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.22.1-0</code>,  <code>1.22.0-0</code>,  <code>1.18.0-0</code>,  <code>1.14.0-0</code>,  <code>1.12.2-0</code>,  <code>1.10.0-0</code>,  <code>1.6.1-0</code>,  <code>1.4.0-0</code>,  <code>1.2.1-0</code>,  </span></summary>
      

      ``1.22.1-0``,  ``1.22.0-0``,  ``1.18.0-0``,  ``1.14.0-0``,  ``1.12.2-0``,  ``1.10.0-0``,  ``1.6.1-0``,  ``1.4.0-0``,  ``1.2.1-0``,  ``1.2.0-0``,  ``1.0.3-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.22.1","1.22.0","1.18.0","1.14.0","1.12.2"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-microbiotaprocess"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-microbiotaprocess"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-microbiotaprocess"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-microbiotaprocess
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-microbiotaprocess/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-microbiotaprocess', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-microbiotaprocess
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-microbiotaprocess/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-microbiotaprocess', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-microbiotaprocess
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-microbiotaprocess/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-microbiotaprocess', spec);
            } catch (err) {
