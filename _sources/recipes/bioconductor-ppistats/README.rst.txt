...
.. conda:recipe:: bioconductor-ppistats
   ...
   :homepage: https://bioconductor.org/packages/3.10/bioc/html/ppiStats.html
...
.. conda:package:: bioconductor-ppistats
   ...
   :versions: 1.52.0-1, 1.50.0-1, 1.48.0-0, 1.46.0-0, 1.44.0-0
   
   :depends bioconductor-biobase: >=2.46.0,<2.47.0
   :depends bioconductor-category: >=2.52.0,<2.53.0
   :depends bioconductor-graph: >=1.64.0,<1.65.0
   :depends bioconductor-ppidata: >=0.24.0,<0.25.0
