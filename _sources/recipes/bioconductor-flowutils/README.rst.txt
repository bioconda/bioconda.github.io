...
.. conda:package:: bioconductor-flowutils
   ...
   :depends: :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`bioconductor-flowcore` >=1.48.0,<1.49.0 :conda:package:`bioconductor-graph` >=1.60.0,<1.61.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-corpcor`  :conda:package:`r-runit`  :conda:package:`r-xml`  

   :required~by: |required_by_bioconductor-flowutils|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-flowutils


.. |required_by_bioconductor-flowutils| conda:required_by:: bioconductor-flowutils
