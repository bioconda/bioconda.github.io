...
.. conda:recipe:: bioconductor-tofsims
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/tofsims.html
   :license: GPL-3
...
.. conda:package:: bioconductor-tofsims
   ...
   :versions:
      ...
      ``1.20.0-0``,  ``1.18.0-1``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-0``,  ``1.12.0-1``,  ``1.12.0-0``,  ``1.10.1-0``,  ``1.10.0-0``

      

   
   :depends bioconductor-alsace: ``>=1.28.0,<1.29.0``
