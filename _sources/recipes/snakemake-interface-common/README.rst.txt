...
.. conda:package:: snakemake-interface-common
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.14.1-0</code>,  <code>1.14.0-0</code>,  <code>1.13.0-0</code>,  <code>1.12.0-0</code>,  <code>1.10.0-0</code>,  <code>1.8.0-0</code>,  <code>1.7.3-0</code>,  <code>1.7.1-0</code>,  <code>1.4.1-0</code>,  </span></summary>
      

      ``1.14.1-0``,  ``1.14.0-0``,  ``1.13.0-0``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.7.3-0``,  ``1.7.1-0``,  ``1.4.1-0``,  ``1.3.3-0``,  ``1.3.2-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.14.1","1.14.0","1.13.0","1.12.0","1.10.0"];
    </script>
