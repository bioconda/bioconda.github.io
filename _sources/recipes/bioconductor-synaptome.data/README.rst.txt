...
.. conda:recipe:: bioconductor-synaptome.data
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/synaptome.data.html
...
.. conda:package:: bioconductor-synaptome.data
   ...
   :versions:
      ...
      ``0.99.6-1``,  ``0.99.6-0``,  ``0.99.3-1``,  ``0.99.3-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.99.6","0.99.6","0.99.3","0.99.3"];
    </script>
