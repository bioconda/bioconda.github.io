...
.. conda:recipe:: bioconductor-ygs98probe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/ygs98probe.html
   :license: LGPL
...
.. conda:package:: bioconductor-ygs98probe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ygs98probe

   and update with::

      mamba update bioconductor-ygs98probe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ygs98probe
