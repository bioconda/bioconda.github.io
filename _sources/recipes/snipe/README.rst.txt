...
.. conda:package:: snipe
   ...
   :depends on lzstring: 
   :depends on numpy: ``>=1.22,<2``
   :depends on pandas: 
   :depends on pathos: 
   :depends on pyfastx: ``>=2.1.0,<3.0a0``
   :depends on python: ``>=3.7,<3.12``
   :depends on rapidfuzz: 
   :depends on requests: ``>=2.25.1``
   :depends on sourmash: ``>=4.8.11``
   :depends on tqdm: 
   :depends on zlib: 
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_snipe"></div>
   <div style="width: 100%" id="platform_plot_snipe"></div>
   <div style="width: 100%" id="cdf_plot_snipe"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/snipe/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_snipe', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for snipe
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/snipe/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_snipe', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for snipe
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/snipe/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_snipe', spec);
            } catch (err) {
