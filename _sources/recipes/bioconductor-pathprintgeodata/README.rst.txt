...
.. conda:package:: bioconductor-pathprintgeodata
   ...
   :versions:
      ...
      ``1.20.0-1``,  ``1.20.0-0``,  ``1.19.1-0``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-1``,  ``1.14.0-0``,  ``1.12.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-pathprintgeodata";
        var versions = ["1.20.0","1.20.0","1.19.1","1.18.0","1.16.0"];
    </script>
