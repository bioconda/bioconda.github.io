...
.. conda:recipe:: bioconductor-raex10stprobeset.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/raex10stprobeset.db.html
...
.. conda:package:: bioconductor-raex10stprobeset.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-raex10stprobeset.db

   and update with::

      mamba update bioconductor-raex10stprobeset.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-raex10stprobeset.db
