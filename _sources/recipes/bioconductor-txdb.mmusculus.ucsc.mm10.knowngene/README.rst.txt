...
.. conda:recipe:: bioconductor-txdb.mmusculus.ucsc.mm10.knowngene
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/TxDb.Mmusculus.UCSC.mm10.knownGene.html
...
.. conda:package:: bioconductor-txdb.mmusculus.ucsc.mm10.knowngene
   ...
   :versions:
      ...
      ``3.10.0-11``,  ``3.10.0-10``,  ``3.10.0-9``,  ``3.10.0-8``,  ``3.10.0-7``,  ``3.10.0-6``,  ``3.10.0-5``,  ``3.10.0-4``,  ``3.10.0-3``,  ``3.10.0-2``,  ``3.10.0-1``,  ``3.10.0-0``,  ``3.4.7-1``,  ``3.4.4-0``,  ``3.4.0-3``,  ``3.4.0-1``,  ``3.4.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-txdb.mmusculus.ucsc.mm10.knowngene

to add into an existing workspace instead, run::

    pixi add bioconductor-txdb.mmusculus.ucsc.mm10.knowngene
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-txdb.mmusculus.ucsc.mm10.knowngene
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-txdb.mmusculus.ucsc.mm10.knowngene"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-txdb.mmusculus.ucsc.mm10.knowngene"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-txdb.mmusculus.ucsc.mm10.knowngene"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-txdb.mmusculus.ucsc.mm10.knowngene
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.mmusculus.ucsc.mm10.knowngene/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-txdb.mmusculus.ucsc.mm10.knowngene', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-txdb.mmusculus.ucsc.mm10.knowngene
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.mmusculus.ucsc.mm10.knowngene/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-txdb.mmusculus.ucsc.mm10.knowngene', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-txdb.mmusculus.ucsc.mm10.knowngene
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.mmusculus.ucsc.mm10.knowngene/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-txdb.mmusculus.ucsc.mm10.knowngene', spec);
            } catch (err) {
