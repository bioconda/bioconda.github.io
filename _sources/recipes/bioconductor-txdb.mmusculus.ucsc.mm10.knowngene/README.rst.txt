...
.. conda:recipe:: bioconductor-txdb.mmusculus.ucsc.mm10.knowngene
   ...
   :homepage: https://bioconductor.org/packages/3.16/data/annotation/html/TxDb.Mmusculus.UCSC.mm10.knownGene.html
...
.. conda:package:: bioconductor-txdb.mmusculus.ucsc.mm10.knowngene
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.10.0-7</code>,  <code>3.10.0-6</code>,  <code>3.10.0-5</code>,  <code>3.10.0-4</code>,  <code>3.10.0-3</code>,  <code>3.10.0-2</code>,  <code>3.10.0-1</code>,  <code>3.10.0-0</code>,  <code>3.4.7-1</code>,  </span></summary>
      

      ``3.10.0-7``,  ``3.10.0-6``,  ``3.10.0-5``,  ``3.10.0-4``,  ``3.10.0-3``,  ``3.10.0-2``,  ``3.10.0-1``,  ``3.10.0-0``,  ``3.4.7-1``,  ``3.4.4-0``,  ``3.4.0-3``,  ``3.4.0-1``,  ``3.4.0-0``
