...
.. conda:recipe:: bioconductor-rrdpdata
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/rRDPData.html
   :license: GPL-2
...
.. conda:package:: bioconductor-rrdpdata
   ...
   :depends on bioconductor-rrdp: ``>=1.44.0,<1.45.0``
   :depends on curl: 
...
to install globally, run::
    ...
    pixi global install bioconductor-rrdpdata

to add into an existing workspace instead, run::

    pixi add bioconductor-rrdpdata
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-rrdpdata
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-rrdpdata"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-rrdpdata"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-rrdpdata"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-rrdpdata
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rrdpdata/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-rrdpdata', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-rrdpdata
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rrdpdata/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-rrdpdata', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-rrdpdata
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rrdpdata/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-rrdpdata', spec);
            } catch (err) {
