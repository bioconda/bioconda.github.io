...
.. conda:recipe:: bioconductor-simd
   ...
   :homepage: https://bioconductor.org/packages/3.11/bioc/html/SIMD.html
   :license: GPL-3
...
.. conda:package:: bioconductor-simd
   ...
   :versions:
      ...
      ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.0-1``,  ``1.2.0-0``,  ``1.0.0-0``

      

   
   :depends bioconductor-edger: ``>=3.32.0,<3.33.0``
   :depends bioconductor-methylmnm: ``>=1.28.0,<1.29.0``
