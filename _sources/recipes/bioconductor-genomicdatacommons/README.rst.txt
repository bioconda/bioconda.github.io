...
.. conda:recipe:: bioconductor-genomicdatacommons
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/GenomicDataCommons.html
...
.. conda:package:: bioconductor-genomicdatacommons
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-genomicdatacommons

   and update with::

      mamba update bioconductor-genomicdatacommons

  To create a new environment, run::

      mamba create --name myenvname bioconductor-genomicdatacommons
