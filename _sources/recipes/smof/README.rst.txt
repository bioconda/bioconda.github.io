...
.. conda:package:: smof
   ...
   :versions:
      ...
      ``2.22.2-0``,  ``2.22.1-0``,  ``2.22.0-0``,  ``2.21.1-0``,  ``2.19.0-0``,  ``2.18.0-0``,  ``2.17.0-0``,  ``2.16.0-0``,  ``2.14.3-0``
  ...
  To create a new environment, run::
      ...
      mamba create --name myenvname smof
...
.. raw:: html
    ...
    <script>
        var package = "smof";
        var versions = ["2.22.2","2.22.1","2.22.0","2.21.1","2.19.0"];
    </script>
