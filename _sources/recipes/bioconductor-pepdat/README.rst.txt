...
.. conda:recipe:: bioconductor-pepdat
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/pepDat.html
...
.. conda:package:: bioconductor-pepdat
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pepdat

   and update with::

      mamba update bioconductor-pepdat

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pepdat
