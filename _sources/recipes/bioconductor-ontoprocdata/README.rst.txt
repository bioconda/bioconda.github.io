...
.. conda:recipe:: bioconductor-ontoprocdata
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/ontoProcData.html
...
.. conda:package:: bioconductor-ontoprocdata
   ...
   :versions:
      ...
      ``0.99.9901-4``,  ``0.99.9901-3``,  ``0.99.9901-2``,  ``0.99.9901-1``,  ``0.99.9901-0``,  ``0.99.9-1``,  ``0.99.9-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-ontoprocdata

to add into an existing workspace instead, run::

    pixi add bioconductor-ontoprocdata
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-ontoprocdata
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["0.99.9901","0.99.9901","0.99.9901","0.99.9901","0.99.9901"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-ontoprocdata"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-ontoprocdata"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-ontoprocdata"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-ontoprocdata
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ontoprocdata/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-ontoprocdata', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-ontoprocdata
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ontoprocdata/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-ontoprocdata', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-ontoprocdata
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ontoprocdata/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-ontoprocdata', spec);
            } catch (err) {
