...
.. conda:package:: abeona
   ...
   :depends: :conda:package:`bwa`  :conda:package:`cortexpy` 0.45.7 :conda:package:`kallisto` 0.44.0 :conda:package:`mccortex` 1.0 :conda:package:`nextflow` 0.32.0 :conda:package:`pandas`  :conda:package:`progressbar2`  :conda:package:`python` >=3.6,<3.7.0a0 
