...
.. conda:recipe:: bioconductor-bovinecdf
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/bovinecdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-bovinecdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bovinecdf

   and update with::

      mamba update bioconductor-bovinecdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bovinecdf
