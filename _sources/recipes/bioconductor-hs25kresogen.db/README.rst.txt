...
.. conda:recipe:: bioconductor-hs25kresogen.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/hs25kresogen.db.html
...
.. conda:package:: bioconductor-hs25kresogen.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hs25kresogen.db

   and update with::

      mamba update bioconductor-hs25kresogen.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hs25kresogen.db
