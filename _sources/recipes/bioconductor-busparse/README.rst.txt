...
.. conda:recipe:: bioconductor-busparse
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/BUSpaRse.html
...
.. conda:package:: bioconductor-busparse
   ...
   :versions:
      ...
      ``1.8.0-2``,  ``1.8.0-1``,  ``1.8.0-0``,  ``1.5.3-0``,  ``1.4.2-0``,  ``1.4.0-0``,  ``1.2.1-0``,  ``1.0.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.8.0","1.8.0","1.8.0","1.5.3","1.4.2"];
    </script>
