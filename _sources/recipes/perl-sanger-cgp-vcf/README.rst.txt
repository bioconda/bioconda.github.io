...
.. conda:package:: perl-sanger-cgp-vcf
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.2.1-10</code>,  <code>2.2.1-9</code>,  <code>2.2.1-8</code>,  <code>2.2.1-7</code>,  <code>2.2.1-6</code>,  <code>2.2.1-5</code>,  <code>2.2.1-4</code>,  <code>2.2.1-3</code>,  <code>2.2.1-2</code>,  </span></summary>
      

      ``2.2.1-10``,  ``2.2.1-9``,  ``2.2.1-8``,  ``2.2.1-7``,  ``2.2.1-6``,  ``2.2.1-5``,  ``2.2.1-4``,  ``2.2.1-3``,  ``2.2.1-2``,  ``2.2.1-1``,  ``2.2.1-0``,  ``1.3.1-3``,  ``1.3.1-2``,  ``1.3.1-1``,  ``1.3.1-0``
   ...
   :depends on perl-const-fast: 
   :depends on perl-data-uuid: 
   :depends on perl-datetime: 
   :depends on perl-ipc-system-simple: ``1.30.*``
...
to install globally, run::
    ...
    pixi global install perl-sanger-cgp-vcf

to add into an existing workspace instead, run::

    pixi add perl-sanger-cgp-vcf
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname perl-sanger-cgp-vcf
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_perl-sanger-cgp-vcf"></div>
   <div style="width: 100%" id="platform_plot_perl-sanger-cgp-vcf"></div>
   <div style="width: 100%" id="cdf_plot_perl-sanger-cgp-vcf"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for perl-sanger-cgp-vcf
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-sanger-cgp-vcf/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_perl-sanger-cgp-vcf', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for perl-sanger-cgp-vcf
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-sanger-cgp-vcf/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_perl-sanger-cgp-vcf', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for perl-sanger-cgp-vcf
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-sanger-cgp-vcf/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_perl-sanger-cgp-vcf', spec);
            } catch (err) {
