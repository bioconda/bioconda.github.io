...
.. conda:recipe:: gcs-oauth2-boto-plugin
   ...
   :license: Apache 2.0
   :recipe: /`gcs-oauth2-boto-plugin <https://github.com/bioconda/bioconda-recipes/tree/master/recipes/gcs-oauth2-boto-plugin>`_/`meta.yaml <https://github.com/bioconda/bioconda-recipes/tree/master/recipes/gcs-oauth2-boto-plugin/meta.yaml>`_
