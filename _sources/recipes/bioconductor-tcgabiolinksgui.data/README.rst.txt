...
.. conda:recipe:: bioconductor-tcgabiolinksgui.data
   ...
   :homepage: https://bioconductor.org/packages/3.16/data/experiment/html/TCGAbiolinksGUI.data.html
   :license: GPL-3
...
.. conda:package:: bioconductor-tcgabiolinksgui.data
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.20.0-0</code>,  <code>1.18.0-0</code>,  <code>1.17.0-0</code>,  <code>1.14.1-0</code>,  <code>1.14.0-0</code>,  <code>1.12.0-0</code>,  <code>1.10.0-1</code>,  <code>1.10.0-0</code>,  <code>1.9.2-0</code>,  </span></summary>
      

      ``1.20.0-0``,  ``1.18.0-0``,  ``1.17.0-0``,  ``1.14.1-0``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.0-1``,  ``1.10.0-0``,  ``1.9.2-0``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-1``,  ``1.4.0-0``,  ``1.3.0-0``,  ``1.2.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.20.0","1.18.0","1.17.0","1.14.1","1.14.0"];
    </script>
