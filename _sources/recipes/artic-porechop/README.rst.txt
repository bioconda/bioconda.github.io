...
to install globally, run::
    ...
    pixi global install artic-porechop

to add into an existing workspace instead, run::

    pixi add artic-porechop
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname artic-porechop
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_artic-porechop"></div>
   <div style="width: 100%" id="platform_plot_artic-porechop"></div>
   <div style="width: 100%" id="cdf_plot_artic-porechop"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for artic-porechop
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/artic-porechop/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_artic-porechop', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for artic-porechop
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/artic-porechop/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_artic-porechop', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for artic-porechop
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/artic-porechop/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_artic-porechop', spec);
            } catch (err) {
