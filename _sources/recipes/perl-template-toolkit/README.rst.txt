...
.. conda:package:: perl-template-toolkit
   ...
   :depends on perl-image-info: ``>=1.45,<2.0a0``
   :depends on perl-image-size: 
...
to install globally, run::
    ...
    pixi global install perl-template-toolkit

to add into an existing workspace instead, run::

    pixi add perl-template-toolkit
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname perl-template-toolkit
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_perl-template-toolkit"></div>
   <div style="width: 100%" id="platform_plot_perl-template-toolkit"></div>
   <div style="width: 100%" id="cdf_plot_perl-template-toolkit"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for perl-template-toolkit
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-template-toolkit/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_perl-template-toolkit', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for perl-template-toolkit
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-template-toolkit/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_perl-template-toolkit', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for perl-template-toolkit
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-template-toolkit/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_perl-template-toolkit', spec);
            } catch (err) {
