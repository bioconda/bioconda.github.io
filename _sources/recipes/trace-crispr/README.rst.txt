...
to install globally, run::
    ...
    pixi global install trace-crispr

to add into an existing workspace instead, run::

    pixi add trace-crispr
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install trace-crispr

Alternatively, to install into a new environment, run::

    conda create -n envname trace-crispr
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_trace-crispr"></div>
   <div style="width: 100%" id="platform_plot_trace-crispr"></div>
   <div style="width: 100%" id="cdf_plot_trace-crispr"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for trace-crispr
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/trace-crispr/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_trace-crispr', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for trace-crispr
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/trace-crispr/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_trace-crispr', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for trace-crispr
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/trace-crispr/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_trace-crispr', spec);
            } catch (err) {
