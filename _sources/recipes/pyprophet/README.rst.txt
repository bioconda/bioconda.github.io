...
.. conda:package:: pyprophet
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.1.11-0</code>,  <code>2.1.10-2</code>,  <code>2.1.10-1</code>,  <code>2.1.10-0</code>,  <code>2.1.6-0</code>,  <code>2.1.5-1</code>,  <code>2.1.5-0</code>,  <code>2.1.4-0</code>,  <code>2.1.3-0</code>,  </span></summary>
      

      ``2.1.11-0``,  ``2.1.10-2``,  ``2.1.10-1``,  ``2.1.10-0``,  ``2.1.6-0``,  ``2.1.5-1``,  ``2.1.5-0``,  ``2.1.4-0``,  ``2.1.3-0``,  ``0.24.1-1``,  ``0.24.1-0``,  ``0.22.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.1.11","2.1.10","2.1.10","2.1.10","2.1.6"];
    </script>
