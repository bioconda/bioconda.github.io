...
.. conda:recipe:: bioconductor-zebrafishrnaseq
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/experiment/html/zebrafishRNASeq.html
   :license: GPL
...
.. conda:package:: bioconductor-zebrafishrnaseq
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-zebrafishrnaseq

   and update with::

      mamba update bioconductor-zebrafishrnaseq

  To create a new environment, run::

      mamba create --name myenvname bioconductor-zebrafishrnaseq
