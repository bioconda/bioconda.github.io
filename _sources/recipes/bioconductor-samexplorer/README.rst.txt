...
.. conda:recipe:: bioconductor-samexplorer
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/samExploreR.html
   :license: GPL-3
...
.. conda:package:: bioconductor-samexplorer
   ...
   :versions:
      ...
      ``1.13.0-1``,  ``1.13.0-0``,  ``1.12.0-0``,  ``1.10.0-1``,  ``1.8.0-1``,  ``1.8.0-0``,  ``1.6.1-0``,  ``1.6.0-0``

      

   
   :depends bioconductor-edger: ``>=3.32.0,<3.33.0``
   :depends bioconductor-rnaseqdata.hnrnpc.bam.chr14: ``>=0.28.0,<0.29.0``
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-samexplorer";
        var versions = ["1.13.0","1.13.0","1.12.0","1.10.0","1.8.0"];
    </script>
