...
.. conda:recipe:: bioconductor-rebet
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/REBET.html
   :license: GPL-2
...
.. conda:package:: bioconductor-rebet
   ...
   :depends on bioconductor-asset: ``>=2.28.0,<2.29.0``
   :depends on bioconductor-asset: ``>=2.28.0,<2.29.0a0``
...
to install globally, run::
    ...
    pixi global install bioconductor-rebet

to add into an existing workspace instead, run::

    pixi add bioconductor-rebet
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-rebet
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-rebet"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-rebet"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-rebet"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-rebet
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rebet/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-rebet', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-rebet
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rebet/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-rebet', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-rebet
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rebet/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-rebet', spec);
            } catch (err) {
