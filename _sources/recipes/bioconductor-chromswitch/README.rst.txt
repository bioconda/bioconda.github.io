...
.. conda:package:: bioconductor-chromswitch
   ...
   :depends on r-cluster: ``>=2.0.6``
   :depends on r-dplyr: ``>=0.5.0``
   :depends on r-gplots: ``>=3.0.1``
   :depends on r-lazyeval: ``>=0.2.0``
   :depends on r-magrittr: ``>=1.5``
   :depends on r-matrixstats: ``>=0.52``
   :depends on r-nmf: ``>=0.20.6``
   :depends on r-tidyr: ``>=0.6.3``
...
to install globally, run::
    ...
    pixi global install bioconductor-chromswitch

to add into an existing workspace instead, run::

    pixi add bioconductor-chromswitch
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-chromswitch
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-chromswitch"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-chromswitch"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-chromswitch"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-chromswitch
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-chromswitch/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-chromswitch', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-chromswitch
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-chromswitch/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-chromswitch', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-chromswitch
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-chromswitch/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-chromswitch', spec);
            } catch (err) {
