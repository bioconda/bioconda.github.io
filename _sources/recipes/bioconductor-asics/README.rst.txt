...
.. conda:recipe:: bioconductor-asics
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/ASICS.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-asics
   ...
   :versions:
      ...
      ``2.14.0-0``,  ``2.10.0-0``,  ``2.8.0-0``,  ``2.6.1-1``,  ``2.6.1-0``,  ``2.4.0-0``,  ``2.2.0-0``,  ``2.0.1-0``,  ``1.2.0-0``

      

   
   :depends bioconductor-biocparallel: ``>=1.32.0,<1.33.0``
   :depends bioconductor-pepsnmr: ``>=1.16.0,<1.17.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.14.0","2.10.0","2.8.0","2.6.1","2.6.1"];
    </script>
