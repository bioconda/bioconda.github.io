...
.. conda:recipe:: longphase
   ...
   :documentation: https://github.com/twolinin/longphase/blob/v2.0.2/README.md
...
.. conda:package:: longphase
   ...
   :versions:
      ...
      ``2.0.2-0``,  ``2.0.1-1``,  ``2.0.1-0``,  ``2.0-0``,  ``1.7.3-0``
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install longphase

Alternatively, to install into a new environment, run::

    conda create -n envname longphase
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["2.0.2","2.0.1","2.0.1","2.0","1.7.3"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_longphase"></div>
   <div style="width: 100%" id="platform_plot_longphase"></div>
   <div style="width: 100%" id="cdf_plot_longphase"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/longphase/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_longphase', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for longphase
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/longphase/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_longphase', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for longphase
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/longphase/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_longphase', spec);
            } catch (err) {
