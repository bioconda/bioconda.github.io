...
.. conda:recipe:: bioconductor-txdb.rnorvegicus.ucsc.rn7.refgene
   ...
   :homepage: https://bioconductor.org/packages/3.16/data/annotation/html/TxDb.Rnorvegicus.UCSC.rn7.refGene.html
...
.. conda:package:: bioconductor-txdb.rnorvegicus.ucsc.rn7.refgene
   ...
   :versions:
      ...
      ``3.15.0-1``,  ``3.15.0-0``,  ``3.14.0-1``,  ``3.14.0-0``
   ...
   and update with::
      ...
      conda update bioconductor-txdb.rnorvegicus.ucsc.rn7.refgene
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["3.15.0","3.15.0","3.14.0","3.14.0"];
    </script>
