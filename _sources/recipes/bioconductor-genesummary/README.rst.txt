...
.. conda:recipe:: bioconductor-genesummary
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/GeneSummary.html
...
.. conda:package:: bioconductor-genesummary
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-genesummary

   and update with::

      mamba update bioconductor-genesummary

  To create a new environment, run::

      mamba create --name myenvname bioconductor-genesummary
