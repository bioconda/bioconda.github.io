...
.. conda:package:: saccharis
   ...
   :versions:
      ...
      ``2.0.1-1``,  ``2.0.1-0``,  ``2.0.0.dev21-2``,  ``2.0.0.dev21-0``,  ``2.0.0.dev20-0``,  ``2.0.0.dev19-7``,  ``2.0.0.dev19-0``,  ``2.0.0.dev18-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.0.1","2.0.1","2.0.0.dev21","2.0.0.dev21","2.0.0.dev20"];
    </script>
