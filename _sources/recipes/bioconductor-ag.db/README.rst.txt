...
.. conda:recipe:: bioconductor-ag.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/ag.db.html
...
.. conda:package:: bioconductor-ag.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ag.db

   and update with::

      mamba update bioconductor-ag.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ag.db
