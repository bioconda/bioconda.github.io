...
.. conda:recipe:: bioconductor-listeretalbsseq
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/ListerEtAlBSseq.html
...
.. conda:package:: bioconductor-listeretalbsseq
   ...
   :depends bioconductor-methylpipe: ``>=1.44.0,<1.45.0``
   :depends curl: 
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-listeretalbsseq

   and update with::

      mamba update bioconductor-listeretalbsseq

  To create a new environment, run::

      mamba create --name myenvname bioconductor-listeretalbsseq
