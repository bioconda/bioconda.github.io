...
.. conda:recipe:: bioconductor-cyp450cdf
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/cyp450cdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-cyp450cdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-cyp450cdf

   and update with::

      mamba update bioconductor-cyp450cdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-cyp450cdf
