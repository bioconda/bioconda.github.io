...
.. conda:package:: bioconductor-hom.dr.inp.db
   ...
   :required~by: |required_by_bioconductor-hom.dr.inp.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-hom.dr.inp.db


.. |required_by_bioconductor-hom.dr.inp.db| conda:required_by:: bioconductor-hom.dr.inp.db
