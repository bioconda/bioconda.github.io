...
.. conda:package:: bioconductor-indac.db
   ...
   :required~by: |required_by_bioconductor-indac.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-indac.db


.. |required_by_bioconductor-indac.db| conda:required_by:: bioconductor-indac.db
