...
.. conda:recipe:: bioconductor-singlemoleculefootprintingdata
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/experiment/html/SingleMoleculeFootprintingData.html
   :license: GPL-3
...
.. conda:package:: bioconductor-singlemoleculefootprintingdata
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-singlemoleculefootprintingdata

   and update with::

      mamba update bioconductor-singlemoleculefootprintingdata

  To create a new environment, run::

      mamba create --name myenvname bioconductor-singlemoleculefootprintingdata
