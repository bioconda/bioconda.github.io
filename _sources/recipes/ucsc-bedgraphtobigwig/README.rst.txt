...
.. conda:package:: ucsc-bedgraphtobigwig
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>482-0</code>,  <code>481-0</code>,  <code>472-2</code>,  <code>472-1</code>,  <code>472-0</code>,  <code>469-0</code>,  <code>455-1</code>,  <code>455-0</code>,  <code>445-0</code>,  </span></summary>
      

      ``482-0``,  ``481-0``,  ``472-2``,  ``472-1``,  ``472-0``,  ``469-0``,  ``455-1``,  ``455-0``,  ``445-0``,  ``377-3``,  ``377-2``,  ``377-1``,  ``377-0``,  ``366-0``,  ``357-4``,  ``357-3``,  ``357-1``,  ``357-0``,  ``332-0``,  ``324-0``,  ``308-1``,  ``308-0``
...
to install globally, run::
    ...
    pixi global install ucsc-bedgraphtobigwig

to add into an existing workspace instead, run::

    pixi add ucsc-bedgraphtobigwig
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname ucsc-bedgraphtobigwig
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["482","481","472","472","472"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_ucsc-bedgraphtobigwig"></div>
   <div style="width: 100%" id="platform_plot_ucsc-bedgraphtobigwig"></div>
   <div style="width: 100%" id="cdf_plot_ucsc-bedgraphtobigwig"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for ucsc-bedgraphtobigwig
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/ucsc-bedgraphtobigwig/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_ucsc-bedgraphtobigwig', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for ucsc-bedgraphtobigwig
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/ucsc-bedgraphtobigwig/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_ucsc-bedgraphtobigwig', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for ucsc-bedgraphtobigwig
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/ucsc-bedgraphtobigwig/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_ucsc-bedgraphtobigwig', spec);
            } catch (err) {
