...
.. conda:recipe:: bioconductor-xlaevis.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/xlaevis.db.html
...
.. conda:package:: bioconductor-xlaevis.db
   ...
   :depends bioconductor-org.xl.eg.db: ``>=3.17.0,<3.18.0``
   :depends curl: 
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-xlaevis.db

   and update with::

      mamba update bioconductor-xlaevis.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-xlaevis.db
