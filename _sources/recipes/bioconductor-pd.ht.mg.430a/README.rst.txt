...
.. conda:recipe:: bioconductor-pd.ht.mg.430a
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/pd.ht.mg.430a.html
...
.. conda:package:: bioconductor-pd.ht.mg.430a
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.ht.mg.430a

   and update with::

      mamba update bioconductor-pd.ht.mg.430a

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.ht.mg.430a
