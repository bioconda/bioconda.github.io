...
.. conda:package:: bioconductor-basicstan
   ...
   :depends bioconductor-basics: ``>=2.22.0,<2.23.0``
   :depends bioconductor-basics: ``>=2.22.0,<2.23.0a0``
   :depends bioconductor-glmgampoi: ``>=1.22.0,<1.23.0``
   :depends bioconductor-glmgampoi: ``>=1.22.0,<1.23.0a0``
