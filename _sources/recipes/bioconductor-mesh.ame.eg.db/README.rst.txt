...
.. conda:recipe:: bioconductor-mesh.ame.eg.db
   ...
   Mapping table for Ailuropoda melanoleuca Gene ID to MeSH

   :homepage: https://bioconductor.org/packages/3.13/data/annotation/html/MeSH.Ame.eg.db.html
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-mesh.ame.eg.db";
