...
.. conda:package:: intarna
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.3.0.1-1</code>,  <code>3.3.0.1-0</code>,  <code>3.2.2-0</code>,  <code>3.2.0-0</code>,  <code>3.1.5-0</code>,  <code>3.1.3-0</code>,  <code>3.1.2-0</code>,  <code>3.1.1-0</code>,  <code>3.1.0.2-1</code>,  </span></summary>
      

      ``3.3.0.1-1``,  ``3.3.0.1-0``,  ``3.2.2-0``,  ``3.2.0-0``,  ``3.1.5-0``,  ``3.1.3-0``,  ``3.1.2-0``,  ``3.1.1-0``,  ``3.1.0.2-1``,  ``3.1.0.2-0``,  ``3.0.0-0``,  ``2.4.1-2``,  ``2.4.1-1``,  ``2.4.1-0``,  ``2.3.1-2``,  ``2.3.1-1``,  ``2.3.1-0``,  ``2.3.0-0``,  ``2.2.1-0``,  ``2.2.0-3``,  ``2.2.0-2``,  ``2.2.0-1``,  ``2.1.0-2``,  ``2.1.0-1``,  ``2.1.0-0``,  ``2.0.5-0``,  ``2.0.4-1``,  ``2.0.3-1``,  ``2.0.3-0``,  ``2.0.2-0``,  ``2.0.1-1``,  ``2.0.1-0``,  ``2.0.0-0``,  ``1.2.5-2``,  ``1.2.5-1``
...
.. raw:: html
    ...
    <script>
        var package = "intarna";
        var versions = ["3.3.0.1","3.3.0.1","3.2.2","3.2.0","3.1.5"];
    </script>
