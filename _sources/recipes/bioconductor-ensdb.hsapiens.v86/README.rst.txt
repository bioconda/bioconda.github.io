...
.. conda:recipe:: bioconductor-ensdb.hsapiens.v86
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/EnsDb.Hsapiens.v86.html
...
.. conda:package:: bioconductor-ensdb.hsapiens.v86
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ensdb.hsapiens.v86

   and update with::

      mamba update bioconductor-ensdb.hsapiens.v86

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ensdb.hsapiens.v86
