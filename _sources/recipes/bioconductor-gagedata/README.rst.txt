...
.. conda:recipe:: bioconductor-gagedata
   ...
   :homepage: https://bioconductor.org/packages/3.13/data/experiment/html/gageData.html
   :license: GPL (>=2.0)
...
.. conda:package:: bioconductor-gagedata
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.32.0-0</code>,  <code>2.30.0-0</code>,  <code>2.28.0-1</code>,  <code>2.28.0-0</code>,  <code>2.27.0-0</code>,  <code>2.26.0-0</code>,  <code>2.24.0-0</code>,  <code>2.22.0-1</code>,  <code>2.22.0-0</code>,  </span></summary>
      

      ``2.32.0-0``,  ``2.30.0-0``,  ``2.28.0-1``,  ``2.28.0-0``,  ``2.27.0-0``,  ``2.26.0-0``,  ``2.24.0-0``,  ``2.22.0-1``,  ``2.22.0-0``,  ``2.20.0-0``,  ``2.18.0-0``,  ``2.16.0-1``,  ``2.16.0-0``,  ``2.14.0-0``,  ``2.10.0-0``,  ``2.8.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.32.0","2.30.0","2.28.0","2.28.0","2.27.0"];
    </script>
