...
.. conda:recipe:: bioconductor-gagedata
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/experiment/html/gageData.html
   :license: GPL (>=2.0)
...
.. conda:package:: bioconductor-gagedata
   ...
   :versions: 2.20.0, 2.18.0, 2.16.0, 2.14.0, 2.10.0, 2.8.0

   :depends: :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`wget`  

   :required~by: |required_by_bioconductor-gagedata|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-gagedata


.. |required_by_bioconductor-gagedata| conda:required_by:: bioconductor-gagedata
