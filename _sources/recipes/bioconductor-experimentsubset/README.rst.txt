...
.. conda:recipe:: bioconductor-experimentsubset
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/ExperimentSubset.html
...
to install globally, run::
    ...
    pixi global install bioconductor-experimentsubset

to add into an existing workspace instead, run::

    pixi add bioconductor-experimentsubset
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-experimentsubset
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-experimentsubset"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-experimentsubset"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-experimentsubset"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-experimentsubset
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-experimentsubset/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-experimentsubset', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-experimentsubset
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-experimentsubset/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-experimentsubset', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-experimentsubset
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-experimentsubset/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-experimentsubset', spec);
            } catch (err) {
