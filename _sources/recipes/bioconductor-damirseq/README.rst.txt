...
.. conda:recipe:: bioconductor-damirseq
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/DaMiRseq.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-damirseq
   ...
   :versions:
      ...
      ``2.6.0-0``,  ``2.4.0-0``,  ``2.2.0-1``,  ``2.2.0-0``,  ``1.10.0-0``,  ``1.8.0-1``,  ``1.6.2-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.6.0","2.4.0","2.2.0","2.2.0","1.10.0"];
    </script>
