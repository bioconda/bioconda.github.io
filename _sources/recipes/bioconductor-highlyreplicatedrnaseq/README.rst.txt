...
.. conda:recipe:: bioconductor-highlyreplicatedrnaseq
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/HighlyReplicatedRNASeq.html
...
.. conda:package:: bioconductor-highlyreplicatedrnaseq
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-highlyreplicatedrnaseq

   and update with::

      mamba update bioconductor-highlyreplicatedrnaseq

  To create a new environment, run::

      mamba create --name myenvname bioconductor-highlyreplicatedrnaseq
