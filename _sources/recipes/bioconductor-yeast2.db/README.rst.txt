...
.. conda:recipe:: bioconductor-yeast2.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/yeast2.db.html
...
.. conda:package:: bioconductor-yeast2.db
   ...
   :depends bioconductor-org.sc.sgd.db: ``>=3.22.0,<3.23.0``
   :depends curl: 
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-yeast2.db

   and update with::

      mamba update bioconductor-yeast2.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-yeast2.db
