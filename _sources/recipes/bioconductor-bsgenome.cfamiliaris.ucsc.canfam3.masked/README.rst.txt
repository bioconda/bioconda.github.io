...
.. conda:recipe:: bioconductor-bsgenome.cfamiliaris.ucsc.canfam3.masked
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/BSgenome.Cfamiliaris.UCSC.canFam3.masked.html
...
.. conda:package:: bioconductor-bsgenome.cfamiliaris.ucsc.canfam3.masked
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bsgenome.cfamiliaris.ucsc.canfam3.masked

   and update with::

      mamba update bioconductor-bsgenome.cfamiliaris.ucsc.canfam3.masked

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bsgenome.cfamiliaris.ucsc.canfam3.masked
