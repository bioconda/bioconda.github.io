...
.. conda:recipe:: bioconductor-org.xl.eg.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/org.Xl.eg.db.html
...
.. conda:package:: bioconductor-org.xl.eg.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-org.xl.eg.db

   and update with::

      mamba update bioconductor-org.xl.eg.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-org.xl.eg.db
