...
.. conda:package:: repeatscout
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.0.7-1</code>,  <code>1.0.7-0</code>,  <code>1.0.6-3</code>,  <code>1.0.6-2</code>,  <code>1.0.6-1</code>,  <code>1.0.6-0</code>,  <code>1.0.5-3</code>,  <code>1.0.5-2</code>,  <code>1.0.5-1</code>,  </span></summary>
      

      ``1.0.7-1``,  ``1.0.7-0``,  ``1.0.6-3``,  ``1.0.6-2``,  ``1.0.6-1``,  ``1.0.6-0``,  ``1.0.5-3``,  ``1.0.5-2``,  ``1.0.5-1``,  ``1.0.5-0``
...
to install globally, run::
    ...
    pixi global install repeatscout

to add into an existing workspace instead, run::

    pixi add repeatscout
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname repeatscout
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.0.7","1.0.7","1.0.6","1.0.6","1.0.6"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_repeatscout"></div>
   <div style="width: 100%" id="platform_plot_repeatscout"></div>
   <div style="width: 100%" id="cdf_plot_repeatscout"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for repeatscout
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/repeatscout/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_repeatscout', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for repeatscout
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/repeatscout/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_repeatscout', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for repeatscout
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/repeatscout/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_repeatscout', spec);
            } catch (err) {
