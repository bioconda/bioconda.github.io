...
.. conda:recipe:: bioconductor-txdb.rnorvegicus.ucsc.rn6.refgene
   ...
   :homepage: https://bioconductor.org/packages/3.12/data/annotation/html/TxDb.Rnorvegicus.UCSC.rn6.refGene.html
...
.. conda:package:: bioconductor-txdb.rnorvegicus.ucsc.rn6.refgene
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.4.6-6</code>,  <code>3.4.6-5</code>,  <code>3.4.6-4</code>,  <code>3.4.6-3</code>,  <code>3.4.6-2</code>,  <code>3.4.6-1</code>,  <code>3.4.4-0</code>,  <code>3.4.3-0</code>,  <code>3.4.1-1</code>,  </span></summary>
      

      ``3.4.6-6``,  ``3.4.6-5``,  ``3.4.6-4``,  ``3.4.6-3``,  ``3.4.6-2``,  ``3.4.6-1``,  ``3.4.4-0``,  ``3.4.3-0``,  ``3.4.1-1``,  ``3.4.1-0``,  ``3.4.0-1``
