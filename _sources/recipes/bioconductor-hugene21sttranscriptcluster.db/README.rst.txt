...
.. conda:recipe:: bioconductor-hugene21sttranscriptcluster.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/hugene21sttranscriptcluster.db.html
...
.. conda:package:: bioconductor-hugene21sttranscriptcluster.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hugene21sttranscriptcluster.db

   and update with::

      mamba update bioconductor-hugene21sttranscriptcluster.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hugene21sttranscriptcluster.db
