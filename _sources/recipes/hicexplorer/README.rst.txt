...
.. conda:package:: hicexplorer
   ...
   :versions: 2.2, 2.2beta, 2.1.4, 2.1.3, 2.1.2, 2.1.1, 2.1, 2.1alpha1, 2.0, 1.8.1, 1.8, 1.7.2, 1.7.1, 1.6.1, 1.6, 1.4, 1.3, 1.2, 1.1a, 0.1

   :depends: :conda:package:`biopython`  :conda:package:`configparser`  :conda:package:`cooler` >=0.7.11 :conda:package:`future`  :conda:package:`hicmatrix`  :conda:package:`intervaltree`  :conda:package:`jinja2`  :conda:package:`matplotlib` >=2.2.* :conda:package:`numpy` >=1.15 :conda:package:`pandas`  :conda:package:`pybigwig`  :conda:package:`pygenometracks`  :conda:package:`pysam`  :conda:package:`pytables`  :conda:package:`python` >=2.7,<2.8.0a0 :conda:package:`scipy`  :conda:package:`six`  :conda:package:`unidecode`  
