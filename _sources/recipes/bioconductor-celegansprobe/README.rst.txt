...
.. conda:recipe:: bioconductor-celegansprobe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/celegansprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-celegansprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-celegansprobe

   and update with::

      mamba update bioconductor-celegansprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-celegansprobe
