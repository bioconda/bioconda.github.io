...
.. conda:package:: bioconductor-faers
   ...
   :depends on r-brio: 
   :depends on r-cli: 
   :depends on r-curl: ``>=6.0.0``
   :depends on r-data.table: 
   :depends on r-httr2: ``>=1.0.0``
   :depends on r-mcmcpack: 
   :depends on r-openebgm: 
   :depends on r-rlang: 
   :depends on r-rvest: 
   :depends on r-vroom: 
   :depends on r-xml2: 
...
to install globally, run::
    ...
    pixi global install bioconductor-faers

to add into an existing workspace instead, run::

    pixi add bioconductor-faers
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-faers

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-faers
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-faers"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-faers"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-faers"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-faers
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-faers/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-faers', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-faers
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-faers/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-faers', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-faers
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-faers/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-faers', spec);
            } catch (err) {
