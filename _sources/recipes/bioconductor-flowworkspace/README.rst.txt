...
.. conda:recipe:: bioconductor-flowworkspace
   ...
   :homepage: https://bioconductor.org/packages/3.23/bioc/html/flowWorkspace.html
...
.. conda:package:: bioconductor-flowworkspace
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>4.24.0-0</code>,  <code>4.22.1-0</code>,  <code>4.18.0-1</code>,  <code>4.18.0-0</code>,  <code>4.14.0-0</code>,  <code>4.12.0-0</code>,  <code>4.10.0-1</code>,  <code>4.10.0-0</code>,  <code>4.6.0-2</code>,  </span></summary>
      

      ``4.24.0-0``,  ``4.22.1-0``,  ``4.18.0-1``,  ``4.18.0-0``,  ``4.14.0-0``,  ``4.12.0-0``,  ``4.10.0-1``,  ``4.10.0-0``,  ``4.6.0-2``,  ``4.6.0-1``,  ``4.6.0-0``,  ``4.4.0-0``,  ``4.2.0-2``,  ``4.2.0-1``,  ``4.2.0-0``,  ``4.0.1-0``,  ``3.34.0-0``,  ``3.32.0-1``,  ``3.30.2-0``,  ``3.30.1-0``,  ``3.28.2-0``,  ``3.26.2-0``,  ``3.24.4-0``
   ...
   :depends on bioconductor-delayedarray: ``>=0.36.1,<0.37.0a0``
   ...
   :depends on bioconductor-ncdfflow: ``>=2.58.0,<2.59.0``
   :depends on bioconductor-ncdfflow: ``>=2.58.0,<2.59.0a0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["4.24.0","4.22.1","4.18.0","4.18.0","4.14.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-flowworkspace"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-flowworkspace"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-flowworkspace"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-flowworkspace
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-flowworkspace/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-flowworkspace', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-flowworkspace
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-flowworkspace/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-flowworkspace', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-flowworkspace
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-flowworkspace/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-flowworkspace', spec);
            } catch (err) {
