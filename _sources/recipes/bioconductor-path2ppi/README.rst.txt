...
============= ===========
Home          http://bioconductor.org/packages/3.7/bioc/html/Path2PPI.html
Versions      1.10.0, 1.6.0, 1.8.0
License       GPL (>= 2)
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes/bioconductor-path2ppi
