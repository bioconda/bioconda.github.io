...
.. conda:package:: minimap2
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.20-0</code>,  <code>2.19-0</code>,  <code>2.18-0</code>,  <code>2.17-4</code>,  <code>2.17-3</code>,  <code>2.17-2</code>,  <code>2.17-1</code>,  <code>2.17-0</code>,  <code>2.16-1</code>,  </span></summary>
      

      ``2.20-0``,  ``2.19-0``,  ``2.18-0``,  ``2.17-4``,  ``2.17-3``,  ``2.17-2``,  ``2.17-1``,  ``2.17-0``,  ``2.16-1``,  ``2.16-0``,  ``2.15-1``,  ``2.15-0``,  ``2.14-0``,  ``2.13-0``,  ``2.12-0``,  ``2.11-0``,  ``2.10-1``,  ``2.9-1``,  ``2.8-1``,  ``2.8-0``,  ``2.7-1``,  ``2.7-0``,  ``2.6.1-0``,  ``2.6-0``,  ``2.5-0``,  ``2.4-0``,  ``2.3-0``,  ``2.1.1-0``,  ``2.1.r311-0``,  ``2.0.r191-0``
