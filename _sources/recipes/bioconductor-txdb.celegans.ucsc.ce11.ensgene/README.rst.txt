...
.. conda:recipe:: bioconductor-txdb.celegans.ucsc.ce11.ensgene
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/TxDb.Celegans.UCSC.ce11.ensGene.html
...
.. conda:package:: bioconductor-txdb.celegans.ucsc.ce11.ensgene
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.15.0-4</code>,  <code>3.15.0-3</code>,  <code>3.15.0-2</code>,  <code>3.15.0-1</code>,  <code>3.15.0-0</code>,  <code>3.12.0-4</code>,  <code>3.12.0-3</code>,  <code>3.12.0-2</code>,  <code>3.12.0-1</code>,  </span></summary>
      

      ``3.15.0-4``,  ``3.15.0-3``,  ``3.15.0-2``,  ``3.15.0-1``,  ``3.15.0-0``,  ``3.12.0-4``,  ``3.12.0-3``,  ``3.12.0-2``,  ``3.12.0-1``,  ``3.12.0-0``,  ``3.11.0-0``,  ``3.4.6-2``,  ``3.4.6-1``
...
to install globally, run::
    ...
    pixi global install bioconductor-txdb.celegans.ucsc.ce11.ensgene

to add into an existing workspace instead, run::

    pixi add bioconductor-txdb.celegans.ucsc.ce11.ensgene
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-txdb.celegans.ucsc.ce11.ensgene
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-txdb.celegans.ucsc.ce11.ensgene"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-txdb.celegans.ucsc.ce11.ensgene"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-txdb.celegans.ucsc.ce11.ensgene"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-txdb.celegans.ucsc.ce11.ensgene
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.celegans.ucsc.ce11.ensgene/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-txdb.celegans.ucsc.ce11.ensgene', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-txdb.celegans.ucsc.ce11.ensgene
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.celegans.ucsc.ce11.ensgene/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-txdb.celegans.ucsc.ce11.ensgene', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-txdb.celegans.ucsc.ce11.ensgene
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.celegans.ucsc.ce11.ensgene/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-txdb.celegans.ucsc.ce11.ensgene', spec);
            } catch (err) {
