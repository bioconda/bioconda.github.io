...
.. conda:recipe:: bioconductor-rnagilentdesign028282.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/RnAgilentDesign028282.db.html
...
.. conda:package:: bioconductor-rnagilentdesign028282.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rnagilentdesign028282.db

   and update with::

      mamba update bioconductor-rnagilentdesign028282.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rnagilentdesign028282.db
