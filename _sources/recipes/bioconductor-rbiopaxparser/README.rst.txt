...
.. conda:recipe:: bioconductor-rbiopaxparser
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/rBiopaxParser.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-rbiopaxparser
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.46.0-0</code>,  <code>2.42.0-0</code>,  <code>2.40.0-0</code>,  <code>2.38.0-0</code>,  <code>2.34.0-0</code>,  <code>2.32.0-0</code>,  <code>2.30.0-1</code>,  <code>2.30.0-0</code>,  <code>2.28.0-0</code>,  </span></summary>
      

      ``2.46.0-0``,  ``2.42.0-0``,  ``2.40.0-0``,  ``2.38.0-0``,  ``2.34.0-0``,  ``2.32.0-0``,  ``2.30.0-1``,  ``2.30.0-0``,  ``2.28.0-0``,  ``2.26.0-0``,  ``2.24.0-1``,  ``2.24.0-0``,  ``2.22.0-1``,  ``2.22.0-0``,  ``2.20.0-0``,  ``2.18.0-0``,  ``2.16.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.46.0","2.42.0","2.40.0","2.38.0","2.34.0"];
    </script>
