...
.. conda:recipe:: bioconductor-meal
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/MEAL.html
...
.. conda:package:: bioconductor-meal
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-meal

   and update with::

      mamba update bioconductor-meal

  To create a new environment, run::

      mamba create --name myenvname bioconductor-meal
