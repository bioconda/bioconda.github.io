...
.. conda:recipe:: bioconductor-imman
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/IMMAN.html
...
.. conda:package:: bioconductor-imman
   ...
   :versions:
      ...
      ``1.30.0-0``,  ``1.26.0-0``,  ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.0-1``,  ``1.10.0-0``,  ``1.7.0-0``,  ``1.6.0-0``,  ``1.4.0-1``,  ``1.2.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-imman

to add into an existing workspace instead, run::

    pixi add bioconductor-imman
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-imman
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-imman"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-imman"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-imman"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-imman
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-imman/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-imman', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-imman
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-imman/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-imman', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-imman
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-imman/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-imman', spec);
            } catch (err) {
