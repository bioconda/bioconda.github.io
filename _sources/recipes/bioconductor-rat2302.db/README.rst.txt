...
.. conda:recipe:: bioconductor-rat2302.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/rat2302.db.html
...
.. conda:package:: bioconductor-rat2302.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rat2302.db

   and update with::

      mamba update bioconductor-rat2302.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rat2302.db
