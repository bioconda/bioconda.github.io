...
.. conda:package:: resfinder
   ...
   :versions:
      ...
      ``4.7.2-0``,  ``4.7.0-0``,  ``4.6.0-0``,  ``4.5.0-0``,  ``4.4.3-0``,  ``4.4.2-1``,  ``4.4.2-0``,  ``4.1.11-0``
   ...
   :depends on cgecore: ``2.0.1``
   :depends on cgelib: ``>=0.7.3``
   :depends on git: 
   :depends on kma: 
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname resfinder
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["4.7.2","4.7.0","4.6.0","4.5.0","4.4.3"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_resfinder"></div>
   <div style="width: 100%" id="platform_plot_resfinder"></div>
   <div style="width: 100%" id="cdf_plot_resfinder"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/resfinder/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_resfinder', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for resfinder
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/resfinder/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_resfinder', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for resfinder
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/resfinder/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_resfinder', spec);
            } catch (err) {
