...
.. conda:recipe:: bioconductor-ibh
   ...
   :homepage: https://bioconductor.org/packages/3.11/bioc/html/ibh.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-ibh
   ...
   :versions:
      ...
      ``1.38.0-0``,  ``1.36.0-0``,  ``1.34.0-1``,  ``1.32.0-1``,  ``1.32.0-0``,  ``1.30.0-0``,  ``1.28.0-0``,  ``1.26.0-0``

      

   
   :depends bioconductor-simpintlists: ``>=1.25.0,<1.26.0``
