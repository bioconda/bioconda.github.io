...
.. conda:package:: bioconductor-ibh
   ...
   :depends: :conda:package:`bioconductor-simpintlists` >=1.18.0,<1.19.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-ibh|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-ibh


.. |required_by_bioconductor-ibh| conda:required_by:: bioconductor-ibh
