...
.. conda:package:: oakvar
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.9.91-0</code>,  <code>2.9.90-0</code>,  <code>2.9.89-0</code>,  <code>2.9.88-0</code>,  <code>2.9.87-0</code>,  <code>2.9.85-0</code>,  <code>2.9.83-0</code>,  <code>2.9.82-0</code>,  <code>2.9.81-0</code>,  </span></summary>
      

      ``2.9.91-0``,  ``2.9.90-0``,  ``2.9.89-0``,  ``2.9.88-0``,  ``2.9.87-0``,  ``2.9.85-0``,  ``2.9.83-0``,  ``2.9.82-0``,  ``2.9.81-0``,  ``2.9.80-0``,  ``2.9.78-0``,  ``2.9.77-0``,  ``2.9.75-0``,  ``2.9.72-0``,  ``2.9.71-0``,  ``2.9.69-0``,  ``2.9.68-0``,  ``2.9.64-0``,  ``2.9.62-0``,  ``2.9.60-0``,  ``2.9.59-0``,  ``2.9.58-0``,  ``2.9.57-0``,  ``2.9.56-0``,  ``2.9.55-0``,  ``2.9.54-0``,  ``2.9.53-0``,  ``2.9.52-0``,  ``2.9.51-0``,  ``2.9.49-0``,  ``2.9.43-0``,  ``2.9.41-0``,  ``2.9.39-0``,  ``2.9.37-0``,  ``2.9.36-0``,  ``2.9.34-0``,  ``2.9.3-0``,  ``2.9.2-0``,  ``2.9.1-0``,  ``2.8.40-0``,  ``2.8.38-0``,  ``2.8.37-0``,  ``2.8.36-0``,  ``2.8.35-0``,  ``2.8.28-0``,  ``2.7.40-0``
...
.. raw:: html
    ...
    <script>
        var package = "oakvar";
        var versions = ["2.9.91","2.9.90","2.9.89","2.9.88","2.9.87"];
    </script>
