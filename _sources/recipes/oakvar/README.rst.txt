...
.. conda:package:: oakvar
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.9.68-0</code>,  <code>2.9.64-0</code>,  <code>2.9.62-0</code>,  <code>2.9.60-0</code>,  <code>2.9.59-0</code>,  <code>2.9.58-0</code>,  <code>2.9.57-0</code>,  <code>2.9.56-0</code>,  <code>2.9.55-0</code>,  </span></summary>
      

      ``2.9.68-0``,  ``2.9.64-0``,  ``2.9.62-0``,  ``2.9.60-0``,  ``2.9.59-0``,  ``2.9.58-0``,  ``2.9.57-0``,  ``2.9.56-0``,  ``2.9.55-0``,  ``2.9.54-0``,  ``2.9.53-0``,  ``2.9.52-0``,  ``2.9.51-0``,  ``2.9.49-0``,  ``2.9.43-0``,  ``2.9.41-0``,  ``2.9.39-0``,  ``2.9.37-0``,  ``2.9.36-0``,  ``2.9.34-0``,  ``2.9.3-0``,  ``2.9.2-0``,  ``2.9.1-0``,  ``2.8.40-0``,  ``2.8.38-0``,  ``2.8.37-0``,  ``2.8.36-0``,  ``2.8.35-0``,  ``2.8.28-0``,  ``2.7.40-0``
...
.. raw:: html
    ...
    <script>
        var package = "oakvar";
        var versions = ["2.9.68","2.9.64","2.9.62","2.9.60","2.9.59"];
    </script>
