...
.. conda:recipe:: bioconductor-arrmnormalization
   ...
   :homepage: https://bioconductor.org/packages/3.11/bioc/html/ARRmNormalization.html
...
.. conda:package:: bioconductor-arrmnormalization
   ...
   :versions:
      ...
      ``1.30.0-0``,  ``1.28.0-0``,  ``1.26.0-1``,  ``1.24.0-1``,  ``1.24.0-0``,  ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.0-0``

      

   
   :depends bioconductor-arrmdata: ``>=1.25.0,<1.26.0``
