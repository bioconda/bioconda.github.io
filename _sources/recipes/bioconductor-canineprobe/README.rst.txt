...
.. conda:recipe:: bioconductor-canineprobe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/canineprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-canineprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-canineprobe

   and update with::

      mamba update bioconductor-canineprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-canineprobe
