...
.. conda:recipe:: bioconductor-canineprobe
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/canineprobe.html
   :license: LGPL
...
to install globally, run::
    ...
    pixi global install bioconductor-canineprobe

to add into an existing workspace instead, run::

    pixi add bioconductor-canineprobe
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-canineprobe
...
.. raw:: html
   ...
   <script>
      var package = "bioconductor-canineprobe";
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-canineprobe"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-canineprobe"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-canineprobe"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-canineprobe
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-canineprobe/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-canineprobe', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-canineprobe
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-canineprobe/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-canineprobe', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-canineprobe
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-canineprobe/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-canineprobe', spec);
            } catch (err) {
