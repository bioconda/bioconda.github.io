...
.. conda:package:: pegasusio
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.4.0.post1-0</code>,  <code>0.4.0-0</code>,  <code>0.3.1.post2-0</code>,  <code>0.3.1.post1-0</code>,  <code>0.3.1-0</code>,  <code>0.3.0-0</code>,  <code>0.2.14-0</code>,  <code>0.2.13-0</code>,  <code>0.2.12.post1-0</code>,  </span></summary>
      

      ``0.4.0.post1-0``,  ``0.4.0-0``,  ``0.3.1.post2-0``,  ``0.3.1.post1-0``,  ``0.3.1-0``,  ``0.3.0-0``,  ``0.2.14-0``,  ``0.2.13-0``,  ``0.2.12.post1-0``,  ``0.2.12-0``,  ``0.2.11-0``,  ``0.2.10-1``,  ``0.2.10-0``,  ``0.2.9-0``,  ``0.2.8.post2-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.4.0.post1","0.4.0","0.3.1.post2","0.3.1.post1","0.3.1"];
    </script>
