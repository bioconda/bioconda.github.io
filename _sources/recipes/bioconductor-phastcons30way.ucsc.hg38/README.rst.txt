...
.. conda:recipe:: bioconductor-phastcons30way.ucsc.hg38
   ...
   :homepage: https://bioconductor.org/packages/3.16/data/annotation/html/phastCons30way.UCSC.hg38.html
...
.. conda:package:: bioconductor-phastcons30way.ucsc.hg38
   ...
   :versions:
      ...
      ``3.13.0-2``,  ``3.13.0-1``,  ``3.13.0-0``,  ``3.11.1-3``,  ``3.11.1-2``,  ``3.11.1-1``,  ``3.11.1-0``
   ...
   and update with::
      ...
      conda update bioconductor-phastcons30way.ucsc.hg38
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["3.13.0","3.13.0","3.13.0","3.11.1","3.11.1"];
    </script>
