...
.. conda:recipe:: bioconductor-agprobe
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/agprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-agprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-agprobe

   and update with::

      mamba update bioconductor-agprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-agprobe
