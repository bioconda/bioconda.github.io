...
.. conda:recipe:: bioconductor-illuminahumanmethylation450kmanifest
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/IlluminaHumanMethylation450kmanifest.html
...
.. conda:package:: bioconductor-illuminahumanmethylation450kmanifest
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.4.0-18</code>,  <code>0.4.0-17</code>,  <code>0.4.0-16</code>,  <code>0.4.0-15</code>,  <code>0.4.0-14</code>,  <code>0.4.0-13</code>,  <code>0.4.0-12</code>,  <code>0.4.0-11</code>,  <code>0.4.0-10</code>,  </span></summary>
      

      ``0.4.0-18``,  ``0.4.0-17``,  ``0.4.0-16``,  ``0.4.0-15``,  ``0.4.0-14``,  ``0.4.0-13``,  ``0.4.0-12``,  ``0.4.0-11``,  ``0.4.0-10``,  ``0.4.0-9``,  ``0.4.0-8``,  ``0.4.0-7``,  ``0.4.0-6``,  ``0.4.0-4``,  ``0.4.0-3``,  ``0.4.0-2``,  ``0.4.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-illuminahumanmethylation450kmanifest

to add into an existing workspace instead, run::

    pixi add bioconductor-illuminahumanmethylation450kmanifest
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-illuminahumanmethylation450kmanifest

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-illuminahumanmethylation450kmanifest
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-illuminahumanmethylation450kmanifest"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-illuminahumanmethylation450kmanifest"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-illuminahumanmethylation450kmanifest"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-illuminahumanmethylation450kmanifest
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-illuminahumanmethylation450kmanifest/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-illuminahumanmethylation450kmanifest', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-illuminahumanmethylation450kmanifest
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-illuminahumanmethylation450kmanifest/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-illuminahumanmethylation450kmanifest', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-illuminahumanmethylation450kmanifest
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-illuminahumanmethylation450kmanifest/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-illuminahumanmethylation450kmanifest', spec);
            } catch (err) {
