...
.. conda:recipe:: bioconductor-soybeancdf
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/soybeancdf.html
   :license: LGPL
...
to install globally, run::
    ...
    pixi global install bioconductor-soybeancdf

to add into an existing workspace instead, run::

    pixi add bioconductor-soybeancdf
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-soybeancdf
...
For e.g. docker, run::
    ...
    docker pull quay.io/biocontainers/bioconductor-soybeancdf:<tag>

(see `bioconductor-soybeancdf/tags`_ for valid values for ``<tag>``).
...
.. _`bioconductor-soybeancdf/tags`: https://quay.io/repository/biocontainers/bioconductor-soybeancdf?tab=tags


.. raw:: html

   <script>
      var package = "bioconductor-soybeancdf";
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-soybeancdf"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-soybeancdf"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-soybeancdf"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-soybeancdf
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-soybeancdf/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-soybeancdf', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-soybeancdf
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-soybeancdf/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-soybeancdf', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-soybeancdf
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-soybeancdf/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-soybeancdf', spec);
            } catch (err) {
