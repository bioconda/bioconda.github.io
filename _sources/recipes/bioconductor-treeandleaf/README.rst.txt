...
.. conda:recipe:: bioconductor-treeandleaf
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/TreeAndLeaf.html
...
.. conda:package:: bioconductor-treeandleaf
   ...
   :versions:
      ...
      ``1.18.0-0``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.6.1-0``,  ``1.4.0-0``,  ``1.2.0-1``,  ``1.2.0-0``,  ``1.0.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.18.0","1.14.0","1.12.0","1.10.0","1.6.1"];
    </script>
