...
.. conda:package:: bioconductor-quartpac
   ...
   :depends bioconductor-graphpac: ``>=1.44.0,<1.45.0``
   :depends bioconductor-ipac: ``>=1.46.0,<1.47.0``
   :depends bioconductor-spacepac: ``>=1.40.0,<1.41.0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-quartpac

   and update with::

      mamba update bioconductor-quartpac

  To create a new environment, run::

      mamba create --name myenvname bioconductor-quartpac
