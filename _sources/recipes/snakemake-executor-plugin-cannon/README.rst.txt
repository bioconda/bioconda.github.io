...
.. conda:package:: snakemake-executor-plugin-cannon
   ...
   :versions:
      ...
      ``1.9.2.post2-0``,  ``1.8.0.post2-0``,  ``1.6.0.post1-0``,  ``1.5.0.post1-0``,  ``1.4.0.post1-0``,  ``1.3.6.post2-0``,  ``1.3.6.post1-0``,  ``1.2.2.post1-0``,  ``1.2.1a0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.9.2.post2","1.8.0.post2","1.6.0.post1","1.5.0.post1","1.4.0.post1"];
    </script>
