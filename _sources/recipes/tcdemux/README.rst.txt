...
.. conda:package:: tcdemux
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.0.26-1</code>,  <code>0.0.26-0</code>,  <code>0.0.25-1</code>,  <code>0.0.25-0</code>,  <code>0.0.24-0</code>,  <code>0.0.22-0</code>,  <code>0.0.21-0</code>,  <code>0.0.20-0</code>,  <code>0.0.18-0</code>,  </span></summary>
      

      ``0.0.26-1``,  ``0.0.26-0``,  ``0.0.25-1``,  ``0.0.25-0``,  ``0.0.24-0``,  ``0.0.22-0``,  ``0.0.21-0``,  ``0.0.20-0``,  ``0.0.18-0``,  ``0.0.17-0``,  ``0.0.16-0``,  ``0.0.15-0``,  ``0.0.14-0``,  ``0.0.13-0``
...
.. raw:: html
    ...
    <script>
        var package = "tcdemux";
        var versions = ["0.0.26","0.0.26","0.0.25","0.0.25","0.0.24"];
    </script>
