...
.. conda:recipe:: bioconductor-qsea
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/qsea.html
   :license: GPL-2
...
.. conda:package:: bioconductor-qsea
   ...
   :depends bioconductor-hmmcopy: ``>=1.44.0,<1.45.0``
   :depends bioconductor-hmmcopy: ``>=1.44.0,<1.45.0a0``
