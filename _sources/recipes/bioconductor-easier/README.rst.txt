...
.. conda:package:: bioconductor-easier
   ...
   :versions:
      ...
      ``1.8.0-0``,  ``1.6.3-0``,  ``1.4.0-0``,  ``1.0.0-0``
   ...
   :depends bioconductor-easierdata: ``>=1.8.0,<1.9.0``
   :depends bioconductor-progeny: ``>=1.24.0,<1.25.0``
   :depends bioconductor-quantiseqr: ``>=1.10.0,<1.11.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.8.0","1.6.3","1.4.0","1.0.0"];
    </script>
