...
.. conda:recipe:: bioconductor-tcgacrcmrna
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/TCGAcrcmRNA.html
   :license: GPL-2
...
.. conda:package:: bioconductor-tcgacrcmrna
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-tcgacrcmrna

   and update with::

      mamba update bioconductor-tcgacrcmrna

  To create a new environment, run::

      mamba create --name myenvname bioconductor-tcgacrcmrna
