...
.. conda:recipe:: bioconductor-xlaevis2cdf
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/xlaevis2cdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-xlaevis2cdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-xlaevis2cdf

   and update with::

      mamba update bioconductor-xlaevis2cdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-xlaevis2cdf
