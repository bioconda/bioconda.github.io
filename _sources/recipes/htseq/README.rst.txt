...
.. conda:package:: htseq
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.99.2-0</code>,  <code>0.13.5-1</code>,  <code>0.13.5-0</code>,  <code>0.12.4-2</code>,  <code>0.12.4-1</code>,  <code>0.12.4-0</code>,  <code>0.12.3-0</code>,  <code>0.11.3-0</code>,  <code>0.11.2-1</code>,  </span></summary>
      

      ``1.99.2-0``,  ``0.13.5-1``,  ``0.13.5-0``,  ``0.12.4-2``,  ``0.12.4-1``,  ``0.12.4-0``,  ``0.12.3-0``,  ``0.11.3-0``,  ``0.11.2-1``,  ``0.11.2-0``,  ``0.11.1-0``,  ``0.11.0-1``,  ``0.11.0-0``,  ``0.9.1-4``,  ``0.9.1-3``,  ``0.9.1-2``,  ``0.9.1-1``,  ``0.9.1-0``,  ``0.7.2-4``,  ``0.7.2-3``,  ``0.7.2-2``,  ``0.7.2-1``,  ``0.7.2-0``,  ``0.6.1.post1-6``,  ``0.6.1.post1-5``,  ``0.6.1.post1-4``,  ``0.6.1-5``,  ``0.6.1-4``,  ``0.6.1-3``,  ``0.6.1-2``,  ``0.6.1-1``,  ``0.6.1-0``,  ``0.6.1p1-1``,  ``0.6.1p1-0``
...
.. raw:: html
    ...
    <script>
        var package = "htseq";
        var versions = ["1.99.2","0.13.5","0.13.5","0.12.4","0.12.4"];
    </script>
