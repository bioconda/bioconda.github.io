...
.. conda:recipe:: bioconductor-pd.chogene.2.1.st
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/pd.chogene.2.1.st.html
...
.. conda:package:: bioconductor-pd.chogene.2.1.st
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.chogene.2.1.st

   and update with::

      mamba update bioconductor-pd.chogene.2.1.st

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.chogene.2.1.st
