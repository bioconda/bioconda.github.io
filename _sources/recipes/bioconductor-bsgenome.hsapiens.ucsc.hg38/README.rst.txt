...
.. conda:recipe:: bioconductor-bsgenome.hsapiens.ucsc.hg38
   ...
   Full genome sequences for Homo sapiens \(UCSC version hg38\, based on GRCh38.p12\)

   :homepage: https://bioconductor.org/packages/3.13/data/annotation/html/BSgenome.Hsapiens.UCSC.hg38.html
...
.. conda:package:: bioconductor-bsgenome.hsapiens.ucsc.hg38
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.4.3-3</code>,  <code>1.4.3-2</code>,  <code>1.4.3-1</code>,  <code>1.4.3-0</code>,  <code>1.4.1-8</code>,  <code>1.4.1-7</code>,  <code>1.4.1-5</code>,  <code>1.4.1-4</code>,  <code>1.4.1-2</code>,  </span></summary>
      

      ``1.4.3-3``,  ``1.4.3-2``,  ``1.4.3-1``,  ``1.4.3-0``,  ``1.4.1-8``,  ``1.4.1-7``,  ``1.4.1-5``,  ``1.4.1-4``,  ``1.4.1-2``,  ``1.4.1-1``,  ``1.4.1-0``
