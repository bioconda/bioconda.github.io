...
.. conda:package:: bioconductor-hipathia
   ...
   :depends: :conda:package:`bioconductor-annotationhub` >=2.14.0,<2.15.0 :conda:package:`bioconductor-delayedarray` >=0.8.0,<0.9.0 :conda:package:`bioconductor-limma` >=3.38.0,<3.39.0 :conda:package:`bioconductor-multiassayexperiment` >=1.8.0,<1.9.0 :conda:package:`bioconductor-preprocesscore` >=1.44.0,<1.45.0 :conda:package:`bioconductor-s4vectors` >=0.20.0,<0.21.0 :conda:package:`bioconductor-summarizedexperiment` >=1.12.0,<1.13.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-coin`  :conda:package:`r-igraph` >=1.0.1 :conda:package:`r-matrixstats`  :conda:package:`r-servr`  

   :required~by: |required_by_bioconductor-hipathia|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-hipathia


.. |required_by_bioconductor-hipathia| conda:required_by:: bioconductor-hipathia
