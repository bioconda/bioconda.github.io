...
.. conda:package:: cgatcore
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.6.21-0</code>,  <code>0.6.20-0</code>,  <code>0.6.19-0</code>,  <code>0.6.16-0</code>,  <code>0.6.15-0</code>,  <code>0.6.14-0</code>,  <code>0.6.11-0</code>,  <code>0.6.10-0</code>,  <code>0.6.9-0</code>,  </span></summary>
      

      ``0.6.21-0``,  ``0.6.20-0``,  ``0.6.19-0``,  ``0.6.16-0``,  ``0.6.15-0``,  ``0.6.14-0``,  ``0.6.11-0``,  ``0.6.10-0``,  ``0.6.9-0``,  ``0.6.7-0``,  ``0.6.5-1``,  ``0.6.5-0``,  ``0.6.4-0``,  ``0.6.3-1``,  ``0.6.3-0``,  ``0.6.1-1``,  ``0.6.1-0``,  ``0.5.15-1``,  ``0.5.15-0``,  ``0.5.14-0``,  ``0.5.13-0``,  ``0.5.12-1``,  ``0.5.11-0``,  ``0.5.10-0``,  ``0.5.6-0``,  ``0.5.4-0``,  ``0.5.2-0``,  ``0.5.1-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.6.21","0.6.20","0.6.19","0.6.16","0.6.15"];
    </script>
