...
.. conda:recipe:: bioconductor-convert
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/convert.html
   :license: LGPL
...
.. conda:package:: bioconductor-convert
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-convert

   and update with::

      mamba update bioconductor-convert

  To create a new environment, run::

      mamba create --name myenvname bioconductor-convert
