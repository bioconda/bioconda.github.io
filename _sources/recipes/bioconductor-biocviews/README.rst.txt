...
.. conda:recipe:: bioconductor-biocviews
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/biocViews.html
...
.. conda:package:: bioconductor-biocviews
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.78.2-0</code>,  <code>1.78.0-0</code>,  <code>1.74.0-0</code>,  <code>1.70.0-0</code>,  <code>1.68.1-0</code>,  <code>1.66.0-0</code>,  <code>1.62.0-0</code>,  <code>1.60.0-0</code>,  <code>1.58.1-0</code>,  </span></summary>
      

      ``1.78.2-0``,  ``1.78.0-0``,  ``1.74.0-0``,  ``1.70.0-0``,  ``1.68.1-0``,  ``1.66.0-0``,  ``1.62.0-0``,  ``1.60.0-0``,  ``1.58.1-0``,  ``1.58.0-0``,  ``1.56.0-0``,  ``1.54.0-0``,  ``1.52.2-0``,  ``1.50.9-0``,  ``1.48.3-0``,  ``1.46.0-0``,  ``1.44.0-1``,  ``1.44.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-biocviews

to add into an existing workspace instead, run::

    pixi add bioconductor-biocviews
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-biocviews
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.78.2","1.78.0","1.74.0","1.70.0","1.68.1"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-biocviews"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-biocviews"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-biocviews"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-biocviews
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-biocviews/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-biocviews', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-biocviews
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-biocviews/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-biocviews', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-biocviews
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-biocviews/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-biocviews', spec);
            } catch (err) {
