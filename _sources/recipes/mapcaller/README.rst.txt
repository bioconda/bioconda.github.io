...
.. conda:package:: mapcaller
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.9.9.41-2</code>,  <code>0.9.9.41-1</code>,  <code>0.9.9.41-0</code>,  <code>0.9.9.40-0</code>,  <code>0.9.9.39-0</code>,  <code>0.9.9.38-0</code>,  <code>0.9.9.37-0</code>,  <code>0.9.9.35-0</code>,  <code>0.9.9.34-0</code>,  </span></summary>
      

      ``0.9.9.41-2``,  ``0.9.9.41-1``,  ``0.9.9.41-0``,  ``0.9.9.40-0``,  ``0.9.9.39-0``,  ``0.9.9.38-0``,  ``0.9.9.37-0``,  ``0.9.9.35-0``,  ``0.9.9.34-0``,  ``0.9.9.33-0``,  ``0.9.9.32-0``,  ``0.9.9.31-0``,  ``0.9.9.30-0``,  ``0.9.9.29-0``,  ``0.9.9.28-0``,  ``0.9.9.27-0``,  ``0.9.9.26-0``,  ``0.9.9.25-0``,  ``0.9.9.23-0``,  ``0.9.9.22-0``,  ``0.9.9.21-0``,  ``0.9.9.19-0``,  ``0.9.9.18-0``,  ``0.9.9.17-0``,  ``0.9.9.16-0``,  ``0.9.9.15-0``,  ``0.9.9.7-0``,  ``0.9.9.6-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.9.9.41","0.9.9.41","0.9.9.41","0.9.9.40","0.9.9.39"];
    </script>
