...
.. conda:package:: bioconductor-les
   ...
   :depends: :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-boot`  :conda:package:`r-fdrtool`  :conda:package:`r-gplots`  :conda:package:`r-rcolorbrewer`  

   :required~by: |required_by_bioconductor-les|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-les


.. |required_by_bioconductor-les| conda:required_by:: bioconductor-les
