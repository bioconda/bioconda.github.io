...
.. conda:recipe:: bioconductor-muscle
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/muscle.html
   :license: Unlimited
...
.. conda:package:: bioconductor-muscle
   ...
   :versions:
      ...
      ``3.52.0-0``,  ``3.48.0-0``,  ``3.44.0-0``,  ``3.42.0-0``,  ``3.40.0-1``,  ``3.40.0-0``,  ``3.36.0-2``,  ``3.36.0-1``,  ``3.36.0-0``,  ``3.34.0-0``,  ``3.32.0-1``,  ``3.32.0-0``,  ``3.30.0-0``,  ``3.28.0-0``,  ``3.26.0-1``,  ``3.24.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-muscle

to add into an existing workspace instead, run::

    pixi add bioconductor-muscle
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-muscle
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-muscle"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-muscle"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-muscle"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-muscle
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-muscle/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-muscle', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-muscle
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-muscle/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-muscle', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-muscle
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-muscle/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-muscle', spec);
            } catch (err) {
