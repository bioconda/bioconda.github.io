...
.. conda:package:: locityper
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.3.1-0</code>,  <code>1.3.0-0</code>,  <code>1.2.3-0</code>,  <code>1.2.1-1</code>,  <code>1.2.1-0</code>,  <code>1.2.0-0</code>,  <code>1.1.2-0</code>,  <code>1.1.1-0</code>,  <code>1.1.0-0</code>,  </span></summary>
      

      ``1.3.1-0``,  ``1.3.0-0``,  ``1.2.3-0``,  ``1.2.1-1``,  ``1.2.1-0``,  ``1.2.0-0``,  ``1.1.2-0``,  ``1.1.1-0``,  ``1.1.0-0``,  ``1.0.0-0``,  ``0.19.1-0``,  ``0.18.0-0``,  ``0.17.5-0``,  ``0.17.4-1``,  ``0.17.4-0``,  ``0.17.3-0``,  ``0.16.12-0``,  ``0.16.11-0``,  ``0.16.10-0``,  ``0.16.9-0``,  ``0.16.8-0``,  ``0.16.7-0``,  ``0.16.6-0``,  ``0.16.5-0``,  ``0.16.0-0``,  ``0.15.3-0``,  ``0.15.2-0``,  ``0.15.1-0``,  ``0.15.0-0``,  ``0.14.5-0``,  ``0.14.4-0``,  ``0.13.4-0``
   ...
   :depends pysam: 
   :depends python: 
   :depends samtools: ``>=1.19``
   :depends strobealign: ``>=0.17``
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.3.1","1.3.0","1.2.3","1.2.1","1.2.1"];
    </script>
