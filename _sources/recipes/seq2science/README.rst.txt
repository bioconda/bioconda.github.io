...
.. conda:package:: seq2science
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.9.2-0</code>,  <code>0.9.1-0</code>,  <code>0.9.0-0</code>,  <code>0.8.0-0</code>,  <code>0.7.2-0</code>,  <code>0.7.1-0</code>,  <code>0.7.0-0</code>,  <code>0.6.1-0</code>,  <code>0.6.0-0</code>,  </span></summary>
      

      ``0.9.2-0``,  ``0.9.1-0``,  ``0.9.0-0``,  ``0.8.0-0``,  ``0.7.2-0``,  ``0.7.1-0``,  ``0.7.0-0``,  ``0.6.1-0``,  ``0.6.0-0``,  ``0.5.6-0``,  ``0.5.5-0``,  ``0.5.4-0``,  ``0.5.3-0``,  ``0.5.2-0``,  ``0.5.1-0``,  ``0.5.0-0``,  ``0.4.3-0``,  ``0.4.2-0``,  ``0.4.1-0``,  ``0.4.0-1``,  ``0.4.0-0``,  ``0.3.2-0``,  ``0.3.1-0``,  ``0.3.0-0``,  ``0.2.3-0``,  ``0.2.2-1``,  ``0.2.2-0``,  ``0.2.1-0``,  ``0.2.0-0``,  ``0.1.0-0``,  ``0.0.3-0``,  ``0.0.2-0``,  ``0.0.1-0``,  ``0.0.0-0``
   ...
   :depends argcomplete: ``1.12.3.*``
   :depends biopython: ``1.79.*``
   :depends conda: ``4.12.0.*``
   :depends conda-ecosystem-user-package-isolation: ``1.0.*``
   :depends filelock: ``3.4.0.*``
   :depends genomepy: ``0.12.0.*``
   :depends mamba: ``0.23.3.*``
   ...
   :depends python: ``3.8.*``
   :depends pyyaml: ``6.0.*``
   :depends snakemake-minimal: ``7.7.0.*``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.9.2","0.9.1","0.9.0","0.8.0","0.7.2"];
    </script>
