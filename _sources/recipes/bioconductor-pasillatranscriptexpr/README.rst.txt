...
.. conda:recipe:: bioconductor-pasillatranscriptexpr
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/PasillaTranscriptExpr.html
   :license: GPL (>= 3)
...
.. conda:package:: bioconductor-pasillatranscriptexpr
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pasillatranscriptexpr

   and update with::

      mamba update bioconductor-pasillatranscriptexpr

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pasillatranscriptexpr
