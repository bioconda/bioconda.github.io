...
.. conda:package:: bioconductor-affyilm
   ...
   :depends: :conda:package:`bioconductor-affxparser` >=1.54.0,<1.55.0 :conda:package:`bioconductor-affy` >=1.60.0,<1.61.0 :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`bioconductor-gcrma` >=2.54.0,<2.55.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-affyilm|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-affyilm


.. |required_by_bioconductor-affyilm| conda:required_by:: bioconductor-affyilm
