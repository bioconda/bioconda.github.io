...
.. conda:recipe:: bioconductor-mnem
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/mnem.html
   :license: GPL-3
...
.. conda:package:: bioconductor-mnem
   ...
   :versions:
      ...
      ``1.8.0-0``,  ``1.6.5-0``,  ``1.6.1-0``,  ``1.4.0-0``

      

   
   :depends bioconductor-graph: ``>=1.70.0,<1.71.0``
   :depends bioconductor-linnorm: ``>=2.16.0,<2.17.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.8.0","1.6.5","1.6.1","1.4.0"];
    </script>
