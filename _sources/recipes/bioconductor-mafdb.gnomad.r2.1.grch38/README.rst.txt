...
.. conda:recipe:: bioconductor-mafdb.gnomad.r2.1.grch38
   ...
   :homepage: https://bioconductor.org/packages/3.13/data/annotation/html/MafDb.gnomAD.r2.1.GRCh38.html
...
.. conda:package:: bioconductor-mafdb.gnomad.r2.1.grch38
   ...
   :versions:
      ...
      ``3.10.0-3``,  ``3.10.0-1``,  ``3.10.0-0``,  ``3.9.0-1``
   ...
   and update with::
      ...
      conda update bioconductor-mafdb.gnomad.r2.1.grch38
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["3.10.0","3.10.0","3.10.0","3.9.0"];
    </script>
