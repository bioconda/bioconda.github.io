...
.. conda:package:: bioconductor-pd.x.tropicalis
   ...
   :required~by: |required_by_bioconductor-pd.x.tropicalis|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-pd.x.tropicalis


.. |required_by_bioconductor-pd.x.tropicalis| conda:required_by:: bioconductor-pd.x.tropicalis
