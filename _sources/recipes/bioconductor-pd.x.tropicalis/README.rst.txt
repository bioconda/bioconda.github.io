...
.. conda:recipe:: bioconductor-pd.x.tropicalis
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/pd.x.tropicalis.html
...
.. conda:package:: bioconductor-pd.x.tropicalis
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.x.tropicalis

   and update with::

      mamba update bioconductor-pd.x.tropicalis

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.x.tropicalis
