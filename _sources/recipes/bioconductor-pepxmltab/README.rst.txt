...
.. conda:recipe:: bioconductor-pepxmltab
   ...
   :homepage: https://bioconductor.org/packages/3.8/bioc/html/pepXMLTab.html
...
.. conda:package:: bioconductor-pepxmltab
   ...
   :depends: :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-xml` >=3.98-1.1 

   :required~by: |required_by_bioconductor-pepxmltab|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-pepxmltab


.. |required_by_bioconductor-pepxmltab| conda:required_by:: bioconductor-pepxmltab
