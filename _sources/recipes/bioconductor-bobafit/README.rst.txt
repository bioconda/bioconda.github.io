...
.. conda:recipe:: bioconductor-bobafit
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/BOBaFIT.html
   :license: GPL (>= 3)
...
to install globally, run::
    ...
    pixi global install bioconductor-bobafit

to add into an existing workspace instead, run::

    pixi add bioconductor-bobafit
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-bobafit
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-bobafit"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-bobafit"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-bobafit"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-bobafit
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bobafit/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-bobafit', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-bobafit
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bobafit/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-bobafit', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-bobafit
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bobafit/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-bobafit', spec);
            } catch (err) {
