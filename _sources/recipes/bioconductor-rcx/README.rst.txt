...
.. conda:recipe:: bioconductor-rcx
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/RCX.html
...
.. conda:package:: bioconductor-rcx
   ...
   :versions:
      ...
      ``1.14.2-0``,  ``1.14.1-0``,  ``1.14.0-0``,  ``1.10.0-0``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-rcx

to add into an existing workspace instead, run::

    pixi add bioconductor-rcx
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-rcx
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.14.2","1.14.1","1.14.0","1.10.0","1.6.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-rcx"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-rcx"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-rcx"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-rcx
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rcx/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-rcx', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-rcx
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rcx/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-rcx', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-rcx
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rcx/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-rcx', spec);
            } catch (err) {
