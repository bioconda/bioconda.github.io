...
.. conda:package:: bioconductor-genemeta
   ...
   :depends: :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`bioconductor-genefilter` >=1.64.0,<1.65.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-genemeta|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-genemeta


.. |required_by_bioconductor-genemeta| conda:required_by:: bioconductor-genemeta
