...
.. conda:recipe:: bioconductor-bovine.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/bovine.db.html
...
.. conda:package:: bioconductor-bovine.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bovine.db

   and update with::

      mamba update bioconductor-bovine.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bovine.db
