...
.. conda:recipe:: bioconductor-human660quadv1acrlmm
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/human660quadv1aCrlmm.html
...
.. conda:package:: bioconductor-human660quadv1acrlmm
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.0.3-13</code>,  <code>1.0.3-12</code>,  <code>1.0.3-11</code>,  <code>1.0.3-10</code>,  <code>1.0.3-9</code>,  <code>1.0.3-8</code>,  <code>1.0.3-7</code>,  <code>1.0.3-6</code>,  <code>1.0.3-5</code>,  </span></summary>
      

      ``1.0.3-13``,  ``1.0.3-12``,  ``1.0.3-11``,  ``1.0.3-10``,  ``1.0.3-9``,  ``1.0.3-8``,  ``1.0.3-7``,  ``1.0.3-6``,  ``1.0.3-5``,  ``1.0.3-4``,  ``1.0.3-3``,  ``1.0.3-2``,  ``1.0.3-1``,  ``1.0.3-0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-human660quadv1acrlmm

   and update with::

      mamba update bioconductor-human660quadv1acrlmm

  To create a new environment, run::

      mamba create --name myenvname bioconductor-human660quadv1acrlmm
