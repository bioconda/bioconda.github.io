...
.. conda:recipe:: bioconductor-clariomdhumanprobeset.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/clariomdhumanprobeset.db.html
...
.. conda:package:: bioconductor-clariomdhumanprobeset.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-clariomdhumanprobeset.db

   and update with::

      mamba update bioconductor-clariomdhumanprobeset.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-clariomdhumanprobeset.db
