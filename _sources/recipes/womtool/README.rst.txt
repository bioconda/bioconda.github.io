...
.. conda:package:: womtool
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>61-0</code>,  <code>60-1</code>,  <code>60-0</code>,  <code>58-0</code>,  <code>57-0</code>,  <code>56-0</code>,  <code>55-0</code>,  <code>54-0</code>,  <code>53.1-0</code>,  </span></summary>
      

      ``61-0``,  ``60-1``,  ``60-0``,  ``58-0``,  ``57-0``,  ``56-0``,  ``55-0``,  ``54-0``,  ``53.1-0``,  ``53-0``,  ``52-0``,  ``51-0``,  ``50-0``,  ``49-0``,  ``48-0``,  ``47-0``,  ``46.1-0``,  ``46-0``,  ``45.1-0``,  ``45-0``,  ``44-0``,  ``43-0``,  ``42-0``,  ``41-0``,  ``40-0``,  ``38-0``,  ``36-0``,  ``31-1``,  ``31-0``
