...
.. conda:recipe:: bioconductor-pd.cotton
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/pd.cotton.html
...
.. conda:package:: bioconductor-pd.cotton
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.cotton

   and update with::

      mamba update bioconductor-pd.cotton

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.cotton
