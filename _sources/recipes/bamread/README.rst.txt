...
.. conda:package:: bamread
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.0.13-0</code>,  <code>0.0.11-1</code>,  <code>0.0.11-0</code>,  <code>0.0.9-1</code>,  <code>0.0.9-0</code>,  <code>0.0.8-0</code>,  <code>0.0.7-2</code>,  <code>0.0.7-1</code>,  <code>0.0.7-0</code>,  </span></summary>
      

      ``0.0.13-0``,  ``0.0.11-1``,  ``0.0.11-0``,  ``0.0.9-1``,  ``0.0.9-0``,  ``0.0.8-0``,  ``0.0.7-2``,  ``0.0.7-1``,  ``0.0.7-0``,  ``0.0.6-0``,  ``0.0.5-0``,  ``0.0.4-1``,  ``0.0.4-0``
...
.. raw:: html
    ...
    <script>
        var package = "bamread";
        var versions = ["0.0.13","0.0.11","0.0.11","0.0.9","0.0.9"];
    </script>
