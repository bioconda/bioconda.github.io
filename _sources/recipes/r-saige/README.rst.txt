...
.. conda:package:: r-saige
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.3.1-3</code>,  <code>1.3.1-2</code>,  <code>1.3.1-1</code>,  <code>1.3.1-0</code>,  <code>1.2.0-0</code>,  <code>1.1.9-3</code>,  <code>1.1.9-2</code>,  <code>1.1.9-1</code>,  <code>1.1.9-0</code>,  </span></summary>
      

      ``1.3.1-3``,  ``1.3.1-2``,  ``1.3.1-1``,  ``1.3.1-0``,  ``1.2.0-0``,  ``1.1.9-3``,  ``1.1.9-2``,  ``1.1.9-1``,  ``1.1.9-0``,  ``1.1.8-0``,  ``0.45.0-5``,  ``0.45.0-4``,  ``0.45.0-3``,  ``0.45.0-2``,  ``0.45.0-0``,  ``0.44.6.5-3``,  ``0.44.6.5-2``,  ``0.44.6.5-1``,  ``0.44.6.5-0``,  ``0.44.6.2-0``,  ``0.44.6.1-0``,  ``0.44.6-0``,  ``0.44.5-1``,  ``0.44.5-0``,  ``0.44.2-0``,  ``0.44.1-0``,  ``0.44.0-0``,  ``0.43.3-0``,  ``0.43.0-0``,  ``0.42.1-1``,  ``0.42.1-0``,  ``0.42.0-1``,  ``0.42.0-0``,  ``0.39.0-1``,  ``0.39.0-0``,  ``0.35.8.8-2``,  ``0.35.8.8-1``,  ``0.35.8.8-0``
   ...
   :depends r-skat: 
   :depends r-spatest: 
   :depends savvy: ``>=2.1.0,<3.0a0``
   :depends superlu: ``>=7.0.1,<7.1.0a0``
...
.. raw:: html
    ...
    <script>
        var package = "r-saige";
        var versions = ["1.3.1","1.3.1","1.3.1","1.3.1","1.2.0"];
    </script>
