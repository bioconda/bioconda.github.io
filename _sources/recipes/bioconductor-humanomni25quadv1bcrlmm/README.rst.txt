...
.. conda:recipe:: bioconductor-humanomni25quadv1bcrlmm
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/humanomni25quadv1bCrlmm.html
...
.. conda:package:: bioconductor-humanomni25quadv1bcrlmm
   ...
   :versions:
      ...
      ``1.0.2-14``,  ``1.0.2-13``,  ``1.0.2-12``,  ``1.0.2-11``,  ``1.0.2-10``,  ``1.0.2-9``,  ``1.0.2-8``,  ``1.0.2-7``,  ``1.0.2-6``,  ``1.0.2-5``,  ``1.0.2-4``,  ``1.0.2-3``,  ``1.0.2-2``,  ``1.0.2-1``,  ``1.0.2-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-humanomni25quadv1bcrlmm

to add into an existing workspace instead, run::

    pixi add bioconductor-humanomni25quadv1bcrlmm
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-humanomni25quadv1bcrlmm
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-humanomni25quadv1bcrlmm"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-humanomni25quadv1bcrlmm"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-humanomni25quadv1bcrlmm"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-humanomni25quadv1bcrlmm
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-humanomni25quadv1bcrlmm/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-humanomni25quadv1bcrlmm', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-humanomni25quadv1bcrlmm
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-humanomni25quadv1bcrlmm/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-humanomni25quadv1bcrlmm', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-humanomni25quadv1bcrlmm
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-humanomni25quadv1bcrlmm/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-humanomni25quadv1bcrlmm', spec);
            } catch (err) {
