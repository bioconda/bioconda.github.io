...
============= ===========
Home          http://bioconductor.org/packages/3.6/data/experiment/html/HSMMSingleCell.html
Versions      0.110.0, 0.112.0, 0.114.0
License       Artistic-2.0
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes/bioconductor-hsmmsinglecell
...
A Docker container is available at https://quay.io/repository/biocontainers/bioconductor-hsmmsinglecell.
...
Render an |badge| badge with the following Markdown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square)](http://bioconda.github.io/recipes/bioconductor-hsmmsinglecell/README.html)

.. |badge| image:: https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square
           :target: http://bioconda.github.io/recipes/bioconductor-hsmmsinglecell/README.html
.. |downloads| image:: https://anaconda.org/bioconda/bioconductor-hsmmsinglecell/badges/downloads.svg
               :target: https://anaconda.org/bioconda/bioconductor-hsmmsinglecell
.. |docker| image:: https://quay.io/repository/biocontainers/bioconductor-hsmmsinglecell/status
