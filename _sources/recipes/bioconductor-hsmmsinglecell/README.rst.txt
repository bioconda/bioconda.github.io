...
.. conda:recipe:: bioconductor-hsmmsinglecell
   ...
   :homepage: https://bioconductor.org/packages/3.16/data/experiment/html/HSMMSingleCell.html
...
.. conda:package:: bioconductor-hsmmsinglecell
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.18.0-0</code>,  <code>1.17.0-0</code>,  <code>1.14.0-1</code>,  <code>1.14.0-0</code>,  <code>1.12.0-0</code>,  <code>1.10.0-1</code>,  <code>1.10.0-0</code>,  <code>1.9.0-0</code>,  <code>1.8.0-0</code>,  </span></summary>
      

      ``1.18.0-0``,  ``1.17.0-0``,  ``1.14.0-1``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.0-1``,  ``1.10.0-0``,  ``1.9.0-0``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-1``,  ``1.4.0-0``,  ``1.2.0-0``,  ``0.114.0-0``,  ``0.112.0-1``,  ``0.112.0-0``,  ``0.110.0-1``,  ``0.110.0-0``
   ...
   :depends bioconductor-data-packages: ``>=20221112``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.18.0","1.17.0","1.14.0","1.14.0","1.12.0"];
    </script>
