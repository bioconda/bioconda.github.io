...
.. conda:recipe:: bioconductor-plotgardener
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/plotgardener.html
...
.. conda:package:: bioconductor-plotgardener
   ...
   :versions:
      ...
      ``1.0.17-0``,  ``1.0.14-0``,  ``1.0.1-0``,  ``1.0.0-0``
   ...
   and update with::
      ...
      conda update bioconductor-plotgardener
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.0.17","1.0.14","1.0.1","1.0.0"];
    </script>
