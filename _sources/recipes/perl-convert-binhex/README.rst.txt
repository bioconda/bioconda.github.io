...
.. conda:package:: perl-convert-binhex
   ...
   :required~by: |required_by_perl-convert-binhex|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/perl-convert-binhex


.. |required_by_perl-convert-binhex| conda:required_by:: perl-convert-binhex
