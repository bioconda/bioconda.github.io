...
.. conda:recipe:: bioconductor-enrichmentbrowser
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/EnrichmentBrowser.html
...
.. conda:package:: bioconductor-enrichmentbrowser
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.40.0-0</code>,  <code>2.36.0-0</code>,  <code>2.32.0-0</code>,  <code>2.30.1-0</code>,  <code>2.28.0-0</code>,  <code>2.24.0-0</code>,  <code>2.22.0-0</code>,  <code>2.20.7-0</code>,  <code>2.20.0-0</code>,  </span></summary>
      

      ``2.40.0-0``,  ``2.36.0-0``,  ``2.32.0-0``,  ``2.30.1-0``,  ``2.28.0-0``,  ``2.24.0-0``,  ``2.22.0-0``,  ``2.20.7-0``,  ``2.20.0-0``,  ``2.18.0-0``,  ``2.16.0-0``,  ``2.14.3-0``,  ``2.12.0-0``,  ``2.10.11-0``
   ...
   :depends on bioconductor-spia: ``>=2.62.0,<2.63.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-enrichmentbrowser

to add into an existing workspace instead, run::

    pixi add bioconductor-enrichmentbrowser
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-enrichmentbrowser
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["2.40.0","2.36.0","2.32.0","2.30.1","2.28.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-enrichmentbrowser"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-enrichmentbrowser"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-enrichmentbrowser"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-enrichmentbrowser
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-enrichmentbrowser/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-enrichmentbrowser', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-enrichmentbrowser
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-enrichmentbrowser/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-enrichmentbrowser', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-enrichmentbrowser
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-enrichmentbrowser/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-enrichmentbrowser', spec);
            } catch (err) {
