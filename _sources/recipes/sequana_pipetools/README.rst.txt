...
.. conda:package:: sequana_pipetools
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.7.0-0</code>,  <code>1.6.0-0</code>,  <code>1.5.7-0</code>,  <code>1.5.5-0</code>,  <code>1.5.4-0</code>,  <code>1.5.3-0</code>,  <code>1.5.2-0</code>,  <code>1.5.1-0</code>,  <code>1.4.0-0</code>,  </span></summary>
      

      ``1.7.0-0``,  ``1.6.0-0``,  ``1.5.7-0``,  ``1.5.5-0``,  ``1.5.4-0``,  ``1.5.3-0``,  ``1.5.2-0``,  ``1.5.1-0``,  ``1.4.0-0``,  ``1.3.1-0``,  ``1.3.0-0``,  ``1.2.2-0``,  ``0.9.4-0``,  ``0.9.0-0``,  ``0.8.1-0``,  ``0.8.0-0``,  ``0.7.6-0``,  ``0.7.5-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.7.0","1.6.0","1.5.7","1.5.5","1.5.4"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_sequana_pipetools"></div>
   <div style="width: 100%" id="platform_plot_sequana_pipetools"></div>
   <div style="width: 100%" id="cdf_plot_sequana_pipetools"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for sequana_pipetools
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/sequana_pipetools/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_sequana_pipetools', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for sequana_pipetools
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/sequana_pipetools/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_sequana_pipetools', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for sequana_pipetools
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/sequana_pipetools/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_sequana_pipetools', spec);
            } catch (err) {
