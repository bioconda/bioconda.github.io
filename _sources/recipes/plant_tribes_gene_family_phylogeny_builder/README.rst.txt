...
.. conda:package:: plant_tribes_gene_family_phylogeny_builder
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install plant_tribes_gene_family_phylogeny_builder

   and update with::

      mamba update plant_tribes_gene_family_phylogeny_builder

  To create a new environment, run::

      mamba create --name myenvname plant_tribes_gene_family_phylogeny_builder
