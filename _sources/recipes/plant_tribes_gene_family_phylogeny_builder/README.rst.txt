...
.. conda:package:: plant_tribes_gene_family_phylogeny_builder
   ...
   :depends: :conda:package:`fasttree` >=2,<3 :conda:package:`perl`  :conda:package:`raxml` >=8,<9 

   :required~by: |required_by_plant_tribes_gene_family_phylogeny_builder|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/plant_tribes_gene_family_phylogeny_builder


.. |required_by_plant_tribes_gene_family_phylogeny_builder| conda:required_by:: plant_tribes_gene_family_phylogeny_builder
