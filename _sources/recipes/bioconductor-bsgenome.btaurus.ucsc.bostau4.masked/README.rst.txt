...
.. conda:recipe:: bioconductor-bsgenome.btaurus.ucsc.bostau4.masked
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/BSgenome.Btaurus.UCSC.bosTau4.masked.html
...
.. conda:package:: bioconductor-bsgenome.btaurus.ucsc.bostau4.masked
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bsgenome.btaurus.ucsc.bostau4.masked

   and update with::

      mamba update bioconductor-bsgenome.btaurus.ucsc.bostau4.masked

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bsgenome.btaurus.ucsc.bostau4.masked
