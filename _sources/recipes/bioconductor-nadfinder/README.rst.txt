...
.. conda:package:: bioconductor-nadfinder
   ...
   :versions: 1.10.0-0, 1.8.1-0, 1.6.0-0, 1.4.0-0, 1.2.0-0
   
   :depends bioconductor-atacseqqc: >=1.10.0,<1.11.0
   :depends bioconductor-biocgenerics: >=0.32.0,<0.33.0
   :depends bioconductor-csaw: >=1.20.0,<1.21.0
   :depends bioconductor-empiricalbrownsmethod: >=1.14.0,<1.15.0
   ...
   :depends bioconductor-trackviewer: >=1.22.0,<1.23.0
