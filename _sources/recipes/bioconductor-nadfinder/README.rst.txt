...
.. conda:package:: bioconductor-nadfinder
   ...
   :versions:
      ...
      ``1.16.0-0``,  ``1.14.0-1``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.1-0``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.0-0``

      

   
   :depends bioconductor-atacseqqc: ``>=1.16.0,<1.17.0``
   ...
   :depends bioconductor-trackviewer: ``>=1.28.0,<1.29.0``
