...
.. conda:recipe:: bioconductor-sampleclassifierdata
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/sampleClassifierData.html
...
.. conda:package:: bioconductor-sampleclassifierdata
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.34.0-0</code>,  <code>1.30.0-0</code>,  <code>1.26.0-0</code>,  <code>1.24.0-0</code>,  <code>1.22.0-0</code>,  <code>1.18.0-1</code>,  <code>1.18.0-0</code>,  <code>1.16.0-0</code>,  <code>1.14.1-0</code>,  </span></summary>
      

      ``1.34.0-0``,  ``1.30.0-0``,  ``1.26.0-0``,  ``1.24.0-0``,  ``1.22.0-0``,  ``1.18.0-1``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.1-0``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-1``,  ``1.6.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-sampleclassifierdata

to add into an existing workspace instead, run::

    pixi add bioconductor-sampleclassifierdata
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-sampleclassifierdata
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-sampleclassifierdata"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-sampleclassifierdata"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-sampleclassifierdata"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-sampleclassifierdata
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-sampleclassifierdata/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-sampleclassifierdata', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-sampleclassifierdata
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-sampleclassifierdata/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-sampleclassifierdata', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-sampleclassifierdata
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-sampleclassifierdata/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-sampleclassifierdata', spec);
            } catch (err) {
