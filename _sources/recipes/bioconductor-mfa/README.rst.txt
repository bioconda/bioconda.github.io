...
.. conda:recipe:: bioconductor-mfa
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/mfa.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-mfa
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mfa

   and update with::

      mamba update bioconductor-mfa

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mfa
