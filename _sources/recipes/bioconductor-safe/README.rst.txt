...
.. conda:package:: bioconductor-safe
   ...
   :depends: :conda:package:`bioconductor-annotationdbi` >=1.44.0,<1.45.0 :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-sparsem`  

   :required~by: |required_by_bioconductor-safe|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-safe


.. |required_by_bioconductor-safe| conda:required_by:: bioconductor-safe
