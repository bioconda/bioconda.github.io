...
.. conda:recipe:: bioconductor-ecoli2probe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/ecoli2probe.html
   :license: LGPL
...
.. conda:package:: bioconductor-ecoli2probe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ecoli2probe

   and update with::

      mamba update bioconductor-ecoli2probe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ecoli2probe
