...
.. conda:recipe:: bioconductor-saureusprobe
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/saureusprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-saureusprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-saureusprobe

   and update with::

      mamba update bioconductor-saureusprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-saureusprobe
