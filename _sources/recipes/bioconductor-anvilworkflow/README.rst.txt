...
.. conda:recipe:: bioconductor-anvilworkflow
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/AnVILWorkflow.html
...
.. conda:package:: bioconductor-anvilworkflow
   ...
   :versions:
      ...
      ``1.10.2-0``,  ``1.10.0-0``,  ``1.6.0-0``,  ``1.2.0-0``,  ``1.0.1-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.10.2","1.10.0","1.6.0","1.2.0","1.0.1"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-anvilworkflow"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-anvilworkflow"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-anvilworkflow"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-anvilworkflow
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-anvilworkflow/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-anvilworkflow', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-anvilworkflow
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-anvilworkflow/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-anvilworkflow', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-anvilworkflow
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-anvilworkflow/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-anvilworkflow', spec);
            } catch (err) {
