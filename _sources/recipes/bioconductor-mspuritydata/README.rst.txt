...
.. conda:recipe:: bioconductor-mspuritydata
   ...
   :homepage: https://bioconductor.org/packages/3.16/data/experiment/html/msPurityData.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-mspuritydata
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.28.0-0</code>,  <code>1.26.0-1</code>,  <code>1.26.0-0</code>,  <code>1.25.0-0</code>,  <code>1.22.0-1</code>,  <code>1.22.0-0</code>,  <code>1.20.0-0</code>,  <code>1.18.0-0</code>,  <code>1.17.0-0</code>,  </span></summary>
      

      ``1.28.0-0``,  ``1.26.0-1``,  ``1.26.0-0``,  ``1.25.0-0``,  ``1.22.0-1``,  ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.17.0-0``,  ``1.16.0-0``,  ``1.14.0-0``,  ``1.12.0-1``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-1``,  ``1.8.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.28.0","1.26.0","1.26.0","1.25.0","1.22.0"];
    </script>
