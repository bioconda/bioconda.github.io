...
.. conda:recipe:: bioconductor-pd.genomewidesnp.6
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/pd.genomewidesnp.6.html
...
.. conda:package:: bioconductor-pd.genomewidesnp.6
   ...
   :required~by: |required_by_bioconductor-pd.genomewidesnp.6|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-pd.genomewidesnp.6


.. |required_by_bioconductor-pd.genomewidesnp.6| conda:required_by:: bioconductor-pd.genomewidesnp.6
