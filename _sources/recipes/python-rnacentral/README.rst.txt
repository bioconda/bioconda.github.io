...
.. conda:package:: python-rnacentral
   ...
   :required~by: |required_by_python-rnacentral|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/python-rnacentral


.. |required_by_python-rnacentral| conda:required_by:: python-rnacentral
