...
.. conda:recipe:: bioconductor-brgedata
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/experiment/html/brgedata.html
...
.. conda:package:: bioconductor-brgedata
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-brgedata

   and update with::

      mamba update bioconductor-brgedata

  To create a new environment, run::

      mamba create --name myenvname bioconductor-brgedata
