...
.. conda:package:: r-sigminer
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.1.9-2</code>,  <code>2.1.9-1</code>,  <code>2.1.9-0</code>,  <code>2.1.8-1</code>,  <code>2.1.8-0</code>,  <code>2.1.7-1</code>,  <code>2.1.7-0</code>,  <code>2.1.6-1</code>,  <code>2.1.6-0</code>,  </span></summary>
      

      ``2.1.9-2``,  ``2.1.9-1``,  ``2.1.9-0``,  ``2.1.8-1``,  ``2.1.8-0``,  ``2.1.7-1``,  ``2.1.7-0``,  ``2.1.6-1``,  ``2.1.6-0``,  ``2.1.5-1``,  ``2.1.5-0``,  ``2.1.4-0``,  ``2.1.3-1``,  ``2.1.3-0``,  ``2.1.2-1``,  ``2.1.2-0``,  ``2.1.1-0``,  ``2.1.0-0``,  ``2.0.5-0``,  ``2.0.4-0``,  ``2.0.3-0``,  ``2.0.2-0``,  ``2.0.1-1``,  ``2.0.1-0``,  ``2.0.0-1``,  ``2.0.0-0``,  ``1.2.5-1``,  ``1.2.5-0``,  ``1.2.4-0``,  ``1.2.1-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.1.9","2.1.9","2.1.9","2.1.8","2.1.8"];
    </script>
