...
.. conda:package:: fastool
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.1.4-10</code>,  <code>0.1.4-9</code>,  <code>0.1.4-8</code>,  <code>0.1.4-7</code>,  <code>0.1.4-6</code>,  <code>0.1.4-5</code>,  <code>0.1.4-4</code>,  <code>0.1.4-3</code>,  <code>0.1.4-2</code>,  </span></summary>
      

      ``0.1.4-10``,  ``0.1.4-9``,  ``0.1.4-8``,  ``0.1.4-7``,  ``0.1.4-6``,  ``0.1.4-5``,  ``0.1.4-4``,  ``0.1.4-3``,  ``0.1.4-2``,  ``0.1.4-1``,  ``0.1.4-0``
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname fastool
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_fastool"></div>
   <div style="width: 100%" id="platform_plot_fastool"></div>
   <div style="width: 100%" id="cdf_plot_fastool"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/fastool/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_fastool', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for fastool
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/fastool/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_fastool', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for fastool
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/fastool/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_fastool', spec);
            } catch (err) {
