...
.. conda:recipe:: wfmash
   ...
   :documentation: https://github.com/waveygang/wfmash/blob/v0.24.2/README.md
...
.. conda:package:: wfmash
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.24.2-1</code>,  <code>0.24.2-0</code>,  <code>0.24.1-1</code>,  <code>0.24.1-0</code>,  <code>0.24.0-0</code>,  <code>0.23.0-0</code>,  <code>0.22.0-1</code>,  <code>0.22.0-0</code>,  <code>0.21.0-0</code>,  </span></summary>
      

      ``0.24.2-1``,  ``0.24.2-0``,  ``0.24.1-1``,  ``0.24.1-0``,  ``0.24.0-0``,  ``0.23.0-0``,  ``0.22.0-1``,  ``0.22.0-0``,  ``0.21.0-0``,  ``0.20.0-0``,  ``0.19.0-0``,  ``0.18.0-0``,  ``0.17.0-0``,  ``0.16.0-0``,  ``0.15.0-1``,  ``0.15.0-0``,  ``0.14.0-0``,  ``0.13.1-0``,  ``0.13.0-0``,  ``0.12.6-1``,  ``0.12.6-0``,  ``0.12.5-0``,  ``0.10.5-0``,  ``0.10.4-0``,  ``0.10.3-2``,  ``0.10.3-1``,  ``0.10.3-0``,  ``0.10.2-1``,  ``0.10.2-0``,  ``0.10.1-0``,  ``0.10.0-2``,  ``0.10.0-1``,  ``0.10.0-0``,  ``0.9.1-3``,  ``0.9.1-2``,  ``0.9.1-1``,  ``0.9.1-0``,  ``0.8.2-0``,  ``0.8.1-0``,  ``0.8.0-0``,  ``0.7.0-2``,  ``0.7.0-1``,  ``0.7.0-0``,  ``0.6.1-0``
...
.. raw:: html
   ...
   <script>
      var package = "wfmash";
      var versions = ["0.24.2","0.24.2","0.24.1","0.24.1","0.24.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_wfmash"></div>
   <div style="width: 100%" id="platform_plot_wfmash"></div>
   <div style="width: 100%" id="cdf_plot_wfmash"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/wfmash/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_wfmash', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for wfmash
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/wfmash/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_wfmash', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for wfmash
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/wfmash/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_wfmash', spec);
            } catch (err) {
