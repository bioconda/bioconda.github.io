...
.. conda:recipe:: bioconductor-mta10probeset.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/mta10probeset.db.html
...
.. conda:package:: bioconductor-mta10probeset.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mta10probeset.db

   and update with::

      mamba update bioconductor-mta10probeset.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mta10probeset.db
