...
.. conda:package:: pgscatalog.core
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.1.1-0</code>,  <code>1.1.0-0</code>,  <code>1.0.2-0</code>,  <code>1.0.1-0</code>,  <code>1.0.0-0</code>,  <code>0.3.3-0</code>,  <code>0.3.2-0</code>,  <code>0.3.1-0</code>,  <code>0.2.2-0</code>,  </span></summary>
      

      ``1.1.1-0``,  ``1.1.0-0``,  ``1.0.2-0``,  ``1.0.1-0``,  ``1.0.0-0``,  ``0.3.3-0``,  ``0.3.2-0``,  ``0.3.1-0``,  ``0.2.2-0``,  ``0.2.1-0``
   ...
   :depends on pyliftover: ``>=0.4.1``
   :depends on python: ``>=3.10``
   :depends on python-zlib-ng: 
   :depends on tenacity: ``>=9.0.0``
   :depends on tqdm: ``>=4.67.1``
   :depends on xopen: ``>=2.0.2``
...
to install globally, run::
    ...
    pixi global install pgscatalog.core

to add into an existing workspace instead, run::

    pixi add pgscatalog.core
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install pgscatalog.core

Alternatively, to install into a new environment, run::

    conda create -n envname pgscatalog.core
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_pgscatalog.core"></div>
   <div style="width: 100%" id="platform_plot_pgscatalog.core"></div>
   <div style="width: 100%" id="cdf_plot_pgscatalog.core"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for pgscatalog.core
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/pgscatalog.core/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_pgscatalog.core', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for pgscatalog.core
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/pgscatalog.core/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_pgscatalog.core', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for pgscatalog.core
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/pgscatalog.core/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_pgscatalog.core', spec);
            } catch (err) {
