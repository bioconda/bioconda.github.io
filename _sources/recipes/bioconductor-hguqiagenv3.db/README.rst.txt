...
.. conda:package:: bioconductor-hguqiagenv3.db
   ...
   :required~by: |required_by_bioconductor-hguqiagenv3.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-hguqiagenv3.db


.. |required_by_bioconductor-hguqiagenv3.db| conda:required_by:: bioconductor-hguqiagenv3.db
