...
.. conda:recipe:: bioconductor-ampaffyexample
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/experiment/html/AmpAffyExample.html
   :license: LGPL (>= 2)
...
.. conda:package:: bioconductor-ampaffyexample
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ampaffyexample

   and update with::

      mamba update bioconductor-ampaffyexample

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ampaffyexample
