...
.. conda:package:: pyrodigal
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.6.2-0</code>,  <code>0.5.4-0</code>,  <code>0.5.3-0</code>,  <code>0.5.1-0</code>,  <code>0.5.0-0</code>,  <code>0.4.7-0</code>,  <code>0.4.6-1</code>,  <code>0.4.6-0</code>,  <code>0.4.5-0</code>,  </span></summary>
      

      ``0.6.2-0``,  ``0.5.4-0``,  ``0.5.3-0``,  ``0.5.1-0``,  ``0.5.0-0``,  ``0.4.7-0``,  ``0.4.6-1``,  ``0.4.6-0``,  ``0.4.5-0``,  ``0.3.0-0``,  ``0.2.1-1``,  ``0.2.1-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.6.2","0.5.4","0.5.3","0.5.1","0.5.0"];
    </script>
