...
.. conda:recipe:: bioconductor-pd.plasmodium.anopheles
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/pd.plasmodium.anopheles.html
...
.. conda:package:: bioconductor-pd.plasmodium.anopheles
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.plasmodium.anopheles

   and update with::

      mamba update bioconductor-pd.plasmodium.anopheles

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.plasmodium.anopheles
