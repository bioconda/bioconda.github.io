...
.. conda:package:: pathogen-profiler
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>4.6.0-0</code>,  <code>4.5.1-0</code>,  <code>4.5.0-1</code>,  <code>4.5.0-0</code>,  <code>4.4.0-0</code>,  <code>4.3.0-0</code>,  <code>4.2.0-1</code>,  <code>4.2.0-0</code>,  <code>4.1.0-0</code>,  </span></summary>
      

      ``4.6.0-0``,  ``4.5.1-0``,  ``4.5.0-1``,  ``4.5.0-0``,  ``4.4.0-0``,  ``4.3.0-0``,  ``4.2.0-1``,  ``4.2.0-0``,  ``4.1.0-0``,  ``4.0.0-0``,  ``3.1.0-0``,  ``3.0.0-0``,  ``2.0.4-1``,  ``2.0.4-0``,  ``2.0.3-0``,  ``2.0.2-1``,  ``2.0.2-0``,  ``2.0.1-0``,  ``2.0.0-1``,  ``2.0.0-0``,  ``1.7.3-1``,  ``1.7.3-0``,  ``1.7.2-0``,  ``1.7.1-1``,  ``1.7.1-0``,  ``1.7-0``,  ``1.6.1-0``,  ``1.6-0``,  ``1.5-0``,  ``1.3-0``,  ``1.2-0``,  ``1.1-2``,  ``1.1-1``,  ``1.1-0``,  ``1.0-0``,  ``0.1-3``,  ``0.1-2``,  ``0.1-1``,  ``0.1-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["4.6.0","4.5.1","4.5.0","4.5.0","4.4.0"];
    </script>
