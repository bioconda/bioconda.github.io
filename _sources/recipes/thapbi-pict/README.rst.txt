...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.0.24","1.0.23","1.0.22","1.0.21","1.0.20"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_thapbi-pict"></div>
   <div style="width: 100%" id="platform_plot_thapbi-pict"></div>
   <div style="width: 100%" id="cdf_plot_thapbi-pict"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for thapbi-pict
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/thapbi-pict/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_thapbi-pict', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for thapbi-pict
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/thapbi-pict/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_thapbi-pict', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for thapbi-pict
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/thapbi-pict/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_thapbi-pict', spec);
            } catch (err) {
