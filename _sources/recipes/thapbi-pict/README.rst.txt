...
.. conda:package:: thapbi-pict
   ...
   :depends blast: 
   :depends cutadapt: ``>=4.0``
   :depends flash: ``>=1.2.11``
   :depends graphviz: 
   :depends matplotlib-base: 
   :depends networkx: ``>=2.4,!=2.8.3,!=2.8.4``
   :depends pydot: 
   :depends python: ``>=3.6``
   :depends rapidfuzz: ``>=2.4.0``
   :depends sqlalchemy: 
   :depends xlsxwriter: 
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.13.5","0.13.4","0.13.3","0.13.2","0.13.1"];
    </script>
