...
.. conda:recipe:: bioconductor-ace
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/ACE.html
   :license: GPL-2
...
.. conda:package:: bioconductor-ace
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ace

   and update with::

      mamba update bioconductor-ace

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ace
