...
.. conda:recipe:: bioconductor-hgu133plus2probe
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/hgu133plus2probe.html
   :license: LGPL
...
to install globally, run::
    ...
    pixi global install bioconductor-hgu133plus2probe

to add into an existing workspace instead, run::

    pixi add bioconductor-hgu133plus2probe
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-hgu133plus2probe
...
For e.g. docker, run::
    ...
    docker pull quay.io/biocontainers/bioconductor-hgu133plus2probe:<tag>
...
.. |downloads_bioconductor-hgu133plus2probe| image:: https://img.shields.io/conda/dn/bioconda/bioconductor-hgu133plus2probe.svg?style=flat
   :target: https://anaconda.org/bioconda/bioconductor-hgu133plus2probe
   :alt:   (downloads)
...
.. raw:: html
   ...
   <script>
      var package = "bioconductor-hgu133plus2probe";
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-hgu133plus2probe"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-hgu133plus2probe"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-hgu133plus2probe"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-hgu133plus2probe
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hgu133plus2probe/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-hgu133plus2probe', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-hgu133plus2probe
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hgu133plus2probe/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-hgu133plus2probe', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-hgu133plus2probe
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hgu133plus2probe/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-hgu133plus2probe', spec);
            } catch (err) {
