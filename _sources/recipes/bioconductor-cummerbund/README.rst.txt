...
.. conda:recipe:: bioconductor-cummerbund
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/cummeRbund.html
...
.. conda:package:: bioconductor-cummerbund
   ...
   :versions:
      ...
      ``2.48.0-0``,  ``2.44.0-0``,  ``2.42.0-0``,  ``2.40.0-0``,  ``2.36.0-0``,  ``2.34.0-0``,  ``2.32.0-1``,  ``2.32.0-0``,  ``2.30.0-0``,  ``2.28.0-0``,  ``2.26.0-1``,  ``2.24.0-0``,  ``2.22.0-0``,  ``2.20.0-0``,  ``2.18.0-0``,  ``2.16.0-0``,  ``2.12.1-1``,  ``2.12.1-0``,  ``2.8.2-1``,  ``2.8.2-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-cummerbund

to add into an existing workspace instead, run::

    pixi add bioconductor-cummerbund
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-cummerbund
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-cummerbund"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-cummerbund"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-cummerbund"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-cummerbund
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-cummerbund/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-cummerbund', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-cummerbund
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-cummerbund/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-cummerbund', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-cummerbund
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-cummerbund/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-cummerbund', spec);
            } catch (err) {
