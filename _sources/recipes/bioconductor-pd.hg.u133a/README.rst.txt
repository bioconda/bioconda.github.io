...
.. conda:recipe:: bioconductor-pd.hg.u133a
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/pd.hg.u133a.html
...
.. conda:package:: bioconductor-pd.hg.u133a
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.hg.u133a

   and update with::

      mamba update bioconductor-pd.hg.u133a

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.hg.u133a
