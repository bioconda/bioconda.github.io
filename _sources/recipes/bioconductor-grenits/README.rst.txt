...
.. conda:recipe:: bioconductor-grenits
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/GRENITS.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-grenits
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.62.0-0</code>,  <code>1.58.0-0</code>,  <code>1.54.0-1</code>,  <code>1.54.0-0</code>,  <code>1.52.1-0</code>,  <code>1.50.0-1</code>,  <code>1.50.0-0</code>,  <code>1.46.0-2</code>,  <code>1.46.0-1</code>,  </span></summary>
      

      ``1.62.0-0``,  ``1.58.0-0``,  ``1.54.0-1``,  ``1.54.0-0``,  ``1.52.1-0``,  ``1.50.0-1``,  ``1.50.0-0``,  ``1.46.0-2``,  ``1.46.0-1``,  ``1.46.0-0``,  ``1.44.0-0``,  ``1.42.0-1``,  ``1.42.0-0``,  ``1.40.0-0``,  ``1.38.0-0``,  ``1.36.0-0``,  ``1.34.0-0``
   ...
   :depends on r-rcpp: ``>=0.8.6``
   :depends on r-rcpparmadillo: ``>=0.2.8``
...
to install globally, run::
    ...
    pixi global install bioconductor-grenits

to add into an existing workspace instead, run::

    pixi add bioconductor-grenits
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-grenits
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.62.0","1.58.0","1.54.0","1.54.0","1.52.1"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-grenits"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-grenits"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-grenits"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-grenits
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-grenits/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-grenits', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-grenits
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-grenits/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-grenits', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-grenits
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-grenits/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-grenits', spec);
            } catch (err) {
