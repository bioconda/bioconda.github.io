...
.. conda:recipe:: bioconductor-schex
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/schex.html
   :license: GPL-3
...
.. conda:package:: bioconductor-schex
   ...
   :versions:
      ...
      ``1.16.0-0``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.8.0-0``,  ``1.5.0-0``,  ``1.4.0-1``,  ``1.4.0-0``,  ``1.2.0-0``,  ``1.0.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.16.0","1.14.0","1.12.0","1.8.0","1.5.0"];
    </script>
