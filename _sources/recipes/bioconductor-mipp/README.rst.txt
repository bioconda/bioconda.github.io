...
.. conda:recipe:: bioconductor-mipp
   ...
   :homepage: https://bioconductor.org/packages/3.8/bioc/html/MiPP.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-mipp
   ...
   :depends: :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-e1071`  :conda:package:`r-mass`  

   :required~by: |required_by_bioconductor-mipp|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-mipp


.. |required_by_bioconductor-mipp| conda:required_by:: bioconductor-mipp
