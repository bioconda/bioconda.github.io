...
.. conda:package:: qimba
   ...
   :depends on dnaio: ``>=1.1``
   :depends on fastp: 
   :depends on fasttree: ``>=2.0``
   :depends on kraken2: 
   :depends on mafft: ``>=7.0``
   :depends on minimap2: ``>=2.1``
   :depends on pandas: ``>=2.0.0``
   :depends on python: ``>=3.9``
   :depends on seqfu: ``>1.20``
   :depends on usearch: 
   :depends on xopen: ``>=2.0``
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_qimba"></div>
   <div style="width: 100%" id="platform_plot_qimba"></div>
   <div style="width: 100%" id="cdf_plot_qimba"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/qimba/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_qimba', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for qimba
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/qimba/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_qimba', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for qimba
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/qimba/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_qimba', spec);
            } catch (err) {
