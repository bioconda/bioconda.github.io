...
.. conda:recipe:: bioconductor-pd.mapping250k.sty
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/pd.mapping250k.sty.html
...
.. conda:package:: bioconductor-pd.mapping250k.sty
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.mapping250k.sty

   and update with::

      mamba update bioconductor-pd.mapping250k.sty

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.mapping250k.sty
