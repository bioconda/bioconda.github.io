...
.. conda:recipe:: bioconductor-graphite
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/graphite.html
   :license: AGPL-3
...
.. conda:package:: bioconductor-graphite
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.36.0-1</code>,  <code>1.36.0-0</code>,  <code>1.34.0-0</code>,  <code>1.32.0-0</code>,  <code>1.30.0-1</code>,  <code>1.28.2-0</code>,  <code>1.28.1-0</code>,  <code>1.26.3-0</code>,  <code>1.24.0-0</code>,  </span></summary>
      

      ``1.36.0-1``,  ``1.36.0-0``,  ``1.34.0-0``,  ``1.32.0-0``,  ``1.30.0-1``,  ``1.28.2-0``,  ``1.28.1-0``,  ``1.26.3-0``,  ``1.24.0-0``,  ``1.22.0-0``,  ``1.16.0-0``
