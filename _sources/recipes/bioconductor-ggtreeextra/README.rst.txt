...
.. conda:recipe:: bioconductor-ggtreeextra
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/ggtreeExtra.html
   :license: GPL (>= 3)
...
.. conda:package:: bioconductor-ggtreeextra
   ...
   :versions:
      ...
      ``1.10.0-0``,  ``1.8.0-0``,  ``1.4.0-0``,  ``1.2.0-0``,  ``1.0.2-0``,  ``1.0.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.10.0","1.8.0","1.4.0","1.2.0","1.0.2"];
    </script>
