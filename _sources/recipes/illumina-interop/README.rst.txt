...
.. conda:package:: illumina-interop
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.1.25-0</code>,  <code>1.1.24-0</code>,  <code>1.1.23-1</code>,  <code>1.1.23-0</code>,  <code>1.1.22-0</code>,  <code>1.1.21-1</code>,  <code>1.1.21-0</code>,  <code>1.1.20-0</code>,  <code>1.1.19-0</code>,  </span></summary>
      

      ``1.1.25-0``,  ``1.1.24-0``,  ``1.1.23-1``,  ``1.1.23-0``,  ``1.1.22-0``,  ``1.1.21-1``,  ``1.1.21-0``,  ``1.1.20-0``,  ``1.1.19-0``,  ``1.1.18-0``,  ``1.1.16-0``,  ``1.1.15-0``,  ``1.1.14-0``,  ``1.1.12-0``,  ``1.1.11-0``,  ``1.1.10-0``,  ``1.1.9-0``,  ``1.1.8-0``,  ``1.1.7-0``,  ``1.1.6-0``,  ``1.1.4-3``,  ``1.1.4-0``,  ``1.0.25-1``,  ``1.0.25-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.1.25","1.1.24","1.1.23","1.1.23","1.1.22"];
    </script>
