...
.. conda:package:: rnaquast
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.3.2-0</code>,  <code>2.3.0-0</code>,  <code>2.2.3-0</code>,  <code>2.2.1-0</code>,  <code>2.2.0-2</code>,  <code>2.2.0-1</code>,  <code>2.2.0-0</code>,  <code>2.1.0-1</code>,  <code>2.1.0-0</code>,  </span></summary>
      

      ``2.3.2-0``,  ``2.3.0-0``,  ``2.2.3-0``,  ``2.2.1-0``,  ``2.2.0-2``,  ``2.2.0-1``,  ``2.2.0-0``,  ``2.1.0-1``,  ``2.1.0-0``,  ``2.0.1-0``,  ``2.0.0-0``,  ``1.5.1-0``
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname rnaquast
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["2.3.2","2.3.0","2.2.3","2.2.1","2.2.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_rnaquast"></div>
   <div style="width: 100%" id="platform_plot_rnaquast"></div>
   <div style="width: 100%" id="cdf_plot_rnaquast"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/rnaquast/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_rnaquast', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for rnaquast
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/rnaquast/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_rnaquast', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for rnaquast
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/rnaquast/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_rnaquast', spec);
            } catch (err) {
