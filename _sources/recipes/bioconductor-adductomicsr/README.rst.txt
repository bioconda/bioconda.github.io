...
.. conda:recipe:: bioconductor-adductomicsr
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/adductomicsR.html
...
.. conda:package:: bioconductor-adductomicsr
   ...
   :versions:
      ...
      ``1.8.0-0``,  ``1.6.0-1``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.0-1``,  ``1.0.0-1``

      

   
   :depends bioconductor-adductdata: ``>=1.8.0,<1.9.0``
