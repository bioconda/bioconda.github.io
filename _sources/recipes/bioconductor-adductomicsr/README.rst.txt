...
.. conda:recipe:: bioconductor-adductomicsr
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/adductomicsR.html
...
.. conda:package:: bioconductor-adductomicsr
   ...
   :versions:
      ...
      ``1.16.0-0``,  ``1.14.0-0``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.0-1``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.0-1``,  ``1.0.0-1``

      

   
   :depends bioconductor-adductdata: ``>=1.16.0,<1.17.0``
