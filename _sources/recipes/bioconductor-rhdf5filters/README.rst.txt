...
.. conda:recipe:: bioconductor-rhdf5filters
   ...
   :homepage: https://bioconductor.org/packages/3.23/bioc/html/rhdf5filters.html
...
.. conda:package:: bioconductor-rhdf5filters
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.24.1-0</code>,  <code>1.22.0-0</code>,  <code>1.18.0-1</code>,  <code>1.18.0-0</code>,  <code>1.14.1-1</code>,  <code>1.14.1-0</code>,  <code>1.12.1-1</code>,  <code>1.12.1-0</code>,  <code>1.10.0-1</code>,  </span></summary>
      

      ``1.24.1-0``,  ``1.22.0-0``,  ``1.18.0-1``,  ``1.18.0-0``,  ``1.14.1-1``,  ``1.14.1-0``,  ``1.12.1-1``,  ``1.12.1-0``,  ``1.10.0-1``,  ``1.10.0-0``,  ``1.6.0-2``,  ``1.6.0-1``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.0-1``,  ``1.2.0-0``,  ``1.0.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-rhdf5filters

to add into an existing workspace instead, run::

    pixi add bioconductor-rhdf5filters
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-rhdf5filters
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.24.1","1.22.0","1.18.0","1.18.0","1.14.1"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-rhdf5filters"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-rhdf5filters"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-rhdf5filters"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-rhdf5filters
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rhdf5filters/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-rhdf5filters', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-rhdf5filters
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rhdf5filters/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-rhdf5filters', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-rhdf5filters
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rhdf5filters/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-rhdf5filters', spec);
            } catch (err) {
