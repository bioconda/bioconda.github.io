...
.. conda:package:: bioconductor-pd.s.aureus
   ...
   :required~by: |required_by_bioconductor-pd.s.aureus|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-pd.s.aureus


.. |required_by_bioconductor-pd.s.aureus| conda:required_by:: bioconductor-pd.s.aureus
