...
.. conda:package:: art_modern-openmpi
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.5.1-0</code>,  <code>1.5.0-0</code>,  <code>1.4.1-0</code>,  <code>1.4.0-1</code>,  <code>1.4.0-0</code>,  <code>1.3.4-0</code>,  <code>1.3.3-0</code>,  <code>1.3.2-0</code>,  <code>1.3.1-0</code>,  </span></summary>
      

      ``1.5.1-0``,  ``1.5.0-0``,  ``1.4.1-0``,  ``1.4.0-1``,  ``1.4.0-0``,  ``1.3.4-0``,  ``1.3.3-0``,  ``1.3.2-0``,  ``1.3.1-0``,  ``1.3.0-1``,  ``1.3.0-0``,  ``1.2.0-0``
...
to install globally, run::
    ...
    pixi global install art_modern-openmpi

to add into an existing workspace instead, run::

    pixi add art_modern-openmpi
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install art_modern-openmpi

Alternatively, to install into a new environment, run::

    conda create -n envname art_modern-openmpi
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.5.1","1.5.0","1.4.1","1.4.0","1.4.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_art_modern-openmpi"></div>
   <div style="width: 100%" id="platform_plot_art_modern-openmpi"></div>
   <div style="width: 100%" id="cdf_plot_art_modern-openmpi"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for art_modern-openmpi
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/art_modern-openmpi/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_art_modern-openmpi', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for art_modern-openmpi
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/art_modern-openmpi/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_art_modern-openmpi', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for art_modern-openmpi
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/art_modern-openmpi/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_art_modern-openmpi', spec);
            } catch (err) {
