...
.. conda:recipe:: bioconductor-canine2probe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/canine2probe.html
   :license: LGPL
...
.. conda:package:: bioconductor-canine2probe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-canine2probe

   and update with::

      mamba update bioconductor-canine2probe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-canine2probe
