...
.. conda:recipe:: bioconductor-hgfocus.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/hgfocus.db.html
...
.. conda:package:: bioconductor-hgfocus.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hgfocus.db

   and update with::

      mamba update bioconductor-hgfocus.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hgfocus.db
