...
.. conda:package:: bioconductor-hgfocus.db
   ...
   :required~by: |required_by_bioconductor-hgfocus.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-hgfocus.db


.. |required_by_bioconductor-hgfocus.db| conda:required_by:: bioconductor-hgfocus.db
