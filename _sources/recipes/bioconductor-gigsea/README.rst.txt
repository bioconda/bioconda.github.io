...
.. conda:package:: bioconductor-gigsea
   ...
   :depends: :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-locfdr`  :conda:package:`r-mass`  :conda:package:`r-matrix`  

   :required~by: |required_by_bioconductor-gigsea|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-gigsea


.. |required_by_bioconductor-gigsea| conda:required_by:: bioconductor-gigsea
