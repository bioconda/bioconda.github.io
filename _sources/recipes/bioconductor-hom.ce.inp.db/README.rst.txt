...
.. conda:recipe:: bioconductor-hom.ce.inp.db
   ...
   :homepage: https://bioconductor.org/packages/3.12/data/annotation/html/hom.Ce.inp.db.html
...
.. conda:package:: bioconductor-hom.ce.inp.db
   ...
   or use the docker container::
      ...
      docker pull quay.io/biocontainers/bioconductor-hom.ce.inp.db:<tag>

   (see `bioconductor-hom.ce.inp.db/tags`_ for valid values for ``<tag>``)
...
.. _`bioconductor-hom.ce.inp.db/tags`: https://quay.io/repository/biocontainers/bioconductor-hom.ce.inp.db?tab=tags


.. raw:: html

    <script>
        var package = "bioconductor-hom.ce.inp.db";
