...
.. conda:package:: pharmcat3
   ...
   :versions:
      ...
      ``3.4.0-0``,  ``3.3.0-0``,  ``3.2.0-0``,  ``3.1.1-0``
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install pharmcat3

Alternatively, to install into a new environment, run::

    conda create -n envname pharmcat3
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["3.4.0","3.3.0","3.2.0","3.1.1"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_pharmcat3"></div>
   <div style="width: 100%" id="platform_plot_pharmcat3"></div>
   <div style="width: 100%" id="cdf_plot_pharmcat3"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/pharmcat3/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_pharmcat3', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for pharmcat3
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/pharmcat3/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_pharmcat3', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for pharmcat3
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/pharmcat3/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_pharmcat3', spec);
            } catch (err) {
