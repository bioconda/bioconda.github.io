...
.. conda:recipe:: bioconductor-intramirexplorer
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/IntramiRExploreR.html
   :license: GPL-2
...
.. conda:package:: bioconductor-intramirexplorer
   ...
   :versions:
      ...
      ``1.12.0-1``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.0-1``,  ``1.6.0-0``,  ``1.4.0-0``

      

   
   :depends bioconductor-fgnet: ``>=3.23.0,<3.24.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.12.0","1.12.0","1.10.0","1.8.0","1.6.0"];
    </script>
