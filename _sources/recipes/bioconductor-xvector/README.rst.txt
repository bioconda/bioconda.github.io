...
.. conda:recipe:: bioconductor-xvector
   ...
   :homepage: https://bioconductor.org/packages/3.11/bioc/html/XVector.html
...
.. conda:package:: bioconductor-xvector
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.30.0-0</code>,  <code>0.28.0-0</code>,  <code>0.26.0-0</code>,  <code>0.24.0-1</code>,  <code>0.22.0-0</code>,  <code>0.20.0-0</code>,  <code>0.18.0-0</code>,  <code>0.16.0-0</code>,  <code>0.14.1-0</code>,  </span></summary>
      

      ``0.30.0-0``,  ``0.28.0-0``,  ``0.26.0-0``,  ``0.24.0-1``,  ``0.22.0-0``,  ``0.20.0-0``,  ``0.18.0-0``,  ``0.16.0-0``,  ``0.14.1-0``,  ``0.12.1-0``,  ``0.10.0-1``,  ``0.10.0-0``,  ``0.8.0-0``
