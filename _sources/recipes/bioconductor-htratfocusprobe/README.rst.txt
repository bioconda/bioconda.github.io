...
.. conda:recipe:: bioconductor-htratfocusprobe
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/htratfocusprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-htratfocusprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-htratfocusprobe

   and update with::

      mamba update bioconductor-htratfocusprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-htratfocusprobe
