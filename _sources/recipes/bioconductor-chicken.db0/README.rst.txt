...
.. conda:recipe:: bioconductor-chicken.db0
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/chicken.db0.html
...
.. conda:package:: bioconductor-chicken.db0
   ...
   :required~by: |required_by_bioconductor-chicken.db0|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-chicken.db0


.. |required_by_bioconductor-chicken.db0| conda:required_by:: bioconductor-chicken.db0
