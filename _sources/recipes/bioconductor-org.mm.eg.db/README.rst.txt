...
.. conda:recipe:: bioconductor-org.mm.eg.db
   ...
   :homepage: https://bioconductor.org/packages/3.13/data/annotation/html/org.Mm.eg.db.html
...
.. conda:package:: bioconductor-org.mm.eg.db
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.14.0-0</code>,  <code>3.13.0-0</code>,  <code>3.12.0-1</code>,  <code>3.12.0-0</code>,  <code>3.11.4-1</code>,  <code>3.11.4-0</code>,  <code>3.11.1-0</code>,  <code>3.10.0-0</code>,  <code>3.8.2-1</code>,  </span></summary>
      

      ``3.14.0-0``,  ``3.13.0-0``,  ``3.12.0-1``,  ``3.12.0-0``,  ``3.11.4-1``,  ``3.11.4-0``,  ``3.11.1-0``,  ``3.10.0-0``,  ``3.8.2-1``,  ``3.7.0-0``,  ``3.6.0-0``,  ``3.5.0-1``,  ``3.5.0-0``,  ``3.4.2-0``,  ``3.4.1-0``,  ``3.4.0-0``,  ``3.3.0-2``,  ``3.3.0-1``,  ``3.3.0-0``,  ``3.2.3-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["3.14.0","3.13.0","3.12.0","3.12.0","3.11.4"];
    </script>
