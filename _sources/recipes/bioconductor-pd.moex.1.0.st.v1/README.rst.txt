...
.. conda:recipe:: bioconductor-pd.moex.1.0.st.v1
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/pd.moex.1.0.st.v1.html
...
.. conda:package:: bioconductor-pd.moex.1.0.st.v1
   ...
   :required~by: |required_by_bioconductor-pd.moex.1.0.st.v1|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-pd.moex.1.0.st.v1


.. |required_by_bioconductor-pd.moex.1.0.st.v1| conda:required_by:: bioconductor-pd.moex.1.0.st.v1
