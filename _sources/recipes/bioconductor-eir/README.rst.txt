...
.. conda:package:: bioconductor-eir
   ...
   :depends: :conda:package:`bioconductor-biocgenerics` >=0.28.0,<0.29.0 :conda:package:`bioconductor-chemminer` >=3.34.0,<3.35.0 :conda:package:`bioconductor-gesper` >=1.14.0,<1.15.0 :conda:package:`libcxx` >=4.0.1 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-dbi`  :conda:package:`r-digest`  :conda:package:`r-rcppannoy` >=0.0.9 :conda:package:`r-rcurl`  :conda:package:`r-runit`  :conda:package:`r-snow`  :conda:package:`r-snowfall`  
