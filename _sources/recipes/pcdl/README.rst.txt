...
.. conda:recipe:: pcdl
   ...
   :documentation: https://github.com/elmbeech/physicelldataloader/blob/v4.1.5/README.md
...
.. conda:package:: pcdl
   ...
   :versions:
      ...
      ``4.1.5-0``,  ``4.1.3-0``,  ``3.3.8-0``,  ``3.3.7-0``,  ``3.3.6-0``
...
.. raw:: html
   ...
   <script>
      var package = "pcdl";
      var versions = ["4.1.5","4.1.3","3.3.8","3.3.7","3.3.6"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_pcdl"></div>
   <div style="width: 100%" id="platform_plot_pcdl"></div>
   <div style="width: 100%" id="cdf_plot_pcdl"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/pcdl/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_pcdl', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for pcdl
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/pcdl/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_pcdl', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for pcdl
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/pcdl/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_pcdl', spec);
            } catch (err) {
