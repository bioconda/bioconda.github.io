...
.. conda:recipe:: bioconductor-gseamining
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/GSEAmining.html
...
.. conda:package:: bioconductor-gseamining
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-gseamining

   and update with::

      mamba update bioconductor-gseamining

  To create a new environment, run::

      mamba create --name myenvname bioconductor-gseamining
