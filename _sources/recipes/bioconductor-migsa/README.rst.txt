...
============= ===========
Home          https://bioconductor.org/packages/3.8/bioc/html/MIGSA.html
Versions      
License       GPL (>= 2)
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes//bioconductor-migsa/meta.yaml
...
A Docker container is available at https://quay.io/repository/biocontainers/bioconductor-migsa.
...
Render an |badge| badge with the following Markdown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square)](http://bioconda.github.io/recipes/bioconductor-migsa/README.html)

.. |badge| image:: https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square
           :target: http://bioconda.github.io/recipes/bioconductor-migsa/README.html
.. |downloads| image:: https://anaconda.org/bioconda/bioconductor-migsa/badges/downloads.svg
               :target: https://anaconda.org/bioconda/bioconductor-migsa
.. |docker| image:: https://quay.io/repository/biocontainers/bioconductor-migsa/status
