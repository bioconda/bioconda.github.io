...
.. conda:package:: perl-json-xs
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>4.03-0</code>,  <code>4.02-3</code>,  <code>4.02-2</code>,  <code>4.02-1</code>,  <code>4.02-0</code>,  <code>4.0-0</code>,  <code>3.04-0</code>,  <code>2.34-4</code>,  <code>2.34-3</code>,  </span></summary>
      

      ``4.03-0``,  ``4.02-3``,  ``4.02-2``,  ``4.02-1``,  ``4.02-0``,  ``4.0-0``,  ``3.04-0``,  ``2.34-4``,  ``2.34-3``,  ``2.34-2``,  ``2.34-1``,  ``2.34-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["4.03","4.02","4.02","4.02","4.02"];
    </script>
