...
.. conda:recipe:: bioconductor-rtopper
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/RTopper.html
...
.. conda:package:: bioconductor-rtopper
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rtopper

   and update with::

      mamba update bioconductor-rtopper

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rtopper
