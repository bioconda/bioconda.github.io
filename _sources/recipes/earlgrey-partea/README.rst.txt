...
.. conda:package:: earlgrey-partea
   ...
   :versions:
      ...
      ``0.2.0-0``,  ``0.1.8-1``,  ``0.1.8-0``,  ``0.1.7-0``,  ``0.1.6-0``,  ``0.1.4-0``

      

   
   :depends on biopython: 
   :depends on busco: ``>=5.4``
   :depends on cd-hit: 
   :depends on clipkit: 
   ...
   :depends on snakemake-executor-plugin-lsf: 
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["0.2.0","0.1.8","0.1.8","0.1.7","0.1.6"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_earlgrey-partea"></div>
   <div style="width: 100%" id="platform_plot_earlgrey-partea"></div>
   <div style="width: 100%" id="cdf_plot_earlgrey-partea"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for earlgrey-partea
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/earlgrey-partea/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_earlgrey-partea', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for earlgrey-partea
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/earlgrey-partea/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_earlgrey-partea', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for earlgrey-partea
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/earlgrey-partea/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_earlgrey-partea', spec);
            } catch (err) {
