...
.. raw:: html
    ...
    <script>
        var package = "gmap";
        var versions = ["2024.02.22","2023.12.01","2023.10.10","2023.10.10","2023.10.01"];
    </script>
