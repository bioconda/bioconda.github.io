...
.. conda:package:: ucsc-ixixx
   ...
   :versions:
      ...
      ``469-1``,  ``469-0``,  ``466-0``,  ``377-3``,  ``377-2``,  ``377-1``,  ``377-0``,  ``366-0``,  ``357-2``,  ``357-1``,  ``357-0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install ucsc-ixixx

   and update with::

      mamba update ucsc-ixixx

  To create a new environment, run::

      mamba create --name myenvname ucsc-ixixx
