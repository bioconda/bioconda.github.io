...
.. conda:recipe:: bioconductor-cicero
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/cicero.html
...
.. conda:package:: bioconductor-cicero
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.28.3-0</code>,  <code>1.28.0-0</code>,  <code>1.24.0-0</code>,  <code>1.20.0-0</code>,  <code>1.18.0-0</code>,  <code>1.16.0-0</code>,  <code>1.12.0-0</code>,  <code>1.10.0-0</code>,  <code>1.8.1-0</code>,  </span></summary>
      

      ``1.28.3-0``,  ``1.28.0-0``,  ``1.24.0-0``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.1-0``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.0-1``,  ``1.0.14-0``
   ...
   :depends on bioconductor-monocle: ``>=2.38.0,<2.39.0``
   :depends on bioconductor-s4vectors: ``>=0.48.0,<0.49.0``
   :depends on r-assertthat: ``>=0.2.0``
   :depends on r-base: ``>=4.5,<4.6.0a0``
   :depends on r-data.table: ``>=1.10.4``
   :depends on r-dplyr: ``>=0.7.4``
   :depends on r-fnn: ``>=1.1``
   :depends on r-ggplot2: ``>=2.2.1``
   :depends on r-glasso: ``>=1.8``
   :depends on r-igraph: ``>=1.1.0``
   :depends on r-matrix: ``>=1.2-12``
...
to install globally, run::
    ...
    pixi global install bioconductor-cicero

to add into an existing workspace instead, run::

    pixi add bioconductor-cicero
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-cicero
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.28.3","1.28.0","1.24.0","1.20.0","1.18.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-cicero"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-cicero"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-cicero"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-cicero
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-cicero/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-cicero', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-cicero
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-cicero/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-cicero', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-cicero
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-cicero/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-cicero', spec);
            } catch (err) {
