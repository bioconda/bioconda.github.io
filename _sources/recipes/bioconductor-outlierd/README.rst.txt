...
.. conda:recipe:: bioconductor-outlierd
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/OutlierD.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-outlierd
   ...
   :versions:
      ...
      ``1.53.0-1``,  ``1.53.0-0``,  ``1.52.0-0``,  ``1.50.0-0``,  ``1.48.0-1``,  ``1.46.0-0``,  ``1.44.0-0``,  ``1.42.0-0``,  ``1.40.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-outlierd";
        var versions = ["1.53.0","1.53.0","1.52.0","1.50.0","1.48.0"];
    </script>
