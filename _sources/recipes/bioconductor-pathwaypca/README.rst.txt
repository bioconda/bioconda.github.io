...
.. conda:recipe:: bioconductor-pathwaypca
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/pathwayPCA.html
   :license: GPL-3
...
.. conda:package:: bioconductor-pathwaypca
   ...
   :versions:
      ...
      ``1.16.1-0``,  ``1.14.0-0``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.3-0``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.0-0``,  ``1.0.0-1``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.16.1","1.14.0","1.10.0","1.8.0","1.6.3"];
    </script>
