...
.. conda:package:: metabolabpy
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.9.78-0</code>,  <code>0.9.77-0</code>,  <code>0.9.74-0</code>,  <code>0.9.73-0</code>,  <code>0.9.72-0</code>,  <code>0.9.71-0</code>,  <code>0.9.70-0</code>,  <code>0.9.69-0</code>,  <code>0.9.68-0</code>,  </span></summary>
      

      ``0.9.78-0``,  ``0.9.77-0``,  ``0.9.74-0``,  ``0.9.73-0``,  ``0.9.72-0``,  ``0.9.71-0``,  ``0.9.70-0``,  ``0.9.69-0``,  ``0.9.68-0``,  ``0.9.67-0``,  ``0.9.66-0``,  ``0.9.65-0``,  ``0.9.64-0``,  ``0.9.63-0``,  ``0.9.62-0``,  ``0.9.61-0``,  ``0.9.59-0``,  ``0.9.53-0``,  ``0.9.51-0``,  ``0.9.50-0``,  ``0.9.48-0``,  ``0.9.47-0``,  ``0.9.46-0``,  ``0.9.45-0``,  ``0.9.44-0``,  ``0.9.43-0``,  ``0.9.42-0``,  ``0.9.41-0``,  ``0.6.53-0``,  ``0.6.51-0``,  ``0.6.50-0``,  ``0.6.49-0``,  ``0.6.48-0``,  ``0.6.46-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.9.78","0.9.77","0.9.74","0.9.73","0.9.72"];
    </script>
