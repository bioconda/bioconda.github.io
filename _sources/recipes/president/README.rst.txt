...
.. conda:package:: president
   ...
   :depends on pandas: ``>=1.2.1``
   :depends on pblat: ``>=2.5``
   :depends on python: ``>=3.8``
   :depends on screed: ``>=1.0.4``
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname president
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_president"></div>
   <div style="width: 100%" id="platform_plot_president"></div>
   <div style="width: 100%" id="cdf_plot_president"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/president/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_president', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for president
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/president/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_president', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for president
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/president/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_president', spec);
            } catch (err) {
