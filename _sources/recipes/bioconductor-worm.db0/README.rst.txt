...
.. conda:recipe:: bioconductor-worm.db0
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/worm.db0.html
...
.. conda:package:: bioconductor-worm.db0
   ...
   :required~by: |required_by_bioconductor-worm.db0|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-worm.db0


.. |required_by_bioconductor-worm.db0| conda:required_by:: bioconductor-worm.db0
