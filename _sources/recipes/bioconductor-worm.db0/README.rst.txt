...
.. conda:recipe:: bioconductor-worm.db0
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/worm.db0.html
...
.. conda:package:: bioconductor-worm.db0
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-worm.db0

   and update with::

      mamba update bioconductor-worm.db0

  To create a new environment, run::

      mamba create --name myenvname bioconductor-worm.db0
