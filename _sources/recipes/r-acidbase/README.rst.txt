...
.. conda:package:: r-acidbase
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.6.9-0</code>,  <code>0.6.8-1</code>,  <code>0.6.8-0</code>,  <code>0.5.0-1</code>,  <code>0.5.0-0</code>,  <code>0.4.5-0</code>,  <code>0.4.4-0</code>,  <code>0.4.3-0</code>,  <code>0.3.16-0</code>,  </span></summary>
      

      ``0.6.9-0``,  ``0.6.8-1``,  ``0.6.8-0``,  ``0.5.0-1``,  ``0.5.0-0``,  ``0.4.5-0``,  ``0.4.4-0``,  ``0.4.3-0``,  ``0.3.16-0``,  ``0.3.15-0``,  ``0.3.14-0``,  ``0.3.13-3``,  ``0.3.13-2``,  ``0.3.13-1``,  ``0.3.13-0``,  ``0.2.6-1``,  ``0.2.6-0``,  ``0.2.5-0``,  ``0.2.4-0``,  ``0.2.3-0``,  ``0.1.14-0``,  ``0.1.13-0``,  ``0.1.12-0``,  ``0.1.11-0``,  ``0.1.10-0``,  ``0.1.9-1``,  ``0.1.9-0``,  ``0.1.8-1``,  ``0.1.8-0``,  ``0.1.7-0``,  ``0.1.6-0``,  ``0.1.5-0``,  ``0.1.4-0``,  ``0.1.3-0``,  ``0.1.2-0``,  ``0.1.1-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.6.9","0.6.8","0.6.8","0.5.0","0.5.0"];
    </script>
