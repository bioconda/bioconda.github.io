...
.. conda:recipe:: bioconductor-degnorm
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/DegNorm.html
   :license: LGPL (>= 3)
...
.. conda:package:: bioconductor-degnorm
   ...
   :versions:
      ...
      ``1.10.1-0``,  ``1.8.0-1``,  ``1.8.0-0``,  ``1.4.0-2``,  ``1.4.0-1``,  ``1.4.0-0``,  ``1.2.0-0``,  ``1.0.0-2``,  ``1.0.0-1``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.10.1","1.8.0","1.8.0","1.4.0","1.4.0"];
    </script>
