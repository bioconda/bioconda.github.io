...
.. conda:recipe:: bioconductor-nempi
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/nempi.html
   :license: GPL-3
...
.. conda:package:: bioconductor-nempi
   ...
   :depends bioconductor-epinem: ``>=1.34.0,<1.35.0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-nempi

   and update with::

      mamba update bioconductor-nempi
