...
.. conda:package:: perl-symbol-util
   ...
   :required~by: |required_by_perl-symbol-util|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/perl-symbol-util


.. |required_by_perl-symbol-util| conda:required_by:: perl-symbol-util
