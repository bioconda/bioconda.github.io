...
.. conda:recipe:: bioconductor-homo.sapiens
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/Homo.sapiens.html
...
.. conda:package:: bioconductor-homo.sapiens
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.3.1-18</code>,  <code>1.3.1-17</code>,  <code>1.3.1-16</code>,  <code>1.3.1-15</code>,  <code>1.3.1-14</code>,  <code>1.3.1-13</code>,  <code>1.3.1-12</code>,  <code>1.3.1-11</code>,  <code>1.3.1-10</code>,  </span></summary>
      

      ``1.3.1-18``,  ``1.3.1-17``,  ``1.3.1-16``,  ``1.3.1-15``,  ``1.3.1-14``,  ``1.3.1-13``,  ``1.3.1-12``,  ``1.3.1-11``,  ``1.3.1-10``,  ``1.3.1-9``,  ``1.3.1-8``,  ``1.3.1-7``,  ``1.3.1-6``,  ``1.3.1-4``,  ``1.3.1-3``,  ``1.3.1-1``,  ``1.3.1-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-homo.sapiens

to add into an existing workspace instead, run::

    pixi add bioconductor-homo.sapiens
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-homo.sapiens
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-homo.sapiens"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-homo.sapiens"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-homo.sapiens"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-homo.sapiens
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-homo.sapiens/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-homo.sapiens', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-homo.sapiens
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-homo.sapiens/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-homo.sapiens', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-homo.sapiens
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-homo.sapiens/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-homo.sapiens', spec);
            } catch (err) {
