...
.. conda:recipe:: bioconductor-bsgenome.ptroglodytes.ucsc.pantro5
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/BSgenome.Ptroglodytes.UCSC.panTro5.html
...
.. conda:package:: bioconductor-bsgenome.ptroglodytes.ucsc.pantro5
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.4.2-15</code>,  <code>1.4.2-14</code>,  <code>1.4.2-13</code>,  <code>1.4.2-12</code>,  <code>1.4.2-11</code>,  <code>1.4.2-10</code>,  <code>1.4.2-9</code>,  <code>1.4.2-8</code>,  <code>1.4.2-7</code>,  </span></summary>
      

      ``1.4.2-15``,  ``1.4.2-14``,  ``1.4.2-13``,  ``1.4.2-12``,  ``1.4.2-11``,  ``1.4.2-10``,  ``1.4.2-9``,  ``1.4.2-8``,  ``1.4.2-7``,  ``1.4.2-6``,  ``1.4.2-5``,  ``1.4.2-4``,  ``1.4.2-3``,  ``1.4.2-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-bsgenome.ptroglodytes.ucsc.pantro5

to add into an existing workspace instead, run::

    pixi add bioconductor-bsgenome.ptroglodytes.ucsc.pantro5
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-bsgenome.ptroglodytes.ucsc.pantro5

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-bsgenome.ptroglodytes.ucsc.pantro5
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-bsgenome.ptroglodytes.ucsc.pantro5"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-bsgenome.ptroglodytes.ucsc.pantro5"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-bsgenome.ptroglodytes.ucsc.pantro5"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-bsgenome.ptroglodytes.ucsc.pantro5
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.ptroglodytes.ucsc.pantro5/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-bsgenome.ptroglodytes.ucsc.pantro5', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-bsgenome.ptroglodytes.ucsc.pantro5
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.ptroglodytes.ucsc.pantro5/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-bsgenome.ptroglodytes.ucsc.pantro5', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-bsgenome.ptroglodytes.ucsc.pantro5
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.ptroglodytes.ucsc.pantro5/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-bsgenome.ptroglodytes.ucsc.pantro5', spec);
            } catch (err) {
