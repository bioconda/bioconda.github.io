...
.. conda:recipe:: bioconductor-rhesusprobe
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/rhesusprobe.html
   :license: LGPL
...
to install globally, run::
    ...
    pixi global install bioconductor-rhesusprobe

to add into an existing workspace instead, run::

    pixi add bioconductor-rhesusprobe
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-rhesusprobe
...
.. raw:: html
   ...
   <script>
      var package = "bioconductor-rhesusprobe";
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-rhesusprobe"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-rhesusprobe"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-rhesusprobe"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-rhesusprobe
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rhesusprobe/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-rhesusprobe', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-rhesusprobe
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rhesusprobe/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-rhesusprobe', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-rhesusprobe
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rhesusprobe/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-rhesusprobe', spec);
            } catch (err) {
