...
.. conda:recipe:: bioconductor-rhesusprobe
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/rhesusprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-rhesusprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rhesusprobe

   and update with::

      mamba update bioconductor-rhesusprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rhesusprobe
