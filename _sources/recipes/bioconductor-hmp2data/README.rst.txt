...
.. conda:recipe:: bioconductor-hmp2data
   ...
   :homepage: https://bioconductor.org/packages/3.13/data/experiment/html/HMP2Data.html
...
.. conda:package:: bioconductor-hmp2data
   ...
   :versions:
      ...
      ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-1``,  ``1.4.0-0``,  ``1.1.0-0``,  ``1.0.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.8.0","1.6.0","1.4.0","1.4.0","1.1.0"];
    </script>
