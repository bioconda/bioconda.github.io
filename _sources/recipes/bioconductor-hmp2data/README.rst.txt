...
.. conda:recipe:: bioconductor-hmp2data
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/HMP2Data.html
...
.. conda:package:: bioconductor-hmp2data
   ...
   :depends on bioconductor-phyloseq: ``>=1.50.0,<1.51.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-hmp2data

to add into an existing workspace instead, run::

    pixi add bioconductor-hmp2data
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-hmp2data
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-hmp2data"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-hmp2data"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-hmp2data"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-hmp2data
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hmp2data/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-hmp2data', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-hmp2data
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hmp2data/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-hmp2data', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-hmp2data
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hmp2data/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-hmp2data', spec);
            } catch (err) {
