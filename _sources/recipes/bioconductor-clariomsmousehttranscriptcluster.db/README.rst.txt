...
.. conda:recipe:: bioconductor-clariomsmousehttranscriptcluster.db
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/clariomsmousehttranscriptcluster.db.html
...
.. conda:package:: bioconductor-clariomsmousehttranscriptcluster.db
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-clariomsmousehttranscriptcluster.db:<tag>
