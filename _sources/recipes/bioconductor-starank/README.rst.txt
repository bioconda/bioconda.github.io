...
.. conda:recipe:: bioconductor-starank
   ...
   :homepage: https://bioconductor.org/packages/3.8/bioc/html/staRank.html
   :license: GPL
...
.. conda:package:: bioconductor-starank
   ...
   :depends: :conda:package:`bioconductor-cellhts2` >=2.46.0,<2.47.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-starank|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-starank


.. |required_by_bioconductor-starank| conda:required_by:: bioconductor-starank
