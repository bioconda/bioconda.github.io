...
.. conda:package:: r-acidgenerics
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.6.10-0</code>,  <code>0.6.9-0</code>,  <code>0.6.8-0</code>,  <code>0.6.7-2</code>,  <code>0.6.7-1</code>,  <code>0.6.7-0</code>,  <code>0.6.6-1</code>,  <code>0.6.6-0</code>,  <code>0.6.5-0</code>,  </span></summary>
      

      ``0.6.10-0``,  ``0.6.9-0``,  ``0.6.8-0``,  ``0.6.7-2``,  ``0.6.7-1``,  ``0.6.7-0``,  ``0.6.6-1``,  ``0.6.6-0``,  ``0.6.5-0``,  ``0.6.4-1``,  ``0.6.4-0``,  ``0.6.0-1``,  ``0.6.0-0``,  ``0.5.20-0``,  ``0.5.19-0``,  ``0.5.18-0``,  ``0.5.17-2``,  ``0.5.17-1``,  ``0.5.17-0``,  ``0.5.16-0``,  ``0.4.1-0``,  ``0.4.0-0``,  ``0.3.14-0``,  ``0.3.12-0``,  ``0.3.11-0``,  ``0.3.10-0``,  ``0.3.9-0``,  ``0.3.8-0``,  ``0.3.7-0``,  ``0.3.6-0``,  ``0.3.5-0``,  ``0.3.4-1``,  ``0.3.4-0``,  ``0.3.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.6.10","0.6.9","0.6.8","0.6.7","0.6.7"];
    </script>
