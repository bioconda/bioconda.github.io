...
.. conda:package:: r-acidgenerics
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.7.11-0</code>,  <code>0.7.10-0</code>,  <code>0.7.9-0</code>,  <code>0.7.8-1</code>,  <code>0.7.8-0</code>,  <code>0.7.7-0</code>,  <code>0.7.6-0</code>,  <code>0.7.5-0</code>,  <code>0.7.4-0</code>,  </span></summary>
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["0.7.11","0.7.10","0.7.9","0.7.8","0.7.8"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_r-acidgenerics"></div>
   <div style="width: 100%" id="platform_plot_r-acidgenerics"></div>
   <div style="width: 100%" id="cdf_plot_r-acidgenerics"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for r-acidgenerics
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-acidgenerics/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_r-acidgenerics', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for r-acidgenerics
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-acidgenerics/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_r-acidgenerics', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for r-acidgenerics
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-acidgenerics/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_r-acidgenerics', spec);
            } catch (err) {
