...
.. conda:recipe:: bioconductor-mgu74a.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/mgu74a.db.html
...
.. conda:package:: bioconductor-mgu74a.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mgu74a.db

   and update with::

      mamba update bioconductor-mgu74a.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mgu74a.db
