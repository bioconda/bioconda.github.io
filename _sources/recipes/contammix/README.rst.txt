...
.. conda:package:: contammix
   ...
   :versions:
      ...
      ``1.0.11-5``,  ``1.0.11-4``,  ``1.0.11-3``,  ``1.0.11-2``,  ``1.0.11-1``,  ``1.0.11-0``,  ``1.0.10-1``,  ``1.0.10-0``
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname contammix
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.0.11","1.0.11","1.0.11","1.0.11","1.0.11"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_contammix"></div>
   <div style="width: 100%" id="platform_plot_contammix"></div>
   <div style="width: 100%" id="cdf_plot_contammix"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/contammix/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_contammix', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for contammix
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/contammix/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_contammix', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for contammix
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/contammix/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_contammix', spec);
            } catch (err) {
