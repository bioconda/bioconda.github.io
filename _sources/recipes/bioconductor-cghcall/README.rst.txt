...
.. conda:recipe:: bioconductor-cghcall
   ...
   :homepage: https://bioconductor.org/packages/3.8/bioc/html/CGHcall.html
...
.. conda:package:: bioconductor-cghcall
   ...
   :versions: 2.44.0, 2.42.0, 2.40.0, 2.38.0, 2.34.1, 2.34.0

   :depends: :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`bioconductor-cghbase` >=1.42.0,<1.43.0 :conda:package:`bioconductor-dnacopy` >=1.56.0,<1.57.0 :conda:package:`bioconductor-impute` >=1.56.0,<1.57.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-snowfall`  

   :required~by: |required_by_bioconductor-cghcall|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-cghcall


.. |required_by_bioconductor-cghcall| conda:required_by:: bioconductor-cghcall
