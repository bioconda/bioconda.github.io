...
.. conda:package:: bioconductor-qubic
   ...
   :depends: :conda:package:`libcxx` >=4.0.1 :conda:package:`llvm-openmp`  :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-biclust`  :conda:package:`r-matrix`  :conda:package:`r-rcpp` >=0.11.0 :conda:package:`r-rcpparmadillo`  
