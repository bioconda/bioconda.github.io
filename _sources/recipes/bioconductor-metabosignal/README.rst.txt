...
.. conda:recipe:: bioconductor-metabosignal
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/MetaboSignal.html
   :license: GPL-3
...
.. conda:package:: bioconductor-metabosignal
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.40.0-0</code>,  <code>1.32.0-0</code>,  <code>1.30.1-0</code>,  <code>1.28.0-0</code>,  <code>1.24.0-0</code>,  <code>1.22.0-0</code>,  <code>1.20.0-1</code>,  <code>1.20.0-0</code>,  <code>1.18.0-0</code>,  </span></summary>
      

      ``1.40.0-0``,  ``1.32.0-0``,  ``1.30.1-0``,  ``1.28.0-0``,  ``1.24.0-0``,  ``1.22.0-0``,  ``1.20.0-1``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-1``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-0``
   ...
   :depends on bioconductor-hpar: ``>=1.52.0,<1.53.0``
   :depends on bioconductor-kegggraph: ``>=1.70.0,<1.71.0``
   :depends on bioconductor-keggrest: ``>=1.50.0,<1.51.0``
   :depends on bioconductor-mwastools: ``>=1.34.0,<1.35.0``
   :depends on bioconductor-mygene: ``>=1.46.0,<1.47.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-metabosignal

to add into an existing workspace instead, run::

    pixi add bioconductor-metabosignal
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-metabosignal
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.40.0","1.32.0","1.30.1","1.28.0","1.24.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-metabosignal"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-metabosignal"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-metabosignal"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-metabosignal
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-metabosignal/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-metabosignal', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-metabosignal
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-metabosignal/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-metabosignal', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-metabosignal
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-metabosignal/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-metabosignal', spec);
            } catch (err) {
