...
.. conda:recipe:: bioconductor-metabosignal
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/MetaboSignal.html
   :license: GPL-3
...
.. conda:package:: bioconductor-metabosignal
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.28.0-0</code>,  <code>1.24.0-0</code>,  <code>1.22.0-0</code>,  <code>1.20.0-1</code>,  <code>1.20.0-0</code>,  <code>1.18.0-0</code>,  <code>1.16.0-0</code>,  <code>1.14.0-1</code>,  <code>1.12.0-0</code>,  </span></summary>
      

      ``1.28.0-0``,  ``1.24.0-0``,  ``1.22.0-0``,  ``1.20.0-1``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-1``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-0``
   ...
   :depends bioconductor-hpar: ``>=1.40.0,<1.41.0``
   :depends bioconductor-kegggraph: ``>=1.58.0,<1.59.0``
   :depends bioconductor-keggrest: ``>=1.38.0,<1.39.0``
   :depends bioconductor-mwastools: ``>=1.22.0,<1.23.0``
   :depends bioconductor-mygene: ``>=1.34.0,<1.35.0``
