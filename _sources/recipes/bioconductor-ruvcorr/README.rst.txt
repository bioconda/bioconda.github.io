...
.. conda:recipe:: bioconductor-ruvcorr
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/RUVcorr.html
   :license: GPL-2
...
.. conda:package:: bioconductor-ruvcorr
   ...
   :versions:
      ...
      ``1.22.0-1``,  ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.0-1``,  ``1.16.0-1``,  ``1.14.0-0``

      

   
   :depends bioconductor-biocparallel: ``>=1.24.0,<1.25.0``
   :depends bioconductor-bladderbatch: ``>=1.28.0,<1.29.0``
