...
.. conda:recipe:: bioconductor-deconvr
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/deconvR.html
...
.. conda:package:: bioconductor-deconvr
   ...
   :depends on r-e1071: ``>=1.7.9``
   :depends on r-foreach: ``>=1.5.1``
   :depends on r-magrittr: ``>=2.0.1``
   :depends on r-mass: 
   :depends on r-matrixstats: ``>=0.61.0``
   :depends on r-nnls: ``>=1.4``
   :depends on r-quadprog: ``>=1.5.8``
   :depends on r-rsq: ``>=2.2``
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-deconvr"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-deconvr"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-deconvr"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-deconvr
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-deconvr/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-deconvr', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-deconvr
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-deconvr/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-deconvr', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-deconvr
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-deconvr/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-deconvr', spec);
            } catch (err) {
