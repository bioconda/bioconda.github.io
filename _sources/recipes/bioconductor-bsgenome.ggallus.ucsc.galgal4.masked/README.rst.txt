...
.. conda:package:: bioconductor-bsgenome.ggallus.ucsc.galgal4.masked
   ...
   :depends bioconductor-bsgenome.ggallus.ucsc.galgal4: ``>=1.4.0,<1.5.0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bsgenome.ggallus.ucsc.galgal4.masked

   and update with::

      mamba update bioconductor-bsgenome.ggallus.ucsc.galgal4.masked

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bsgenome.ggallus.ucsc.galgal4.masked
