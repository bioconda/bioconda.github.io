...
.. conda:recipe:: bioconductor-bsgenome.ggallus.ucsc.galgal4.masked
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/BSgenome.Ggallus.UCSC.galGal4.masked.html
...
.. conda:package:: bioconductor-bsgenome.ggallus.ucsc.galgal4.masked
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.3.99-15</code>,  <code>1.3.99-14</code>,  <code>1.3.99-13</code>,  <code>1.3.99-12</code>,  <code>1.3.99-11</code>,  <code>1.3.99-10</code>,  <code>1.3.99-9</code>,  <code>1.3.99-8</code>,  <code>1.3.99-7</code>,  </span></summary>
      

      ``1.3.99-15``,  ``1.3.99-14``,  ``1.3.99-13``,  ``1.3.99-12``,  ``1.3.99-11``,  ``1.3.99-10``,  ``1.3.99-9``,  ``1.3.99-8``,  ``1.3.99-7``,  ``1.3.99-6``,  ``1.3.99-5``,  ``1.3.99-4``,  ``1.3.99-3``,  ``1.3.99-0``
   ...
   :depends on bioconductor-bsgenome.ggallus.ucsc.galgal4: ``>=1.4.0,<1.5.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-bsgenome.ggallus.ucsc.galgal4.masked

to add into an existing workspace instead, run::

    pixi add bioconductor-bsgenome.ggallus.ucsc.galgal4.masked
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-bsgenome.ggallus.ucsc.galgal4.masked
...
For e.g. docker, run::
    ...
    docker pull quay.io/biocontainers/bioconductor-bsgenome.ggallus.ucsc.galgal4.masked:<tag>

(see `bioconductor-bsgenome.ggallus.ucsc.galgal4.masked/tags`_ for valid values for ``<tag>``).
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-bsgenome.ggallus.ucsc.galgal4.masked"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-bsgenome.ggallus.ucsc.galgal4.masked"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-bsgenome.ggallus.ucsc.galgal4.masked"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-bsgenome.ggallus.ucsc.galgal4.masked
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.ggallus.ucsc.galgal4.masked/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-bsgenome.ggallus.ucsc.galgal4.masked', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-bsgenome.ggallus.ucsc.galgal4.masked
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.ggallus.ucsc.galgal4.masked/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-bsgenome.ggallus.ucsc.galgal4.masked', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-bsgenome.ggallus.ucsc.galgal4.masked
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.ggallus.ucsc.galgal4.masked/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-bsgenome.ggallus.ucsc.galgal4.masked', spec);
            } catch (err) {
