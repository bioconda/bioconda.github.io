...
.. conda:package:: sorted_nearest
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.0.32-1</code>,  <code>0.0.32-0</code>,  <code>0.0.31-3</code>,  <code>0.0.31-2</code>,  <code>0.0.31-1</code>,  <code>0.0.31-0</code>,  <code>0.0.30-0</code>,  <code>0.0.29-0</code>,  <code>0.0.28-0</code>,  </span></summary>
      

      ``0.0.32-1``,  ``0.0.32-0``,  ``0.0.31-3``,  ``0.0.31-2``,  ``0.0.31-1``,  ``0.0.31-0``,  ``0.0.30-0``,  ``0.0.29-0``,  ``0.0.28-0``,  ``0.0.24-0``,  ``0.0.23-1``,  ``0.0.22-1``,  ``0.0.20-1``,  ``0.0.19-1``,  ``0.0.18-1``,  ``0.0.17-1``,  ``0.0.17-0``
