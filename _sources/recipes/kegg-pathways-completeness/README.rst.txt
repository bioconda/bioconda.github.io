...
.. conda:recipe:: kegg-pathways-completeness
   ...
   :documentation: https://github.com/EBI-Metagenomics/kegg-pathways-completeness-tool/blob/1.4.4/README.md
...
.. conda:package:: kegg-pathways-completeness
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.4.4-0</code>,  <code>1.4.3-0</code>,  <code>1.4.2-0</code>,  <code>1.4.0-0</code>,  <code>1.3.0-0</code>,  <code>1.2.1-0</code>,  <code>1.0.5-0</code>,  <code>1.0.4-0</code>,  <code>1.0.3-0</code>,  </span></summary>
      

      ``1.4.4-0``,  ``1.4.3-0``,  ``1.4.2-0``,  ``1.4.0-0``,  ``1.3.0-0``,  ``1.2.1-0``,  ``1.0.5-0``,  ``1.0.4-0``,  ``1.0.3-0``,  ``1.0.2-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.4.4","1.4.3","1.4.2","1.4.0","1.3.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_kegg-pathways-completeness"></div>
   <div style="width: 100%" id="platform_plot_kegg-pathways-completeness"></div>
   <div style="width: 100%" id="cdf_plot_kegg-pathways-completeness"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for kegg-pathways-completeness
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/kegg-pathways-completeness/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_kegg-pathways-completeness', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for kegg-pathways-completeness
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/kegg-pathways-completeness/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_kegg-pathways-completeness', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for kegg-pathways-completeness
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/kegg-pathways-completeness/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_kegg-pathways-completeness', spec);
            } catch (err) {
