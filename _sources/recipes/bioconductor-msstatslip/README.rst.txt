...
.. conda:recipe:: bioconductor-msstatslip
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/MSstatsLiP.html
...
.. conda:package:: bioconductor-msstatslip
   ...
   :versions:
      ...
      ``1.16.0-0``,  ``1.8.1-0``,  ``1.6.0-0``,  ``1.3.1-1``,  ``1.3.1-0``,  ``1.0.0-2``,  ``1.0.0-1``,  ``1.0.0-0``
   ...
   :depends on bioconductor-msstatsptm: ``>=2.12.0,<2.13.0a0``
...
to install globally, run::
    ...
    pixi global install bioconductor-msstatslip

to add into an existing workspace instead, run::

    pixi add bioconductor-msstatslip
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-msstatslip

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-msstatslip
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.16.0","1.8.1","1.6.0","1.3.1","1.3.1"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-msstatslip"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-msstatslip"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-msstatslip"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-msstatslip
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-msstatslip/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-msstatslip', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-msstatslip
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-msstatslip/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-msstatslip', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-msstatslip
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-msstatslip/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-msstatslip', spec);
            } catch (err) {
