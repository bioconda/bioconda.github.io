...
.. conda:package:: bioconductor-biomart
   ...
   :versions: 2.38.0, 2.36.1, 2.34.2, 2.34.0, 2.32.1, 2.30.0, 2.28.0, 2.27.0, 2.26.1, 2.26.0

   :depends: :conda:package:`bioconductor-annotationdbi` >=1.44.0,<1.45.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-httr`  :conda:package:`r-progress`  :conda:package:`r-rcurl`  :conda:package:`r-stringr`  :conda:package:`r-xml`  

   :required~by: |required_by_bioconductor-biomart|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-biomart


.. |required_by_bioconductor-biomart| conda:required_by:: bioconductor-biomart
