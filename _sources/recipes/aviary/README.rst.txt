...
.. conda:package:: aviary
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.8.2-0</code>,  <code>0.8.1-0</code>,  <code>0.7.2-0</code>,  <code>0.7.0-0</code>,  <code>0.6.0-0</code>,  <code>0.5.7-0</code>,  <code>0.5.4-0</code>,  <code>0.5.0-0</code>,  <code>0.4.3-0</code>,  </span></summary>
      

      ``0.8.2-0``,  ``0.8.1-0``,  ``0.7.2-0``,  ``0.7.0-0``,  ``0.6.0-0``,  ``0.5.7-0``,  ``0.5.4-0``,  ``0.5.0-0``,  ``0.4.3-0``,  ``0.4.1-0``
...
.. raw:: html
    ...
    <script>
        var package = "aviary";
        var versions = ["0.8.2","0.8.1","0.7.2","0.7.0","0.6.0"];
    </script>
