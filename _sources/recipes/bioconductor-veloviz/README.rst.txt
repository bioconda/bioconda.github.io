...
.. conda:recipe:: bioconductor-veloviz
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/veloviz.html
   :license: GPL-3
...
.. conda:package:: bioconductor-veloviz
   ...
   :versions:
      ...
      ``1.6.0-0``,  ``1.4.0-2``,  ``1.4.0-1``,  ``1.4.0-0``,  ``1.0.0-2``,  ``1.0.0-1``,  ``1.0.0-0``
   ...
   and update with::
      ...
      conda update bioconductor-veloviz
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.6.0","1.4.0","1.4.0","1.4.0","1.0.0"];
    </script>
