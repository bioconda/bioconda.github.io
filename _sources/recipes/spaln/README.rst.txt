...
.. conda:recipe:: spaln
   ...
   :documentation: https://github.com/ogotoh/spaln/blob/ver.3.0.9/README.md
...
.. conda:package:: spaln
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.0.9-0</code>,  <code>3.0.8-1</code>,  <code>3.0.8-0</code>,  <code>3.0.7-1</code>,  <code>3.0.7-0</code>,  <code>3.0.6-0</code>,  <code>3.0.6c-0</code>,  <code>3.0.6b-1</code>,  <code>3.0.6b-0</code>,  </span></summary>
      

      ``3.0.9-0``,  ``3.0.8-1``,  ``3.0.8-0``,  ``3.0.7-1``,  ``3.0.7-0``,  ``3.0.6-0``,  ``3.0.6c-0``,  ``3.0.6b-1``,  ``3.0.6b-0``,  ``3.0.4-0``,  ``3.0.1-0``,  ``3.0.0-0``,  ``2.4.13-2``,  ``2.4.13-1``,  ``2.4.13-0``,  ``2.4.13g-0``,  ``2.4.13f-0``,  ``2.4.9-0``,  ``2.4.8-0``,  ``2.4.7-2``,  ``2.4.7-1``,  ``2.4.7-0``,  ``2.4.6-1``,  ``2.4.6-0``,  ``2.4.5-0``,  ``2.4.4-0``,  ``2.4.03-1``,  ``2.4.03-0``,  ``2.4.02-0``,  ``2.4.01-0``,  ``2.3.3-0``,  ``2.3.3c-0``,  ``2.3.3b-0``,  ``2.3.3a-0``,  ``2.3.2-0``
...
.. raw:: html
   ...
   <script>
      var package = "spaln";
      var versions = ["3.0.9","3.0.8","3.0.8","3.0.7","3.0.7"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_spaln"></div>
   <div style="width: 100%" id="platform_plot_spaln"></div>
   <div style="width: 100%" id="cdf_plot_spaln"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/spaln/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_spaln', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for spaln
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/spaln/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_spaln', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for spaln
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/spaln/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_spaln', spec);
            } catch (err) {
