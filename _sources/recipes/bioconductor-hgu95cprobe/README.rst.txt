...
.. conda:recipe:: bioconductor-hgu95cprobe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/hgu95cprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-hgu95cprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hgu95cprobe

   and update with::

      mamba update bioconductor-hgu95cprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hgu95cprobe
