...
.. conda:recipe:: bioconductor-hcg110probe
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/hcg110probe.html
   :license: LGPL
...
.. conda:package:: bioconductor-hcg110probe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hcg110probe

   and update with::

      mamba update bioconductor-hcg110probe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hcg110probe
