...
.. conda:recipe:: bioconductor-rguatlas4k.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/rguatlas4k.db.html
...
.. conda:package:: bioconductor-rguatlas4k.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rguatlas4k.db

   and update with::

      mamba update bioconductor-rguatlas4k.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rguatlas4k.db
