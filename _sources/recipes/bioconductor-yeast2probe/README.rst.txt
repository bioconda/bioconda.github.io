...
.. conda:recipe:: bioconductor-yeast2probe
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/yeast2probe.html
   :license: LGPL
...
.. conda:package:: bioconductor-yeast2probe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-yeast2probe

   and update with::

      mamba update bioconductor-yeast2probe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-yeast2probe
