...
.. conda:package:: mykrobe
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.12.2-1</code>,  <code>0.12.2-0</code>,  <code>0.12.1-2</code>,  <code>0.12.1-1</code>,  <code>0.12.1-0</code>,  <code>0.12.0-0</code>,  <code>0.11.0-1</code>,  <code>0.11.0-0</code>,  <code>0.10.0-1</code>,  </span></summary>
      

      ``0.12.2-1``,  ``0.12.2-0``,  ``0.12.1-2``,  ``0.12.1-1``,  ``0.12.1-0``,  ``0.12.0-0``,  ``0.11.0-1``,  ``0.11.0-0``,  ``0.10.0-1``,  ``0.10.0-0``,  ``0.9.0-3``,  ``0.9.0-2``,  ``0.9.0-1``,  ``0.9.0-0``,  ``0.8.2-1``,  ``0.8.2-0``,  ``0.8.1-0``,  ``0.8.0-1``,  ``0.8.0-0``,  ``0.7.0-5``,  ``0.7.0-4``,  ``0.7.0-3``,  ``0.7.0-2``,  ``0.7.0-0``,  ``0.6.1-3``,  ``0.6.1-2``,  ``0.6.1-1``,  ``0.6.1-0``,  ``0.5.6-1``,  ``0.5.6-0``
...
.. raw:: html
    ...
    <script>
        var package = "mykrobe";
        var versions = ["0.12.2","0.12.2","0.12.1","0.12.1","0.12.1"];
    </script>
