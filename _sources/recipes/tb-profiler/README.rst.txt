...
.. conda:package:: tb-profiler
   ...
   :depends jinja2: 
   :depends kmc: 
   :depends pathogen-profiler: ``2.0.2.*``
   :depends python: ``>=3.6``
   :depends quickle: 
   :depends weasyprint: 
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["4.4.0","4.3.0","4.2.0","4.1.1","4.1.1"];
    </script>
