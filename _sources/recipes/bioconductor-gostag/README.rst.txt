...
.. conda:recipe:: bioconductor-gostag
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/goSTAG.html
   :license: GPL-3
...
.. conda:package:: bioconductor-gostag
   ...
   :versions:
      ...
      ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.2-0``,  ``1.14.1-0``,  ``1.13.1-0``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-1``,  ``1.6.1-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.18.0","1.16.0","1.14.2","1.14.1","1.13.1"];
    </script>
