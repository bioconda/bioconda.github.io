...
.. conda:recipe:: bioconductor-htmg430a.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/htmg430a.db.html
...
.. conda:package:: bioconductor-htmg430a.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-htmg430a.db

   and update with::

      mamba update bioconductor-htmg430a.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-htmg430a.db
