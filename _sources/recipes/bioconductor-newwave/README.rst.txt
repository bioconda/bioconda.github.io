...
.. conda:recipe:: bioconductor-newwave
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/NewWave.html
   :license: GPL-3
...
.. conda:package:: bioconductor-newwave
   ...
   :versions:
      ...
      ``1.4.0-0``,  ``1.2.0-0``,  ``1.0.2-0``,  ``0.99.10-1``
   ...
   :depends bioconductor-sharedobject: ``>=1.8.0,<1.9.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.4.0","1.2.0","1.0.2","0.99.10"];
    </script>
