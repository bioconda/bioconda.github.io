...
.. conda:recipe:: bioconductor-coregx
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/CoreGx.html
   :license: GPL-3
...
.. conda:package:: bioconductor-coregx
   ...
   :versions:
      ...
      ``2.2.0-0``,  ``1.6.0-0``,  ``1.4.1-0``,  ``1.2.0-1``,  ``1.2.0-0``,  ``1.0.0-0``
   ...
   :depends bioconductor-bumpymatrix: ``>=1.6.0,<1.7.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.2.0","1.6.0","1.4.1","1.2.0","1.2.0"];
    </script>
