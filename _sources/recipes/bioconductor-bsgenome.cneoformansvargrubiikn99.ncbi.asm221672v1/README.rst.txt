...
.. conda:recipe:: bioconductor-bsgenome.cneoformansvargrubiikn99.ncbi.asm221672v1
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/BSgenome.CneoformansVarGrubiiKN99.NCBI.ASM221672v1.html
...
.. conda:package:: bioconductor-bsgenome.cneoformansvargrubiikn99.ncbi.asm221672v1
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bsgenome.cneoformansvargrubiikn99.ncbi.asm221672v1

   and update with::

      mamba update bioconductor-bsgenome.cneoformansvargrubiikn99.ncbi.asm221672v1

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bsgenome.cneoformansvargrubiikn99.ncbi.asm221672v1
