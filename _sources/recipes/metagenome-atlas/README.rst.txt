...
.. conda:package:: metagenome-atlas
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.14.3-0</code>,  <code>2.14.2-0</code>,  <code>2.14.0-0</code>,  <code>2.13.1-0</code>,  <code>2.13.0-0</code>,  <code>2.12.0-1</code>,  <code>2.12.0-0</code>,  <code>2.11.1-0</code>,  <code>2.11.0-1</code>,  </span></summary>
      

      ``2.14.3-0``,  ``2.14.2-0``,  ``2.14.0-0``,  ``2.13.1-0``,  ``2.13.0-0``,  ``2.12.0-1``,  ``2.12.0-0``,  ``2.11.1-0``,  ``2.11.0-1``,  ``2.11.0-0``,  ``2.10.0-0``,  ``2.9.1-0``,  ``2.9.0-0``,  ``2.8.2-0``,  ``2.8.1-0``,  ``2.8.0-0``,  ``2.7.0-0``,  ``2.6a4-0``,  ``2.6a2-0``,  ``2.6a1-0``,  ``2.5.0-0``,  ``2.4.5-0``,  ``2.4.4-0``,  ``2.4.3-0``,  ``2.4.2-0``,  ``2.4.1-0``,  ``2.4-0``,  ``2.3.5-0``,  ``2.3.4-0``,  ``2.3.3-0``,  ``2.3.2-0``,  ``2.3.beta2-0``,  ``2.2.0-0``,  ``2.1.4-1``,  ``2.1.4-0``,  ``2.1.3-0``,  ``2.1.1-0``,  ``2.0.6-1``,  ``2.0.5-1``,  ``2.0.4-1``,  ``2.0.3-1``,  ``2.0.1-1``,  ``2.0.1-0``
   ...
   :depends snakemake-minimal: ``>=7.18.1,<7.19``
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.14.3","2.14.2","2.14.0","2.13.1","2.13.0"];
    </script>
