...
.. conda:recipe:: bioconductor-cghmcr
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/cghMCR.html
   :license: LGPL
...
.. conda:package:: bioconductor-cghmcr
   ...
   :versions:
      ...
      ``1.48.0-1``,  ``1.48.0-0``,  ``1.46.0-0``,  ``1.44.0-0``,  ``1.42.0-1``,  ``1.40.0-0``,  ``1.38.0-0``,  ``1.36.0-0``,  ``1.34.0-0``

      

   
   :depends bioconductor-biocgenerics: ``>=0.36.0,<0.37.0``
   :depends bioconductor-cntools: ``>=1.46.0,<1.47.0``
