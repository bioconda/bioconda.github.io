...
.. conda:recipe:: bioconductor-bsgenome.ptroglodytes.ucsc.pantro3
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/BSgenome.Ptroglodytes.UCSC.panTro3.html
...
.. conda:package:: bioconductor-bsgenome.ptroglodytes.ucsc.pantro3
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bsgenome.ptroglodytes.ucsc.pantro3

   and update with::

      mamba update bioconductor-bsgenome.ptroglodytes.ucsc.pantro3

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bsgenome.ptroglodytes.ucsc.pantro3
