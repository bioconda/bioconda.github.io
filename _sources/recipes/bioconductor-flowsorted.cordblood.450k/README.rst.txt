...
.. conda:recipe:: bioconductor-flowsorted.cordblood.450k
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/FlowSorted.CordBlood.450k.html
...
.. conda:package:: bioconductor-flowsorted.cordblood.450k
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-flowsorted.cordblood.450k

   and update with::

      mamba update bioconductor-flowsorted.cordblood.450k

  To create a new environment, run::

      mamba create --name myenvname bioconductor-flowsorted.cordblood.450k
