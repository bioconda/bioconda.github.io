...
.. conda:recipe:: bioconductor-pd.2006.07.18.hg18.refseq.promoter
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/pd.2006.07.18.hg18.refseq.promoter.html
...
.. conda:package:: bioconductor-pd.2006.07.18.hg18.refseq.promoter
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.8.1-14</code>,  <code>1.8.1-13</code>,  <code>1.8.1-12</code>,  <code>1.8.1-11</code>,  <code>1.8.1-10</code>,  <code>1.8.1-9</code>,  <code>1.8.1-8</code>,  <code>1.8.1-7</code>,  <code>1.8.1-6</code>,  </span></summary>
      

      ``1.8.1-14``,  ``1.8.1-13``,  ``1.8.1-12``,  ``1.8.1-11``,  ``1.8.1-10``,  ``1.8.1-9``,  ``1.8.1-8``,  ``1.8.1-7``,  ``1.8.1-6``,  ``1.8.1-5``,  ``1.8.1-4``,  ``1.8.1-3``,  ``1.8.1-2``,  ``1.8.1-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-pd.2006.07.18.hg18.refseq.promoter

to add into an existing workspace instead, run::

    pixi add bioconductor-pd.2006.07.18.hg18.refseq.promoter
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-pd.2006.07.18.hg18.refseq.promoter

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-pd.2006.07.18.hg18.refseq.promoter
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-pd.2006.07.18.hg18.refseq.promoter"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-pd.2006.07.18.hg18.refseq.promoter"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-pd.2006.07.18.hg18.refseq.promoter"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-pd.2006.07.18.hg18.refseq.promoter
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pd.2006.07.18.hg18.refseq.promoter/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-pd.2006.07.18.hg18.refseq.promoter', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-pd.2006.07.18.hg18.refseq.promoter
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pd.2006.07.18.hg18.refseq.promoter/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-pd.2006.07.18.hg18.refseq.promoter', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-pd.2006.07.18.hg18.refseq.promoter
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pd.2006.07.18.hg18.refseq.promoter/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-pd.2006.07.18.hg18.refseq.promoter', spec);
            } catch (err) {
