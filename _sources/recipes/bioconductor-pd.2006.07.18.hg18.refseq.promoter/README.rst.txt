...
.. conda:recipe:: bioconductor-pd.2006.07.18.hg18.refseq.promoter
   ...
   :homepage: https://bioconductor.org/packages/3.14/data/annotation/html/pd.2006.07.18.hg18.refseq.promoter.html
...
.. conda:package:: bioconductor-pd.2006.07.18.hg18.refseq.promoter
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.8.1-10</code>,  <code>1.8.1-9</code>,  <code>1.8.1-8</code>,  <code>1.8.1-7</code>,  <code>1.8.1-6</code>,  <code>1.8.1-5</code>,  <code>1.8.1-4</code>,  <code>1.8.1-3</code>,  <code>1.8.1-2</code>,  </span></summary>
      

      ``1.8.1-10``,  ``1.8.1-9``,  ``1.8.1-8``,  ``1.8.1-7``,  ``1.8.1-6``,  ``1.8.1-5``,  ``1.8.1-4``,  ``1.8.1-3``,  ``1.8.1-2``,  ``1.8.1-0``
