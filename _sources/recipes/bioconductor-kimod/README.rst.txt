...
============= ===========
Home          https://bioconductor.org/packages/3.8/bioc/html/kimod.html
Versions      1.8.0, 1.6.0
License       GPL (>=2)
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes//home/circleci/project/docs/bioconda-recipes/recipes/bioconductor-kimod/meta.yaml
