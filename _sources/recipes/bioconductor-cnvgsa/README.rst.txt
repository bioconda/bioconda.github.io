...
.. conda:recipe:: bioconductor-cnvgsa
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/cnvGSA.html
   :license: LGPL
...
.. conda:package:: bioconductor-cnvgsa
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-cnvgsa

   and update with::

      mamba update bioconductor-cnvgsa

  To create a new environment, run::

      mamba create --name myenvname bioconductor-cnvgsa
