...
.. conda:recipe:: bioconductor-pocrcannotation.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/POCRCannotation.db.html
...
.. conda:package:: bioconductor-pocrcannotation.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pocrcannotation.db

   and update with::

      mamba update bioconductor-pocrcannotation.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pocrcannotation.db
