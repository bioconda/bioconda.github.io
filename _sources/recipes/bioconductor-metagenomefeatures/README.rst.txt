...
.. conda:recipe:: bioconductor-metagenomefeatures
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/metagenomeFeatures.html
...
.. conda:package:: bioconductor-metagenomefeatures
   ...
   :versions:
      ...
      ``2.10.0-1``,  ``2.10.0-0``,  ``2.8.0-0``,  ``2.6.0-0``,  ``2.4.0-1``,  ``2.2.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-metagenomefeatures";
        var versions = ["2.10.0","2.10.0","2.8.0","2.6.0","2.4.0"];
    </script>
