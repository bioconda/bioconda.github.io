...
.. conda:recipe:: bioconductor-tabulamurisdata
   ...
   :homepage: https://bioconductor.org/packages/3.14/data/experiment/html/TabulaMurisData.html
...
.. conda:package:: bioconductor-tabulamurisdata
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.16.0-0</code>,  <code>1.12.0-1</code>,  <code>1.12.0-0</code>,  <code>1.10.0-0</code>,  <code>1.8.0-1</code>,  <code>1.8.0-0</code>,  <code>1.6.0-0</code>,  <code>1.3.0-0</code>,  <code>1.2.0-1</code>,  </span></summary>
      

      ``1.16.0-0``,  ``1.12.0-1``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-1``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.3.0-0``,  ``1.2.0-1``,  ``1.0.0-0``
