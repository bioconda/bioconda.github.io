...
.. conda:recipe:: bioconductor-oncoscore
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/OncoScore.html
...
.. conda:package:: bioconductor-oncoscore
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-oncoscore

   and update with::

      mamba update bioconductor-oncoscore

  To create a new environment, run::

      mamba create --name myenvname bioconductor-oncoscore
