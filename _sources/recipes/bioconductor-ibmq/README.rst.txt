...
.. conda:package:: bioconductor-ibmq
   ...
   :depends: :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`gsl` >=2.4,<2.5.0a0 :conda:package:`llvm-openmp`  :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-ggplot2` >=0.9.2 
