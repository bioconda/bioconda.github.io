...
.. conda:package:: r-cellassign
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.99.2-7</code>,  <code>0.99.2-6</code>,  <code>0.99.2-5</code>,  <code>0.99.2-4</code>,  <code>0.99.2-3</code>,  <code>0.99.2-2</code>,  <code>0.99.2-1</code>,  <code>0.99.2-0</code>,  <code>0.99.1-0</code>,  </span></summary>
      

      ``0.99.2-7``,  ``0.99.2-6``,  ``0.99.2-5``,  ``0.99.2-4``,  ``0.99.2-3``,  ``0.99.2-2``,  ``0.99.2-1``,  ``0.99.2-0``,  ``0.99.1-0``,  ``0.99.0-1``,  ``0.99.0-0``
...
to install globally, run::
    ...
    pixi global install r-cellassign

to add into an existing workspace instead, run::

    pixi add r-cellassign
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname r-cellassign
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_r-cellassign"></div>
   <div style="width: 100%" id="platform_plot_r-cellassign"></div>
   <div style="width: 100%" id="cdf_plot_r-cellassign"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for r-cellassign
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-cellassign/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_r-cellassign', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for r-cellassign
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-cellassign/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_r-cellassign', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for r-cellassign
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-cellassign/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_r-cellassign', spec);
            } catch (err) {
