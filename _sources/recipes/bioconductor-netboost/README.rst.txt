...
.. conda:recipe:: bioconductor-netboost
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/netboost.html
   :license: GPL-3
...
.. conda:package:: bioconductor-netboost
   ...
   :versions:
      ...
      ``2.0.0-0``,  ``1.6.0-2``,  ``1.6.0-1``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.0-0``,  ``1.0.0-1``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.0.0","1.6.0","1.6.0","1.6.0","1.4.0"];
    </script>
