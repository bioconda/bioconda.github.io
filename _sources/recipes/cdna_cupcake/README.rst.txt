...
.. conda:package:: cdna_cupcake
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>18.1.0-0</code>,  <code>18.0.0-0</code>,  <code>17.0.0-0</code>,  <code>16.0.0-0</code>,  <code>15.1.0-0</code>,  <code>14.2.0-0</code>,  <code>14.0.0-0</code>,  <code>13.0.0-0</code>,  <code>12.5-0</code>,  </span></summary>
      

      ``18.1.0-0``,  ``18.0.0-0``,  ``17.0.0-0``,  ``16.0.0-0``,  ``15.1.0-0``,  ``14.2.0-0``,  ``14.0.0-0``,  ``13.0.0-0``,  ``12.5-0``,  ``12.4.0-1``,  ``12.4.0-0``,  ``12.3.0-0``,  ``12.1.0-1``,  ``12.1.0-0``,  ``12.0.0-0``,  ``11.0.0-0``,  ``10.0.1-0``,  ``9.1.1-0``,  ``9.0.3-0``,  ``8.7.3-0``,  ``5.8-0``,  ``5.3-1``,  ``5.3-0``
