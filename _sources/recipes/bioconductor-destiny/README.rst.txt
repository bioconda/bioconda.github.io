...
.. conda:recipe:: bioconductor-destiny
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/destiny.html
   :license: GPL-3
...
.. conda:package:: bioconductor-destiny
   ...
   :depends on r-ggplot.multistats: 
   :depends on r-ggplot2: 
   :depends on r-ggthemes: 
   :depends on r-irlba: 
   :depends on r-knn.covertree: 
   :depends on r-matrix: 
   :depends on r-proxy: 
   ...
   :depends on r-rlang: 
   :depends on r-rspectra: ``>=0.14-0``
   :depends on r-scales: 
   :depends on r-scatterplot3d: 
   :depends on r-smoother: 
   :depends on r-tidyr: 
...
to install globally, run::
    ...
    pixi global install bioconductor-destiny

to add into an existing workspace instead, run::

    pixi add bioconductor-destiny
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-destiny
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-destiny"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-destiny"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-destiny"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-destiny
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-destiny/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-destiny', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-destiny
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-destiny/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-destiny', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-destiny
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-destiny/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-destiny', spec);
            } catch (err) {
