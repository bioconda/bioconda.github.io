...
.. conda:package:: igv
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.19.8-1</code>,  <code>2.19.8-0</code>,  <code>2.19.7-0</code>,  <code>2.19.6-0</code>,  <code>2.19.4-0</code>,  <code>2.19.3-0</code>,  <code>2.19.2-0</code>,  <code>2.19.1-1</code>,  <code>2.19.1-0</code>,  </span></summary>
      

      ``2.19.8-1``,  ``2.19.8-0``,  ``2.19.7-0``,  ``2.19.6-0``,  ``2.19.4-0``,  ``2.19.3-0``,  ``2.19.2-0``,  ``2.19.1-1``,  ``2.19.1-0``,  ``2.17.4-0``,  ``2.17.3-0``,  ``2.16.2-0``,  ``2.13.2-0``,  ``2.13.1-0``,  ``2.13.0-0``,  ``2.12.3-0``,  ``2.12.2-0``,  ``2.12.1-0``,  ``2.12.0-0``,  ``2.11.9-0``,  ``2.11.7-0``,  ``2.11.6-0``,  ``2.11.5-0``,  ``2.11.4-0``,  ``2.11.3-0``,  ``2.11.2-0``,  ``2.11.1-0``,  ``2.11.0-0``,  ``2.10.3-0``,  ``2.10.2-0``,  ``2.10.0-0``,  ``2.9.5-0``,  ``2.9.4-1``,  ``2.9.4-0``,  ``2.9.3-0``,  ``2.9.2-0``,  ``2.9.1-0``,  ``2.9.0-0``,  ``2.8.13-0``,  ``2.8.12-0``,  ``2.8.11-0``,  ``2.8.10-0``,  ``2.8.9-0``,  ``2.8.8-0``,  ``2.8.6-0``,  ``2.8.5-0``,  ``2.8.4-0``,  ``2.8.3-0``,  ``2.8.2-0``,  ``2.8.1-0``,  ``2.8.0-0``,  ``2.5.2-0``,  ``2.4.17-0``,  ``2.4.16-0``,  ``2.4.9-1``,  ``2.4.9-0``,  ``2.4.6-0``,  ``2.3.98-0``
...
.. raw:: html
   ...
   <script>
      var package = "igv";
      var versions = ["2.19.8","2.19.8","2.19.7","2.19.6","2.19.4"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_igv"></div>
   <div style="width: 100%" id="platform_plot_igv"></div>
   <div style="width: 100%" id="cdf_plot_igv"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/igv/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_igv', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for igv
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/igv/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_igv', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for igv
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/igv/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_igv', spec);
            } catch (err) {
