...
.. conda:recipe:: bioconductor-gskb
   ...
   :homepage: https://bioconductor.org/packages/3.12/data/experiment/html/gskb.html
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-gskb";
        var versions = ["1.22.0","1.22.0","1.21.0","1.20.0","1.18.0"];
    </script>
