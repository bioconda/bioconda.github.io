...
.. conda:package:: bioconductor-scran
   ...
   :versions: 1.10.1, 1.8.4, 1.6.2, 1.4.5

   :depends: :conda:package:`bioconductor-beachmat` >=1.4.0,<1.5.0 :conda:package:`bioconductor-biocgenerics` >=0.28.0,<0.29.0 :conda:package:`bioconductor-biocneighbors` >=1.0.0,<1.1.0 :conda:package:`bioconductor-biocparallel` >=1.16.0,<1.17.0 :conda:package:`bioconductor-delayedarray` >=0.8.0,<0.9.0 :conda:package:`bioconductor-delayedmatrixstats` >=1.4.0,<1.5.0 :conda:package:`bioconductor-edger` >=3.24.0,<3.25.0 :conda:package:`bioconductor-limma` >=3.38.0,<3.39.0 :conda:package:`bioconductor-rhdf5lib` >=1.4.0,<1.5.0 :conda:package:`bioconductor-s4vectors` >=0.20.0,<0.21.0 :conda:package:`bioconductor-scater` >=1.10.0,<1.11.0 :conda:package:`bioconductor-singlecellexperiment` >=1.4.0,<1.5.0 :conda:package:`bioconductor-summarizedexperiment` >=1.12.0,<1.13.0 :conda:package:`libgcc-ng` >=7.3.0 :conda:package:`libstdcxx-ng` >=7.3.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-dynamictreecut`  :conda:package:`r-igraph`  :conda:package:`r-matrix`  :conda:package:`r-rcpp` >=0.12.14 :conda:package:`r-statmod`  

   :required~by: |required_by_bioconductor-scran|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-scran


.. |required_by_bioconductor-scran| conda:required_by:: bioconductor-scran
