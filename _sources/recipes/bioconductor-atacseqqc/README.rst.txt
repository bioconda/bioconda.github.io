...
.. conda:recipe:: bioconductor-atacseqqc
   ...
   :homepage: https://bioconductor.org/packages/3.8/bioc/html/ATACseqQC.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-atacseqqc
   ...
   :versions: 1.6.4, 1.4.3, 1.2.0, 1.0.5

   :depends: :conda:package:`bioconductor-biocgenerics` >=0.28.0,<0.29.0 :conda:package:`bioconductor-biostrings` >=2.50.0,<2.51.0 :conda:package:`bioconductor-bsgenome` >=1.50.0,<1.51.0 :conda:package:`bioconductor-chippeakanno` >=3.16.0,<3.17.0 :conda:package:`bioconductor-genomeinfodb` >=1.18.0,<1.19.0 :conda:package:`bioconductor-genomicalignments` >=1.18.0,<1.19.0 :conda:package:`bioconductor-genomicranges` >=1.34.0,<1.35.0 :conda:package:`bioconductor-genomicscores` >=1.6.0,<1.7.0 :conda:package:`bioconductor-iranges` >=2.16.0,<2.17.0 :conda:package:`bioconductor-limma` >=3.38.0,<3.39.0 :conda:package:`bioconductor-motifstack` >=1.26.0,<1.27.0 :conda:package:`bioconductor-rsamtools` >=1.34.0,<1.35.0 :conda:package:`bioconductor-rtracklayer` >=1.42.0,<1.43.0 :conda:package:`bioconductor-s4vectors` >=0.20.0,<0.21.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-kernsmooth`  :conda:package:`r-preseqr`  :conda:package:`r-randomforest`  

   :required~by: |required_by_bioconductor-atacseqqc|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-atacseqqc


.. |required_by_bioconductor-atacseqqc| conda:required_by:: bioconductor-atacseqqc
