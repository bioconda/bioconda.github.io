...
============= ===========
Home          https://bioconductor.org/packages/3.8/bioc/html/ATACseqQC.html
Versions      1.4.3, 1.2.0, 1.0.5
License       GPL (>= 2)
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes//home/circleci/project/docs/bioconda-recipes/recipes/bioconductor-atacseqqc/meta.yaml
