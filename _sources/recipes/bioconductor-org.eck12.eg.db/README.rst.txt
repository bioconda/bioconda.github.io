...
.. conda:recipe:: bioconductor-org.eck12.eg.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/org.EcK12.eg.db.html
...
.. conda:package:: bioconductor-org.eck12.eg.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-org.eck12.eg.db

   and update with::

      mamba update bioconductor-org.eck12.eg.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-org.eck12.eg.db
