...
.. conda:recipe:: bioconductor-cottoncdf
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/cottoncdf.html
   :license: LGPL
...
to install globally, run::
    ...
    pixi global install bioconductor-cottoncdf

to add into an existing workspace instead, run::

    pixi add bioconductor-cottoncdf
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-cottoncdf
...
For e.g. docker, run::
    ...
    docker pull quay.io/biocontainers/bioconductor-cottoncdf:<tag>

(see `bioconductor-cottoncdf/tags`_ for valid values for ``<tag>``).
...
.. _`bioconductor-cottoncdf/tags`: https://quay.io/repository/biocontainers/bioconductor-cottoncdf?tab=tags


.. raw:: html

   <script>
      var package = "bioconductor-cottoncdf";
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-cottoncdf"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-cottoncdf"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-cottoncdf"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-cottoncdf
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-cottoncdf/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-cottoncdf', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-cottoncdf
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-cottoncdf/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-cottoncdf', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-cottoncdf
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-cottoncdf/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-cottoncdf', spec);
            } catch (err) {
