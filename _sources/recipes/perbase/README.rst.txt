...
.. conda:package:: perbase
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.8.5-1</code>,  <code>0.8.5-0</code>,  <code>0.8.3-1</code>,  <code>0.8.3-0</code>,  <code>0.8.1-1</code>,  <code>0.8.1-0</code>,  <code>0.8.0-0</code>,  <code>0.7.3-0</code>,  <code>0.7.2-0</code>,  </span></summary>
      

      ``0.8.5-1``,  ``0.8.5-0``,  ``0.8.3-1``,  ``0.8.3-0``,  ``0.8.1-1``,  ``0.8.1-0``,  ``0.8.0-0``,  ``0.7.3-0``,  ``0.7.2-0``,  ``0.6.3-1``,  ``0.6.3-0``,  ``0.4.2-0``,  ``0.4.0-0``,  ``0.3.8-0``,  ``0.3.7-0``,  ``0.3.6-0``,  ``0.3.5-0``,  ``0.2.3-0``,  ``0.2.1-0``,  ``0.1.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "perbase";
        var versions = ["0.8.5","0.8.5","0.8.3","0.8.3","0.8.1"];
    </script>
