...
.. conda:recipe:: bioconductor-ebarrays
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/EBarrays.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-ebarrays
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.74.0-0</code>,  <code>2.70.0-0</code>,  <code>2.66.0-1</code>,  <code>2.66.0-0</code>,  <code>2.64.0-0</code>,  <code>2.62.0-1</code>,  <code>2.62.0-0</code>,  <code>2.58.0-2</code>,  <code>2.58.0-1</code>,  </span></summary>
      

      ``2.74.0-0``,  ``2.70.0-0``,  ``2.66.0-1``,  ``2.66.0-0``,  ``2.64.0-0``,  ``2.62.0-1``,  ``2.62.0-0``,  ``2.58.0-2``,  ``2.58.0-1``,  ``2.58.0-0``,  ``2.56.0-0``,  ``2.54.0-1``,  ``2.54.0-0``,  ``2.52.0-0``,  ``2.50.0-0``,  ``2.48.0-1``,  ``2.46.0-0``,  ``2.44.0-0``,  ``2.42.0-0``,  ``2.40.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-ebarrays

to add into an existing workspace instead, run::

    pixi add bioconductor-ebarrays
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-ebarrays
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["2.74.0","2.70.0","2.66.0","2.66.0","2.64.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-ebarrays"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-ebarrays"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-ebarrays"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-ebarrays
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ebarrays/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-ebarrays', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-ebarrays
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ebarrays/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-ebarrays', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-ebarrays
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ebarrays/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-ebarrays', spec);
            } catch (err) {
