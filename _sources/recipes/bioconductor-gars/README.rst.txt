...
.. conda:recipe:: bioconductor-gars
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/GARS.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-gars
   ...
   :versions:
      ...
      ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.0-1``,  ``1.10.0-0``,  ``1.6.0-0``,  ``1.4.0-1``,  ``1.2.0-0``

      

   
   :depends bioconductor-damirseq: ``>=2.6.0,<2.7.0``
   :depends bioconductor-mlseq: ``>=2.12.0,<2.13.0``
