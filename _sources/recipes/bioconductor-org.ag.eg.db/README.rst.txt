...
.. conda:recipe:: bioconductor-org.ag.eg.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/org.Ag.eg.db.html
...
.. conda:package:: bioconductor-org.ag.eg.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-org.ag.eg.db

   and update with::

      mamba update bioconductor-org.ag.eg.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-org.ag.eg.db
