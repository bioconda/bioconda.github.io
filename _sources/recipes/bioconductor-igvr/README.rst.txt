...
.. conda:recipe:: bioconductor-igvr
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/igvR.html
...
.. conda:package:: bioconductor-igvr
   ...
   :versions:
      ...
      ``1.18.0-0``,  ``1.14.0-0``,  ``1.10.0-1``,  ``1.10.0-0``,  ``1.7.8-0``,  ``1.6.1-0``,  ``1.4.0-1``,  ``1.2.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.18.0","1.14.0","1.10.0","1.10.0","1.7.8"];
    </script>
