...
.. conda:package:: r-jackstraw
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.3.21-0</code>,  <code>1.3.17-0</code>,  <code>1.3.9-1</code>,  <code>1.3.9-0</code>,  <code>1.3.8-1</code>,  <code>1.3.8-0</code>,  <code>1.3.1-1</code>,  <code>1.3.1-0</code>,  <code>1.3-6</code>,  </span></summary>
      

      ``1.3.21-0``,  ``1.3.17-0``,  ``1.3.9-1``,  ``1.3.9-0``,  ``1.3.8-1``,  ``1.3.8-0``,  ``1.3.1-1``,  ``1.3.1-0``,  ``1.3-6``,  ``1.3-5``,  ``1.3-4``,  ``1.3-3``,  ``1.3-2``,  ``1.3-1``,  ``1.3-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.3.21","1.3.17","1.3.9","1.3.9","1.3.8"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_r-jackstraw"></div>
   <div style="width: 100%" id="platform_plot_r-jackstraw"></div>
   <div style="width: 100%" id="cdf_plot_r-jackstraw"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for r-jackstraw
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-jackstraw/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_r-jackstraw', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for r-jackstraw
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-jackstraw/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_r-jackstraw', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for r-jackstraw
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-jackstraw/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_r-jackstraw', spec);
            } catch (err) {
