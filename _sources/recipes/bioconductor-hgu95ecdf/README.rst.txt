...
.. conda:recipe:: bioconductor-hgu95ecdf
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/hgu95ecdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-hgu95ecdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hgu95ecdf

   and update with::

      mamba update bioconductor-hgu95ecdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hgu95ecdf
