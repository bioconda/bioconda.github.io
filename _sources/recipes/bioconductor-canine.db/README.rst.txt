...
.. conda:recipe:: bioconductor-canine.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/canine.db.html
...
.. conda:package:: bioconductor-canine.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-canine.db

   and update with::

      mamba update bioconductor-canine.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-canine.db
