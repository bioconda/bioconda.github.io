.. _`bioconductor-rdavidwebservice`:
...
============= ===========
Home          https://bioconductor.org/packages/3.8/bioc/html/RDAVIDWebService.html
Versions      
License       GPL (>=2)
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes//bioconductor-rdavidwebservice/meta.yaml
...
A Docker container is available at https://quay.io/repository/biocontainers/bioconductor-rdavidwebservice.
...
Render an |badge| badge with the following Markdown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square)](http://bioconda.github.io/recipes/bioconductor-rdavidwebservice/README.html)

.. |badge| image:: https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square
           :target: http://bioconda.github.io/recipes/bioconductor-rdavidwebservice/README.html
.. |downloads| image:: https://anaconda.org/bioconda/bioconductor-rdavidwebservice/badges/downloads.svg
               :target: https://anaconda.org/bioconda/bioconductor-rdavidwebservice
.. |docker| image:: https://quay.io/repository/biocontainers/bioconductor-rdavidwebservice/status
