...
.. conda:recipe:: bioconductor-rdavidwebservice
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/RDAVIDWebService.html
   :license: GPL (>=2)
...
.. conda:package:: bioconductor-rdavidwebservice
   ...
   :versions:
      ...
      ``1.28.0-1``,  ``1.28.0-0``,  ``1.24.0-0``,  ``1.22.0-1``,  ``1.20.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-rdavidwebservice";
        var versions = ["1.28.0","1.28.0","1.24.0","1.22.0","1.20.0"];
    </script>
