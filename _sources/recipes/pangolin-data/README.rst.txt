...
.. conda:package:: pangolin-data
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.16-0</code>,  <code>1.15.1-0</code>,  <code>1.14-0</code>,  <code>1.13-1</code>,  <code>1.13-0</code>,  <code>1.12-0</code>,  <code>1.11-0</code>,  <code>1.9-0</code>,  <code>1.8-0</code>,  </span></summary>
      

      ``1.16-0``,  ``1.15.1-0``,  ``1.14-0``,  ``1.13-1``,  ``1.13-0``,  ``1.12-0``,  ``1.11-0``,  ``1.9-0``,  ``1.8-0``,  ``1.6-0``,  ``1.3-0``,  ``1.2.133.2-0``,  ``1.2.133-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.16","1.15.1","1.14","1.13","1.13"];
    </script>
