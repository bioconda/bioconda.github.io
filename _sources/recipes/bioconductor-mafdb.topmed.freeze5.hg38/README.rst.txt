...
.. conda:recipe:: bioconductor-mafdb.topmed.freeze5.hg38
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/MafDb.TOPMed.freeze5.hg38.html
...
.. conda:package:: bioconductor-mafdb.topmed.freeze5.hg38
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mafdb.topmed.freeze5.hg38

   and update with::

      mamba update bioconductor-mafdb.topmed.freeze5.hg38

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mafdb.topmed.freeze5.hg38
