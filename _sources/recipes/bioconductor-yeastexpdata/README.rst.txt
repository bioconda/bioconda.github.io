...
.. conda:recipe:: bioconductor-yeastexpdata
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/yeastExpData.html
   :license: GPL
...
.. conda:package:: bioconductor-yeastexpdata
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.52.0-0</code>,  <code>0.48.0-0</code>,  <code>0.46.0-0</code>,  <code>0.44.0-0</code>,  <code>0.40.0-1</code>,  <code>0.40.0-0</code>,  <code>0.38.0-0</code>,  <code>0.36.0-1</code>,  <code>0.36.0-0</code>,  </span></summary>
      

      ``0.52.0-0``,  ``0.48.0-0``,  ``0.46.0-0``,  ``0.44.0-0``,  ``0.40.0-1``,  ``0.40.0-0``,  ``0.38.0-0``,  ``0.36.0-1``,  ``0.36.0-0``,  ``0.34.0-0``,  ``0.32.0-0``,  ``0.30.0-1``,  ``0.28.0-1``,  ``0.28.0-0``,  ``0.26.0-0``,  ``0.24.0-1``,  ``0.24.0-0``,  ``0.22.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.52.0","0.48.0","0.46.0","0.44.0","0.40.0"];
    </script>
