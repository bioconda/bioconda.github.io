...
.. conda:package:: perl-text-wrap
   ...
   :required~by: |required_by_perl-text-wrap|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/perl-text-wrap


.. |required_by_perl-text-wrap| conda:required_by:: perl-text-wrap
