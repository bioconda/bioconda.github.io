...
.. conda:recipe:: bioconductor-pd.medicago
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/pd.medicago.html
...
to install globally, run::
    ...
    pixi global install bioconductor-pd.medicago

to add into an existing workspace instead, run::

    pixi add bioconductor-pd.medicago
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-pd.medicago
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-pd.medicago"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-pd.medicago"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-pd.medicago"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-pd.medicago
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pd.medicago/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-pd.medicago', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-pd.medicago
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pd.medicago/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-pd.medicago', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-pd.medicago
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pd.medicago/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-pd.medicago', spec);
            } catch (err) {
