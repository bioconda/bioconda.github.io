...
.. conda:recipe:: bioconductor-pd.medicago
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/pd.medicago.html
...
.. conda:package:: bioconductor-pd.medicago
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.medicago

   and update with::

      mamba update bioconductor-pd.medicago

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.medicago
