...
.. conda:recipe:: bioconductor-microbiomeexplorer
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/microbiomeExplorer.html
...
.. conda:package:: bioconductor-microbiomeexplorer
   ...
   :versions:
      ...
      ``1.8.0-0``,  ``1.4.0-0``,  ``1.2.0-0``,  ``1.0.1-1``,  ``1.0.1-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.8.0","1.4.0","1.2.0","1.0.1","1.0.1"];
    </script>
