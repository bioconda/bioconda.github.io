...
.. conda:recipe:: oases
   ...
   :documentation: https://github.com/dzerbino/oases/blob/0.2.09/README.md
   ...
   :links: doi: :doi:`10.1093/bioinformatics/bts094`, biotools: :biotools:`oases`
...
.. conda:package:: oases
   ...
   :versions:
      ...
      ``0.2.09-4``,  ``0.2.09-3``,  ``0.2.09-2``,  ``0.2.09-1``,  ``0.2.09-0``
...
.. raw:: html
   ...
   <script>
      var package = "oases";
      var versions = ["0.2.09","0.2.09","0.2.09","0.2.09","0.2.09"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_oases"></div>
   <div style="width: 100%" id="platform_plot_oases"></div>
   <div style="width: 100%" id="cdf_plot_oases"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/oases/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_oases', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for oases
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/oases/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_oases', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for oases
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/oases/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_oases', spec);
            } catch (err) {
