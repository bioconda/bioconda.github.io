...
.. conda:recipe:: bioconductor-regionreport
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/regionReport.html
...
.. conda:package:: bioconductor-regionreport
   ...
   :depends bioconductor-deformats: ``>=1.38.0,<1.39.0``
   :depends bioconductor-derfinder: ``>=1.44.0,<1.45.0``
