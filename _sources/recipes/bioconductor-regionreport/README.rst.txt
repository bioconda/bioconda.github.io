...
.. conda:recipe:: bioconductor-regionreport
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/regionReport.html
...
.. conda:package:: bioconductor-regionreport
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.44.0-0</code>,  <code>1.40.0-0</code>,  <code>1.36.0-0</code>,  <code>1.34.0-0</code>,  <code>1.32.0-0</code>,  <code>1.27.1-0</code>,  <code>1.26.0-0</code>,  <code>1.24.2-0</code>,  <code>1.24.0-0</code>,  </span></summary>
      

      ``1.44.0-0``,  ``1.40.0-0``,  ``1.36.0-0``,  ``1.34.0-0``,  ``1.32.0-0``,  ``1.27.1-0``,  ``1.26.0-0``,  ``1.24.2-0``,  ``1.24.0-0``,  ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.2-0``,  ``1.16.1-0``
   ...
   :depends on bioconductor-deformats: ``>=1.38.0,<1.39.0``
   ...
   :depends on r-knitrbootstrap: ``>=0.9.0``
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-regionreport"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-regionreport"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-regionreport"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-regionreport
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-regionreport/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-regionreport', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-regionreport
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-regionreport/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-regionreport', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-regionreport
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-regionreport/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-regionreport', spec);
            } catch (err) {
