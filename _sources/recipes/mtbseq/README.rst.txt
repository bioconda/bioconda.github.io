...
.. conda:package:: mtbseq
   ...
   :versions:
      ...
      ``1.1.0-1``,  ``1.1.0-0``,  ``1.0.4-2``,  ``1.0.4-1``,  ``1.0.4-0``,  ``1.0.3-1``,  ``1.0.3-0``
   ...
   :depends on perl-mce: ``>=1.836``
   :depends on perl-number-format: 
   :depends on perl-statistics-basic: ``>=1.6611``
   :depends on picard: ``>=2.17.0,<3``
...
.. raw:: html
   ...
   <script>
      var package = "mtbseq";
      var versions = ["1.1.0","1.1.0","1.0.4","1.0.4","1.0.4"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_mtbseq"></div>
   <div style="width: 100%" id="platform_plot_mtbseq"></div>
   <div style="width: 100%" id="cdf_plot_mtbseq"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/mtbseq/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_mtbseq', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for mtbseq
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/mtbseq/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_mtbseq', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for mtbseq
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/mtbseq/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_mtbseq', spec);
            } catch (err) {
