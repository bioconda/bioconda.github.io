...
.. conda:package:: r-acidplots
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.3.5-1</code>,  <code>0.3.5-0</code>,  <code>0.3.0-0</code>,  <code>0.2.36-0</code>,  <code>0.2.35-0</code>,  <code>0.2.34-0</code>,  <code>0.2.32-0</code>,  <code>0.2.30-0</code>,  <code>0.2.29-0</code>,  </span></summary>
      

      ``0.3.5-1``,  ``0.3.5-0``,  ``0.3.0-0``,  ``0.2.36-0``,  ``0.2.35-0``,  ``0.2.34-0``,  ``0.2.32-0``,  ``0.2.30-0``,  ``0.2.29-0``,  ``0.2.28-0``,  ``0.2.27-0``,  ``0.2.26-1``,  ``0.2.26-0``,  ``0.2.24-0``,  ``0.2.23-0``,  ``0.2.22-0``,  ``0.2.20-0``,  ``0.2.19-0``,  ``0.2.18-0``,  ``0.2.17-0``,  ``0.2.16-0``,  ``0.2.15-0``,  ``0.2.14-0``
