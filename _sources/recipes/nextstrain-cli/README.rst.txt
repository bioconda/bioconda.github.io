...
.. conda:package:: nextstrain-cli
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>8.0.1-0</code>,  <code>8.0.0-0</code>,  <code>7.4.0-1</code>,  <code>7.4.0-0</code>,  <code>7.3.0.post1-0</code>,  <code>7.2.0-0</code>,  <code>7.1.0-0</code>,  <code>7.0.1-0</code>,  <code>7.0.0-0</code>,  </span></summary>
      

      ``8.0.1-0``,  ``8.0.0-0``,  ``7.4.0-1``,  ``7.4.0-0``,  ``7.3.0.post1-0``,  ``7.2.0-0``,  ``7.1.0-0``,  ``7.0.1-0``,  ``7.0.0-0``,  ``6.2.1-0``,  ``6.2.0-1``,  ``6.2.0-0``,  ``6.1.0.post1-0``,  ``6.0.3-0``,  ``6.0.2-0``,  ``6.0.0-0``,  ``5.0.1-0``,  ``5.0.0-0``,  ``4.2.0-1``,  ``4.2.0-0``,  ``4.1.1-1``,  ``4.1.1-0``,  ``4.1.0-0``,  ``4.0.0-0``,  ``3.2.5-0``,  ``3.2.4-0``,  ``3.2.3-0``,  ``3.2.2-0``,  ``3.2.1-0``,  ``3.2.0-0``,  ``3.1.1-0``,  ``3.0.6-0``,  ``3.0.5-0``,  ``3.0.3-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["8.0.1","8.0.0","7.4.0","7.4.0","7.3.0.post1"];
    </script>
