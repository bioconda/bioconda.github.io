...
.. conda:package:: crunchstat-summary
   ...
   :versions:
      ...
      ``3.2.1-0``,  ``3.2.0-0``,  ``3.1.2-0``

      

   
   :depends on arvados-python-client: ``3.2.1``
...
to install globally, run::
    ...
    pixi global install crunchstat-summary

to add into an existing workspace instead, run::

    pixi add crunchstat-summary
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install crunchstat-summary

Alternatively, to install into a new environment, run::

    conda create -n envname crunchstat-summary
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["3.2.1","3.2.0","3.1.2"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_crunchstat-summary"></div>
   <div style="width: 100%" id="platform_plot_crunchstat-summary"></div>
   <div style="width: 100%" id="cdf_plot_crunchstat-summary"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for crunchstat-summary
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/crunchstat-summary/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_crunchstat-summary', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for crunchstat-summary
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/crunchstat-summary/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_crunchstat-summary', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for crunchstat-summary
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/crunchstat-summary/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_crunchstat-summary', spec);
            } catch (err) {
