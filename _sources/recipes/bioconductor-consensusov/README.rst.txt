...
.. conda:recipe:: bioconductor-consensusov
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/consensusOV.html
...
.. conda:package:: bioconductor-consensusov
   ...
   :versions:
      ...
      ``1.12.0-1``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.0-1``,  ``1.4.1-0``,  ``1.2.0-0``,  ``1.0.0-0``

      

   
   :depends bioconductor-biobase: ``>=2.50.0,<2.51.0``
   :depends bioconductor-genefu: ``>=2.22.0,<2.23.0``
