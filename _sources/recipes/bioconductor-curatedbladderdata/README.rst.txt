...
.. conda:recipe:: bioconductor-curatedbladderdata
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/experiment/html/curatedBladderData.html
...
.. conda:package:: bioconductor-curatedbladderdata
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-curatedbladderdata

   and update with::

      mamba update bioconductor-curatedbladderdata

  To create a new environment, run::

      mamba create --name myenvname bioconductor-curatedbladderdata
