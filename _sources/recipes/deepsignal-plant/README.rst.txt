...
.. conda:package:: deepsignal-plant
   ...
   :depends on pytorch: ``>=1.2.0,<=1.11.0``
...
to install globally, run::
    ...
    pixi global install deepsignal-plant

to add into an existing workspace instead, run::

    pixi add deepsignal-plant
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install deepsignal-plant

Alternatively, to install into a new environment, run::

    conda create -n envname deepsignal-plant
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_deepsignal-plant"></div>
   <div style="width: 100%" id="platform_plot_deepsignal-plant"></div>
   <div style="width: 100%" id="cdf_plot_deepsignal-plant"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for deepsignal-plant
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/deepsignal-plant/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_deepsignal-plant', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for deepsignal-plant
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/deepsignal-plant/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_deepsignal-plant', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for deepsignal-plant
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/deepsignal-plant/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_deepsignal-plant', spec);
            } catch (err) {
