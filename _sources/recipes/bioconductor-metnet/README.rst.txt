...
.. conda:recipe:: bioconductor-metnet
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/MetNet.html
   :license: GPL (>= 3)
...
.. conda:package:: bioconductor-metnet
   ...
   :versions:
      ...
      ``1.18.0-0``,  ``1.16.0-0``,  ``1.12.0-0``,  ``1.8.0-1``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.0-1``,  ``1.0.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.18.0","1.16.0","1.12.0","1.8.0","1.8.0"];
    </script>
