...
.. conda:package:: sourmash
   ...
   :depends python: 
   :depends sourmash-minimal: ``4.8.6.*``
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["4.8.6","4.8.5","4.8.4","4.8.3","4.8.2"];
    </script>
