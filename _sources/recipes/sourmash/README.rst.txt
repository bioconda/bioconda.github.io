...
.. conda:package:: sourmash
   ...
   :depends python: 
   :depends sourmash-minimal: ``4.9.0.*``
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["4.9.0","4.8.14","4.8.12","4.8.11","4.8.10"];
    </script>
