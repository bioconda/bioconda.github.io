...
.. conda:package:: sourmash
   ...
   :depends python: 
   :depends sourmash-minimal: ``4.8.9.*``
   :requirements:
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["4.8.9","4.8.8","4.8.7","4.8.6","4.8.5"];
    </script>
