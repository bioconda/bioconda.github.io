...
.. conda:recipe:: bioconductor-scannotatr.models
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/scAnnotatR.models.html
...
.. conda:package:: bioconductor-scannotatr.models
   ...
   :versions:
      ...
      ``0.99.10-6``,  ``0.99.10-5``,  ``0.99.10-4``,  ``0.99.10-3``,  ``0.99.10-2``,  ``0.99.10-1``,  ``0.99.10-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-scannotatr.models

to add into an existing workspace instead, run::

    pixi add bioconductor-scannotatr.models
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-scannotatr.models
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-scannotatr.models"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-scannotatr.models"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-scannotatr.models"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-scannotatr.models
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-scannotatr.models/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-scannotatr.models', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-scannotatr.models
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-scannotatr.models/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-scannotatr.models', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-scannotatr.models
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-scannotatr.models/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-scannotatr.models', spec);
            } catch (err) {
