...
.. conda:package:: bioconductor-plrs
   ...
   :depends: :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`bioconductor-biocgenerics` >=0.28.0,<0.29.0 :conda:package:`bioconductor-cghbase` >=1.42.0,<1.43.0 :conda:package:`bioconductor-marray` >=1.60.0,<1.61.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-ic.infer`  :conda:package:`r-quadprog`  :conda:package:`r-rcsdp`  

   :required~by: |required_by_bioconductor-plrs|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-plrs


.. |required_by_bioconductor-plrs| conda:required_by:: bioconductor-plrs
