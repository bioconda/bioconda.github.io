...
.. conda:recipe:: bioconductor-gseabenchmarker
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/GSEABenchmarkeR.html
...
.. conda:package:: bioconductor-gseabenchmarker
   ...
   :versions:
      ...
      ``1.30.0-0``,  ``1.26.0-0``,  ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.1-0``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.0-1``,  ``1.4.0-1``,  ``1.2.0-0``
   ...
   :depends on bioconductor-keggandmetacoredzpathwaysgeo: ``>=1.30.0,<1.31.0``
   :depends on bioconductor-keggdzpathwaysgeo: ``>=1.48.0,<1.49.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-gseabenchmarker

to add into an existing workspace instead, run::

    pixi add bioconductor-gseabenchmarker
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-gseabenchmarker
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-gseabenchmarker"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-gseabenchmarker"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-gseabenchmarker"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-gseabenchmarker
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-gseabenchmarker/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-gseabenchmarker', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-gseabenchmarker
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-gseabenchmarker/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-gseabenchmarker', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-gseabenchmarker
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-gseabenchmarker/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-gseabenchmarker', spec);
            } catch (err) {
