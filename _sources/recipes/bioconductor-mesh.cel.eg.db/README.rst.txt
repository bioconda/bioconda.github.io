...
.. conda:package:: bioconductor-mesh.cel.eg.db
   ...
   :required~by: |required_by_bioconductor-mesh.cel.eg.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-mesh.cel.eg.db


.. |required_by_bioconductor-mesh.cel.eg.db| conda:required_by:: bioconductor-mesh.cel.eg.db
