...
.. conda:recipe:: bioconductor-rhtslib
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/Rhtslib.html
   :license: LGPL (>= 2)
...
.. conda:package:: bioconductor-rhtslib
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.22.0-1</code>,  <code>1.22.0-0</code>,  <code>1.20.0-0</code>,  <code>1.18.0-1</code>,  <code>1.16.1-1</code>,  <code>1.16.1-0</code>,  <code>1.14.1-0</code>,  <code>1.14.0-0</code>,  <code>1.12.1-0</code>,  </span></summary>
      

      ``1.22.0-1``,  ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.0-1``,  ``1.16.1-1``,  ``1.16.1-0``,  ``1.14.1-0``,  ``1.14.0-0``,  ``1.12.1-0``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.0-1``,  ``1.6.0-0``
