...
.. conda:package:: mlst
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.33.0-0</code>,  <code>2.32.2-0</code>,  <code>2.28.1-0</code>,  <code>2.25.0-0</code>,  <code>2.23.0-1</code>,  <code>2.23.0-0</code>,  <code>2.22.1-0</code>,  <code>2.22.0-0</code>,  <code>2.19.0-1</code>,  </span></summary>
      

      ``2.33.0-0``,  ``2.32.2-0``,  ``2.28.1-0``,  ``2.25.0-0``,  ``2.23.0-1``,  ``2.23.0-0``,  ``2.22.1-0``,  ``2.22.0-0``,  ``2.19.0-1``,  ``2.19.0-0``,  ``2.18.1-0``,  ``2.18.0-0``,  ``2.17.6-1``,  ``2.17.6-0``,  ``2.16.4-0``,  ``2.16.2-1``,  ``2.16.2-0``,  ``2.16.1-0``,  ``2.16-0``,  ``2.15.2-0``,  ``2.15.1-0``,  ``2.15-0``,  ``2.14-0``,  ``2.13-0``,  ``2.12-0``,  ``2.11-0``,  ``2.10-1``,  ``2.10-0``,  ``2.9-6``,  ``2.9-5``,  ``2.9-4``,  ``2.9-3``,  ``2.9-2``,  ``2.9-1``,  ``2.9-0``,  ``2.6-0``
...
.. raw:: html
    ...
    <script>
        var package = "mlst";
        var versions = ["2.33.0","2.32.2","2.28.1","2.25.0","2.23.0"];
    </script>
