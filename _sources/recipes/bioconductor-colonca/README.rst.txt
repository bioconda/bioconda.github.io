...
.. conda:recipe:: bioconductor-colonca
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/colonCA.html
   :license: LGPL
...
.. conda:package:: bioconductor-colonca
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-colonca

   and update with::

      mamba update bioconductor-colonca

  To create a new environment, run::

      mamba create --name myenvname bioconductor-colonca
