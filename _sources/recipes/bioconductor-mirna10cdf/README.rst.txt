...
.. conda:recipe:: bioconductor-mirna10cdf
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/mirna10cdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-mirna10cdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mirna10cdf

   and update with::

      mamba update bioconductor-mirna10cdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mirna10cdf
