...
.. conda:recipe:: msaprobs
   ...
   :links: biotools: :biotools:`msaprobs`, doi: :doi:`10.1093/bioinformatics/btq338`
...
.. conda:package:: msaprobs
   ...
   :versions:
      ...
      ``0.9.7-5``,  ``0.9.7-4``,  ``0.9.7-3``,  ``0.9.7-2``,  ``0.9.7-1``,  ``0.9.7-0``
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname msaprobs
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_msaprobs"></div>
   <div style="width: 100%" id="platform_plot_msaprobs"></div>
   <div style="width: 100%" id="cdf_plot_msaprobs"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/msaprobs/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_msaprobs', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for msaprobs
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/msaprobs/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_msaprobs', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for msaprobs
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/msaprobs/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_msaprobs', spec);
            } catch (err) {
