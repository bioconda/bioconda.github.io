...
.. conda:package:: bioconductor-clusterseq
   ...
   :depends: :conda:package:`bioconductor-bayseq` >=2.16.0,<2.17.0 :conda:package:`bioconductor-biocgenerics` >=0.28.0,<0.29.0 :conda:package:`bioconductor-biocparallel` >=1.16.0,<1.17.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-clusterseq|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-clusterseq


.. |required_by_bioconductor-clusterseq| conda:required_by:: bioconductor-clusterseq
