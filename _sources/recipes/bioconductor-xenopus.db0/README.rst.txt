...
.. conda:recipe:: bioconductor-xenopus.db0
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/xenopus.db0.html
...
.. conda:package:: bioconductor-xenopus.db0
   ...
   :required~by: |required_by_bioconductor-xenopus.db0|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-xenopus.db0


.. |required_by_bioconductor-xenopus.db0| conda:required_by:: bioconductor-xenopus.db0
