...
.. conda:recipe:: bioconductor-mu11ksubacdf
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/mu11ksubacdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-mu11ksubacdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mu11ksubacdf

   and update with::

      mamba update bioconductor-mu11ksubacdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mu11ksubacdf
