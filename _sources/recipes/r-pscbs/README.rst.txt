...
.. conda:package:: r-pscbs
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.66.0-0</code>,  <code>0.65.0-5</code>,  <code>0.65.0-4</code>,  <code>0.65.0-3</code>,  <code>0.65.0-2</code>,  <code>0.65.0-1</code>,  <code>0.65.0-0</code>,  <code>0.64.0-2</code>,  <code>0.64.0-1</code>,  </span></summary>
      

      ``0.66.0-0``,  ``0.65.0-5``,  ``0.65.0-4``,  ``0.65.0-3``,  ``0.65.0-2``,  ``0.65.0-1``,  ``0.65.0-0``,  ``0.64.0-2``,  ``0.64.0-1``,  ``0.64.0-0``,  ``0.63.0-0``,  ``0.61.0-0``,  ``0.60.3-0``,  ``0.60.0-2``,  ``0.60.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "r-pscbs";
        var versions = ["0.66.0","0.65.0","0.65.0","0.65.0","0.65.0"];
    </script>
