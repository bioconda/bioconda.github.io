...
.. conda:package:: mafft
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>7.505-0</code>,  <code>7.490-1</code>,  <code>7.490-0</code>,  <code>7.489-0</code>,  <code>7.487-0</code>,  <code>7.486-0</code>,  <code>7.480-0</code>,  <code>7.475-1</code>,  <code>7.475-0</code>,  </span></summary>
      

      ``7.505-0``,  ``7.490-1``,  ``7.490-0``,  ``7.489-0``,  ``7.487-0``,  ``7.486-0``,  ``7.480-0``,  ``7.475-1``,  ``7.475-0``,  ``7.471-0``,  ``7.470-0``,  ``7.467-0``,  ``7.464-0``,  ``7.463-0``,  ``7.458-0``,  ``7.455-0``,  ``7.453-1``,  ``7.453-0``,  ``7.407-2``,  ``7.407-1``,  ``7.407-0``,  ``7.402-0``,  ``7.313-1``,  ``7.313-0``,  ``7.310-5``,  ``7.310-4``,  ``7.310-3``,  ``7.310-2``,  ``7.310-1``,  ``7.310-0``,  ``7.305-1``,  ``7.305-0``,  ``7.221-0``
...
.. raw:: html
    ...
    <script>
        var package = "mafft";
        var versions = ["7.505","7.490","7.490","7.489","7.487"];
    </script>
