...
.. conda:package:: chromhmm
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.28-0</code>,  <code>1.27-0</code>,  <code>1.26-0</code>,  <code>1.25-0</code>,  <code>1.24-0</code>,  <code>1.23-0</code>,  <code>1.21-1</code>,  <code>1.21-0</code>,  <code>1.20-1</code>,  </span></summary>
      

      ``1.28-0``,  ``1.27-0``,  ``1.26-0``,  ``1.25-0``,  ``1.24-0``,  ``1.23-0``,  ``1.21-1``,  ``1.21-0``,  ``1.20-1``,  ``1.20-0``,  ``1.19-0``,  ``1.15-0``,  ``1.14-0``,  ``1.12-0``,  ``1.11-0``
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname chromhmm
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.28","1.27","1.26","1.25","1.24"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_chromhmm"></div>
   <div style="width: 100%" id="platform_plot_chromhmm"></div>
   <div style="width: 100%" id="cdf_plot_chromhmm"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/chromhmm/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_chromhmm', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for chromhmm
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/chromhmm/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_chromhmm', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for chromhmm
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/chromhmm/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_chromhmm', spec);
            } catch (err) {
