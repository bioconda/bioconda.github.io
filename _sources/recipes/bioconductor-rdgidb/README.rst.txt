...
.. conda:recipe:: bioconductor-rdgidb
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/rDGIdb.html
...
to install globally, run::
    ...
    pixi global install bioconductor-rdgidb

to add into an existing workspace instead, run::

    pixi add bioconductor-rdgidb
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-rdgidb
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-rdgidb"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-rdgidb"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-rdgidb"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-rdgidb
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rdgidb/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-rdgidb', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-rdgidb
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rdgidb/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-rdgidb', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-rdgidb
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rdgidb/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-rdgidb', spec);
            } catch (err) {
