...
.. conda:recipe:: bioconductor-pvac
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/pvac.html
   :license: LGPL (>= 2.0)
...
.. conda:package:: bioconductor-pvac
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pvac

   and update with::

      mamba update bioconductor-pvac

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pvac
