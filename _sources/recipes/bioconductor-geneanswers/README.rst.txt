...
.. conda:recipe:: bioconductor-geneanswers
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/GeneAnswers.html
   :license: LGPL (>= 2)
...
.. conda:package:: bioconductor-geneanswers
   ...
   :versions:
      ...
      ``2.36.0-0``,  ``2.32.0-1``,  ``2.32.0-0``,  ``2.30.0-0``,  ``2.28.0-0``,  ``2.26.0-1``,  ``2.24.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-geneanswers";
