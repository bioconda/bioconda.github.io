...
.. conda:recipe:: bioconductor-rcade
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/Rcade.html
   :license: GPL-2
...
.. conda:package:: bioconductor-rcade
   ...
   :versions:
      ...
      ``1.36.0-0``,  ``1.34.0-0``,  ``1.32.0-1``,  ``1.32.0-0``,  ``1.29.0-0``,  ``1.28.0-0``,  ``1.26.0-1``,  ``1.24.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-rcade";
        var versions = ["1.36.0","1.34.0","1.32.0","1.32.0","1.29.0"];
    </script>
