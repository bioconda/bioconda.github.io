...
.. conda:package:: bioconductor-rcade
   ...
   :depends: :conda:package:`bioconductor-bayseq` >=2.16.0,<2.17.0 :conda:package:`bioconductor-genomeinfodb` >=1.18.0,<1.19.0 :conda:package:`bioconductor-genomicalignments` >=1.18.0,<1.19.0 :conda:package:`bioconductor-genomicranges` >=1.34.0,<1.35.0 :conda:package:`bioconductor-iranges` >=2.16.0,<2.17.0 :conda:package:`bioconductor-rsamtools` >=1.34.0,<1.35.0 :conda:package:`bioconductor-s4vectors` >=0.20.0,<0.21.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-plotrix`  :conda:package:`r-rgl`  

   :required~by: |required_by_bioconductor-rcade|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-rcade


.. |required_by_bioconductor-rcade| conda:required_by:: bioconductor-rcade
