...
.. conda:recipe:: bioconductor-metaboliteidmapping
   ...
   :homepage: https://bioconductor.org/packages/3.14/data/annotation/html/metaboliteIDmapping.html
   :license: GPL-3
...
.. conda:package:: bioconductor-metaboliteidmapping
   ...
   :versions:
      ...
      ``1.0.0-2``,  ``1.0.0-1``,  ``1.0.0-0``,  ``0.99.8-1``,  ``0.99.8-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.0.0","1.0.0","1.0.0","0.99.8","0.99.8"];
    </script>
