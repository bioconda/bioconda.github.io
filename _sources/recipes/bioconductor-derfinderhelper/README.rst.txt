...
.. conda:recipe:: bioconductor-derfinderhelper
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/derfinderHelper.html
...
.. conda:package:: bioconductor-derfinderhelper
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.44.0-0</code>,  <code>1.40.0-0</code>,  <code>1.36.0-0</code>,  <code>1.34.0-0</code>,  <code>1.32.0-0</code>,  <code>1.28.0-0</code>,  <code>1.26.0-0</code>,  <code>1.24.1-0</code>,  <code>1.24.0-0</code>,  </span></summary>
      

      ``1.44.0-0``,  ``1.40.0-0``,  ``1.36.0-0``,  ``1.34.0-0``,  ``1.32.0-0``,  ``1.28.0-0``,  ``1.26.0-0``,  ``1.24.1-0``,  ``1.24.0-0``,  ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.1-0``,  ``1.16.1-0``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-derfinderhelper

to add into an existing workspace instead, run::

    pixi add bioconductor-derfinderhelper
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-derfinderhelper
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-derfinderhelper"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-derfinderhelper"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-derfinderhelper"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-derfinderhelper
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-derfinderhelper/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-derfinderhelper', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-derfinderhelper
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-derfinderhelper/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-derfinderhelper', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-derfinderhelper
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-derfinderhelper/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-derfinderhelper', spec);
            } catch (err) {
