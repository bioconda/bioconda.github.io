...
.. conda:recipe:: bioconductor-affycompdata
   ...
   :homepage: https://bioconductor.org/packages/3.12/data/experiment/html/affycompData.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-affycompdata
   ...
   :versions:
      ...
      ``1.30.0-0``,  ``1.28.0-1``,  ``1.28.0-0``,  ``1.26.0-0``,  ``1.24.0-0``,  ``1.22.0-2``,  ``1.20.0-0``

      

   
   :depends bioconductor-affycomp: ``>=1.68.0,<1.69.0``
