...
.. conda:recipe:: bioconductor-recount
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/recount.html
...
.. conda:package:: bioconductor-recount
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.18.0-0</code>,  <code>1.16.1-0</code>,  <code>1.16.0-0</code>,  <code>1.14.0-0</code>,  <code>1.12.0-0</code>,  <code>1.10.8-0</code>,  <code>1.8.1-0</code>,  <code>1.6.3-0</code>,  <code>1.4.5-0</code>,  </span></summary>
      

      ``1.18.0-0``,  ``1.16.1-0``,  ``1.16.0-0``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.8-0``,  ``1.8.1-0``,  ``1.6.3-0``,  ``1.4.5-0``,  ``1.4.0-0``
