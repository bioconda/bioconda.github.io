...
.. conda:package:: bioconductor-harmonizr
   ...
   :depends on r-janitor: ``>=2.1.0``
   :depends on r-plyr: ``>=1.8.6``
   :depends on r-seriation: ``>=1.3.5``
...
to install globally, run::
    ...
    pixi global install bioconductor-harmonizr

to add into an existing workspace instead, run::

    pixi add bioconductor-harmonizr
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-harmonizr

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-harmonizr
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-harmonizr"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-harmonizr"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-harmonizr"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-harmonizr
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-harmonizr/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-harmonizr', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-harmonizr
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-harmonizr/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-harmonizr', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-harmonizr
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-harmonizr/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-harmonizr', spec);
            } catch (err) {
