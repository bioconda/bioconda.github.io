...
.. conda:package:: bioconductor-mesh.dpe.eg.db
   ...
   :required~by: |required_by_bioconductor-mesh.dpe.eg.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-mesh.dpe.eg.db


.. |required_by_bioconductor-mesh.dpe.eg.db| conda:required_by:: bioconductor-mesh.dpe.eg.db
