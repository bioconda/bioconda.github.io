...
.. conda:recipe:: bioconductor-lumimouseidmapping
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/lumiMouseIDMapping.html
...
.. conda:package:: bioconductor-lumimouseidmapping
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.10.0-14</code>,  <code>1.10.0-13</code>,  <code>1.10.0-12</code>,  <code>1.10.0-11</code>,  <code>1.10.0-10</code>,  <code>1.10.0-9</code>,  <code>1.10.0-8</code>,  <code>1.10.0-7</code>,  <code>1.10.0-6</code>,  </span></summary>
      

      ``1.10.0-14``,  ``1.10.0-13``,  ``1.10.0-12``,  ``1.10.0-11``,  ``1.10.0-10``,  ``1.10.0-9``,  ``1.10.0-8``,  ``1.10.0-7``,  ``1.10.0-6``,  ``1.10.0-5``,  ``1.10.0-4``,  ``1.10.0-3``,  ``1.10.0-2``,  ``1.10.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-lumimouseidmapping

to add into an existing workspace instead, run::

    pixi add bioconductor-lumimouseidmapping
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-lumimouseidmapping
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-lumimouseidmapping"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-lumimouseidmapping"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-lumimouseidmapping"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-lumimouseidmapping
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-lumimouseidmapping/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-lumimouseidmapping', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-lumimouseidmapping
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-lumimouseidmapping/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-lumimouseidmapping', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-lumimouseidmapping
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-lumimouseidmapping/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-lumimouseidmapping', spec);
            } catch (err) {
