...
.. conda:recipe:: bioconductor-rta10transcriptcluster.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/rta10transcriptcluster.db.html
...
.. conda:package:: bioconductor-rta10transcriptcluster.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rta10transcriptcluster.db

   and update with::

      mamba update bioconductor-rta10transcriptcluster.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rta10transcriptcluster.db
