...
.. conda:recipe:: bioconductor-metascope
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/MetaScope.html
   :license: GPL (>= 3)
...
.. conda:package:: bioconductor-metascope
   ...
   :depends on r-data.table: ``>=1.16.2``
   :depends on r-dplyr: 
...
to install globally, run::
    ...
    pixi global install bioconductor-metascope

to add into an existing workspace instead, run::

    pixi add bioconductor-metascope
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-metascope

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-metascope
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-metascope"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-metascope"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-metascope"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-metascope
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-metascope/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-metascope', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-metascope
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-metascope/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-metascope', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-metascope
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-metascope/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-metascope', spec);
            } catch (err) {
