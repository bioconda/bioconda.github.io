...
.. conda:recipe:: bioconductor-excluderanges
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/excluderanges.html
...
.. conda:package:: bioconductor-excluderanges
   ...
   :versions:
      ...
      ``0.99.10-0``,  ``0.99.8-2``,  ``0.99.8-1``,  ``0.99.8-0``,  ``0.99.6-2``,  ``0.99.6-1``,  ``0.99.6-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-excluderanges

to add into an existing workspace instead, run::

    pixi add bioconductor-excluderanges
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-excluderanges
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["0.99.10","0.99.8","0.99.8","0.99.8","0.99.6"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-excluderanges"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-excluderanges"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-excluderanges"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-excluderanges
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-excluderanges/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-excluderanges', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-excluderanges
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-excluderanges/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-excluderanges', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-excluderanges
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-excluderanges/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-excluderanges', spec);
            } catch (err) {
