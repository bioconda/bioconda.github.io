...
.. conda:recipe:: bioconductor-intansv
   ...
   :homepage: https://bioconductor.org/packages/3.8/bioc/html/intansv.html
...
.. conda:package:: bioconductor-intansv
   ...
   :depends: :conda:package:`bioconductor-biocgenerics` >=0.28.0,<0.29.0 :conda:package:`bioconductor-genomicranges` >=1.34.0,<1.35.0 :conda:package:`bioconductor-ggbio` >=1.30.0,<1.31.0 :conda:package:`bioconductor-iranges` >=2.16.0,<2.17.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-plyr`  

   :required~by: |required_by_bioconductor-intansv|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-intansv


.. |required_by_bioconductor-intansv| conda:required_by:: bioconductor-intansv
