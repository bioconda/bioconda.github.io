...
.. conda:recipe:: bioconductor-pd.cytogenetics.array
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/pd.cytogenetics.array.html
...
.. conda:package:: bioconductor-pd.cytogenetics.array
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.cytogenetics.array

   and update with::

      mamba update bioconductor-pd.cytogenetics.array

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.cytogenetics.array
