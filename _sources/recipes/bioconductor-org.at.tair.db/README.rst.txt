...
.. conda:recipe:: bioconductor-org.at.tair.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/org.At.tair.db.html
...
.. conda:package:: bioconductor-org.at.tair.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-org.at.tair.db

   and update with::

      mamba update bioconductor-org.at.tair.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-org.at.tair.db
