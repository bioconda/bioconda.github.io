...
.. conda:recipe:: bioconductor-mircomp
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/miRcomp.html
...
.. conda:package:: bioconductor-mircomp
   ...
   :versions:
      ...
      ``1.24.0-0``,  ``1.22.0-0``,  ``1.20.0-1``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.16.0-1``,  ``1.14.0-1``,  ``1.12.0-0``

      

   
   :depends bioconductor-biobase: ``>=2.54.0,<2.55.0``
   :depends bioconductor-mircompdata: ``>=1.24.0,<1.25.0``
