...
.. conda:recipe:: bioconductor-pi
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/Pi.html
   :license: GPL-3
...
.. conda:package:: bioconductor-pi
   ...
   :versions:
      ...
      ``2.4.0-0``,  ``2.2.0-0``,  ``2.0.0-0``,  ``1.14.0-0``,  ``1.12.0-1``,  ``1.10.0-0``
   ...
   :depends bioconductor-suprahex: ``>=1.30.0,<1.31.0``
