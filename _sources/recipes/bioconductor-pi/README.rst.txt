...
.. conda:package:: bioconductor-pi
   ...
   :versions:
      ...
      ``2.10.0-0``,  ``2.6.0-0``,  ``2.4.0-0``,  ``2.2.0-0``,  ``2.0.0-0``,  ``1.14.0-0``,  ``1.12.0-1``,  ``1.10.0-0``
   ...
   :depends bioconductor-suprahex: ``>=1.36.0,<1.37.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.10.0","2.6.0","2.4.0","2.2.0","2.0.0"];
    </script>
