...
.. conda:recipe:: bioconductor-phemd
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/phemd.html
   :license: GPL-2
...
.. conda:package:: bioconductor-phemd
   ...
   :versions:
      ...
      ``1.16.0-0``,  ``1.6.0-1``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.1.1-0``,  ``1.0.1-0``
   ...
   :depends bioconductor-destiny: ``>=3.14.0,<3.15.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.16.0","1.6.0","1.6.0","1.4.0","1.1.1"];
    </script>
