...
.. conda:recipe:: bioconductor-mouse430a2probe
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/mouse430a2probe.html
   :license: LGPL
...
.. conda:package:: bioconductor-mouse430a2probe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mouse430a2probe

   and update with::

      mamba update bioconductor-mouse430a2probe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mouse430a2probe
