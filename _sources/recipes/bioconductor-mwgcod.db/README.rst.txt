...
.. conda:recipe:: bioconductor-mwgcod.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/mwgcod.db.html
...
.. conda:package:: bioconductor-mwgcod.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mwgcod.db

   and update with::

      mamba update bioconductor-mwgcod.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mwgcod.db
