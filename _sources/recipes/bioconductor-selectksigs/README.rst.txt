...
.. conda:recipe:: bioconductor-selectksigs
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/selectKSigs.html
   :license: GPL-3
...
.. conda:package:: bioconductor-selectksigs
   ...
   :versions:
      ...
      ``1.10.0-1``,  ``1.10.0-0``,  ``1.6.0-2``,  ``1.6.0-1``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.0-1``,  ``1.2.0-0``,  ``1.0.0-0``

      

   
   :depends bioconductor-hilda: ``>=1.12.0,<1.13.0``
