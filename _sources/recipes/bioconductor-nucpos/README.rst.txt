...
.. conda:package:: bioconductor-nucpos
   ...
   :depends: :conda:package:`libgfortran` >=3.0.1 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-nucpos|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-nucpos


.. |required_by_bioconductor-nucpos| conda:required_by:: bioconductor-nucpos
