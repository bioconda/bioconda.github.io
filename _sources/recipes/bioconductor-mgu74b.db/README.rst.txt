...
.. conda:recipe:: bioconductor-mgu74b.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/mgu74b.db.html
...
.. conda:package:: bioconductor-mgu74b.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mgu74b.db

   and update with::

      mamba update bioconductor-mgu74b.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mgu74b.db
