...
.. conda:recipe:: bioconductor-xhybcasneuf
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/XhybCasneuf.html
...
.. conda:package:: bioconductor-xhybcasneuf
   ...
   :depends on bioconductor-ath1121501cdf: ``>=2.18.0,<2.19.0``
   :depends on bioconductor-data-packages: ``>=20260207``
   :depends on bioconductor-tinesath1cdf: ``>=1.48.0,<1.49.0``
   :depends on curl: 
...
to install globally, run::
    ...
    pixi global install bioconductor-xhybcasneuf

to add into an existing workspace instead, run::

    pixi add bioconductor-xhybcasneuf
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-xhybcasneuf
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-xhybcasneuf"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-xhybcasneuf"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-xhybcasneuf"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-xhybcasneuf
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-xhybcasneuf/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-xhybcasneuf', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-xhybcasneuf
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-xhybcasneuf/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-xhybcasneuf', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-xhybcasneuf
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-xhybcasneuf/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-xhybcasneuf', spec);
            } catch (err) {
