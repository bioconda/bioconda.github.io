...
.. conda:package:: atol-reference-data-lookups
   ...
   :depends python: ``>=3.13,<3.15``
   :depends scikit-bio: ``>=0.6.3``
   :depends snakemake: ``>=9.16.3,<10``
   :requirements:
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install atol-reference-data-lookups

   and update with::

      mamba update atol-reference-data-lookups

  To create a new environment, run::

      mamba create --name myenvname atol-reference-data-lookups
