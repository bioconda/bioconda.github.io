...
.. conda:package:: age-metasv
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2015.01.29.3-9</code>,  <code>2015.01.29.3-8</code>,  <code>2015.01.29.3-7</code>,  <code>2015.01.29.3-6</code>,  <code>2015.01.29.3-5</code>,  <code>2015.01.29.3-4</code>,  <code>2015.01.29.3-3</code>,  <code>2015.01.29.3-2</code>,  <code>2015.01.29.3-1</code>,  </span></summary>
      

      ``2015.01.29.3-9``,  ``2015.01.29.3-8``,  ``2015.01.29.3-7``,  ``2015.01.29.3-6``,  ``2015.01.29.3-5``,  ``2015.01.29.3-4``,  ``2015.01.29.3-3``,  ``2015.01.29.3-2``,  ``2015.01.29.3-1``,  ``2015.01.29.3-0``
...
to install globally, run::
    ...
    pixi global install age-metasv
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname age-metasv
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_age-metasv"></div>
   <div style="width: 100%" id="platform_plot_age-metasv"></div>
   <div style="width: 100%" id="cdf_plot_age-metasv"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/age-metasv/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_age-metasv', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for age-metasv
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/age-metasv/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_age-metasv', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for age-metasv
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/age-metasv/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_age-metasv', spec);
            } catch (err) {
