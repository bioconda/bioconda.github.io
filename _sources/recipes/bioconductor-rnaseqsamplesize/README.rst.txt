...
.. conda:recipe:: bioconductor-rnaseqsamplesize
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/RnaSeqSampleSize.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-rnaseqsamplesize
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.20.0-0</code>,  <code>2.16.0-0</code>,  <code>2.12.0-0</code>,  <code>2.10.0-0</code>,  <code>2.8.0-1</code>,  <code>2.8.0-0</code>,  <code>2.4.1-1</code>,  <code>2.4.1-0</code>,  <code>2.4.0-0</code>,  </span></summary>
      

      ``2.20.0-0``,  ``2.16.0-0``,  ``2.12.0-0``,  ``2.10.0-0``,  ``2.8.0-1``,  ``2.8.0-0``,  ``2.4.1-1``,  ``2.4.1-0``,  ``2.4.0-0``,  ``2.2.0-0``,  ``2.0.0-2``,  ``2.0.0-1``,  ``1.17.0-1``,  ``1.16.0-1``,  ``1.14.0-0``,  ``1.12.0-2``
   ...
   :depends on bioconductor-rnaseqsamplesizedata: ``>=1.42.0,<1.43.0``
   :depends on bioconductor-rnaseqsamplesizedata: ``>=1.42.0,<1.43.0a0``
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-rnaseqsamplesize"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-rnaseqsamplesize"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-rnaseqsamplesize"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-rnaseqsamplesize
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rnaseqsamplesize/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-rnaseqsamplesize', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-rnaseqsamplesize
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rnaseqsamplesize/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-rnaseqsamplesize', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-rnaseqsamplesize
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rnaseqsamplesize/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-rnaseqsamplesize', spec);
            } catch (err) {
