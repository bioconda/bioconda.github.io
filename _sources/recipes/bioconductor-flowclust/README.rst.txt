...
.. conda:recipe:: bioconductor-flowclust
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/flowClust.html
   :license: MIT
...
.. conda:package:: bioconductor-flowclust
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.48.0-0</code>,  <code>3.44.0-0</code>,  <code>3.40.0-1</code>,  <code>3.40.0-0</code>,  <code>3.38.0-0</code>,  <code>3.36.0-1</code>,  <code>3.36.0-0</code>,  <code>3.32.0-2</code>,  <code>3.32.0-1</code>,  </span></summary>
      

      ``3.48.0-0``,  ``3.44.0-0``,  ``3.40.0-1``,  ``3.40.0-0``,  ``3.38.0-0``,  ``3.36.0-1``,  ``3.36.0-0``,  ``3.32.0-2``,  ``3.32.0-1``,  ``3.32.0-0``,  ``3.30.0-0``,  ``3.28.0-2``,  ``3.28.0-1``,  ``3.28.0-0``,  ``3.26.0-0``,  ``3.24.0-0``,  ``3.22.0-1``,  ``3.20.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-flowclust

to add into an existing workspace instead, run::

    pixi add bioconductor-flowclust
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-flowclust
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["3.48.0","3.44.0","3.40.0","3.40.0","3.38.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-flowclust"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-flowclust"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-flowclust"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-flowclust
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-flowclust/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-flowclust', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-flowclust
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-flowclust/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-flowclust', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-flowclust
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-flowclust/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-flowclust', spec);
            } catch (err) {
