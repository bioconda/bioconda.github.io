...
.. conda:recipe:: bioconductor-rgsea
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/RGSEA.html
   :license: GPL(>=3)
...
.. conda:package:: bioconductor-rgsea
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rgsea

   and update with::

      mamba update bioconductor-rgsea

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rgsea
