...
.. conda:recipe:: bioconductor-debrowser
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/debrowser.html
...
.. conda:package:: bioconductor-debrowser
   ...
   :versions:
      ...
      ``1.28.2-0``,  ``1.26.0-0``,  ``1.22.1-0``,  ``1.20.0-0``,  ``1.18.2-0``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-0``,  ``1.12.2-0``
   ...
   :depends bioconductor-harman: ``>=1.28.0,<1.29.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.28.2","1.26.0","1.22.1","1.20.0","1.18.2"];
    </script>
