...
.. conda:package:: python-omero
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>5.7.1-0</code>,  <code>5.7.0-0</code>,  <code>5.6.2-0</code>,  <code>5.6.1-0</code>,  <code>5.6.0-0</code>,  <code>5.4.10-1</code>,  <code>5.4.10-0</code>,  <code>5.4.9-0</code>,  <code>5.4.8-1</code>,  </span></summary>
      

      ``5.7.1-0``,  ``5.7.0-0``,  ``5.6.2-0``,  ``5.6.1-0``,  ``5.6.0-0``,  ``5.4.10-1``,  ``5.4.10-0``,  ``5.4.9-0``,  ``5.4.8-1``,  ``5.4.7-1``,  ``5.4.6-1``,  ``5.4.6-0``,  ``5.4.5-0``,  ``5.4.4-0``,  ``5.4.3-0``,  ``5.4.2-0``,  ``5.4.1-0``,  ``5.4.0-0``,  ``5.3.3-0``,  ``5.3.2-0``,  ``5.3.1-0``,  ``5.3.0-2``,  ``5.2.8-2``,  ``5.2.7-2``,  ``5.2.7-1``,  ``5.2.7-0``
