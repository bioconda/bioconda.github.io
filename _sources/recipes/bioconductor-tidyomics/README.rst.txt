...
.. conda:package:: bioconductor-tidyomics
   ...
   :depends on bioconductor-tidyspatialexperiment: ``>=1.6.0,<1.7.0``
   :depends on bioconductor-tidysummarizedexperiment: ``>=1.20.0,<1.21.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-tidyomics

to add into an existing workspace instead, run::

    pixi add bioconductor-tidyomics
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-tidyomics

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-tidyomics
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-tidyomics"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-tidyomics"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-tidyomics"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-tidyomics
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-tidyomics/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-tidyomics', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-tidyomics
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-tidyomics/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-tidyomics', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-tidyomics
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-tidyomics/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-tidyomics', spec);
            } catch (err) {
