...
.. conda:recipe:: bioconductor-reactomegsa.data
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/ReactomeGSA.data.html
...
.. conda:package:: bioconductor-reactomegsa.data
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.24.0-0</code>,  <code>1.20.0-0</code>,  <code>1.16.1-0</code>,  <code>1.14.0-0</code>,  <code>1.11.0-0</code>,  <code>1.8.0-1</code>,  <code>1.8.0-0</code>,  <code>1.6.0-0</code>,  <code>1.4.0-1</code>,  </span></summary>
      

      ``1.24.0-0``,  ``1.20.0-0``,  ``1.16.1-0``,  ``1.14.0-0``,  ``1.11.0-0``,  ``1.8.0-1``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-1``,  ``1.4.0-0``,  ``1.2.0-0``,  ``1.0.0-0``
   ...
   :depends on bioconductor-reactomegsa: ``>=1.24.0,<1.25.0``
   :depends on curl: 
...
to install globally, run::
    ...
    pixi global install bioconductor-reactomegsa.data

to add into an existing workspace instead, run::

    pixi add bioconductor-reactomegsa.data
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-reactomegsa.data
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.24.0","1.20.0","1.16.1","1.14.0","1.11.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-reactomegsa.data"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-reactomegsa.data"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-reactomegsa.data"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-reactomegsa.data
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-reactomegsa.data/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-reactomegsa.data', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-reactomegsa.data
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-reactomegsa.data/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-reactomegsa.data', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-reactomegsa.data
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-reactomegsa.data/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-reactomegsa.data', spec);
            } catch (err) {
