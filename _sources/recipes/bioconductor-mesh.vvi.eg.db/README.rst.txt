...
.. conda:package:: bioconductor-mesh.vvi.eg.db
   ...
   :required~by: |required_by_bioconductor-mesh.vvi.eg.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-mesh.vvi.eg.db


.. |required_by_bioconductor-mesh.vvi.eg.db| conda:required_by:: bioconductor-mesh.vvi.eg.db
