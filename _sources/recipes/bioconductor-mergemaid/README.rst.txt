...
.. conda:package:: bioconductor-mergemaid
   ...
   :depends: :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-mass`  :conda:package:`r-survival`  

   :required~by: |required_by_bioconductor-mergemaid|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-mergemaid


.. |required_by_bioconductor-mergemaid| conda:required_by:: bioconductor-mergemaid
