...
.. conda:package:: bioconductor-consensus
   ...
   :depends: :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-gplots`  :conda:package:`r-matrixstats`  :conda:package:`r-rcolorbrewer`  

   :required~by: |required_by_bioconductor-consensus|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-consensus


.. |required_by_bioconductor-consensus| conda:required_by:: bioconductor-consensus
