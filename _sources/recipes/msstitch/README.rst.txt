...
.. conda:package:: msstitch
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.7-0</code>,  <code>3.6-0</code>,  <code>3.5-0</code>,  <code>3.4-0</code>,  <code>3.3-0</code>,  <code>3.2-0</code>,  <code>3.1-0</code>,  <code>3.0-0</code>,  <code>2.19-0</code>,  </span></summary>
      

      ``3.7-0``,  ``3.6-0``,  ``3.5-0``,  ``3.4-0``,  ``3.3-0``,  ``3.2-0``,  ``3.1-0``,  ``3.0-0``,  ``2.19-0``,  ``2.18-0``,  ``2.17-0``,  ``2.16-0``,  ``2.15-0``,  ``2.14-0``,  ``2.13-1``,  ``2.13-0``,  ``2.12-0``,  ``2.11-0``,  ``2.10-0``,  ``2.9-0``,  ``2.8-0``,  ``2.7-0``,  ``2.6-0``,  ``2.5-0``,  ``2.4-0``,  ``2.3-0``,  ``2.2-0``,  ``1.0-1``,  ``1.0-0``
