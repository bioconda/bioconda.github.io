...
.. conda:recipe:: bioconductor-ccpromise
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/CCPROMISE.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-ccpromise
   ...
   :depends on bioconductor-promise: ``>=1.62.0,<1.63.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-ccpromise

to add into an existing workspace instead, run::

    pixi add bioconductor-ccpromise
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-ccpromise
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-ccpromise"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-ccpromise"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-ccpromise"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-ccpromise
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ccpromise/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-ccpromise', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-ccpromise
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ccpromise/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-ccpromise', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-ccpromise
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ccpromise/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-ccpromise', spec);
            } catch (err) {
