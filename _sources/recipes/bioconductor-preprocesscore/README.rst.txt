...
.. conda:recipe:: bioconductor-preprocesscore
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/preprocessCore.html
   :license: LGPL (>= 2)
...
.. conda:package:: bioconductor-preprocesscore
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.60.0-0</code>,  <code>1.56.0-3</code>,  <code>1.56.0-2</code>,  <code>1.56.0-1</code>,  <code>1.56.0-0</code>,  <code>1.54.0-0</code>,  <code>1.52.1-0</code>,  <code>1.52.0-0</code>,  <code>1.50.0-0</code>,  </span></summary>
      

      ``1.60.0-0``,  ``1.56.0-3``,  ``1.56.0-2``,  ``1.56.0-1``,  ``1.56.0-0``,  ``1.54.0-0``,  ``1.52.1-0``,  ``1.52.0-0``,  ``1.50.0-0``,  ``1.48.0-0``,  ``1.46.0-1``,  ``1.46.0-0``,  ``1.44.0-0``,  ``1.42.0-0``,  ``1.40.0-0``,  ``1.38.1-0``,  ``1.34.0-0``,  ``1.32.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.60.0","1.56.0","1.56.0","1.56.0","1.56.0"];
    </script>
