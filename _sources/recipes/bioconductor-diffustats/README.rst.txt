...
.. conda:recipe:: bioconductor-diffustats
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/diffuStats.html
   :license: GPL-3
...
.. conda:package:: bioconductor-diffustats
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.22.0-0</code>,  <code>1.20.0-0</code>,  <code>1.18.0-2</code>,  <code>1.18.0-1</code>,  <code>1.18.0-0</code>,  <code>1.14.0-2</code>,  <code>1.14.0-1</code>,  <code>1.14.0-0</code>,  <code>1.12.0-0</code>,  </span></summary>
      

      ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.0-2``,  ``1.18.0-1``,  ``1.18.0-0``,  ``1.14.0-2``,  ``1.14.0-1``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.2-0``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-1``,  ``1.4.0-0``,  ``1.2.0-0``,  ``0.104.0-0``,  ``0.102.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.22.0","1.20.0","1.18.0","1.18.0","1.18.0"];
    </script>
