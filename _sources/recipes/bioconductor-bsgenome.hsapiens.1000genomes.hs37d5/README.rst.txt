...
.. conda:recipe:: bioconductor-bsgenome.hsapiens.1000genomes.hs37d5
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/BSgenome.Hsapiens.1000genomes.hs37d5.html
...
.. conda:package:: bioconductor-bsgenome.hsapiens.1000genomes.hs37d5
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.99.1-14</code>,  <code>0.99.1-13</code>,  <code>0.99.1-12</code>,  <code>0.99.1-11</code>,  <code>0.99.1-10</code>,  <code>0.99.1-9</code>,  <code>0.99.1-8</code>,  <code>0.99.1-7</code>,  <code>0.99.1-6</code>,  </span></summary>
      

      ``0.99.1-14``,  ``0.99.1-13``,  ``0.99.1-12``,  ``0.99.1-11``,  ``0.99.1-10``,  ``0.99.1-9``,  ``0.99.1-8``,  ``0.99.1-7``,  ``0.99.1-6``,  ``0.99.1-5``,  ``0.99.1-4``,  ``0.99.1-3``,  ``0.99.1-2``,  ``0.99.1-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-bsgenome.hsapiens.1000genomes.hs37d5

to add into an existing workspace instead, run::

    pixi add bioconductor-bsgenome.hsapiens.1000genomes.hs37d5
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-bsgenome.hsapiens.1000genomes.hs37d5
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-bsgenome.hsapiens.1000genomes.hs37d5"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-bsgenome.hsapiens.1000genomes.hs37d5"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-bsgenome.hsapiens.1000genomes.hs37d5"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-bsgenome.hsapiens.1000genomes.hs37d5
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.hsapiens.1000genomes.hs37d5/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-bsgenome.hsapiens.1000genomes.hs37d5', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-bsgenome.hsapiens.1000genomes.hs37d5
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.hsapiens.1000genomes.hs37d5/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-bsgenome.hsapiens.1000genomes.hs37d5', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-bsgenome.hsapiens.1000genomes.hs37d5
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.hsapiens.1000genomes.hs37d5/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-bsgenome.hsapiens.1000genomes.hs37d5', spec);
            } catch (err) {
