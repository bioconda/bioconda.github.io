...
.. conda:recipe:: bioconductor-gesper
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/gespeR.html
   :license: GPL-3
...
.. conda:package:: bioconductor-gesper
   ...
   :versions:
      ...
      ``1.30.0-0``,  ``1.26.0-0``,  ``1.24.0-0``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.16.0-1``,  ``1.14.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.30.0","1.26.0","1.24.0","1.20.0","1.18.0"];
    </script>
