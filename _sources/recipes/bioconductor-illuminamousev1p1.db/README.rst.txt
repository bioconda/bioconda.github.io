...
.. conda:recipe:: bioconductor-illuminamousev1p1.db
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/illuminaMousev1p1.db.html
...
.. conda:package:: bioconductor-illuminamousev1p1.db
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-illuminamousev1p1.db:<tag>
