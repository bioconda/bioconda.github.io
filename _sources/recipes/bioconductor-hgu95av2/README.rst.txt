...
.. conda:recipe:: bioconductor-hgu95av2
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/hgu95av2.html
...
.. conda:package:: bioconductor-hgu95av2
   ...
   :versions:
      ...
      ``2.2.0-14``,  ``2.2.0-13``,  ``2.2.0-12``,  ``2.2.0-11``,  ``2.2.0-10``,  ``2.2.0-9``,  ``2.2.0-8``,  ``2.2.0-7``,  ``2.2.0-6``,  ``2.2.0-5``,  ``2.2.0-4``,  ``2.2.0-3``,  ``2.2.0-2``,  ``2.2.0-1``,  ``2.2.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-hgu95av2

to add into an existing workspace instead, run::

    pixi add bioconductor-hgu95av2
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-hgu95av2

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-hgu95av2
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-hgu95av2"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-hgu95av2"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-hgu95av2"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-hgu95av2
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hgu95av2/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-hgu95av2', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-hgu95av2
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hgu95av2/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-hgu95av2', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-hgu95av2
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hgu95av2/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-hgu95av2', spec);
            } catch (err) {
