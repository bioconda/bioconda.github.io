...
.. conda:package:: gdmicro
   ...
   :depends on bioconductor-siamcat: ``1.6.0``
   :depends on ipython: 
   ...
   :depends on pytorch: ``1.12.0``
   :depends on r-base: ``3.6.1``
   :depends on r-tidyverse: ``1.2.1``
   :depends on r-yaml: ``2.2.1``
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install gdmicro

Alternatively, to install into a new environment, run::

    conda create -n envname gdmicro
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_gdmicro"></div>
   <div style="width: 100%" id="platform_plot_gdmicro"></div>
   <div style="width: 100%" id="cdf_plot_gdmicro"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/gdmicro/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_gdmicro', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for gdmicro
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/gdmicro/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_gdmicro', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for gdmicro
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/gdmicro/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_gdmicro', spec);
            } catch (err) {
