...
.. conda:package:: bioconductor-bsgenome.tguttata.ucsc.taegut1.masked
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bsgenome.tguttata.ucsc.taegut1.masked

   and update with::

      mamba update bioconductor-bsgenome.tguttata.ucsc.taegut1.masked

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bsgenome.tguttata.ucsc.taegut1.masked
