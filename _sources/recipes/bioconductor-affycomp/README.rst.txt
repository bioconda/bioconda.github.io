...
.. conda:recipe:: bioconductor-affycomp
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/affycomp.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-affycomp
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-affycomp

   and update with::

      mamba update bioconductor-affycomp

  To create a new environment, run::

      mamba create --name myenvname bioconductor-affycomp
