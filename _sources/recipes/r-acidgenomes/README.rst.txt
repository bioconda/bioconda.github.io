...
.. conda:package:: r-acidgenomes
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.4.4-1</code>,  <code>0.4.4-0</code>,  <code>0.3.0-0</code>,  <code>0.2.20-0</code>,  <code>0.2.19-0</code>,  <code>0.2.18-0</code>,  <code>0.2.17-0</code>,  <code>0.2.16-0</code>,  <code>0.2.15-0</code>,  </span></summary>
      

      ``0.4.4-1``,  ``0.4.4-0``,  ``0.3.0-0``,  ``0.2.20-0``,  ``0.2.19-0``,  ``0.2.18-0``,  ``0.2.17-0``,  ``0.2.16-0``,  ``0.2.15-0``,  ``0.2.14-0``,  ``0.2.13-0``,  ``0.2.12-2``,  ``0.2.12-1``,  ``0.2.12-0``,  ``0.2.11-2``,  ``0.2.11-0``,  ``0.1.1-1``,  ``0.1.1-0``
   ...
   :depends bioconductor-annotationdbi: ``>=1.58.0``
   :depends bioconductor-annotationhub: ``>=3.4.0``
   :depends bioconductor-biocgenerics: ``>=0.42.0``
   :depends bioconductor-biomart: ``>=2.52.0``
   :depends bioconductor-ensembldb: ``>=2.20.2``
   :depends bioconductor-genomeinfodb: ``>=1.32.4``
   :depends bioconductor-genomicfeatures: ``>=1.48.4``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.4.4","0.4.4","0.3.0","0.2.20","0.2.19"];
    </script>
