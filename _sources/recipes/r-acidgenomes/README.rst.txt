...
.. conda:package:: r-acidgenomes
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.4.7-0</code>,  <code>0.4.6-0</code>,  <code>0.4.5-0</code>,  <code>0.4.4-1</code>,  <code>0.4.4-0</code>,  <code>0.3.0-0</code>,  <code>0.2.20-0</code>,  <code>0.2.19-0</code>,  <code>0.2.18-0</code>,  </span></summary>
      

      ``0.4.7-0``,  ``0.4.6-0``,  ``0.4.5-0``,  ``0.4.4-1``,  ``0.4.4-0``,  ``0.3.0-0``,  ``0.2.20-0``,  ``0.2.19-0``,  ``0.2.18-0``,  ``0.2.17-0``,  ``0.2.16-0``,  ``0.2.15-0``,  ``0.2.14-0``,  ``0.2.13-0``,  ``0.2.12-2``,  ``0.2.12-1``,  ``0.2.12-0``,  ``0.2.11-2``,  ``0.2.11-0``,  ``0.1.1-1``,  ``0.1.1-0``
   ...
   :depends bioconductor-annotationdbi: ``>=1.60.0``
   :depends bioconductor-annotationhub: ``>=3.6.0``
   :depends bioconductor-biocgenerics: ``>=0.44.0``
   :depends bioconductor-biomart: ``>=2.54.0``
   :depends bioconductor-ensembldb: ``>=2.22.0``
   :depends bioconductor-genomeinfodb: ``>=1.34.0``
   :depends bioconductor-genomicfeatures: ``>=1.50.0``
   :depends bioconductor-genomicranges: ``>=1.50.0``
   :depends bioconductor-iranges: ``>=2.32.0``
   :depends bioconductor-s4vectors: ``>=0.36.0``
   :depends r-acidbase: ``>=0.6.10``
   :depends r-acidcli: ``>=0.2.6``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.4.7","0.4.6","0.4.5","0.4.4","0.4.4"];
    </script>
