...
.. conda:package:: bioconductor-mesh.dme.eg.db
   ...
   :required~by: |required_by_bioconductor-mesh.dme.eg.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-mesh.dme.eg.db


.. |required_by_bioconductor-mesh.dme.eg.db| conda:required_by:: bioconductor-mesh.dme.eg.db
