...
.. conda:recipe:: bioconductor-human610quadv1bcrlmm
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/human610quadv1bCrlmm.html
...
.. conda:package:: bioconductor-human610quadv1bcrlmm
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-human610quadv1bcrlmm

   and update with::

      mamba update bioconductor-human610quadv1bcrlmm

  To create a new environment, run::

      mamba create --name myenvname bioconductor-human610quadv1bcrlmm
