...
.. conda:recipe:: bioconductor-ensdb.mmusculus.v79
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/EnsDb.Mmusculus.v79.html
...
.. conda:package:: bioconductor-ensdb.mmusculus.v79
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ensdb.mmusculus.v79

   and update with::

      mamba update bioconductor-ensdb.mmusculus.v79

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ensdb.mmusculus.v79
