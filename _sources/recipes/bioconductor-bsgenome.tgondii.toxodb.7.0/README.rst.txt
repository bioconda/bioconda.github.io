...
.. conda:recipe:: bioconductor-bsgenome.tgondii.toxodb.7.0
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/BSgenome.Tgondii.ToxoDB.7.0.html
   :license: GPL 3
...
.. conda:package:: bioconductor-bsgenome.tgondii.toxodb.7.0
   ...
   :required~by: |required_by_bioconductor-bsgenome.tgondii.toxodb.7.0|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-bsgenome.tgondii.toxodb.7.0


.. |required_by_bioconductor-bsgenome.tgondii.toxodb.7.0| conda:required_by:: bioconductor-bsgenome.tgondii.toxodb.7.0
