...
.. conda:recipe:: bioconductor-wes.1kg.wugsc
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/WES.1KG.WUGSC.html
   :license: GPL-2
...
to install globally, run::
    ...
    pixi global install bioconductor-wes.1kg.wugsc

to add into an existing workspace instead, run::

    pixi add bioconductor-wes.1kg.wugsc
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-wes.1kg.wugsc
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-wes.1kg.wugsc"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-wes.1kg.wugsc"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-wes.1kg.wugsc"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-wes.1kg.wugsc
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-wes.1kg.wugsc/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-wes.1kg.wugsc', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-wes.1kg.wugsc
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-wes.1kg.wugsc/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-wes.1kg.wugsc', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-wes.1kg.wugsc
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-wes.1kg.wugsc/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-wes.1kg.wugsc', spec);
            } catch (err) {
