...
.. conda:recipe:: bioconductor-lea
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/LEA.html
   :license: GPL-3
...
.. conda:package:: bioconductor-lea
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.22.0-0</code>,  <code>3.18.0-0</code>,  <code>3.14.0-0</code>,  <code>3.12.2-0</code>,  <code>3.10.0-1</code>,  <code>3.10.0-0</code>,  <code>3.6.0-2</code>,  <code>3.6.0-1</code>,  <code>3.6.0-0</code>,  </span></summary>
      

      ``3.22.0-0``,  ``3.18.0-0``,  ``3.14.0-0``,  ``3.12.2-0``,  ``3.10.0-1``,  ``3.10.0-0``,  ``3.6.0-2``,  ``3.6.0-1``,  ``3.6.0-0``,  ``3.4.0-0``,  ``3.2.0-1``,  ``3.2.0-0``,  ``3.0.0-0``,  ``2.8.0-0``,  ``2.6.0-1``,  ``2.6.0-0``,  ``2.4.0-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["3.22.0","3.18.0","3.14.0","3.12.2","3.10.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-lea"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-lea"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-lea"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-lea
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-lea/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-lea', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-lea
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-lea/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-lea', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-lea
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-lea/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-lea', spec);
            } catch (err) {
