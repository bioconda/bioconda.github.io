...
.. conda:recipe:: bioconductor-arraytools
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/ArrayTools.html
   :license: LGPL (>= 2.0)
...
.. conda:package:: bioconductor-arraytools
   ...
   :versions:
      ...
      ``1.50.0-1``,  ``1.50.0-0``,  ``1.48.0-0``,  ``1.46.0-0``,  ``1.44.0-1``,  ``1.42.0-0``,  ``1.40.0-0``,  ``1.38.0-0``,  ``1.36.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-arraytools";
        var versions = ["1.50.0","1.50.0","1.48.0","1.46.0","1.44.0"];
    </script>
