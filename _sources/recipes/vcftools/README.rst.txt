...
.. conda:package:: vcftools
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.1.16-4</code>,  <code>0.1.16-3</code>,  <code>0.1.16-2</code>,  <code>0.1.15-2</code>,  <code>0.1.15-1</code>,  <code>0.1.15-0</code>,  <code>0.1.14-5</code>,  <code>0.1.14-4</code>,  <code>0.1.14-3</code>,  </span></summary>
      

      ``0.1.16-4``,  ``0.1.16-3``,  ``0.1.16-2``,  ``0.1.15-2``,  ``0.1.15-1``,  ``0.1.15-0``,  ``0.1.14-5``,  ``0.1.14-4``,  ``0.1.14-3``,  ``0.1.14-2``,  ``0.1.14-1``,  ``0.1.14-0``,  ``0.1.12b-1``,  ``0.1.12b-0``,  ``0.1.11-2``,  ``0.1.11-1``,  ``0.1.11-0``,  ``0.1.10-1``,  ``0.1.10-0``
