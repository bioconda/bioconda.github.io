...
.. conda:recipe:: bioconductor-icheck
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/iCheck.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-icheck
   ...
   :depends on bioconductor-geneselectmmd: ``>=2.54.0,<2.55.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-icheck

to add into an existing workspace instead, run::

    pixi add bioconductor-icheck
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-icheck
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-icheck"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-icheck"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-icheck"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-icheck
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-icheck/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-icheck', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-icheck
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-icheck/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-icheck', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-icheck
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-icheck/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-icheck', spec);
            } catch (err) {
