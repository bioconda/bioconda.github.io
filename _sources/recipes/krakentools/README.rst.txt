...
.. conda:package:: krakentools
   ...
   :versions:
      ...
      ``1.2.1-0``,  ``1.2-1``,  ``1.2-0``,  ``1.1-0``,  ``1.0.1-0``,  ``0.1-0``
...
to install globally, run::
    ...
    pixi global install krakentools

to add into an existing workspace instead, run::

    pixi add krakentools
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname krakentools
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.2.1","1.2","1.2","1.1","1.0.1"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_krakentools"></div>
   <div style="width: 100%" id="platform_plot_krakentools"></div>
   <div style="width: 100%" id="cdf_plot_krakentools"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for krakentools
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/krakentools/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_krakentools', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for krakentools
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/krakentools/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_krakentools', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for krakentools
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/krakentools/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_krakentools', spec);
            } catch (err) {
