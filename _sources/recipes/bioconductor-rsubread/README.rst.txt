...
.. conda:recipe:: bioconductor-rsubread
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/Rsubread.html
   :license: GPL (>=3)
...
.. conda:package:: bioconductor-rsubread
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.6.1-0</code>,  <code>2.4.3-0</code>,  <code>2.4.0-0</code>,  <code>2.2.1-0</code>,  <code>2.0.0-0</code>,  <code>1.34.6-0</code>,  <code>1.34.4-0</code>,  <code>1.34.0-0</code>,  <code>1.32.4-0</code>,  </span></summary>
      

      ``2.6.1-0``,  ``2.4.3-0``,  ``2.4.0-0``,  ``2.2.1-0``,  ``2.0.0-0``,  ``1.34.6-0``,  ``1.34.4-0``,  ``1.34.0-0``,  ``1.32.4-0``,  ``1.32.2-0``,  ``1.30.9-0``,  ``1.28.1-0``,  ``1.28.0-0``,  ``1.26.1-0``,  ``1.25.2-0``,  ``1.23.0-0``,  ``1.22.1-0``
