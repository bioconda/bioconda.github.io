...
.. conda:recipe:: bioconductor-mogene21stprobeset.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/mogene21stprobeset.db.html
...
.. conda:package:: bioconductor-mogene21stprobeset.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mogene21stprobeset.db

   and update with::

      mamba update bioconductor-mogene21stprobeset.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mogene21stprobeset.db
