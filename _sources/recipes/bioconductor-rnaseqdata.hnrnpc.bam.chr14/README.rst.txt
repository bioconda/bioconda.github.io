...
.. conda:recipe:: bioconductor-rnaseqdata.hnrnpc.bam.chr14
   ...
   :homepage: https://bioconductor.org/packages/3.14/data/experiment/html/RNAseqData.HNRNPC.bam.chr14.html
   :license: LGPL
...
.. conda:package:: bioconductor-rnaseqdata.hnrnpc.bam.chr14
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.32.0-1</code>,  <code>0.32.0-0</code>,  <code>0.30.0-0</code>,  <code>0.28.0-1</code>,  <code>0.28.0-0</code>,  <code>0.27.0-0</code>,  <code>0.26.0-0</code>,  <code>0.24.0-0</code>,  <code>0.22.0-1</code>,  </span></summary>
      

      ``0.32.0-1``,  ``0.32.0-0``,  ``0.30.0-0``,  ``0.28.0-1``,  ``0.28.0-0``,  ``0.27.0-0``,  ``0.26.0-0``,  ``0.24.0-0``,  ``0.22.0-1``,  ``0.22.0-0``,  ``0.20.0-1``,  ``0.20.0-0``
