...
.. conda:package:: bioconductor-trena
   ...
   :depends on bioconductor-biomart: ``>=2.54.0,<2.55.0``
   ...
   :depends on bioconductor-motifdb: ``>=1.40.0,<1.41.0``
   :depends on bioconductor-org.hs.eg.db: ``>=3.16.0,<3.17.0``
   :depends on bioconductor-snplocs.hsapiens.dbsnp150.grch38: ``>=0.99.0,<0.100.0``
   :depends on r-base: ``>=4.2,<4.3.0a0``
   :depends on r-dbi: 
   :depends on r-glmnet: ``>=2.0.3``
   :depends on r-lassopv: 
   :depends on r-randomforest: 
   :depends on r-rmysql: 
   :depends on r-rpostgresql: 
...
to install globally, run::
    ...
    pixi global install bioconductor-trena

to add into an existing workspace instead, run::

    pixi add bioconductor-trena
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-trena
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-trena"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-trena"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-trena"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-trena
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-trena/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-trena', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-trena
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-trena/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-trena', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-trena
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-trena/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-trena', spec);
            } catch (err) {
