...
.. conda:recipe:: bioconductor-cocoa
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/COCOA.html
   :license: GPL-3
...
.. conda:package:: bioconductor-cocoa
   ...
   :versions:
      ...
      ``2.8.0-0``,  ``2.6.0-0``,  ``2.4.0-1``,  ``2.4.0-0``,  ``2.2.0-0``,  ``2.0.0-0``,  ``1.2.0-1``,  ``1.0.1-0``
   ...
   :depends bioconductor-mira: ``>=1.16.0,<1.17.0``
