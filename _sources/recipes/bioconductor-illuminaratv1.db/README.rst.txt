...
.. conda:package:: bioconductor-illuminaratv1.db
   ...
   :required~by: |required_by_bioconductor-illuminaratv1.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-illuminaratv1.db


.. |required_by_bioconductor-illuminaratv1.db| conda:required_by:: bioconductor-illuminaratv1.db
