...
.. conda:recipe:: bioconductor-multiclust
   ...
   :homepage: https://bioconductor.org/packages/3.10/bioc/html/multiClust.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-multiclust
   ...
   :versions: 1.16.0-0, 1.14.0-1, 1.14.0-0, 1.12.0-0, 1.10.0-0, 1.8.2-0
   
   :depends bioconductor-ctc: >=1.60.0,<1.61.0
   :depends r-amap: 
