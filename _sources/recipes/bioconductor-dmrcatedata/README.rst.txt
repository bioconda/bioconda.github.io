...
.. conda:recipe:: bioconductor-dmrcatedata
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/DMRcatedata.html
   :license: GPL-3
...
.. conda:package:: bioconductor-dmrcatedata
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.28.0-0</code>,  <code>2.20.0-0</code>,  <code>2.18.0-0</code>,  <code>2.16.0-0</code>,  <code>2.12.0-1</code>,  <code>2.12.0-0</code>,  <code>2.10.0-0</code>,  <code>2.8.2-0</code>,  <code>2.8.0-0</code>,  </span></summary>
      

      ``2.28.0-0``,  ``2.20.0-0``,  ``2.18.0-0``,  ``2.16.0-0``,  ``2.12.0-1``,  ``2.12.0-0``,  ``2.10.0-0``,  ``2.8.2-0``,  ``2.8.0-0``,  ``2.6.0-0``,  ``2.2.0-0``,  ``1.20.0-1``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-dmrcatedata

to add into an existing workspace instead, run::

    pixi add bioconductor-dmrcatedata
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-dmrcatedata
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["2.28.0","2.20.0","2.18.0","2.16.0","2.12.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-dmrcatedata"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-dmrcatedata"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-dmrcatedata"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-dmrcatedata
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-dmrcatedata/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-dmrcatedata', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-dmrcatedata
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-dmrcatedata/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-dmrcatedata', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-dmrcatedata
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-dmrcatedata/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-dmrcatedata', spec);
            } catch (err) {
