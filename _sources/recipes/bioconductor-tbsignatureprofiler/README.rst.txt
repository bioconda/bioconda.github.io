...
.. conda:recipe:: bioconductor-tbsignatureprofiler
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/TBSignatureProfiler.html
...
.. conda:package:: bioconductor-tbsignatureprofiler
   ...
   :versions:
      ...
      ``1.22.0-0``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.6.0-0``,  ``1.2.0-1``,  ``1.2.0-0``,  ``1.0.0-0``

      

   
   :depends on bioconductor-assign: ``>=1.46.0,<1.47.0``
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-tbsignatureprofiler"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-tbsignatureprofiler"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-tbsignatureprofiler"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-tbsignatureprofiler
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-tbsignatureprofiler/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-tbsignatureprofiler', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-tbsignatureprofiler
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-tbsignatureprofiler/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-tbsignatureprofiler', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-tbsignatureprofiler
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-tbsignatureprofiler/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-tbsignatureprofiler', spec);
            } catch (err) {
