...
.. conda:package:: bpp-popgen
   ...
   :versions:
      ...
      ``3.0.0-0``,  ``2.4.1-5``,  ``2.4.1-4``,  ``2.4.1-3``,  ``2.4.1-2``,  ``2.4.1-1``,  ``2.4.1-0``
...
to install globally, run::
    ...
    pixi global install bpp-popgen
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bpp-popgen
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bpp-popgen"></div>
   <div style="width: 100%" id="platform_plot_bpp-popgen"></div>
   <div style="width: 100%" id="cdf_plot_bpp-popgen"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bpp-popgen/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bpp-popgen', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bpp-popgen
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bpp-popgen/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bpp-popgen', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bpp-popgen
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bpp-popgen/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bpp-popgen', spec);
            } catch (err) {
