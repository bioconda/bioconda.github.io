...
.. conda:recipe:: bioconductor-scnorm
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/SCnorm.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-scnorm
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.20.0-0</code>,  <code>1.16.0-0</code>,  <code>1.14.0-0</code>,  <code>1.12.0-1</code>,  <code>1.12.0-0</code>,  <code>1.10.0-0</code>,  <code>1.8.0-0</code>,  <code>1.6.0-1</code>,  <code>1.4.3-0</code>,  </span></summary>
      

      ``1.20.0-0``,  ``1.16.0-0``,  ``1.14.0-0``,  ``1.12.0-1``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.0-1``,  ``1.4.3-0``,  ``1.2.1-0``,  ``1.0.0-0``
