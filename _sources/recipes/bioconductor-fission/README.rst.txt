...
============= ===========
Home          https://bioconductor.org/packages/3.8/data/experiment/html/fission.html
Versions      
License       LGPL
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes//bioconductor-fission/meta.yaml
...
A Docker container is available at https://quay.io/repository/biocontainers/bioconductor-fission.
...
Render an |badge| badge with the following Markdown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square)](http://bioconda.github.io/recipes/bioconductor-fission/README.html)

.. |badge| image:: https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square
           :target: http://bioconda.github.io/recipes/bioconductor-fission/README.html
.. |downloads| image:: https://anaconda.org/bioconda/bioconductor-fission/badges/downloads.svg
               :target: https://anaconda.org/bioconda/bioconductor-fission
.. |docker| image:: https://quay.io/repository/biocontainers/bioconductor-fission/status
