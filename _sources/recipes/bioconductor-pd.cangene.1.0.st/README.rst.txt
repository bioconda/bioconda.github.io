...
.. conda:recipe:: bioconductor-pd.cangene.1.0.st
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/pd.cangene.1.0.st.html
...
.. conda:package:: bioconductor-pd.cangene.1.0.st
   ...
   :required~by: |required_by_bioconductor-pd.cangene.1.0.st|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-pd.cangene.1.0.st


.. |required_by_bioconductor-pd.cangene.1.0.st| conda:required_by:: bioconductor-pd.cangene.1.0.st
