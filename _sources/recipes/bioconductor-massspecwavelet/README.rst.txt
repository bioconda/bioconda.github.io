...
.. conda:recipe:: bioconductor-massspecwavelet
   ...
   :homepage: https://bioconductor.org/packages/3.8/bioc/html/MassSpecWavelet.html
   :license: LGPL (>= 2)
...
.. conda:package:: bioconductor-massspecwavelet
   ...
   :depends: :conda:package:`libgcc-ng` >=7.3.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-waveslim`  

   :required~by: |required_by_bioconductor-massspecwavelet|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-massspecwavelet


.. |required_by_bioconductor-massspecwavelet| conda:required_by:: bioconductor-massspecwavelet
