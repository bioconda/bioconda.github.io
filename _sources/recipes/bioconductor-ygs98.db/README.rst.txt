...
.. conda:recipe:: bioconductor-ygs98.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/ygs98.db.html
...
.. conda:package:: bioconductor-ygs98.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ygs98.db

   and update with::

      mamba update bioconductor-ygs98.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ygs98.db
