...
.. conda:package:: seqkit
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.13.1-0</code>,  <code>0.13.0-0</code>,  <code>0.12.1-0</code>,  <code>0.12.0-0</code>,  <code>0.11.0-0</code>,  <code>0.10.2-0</code>,  <code>0.10.1-1</code>,  <code>0.10.0-1</code>,  <code>0.9.3-1</code>,  </span></summary>
      

      ``0.13.1-0``,  ``0.13.0-0``,  ``0.12.1-0``,  ``0.12.0-0``,  ``0.11.0-0``,  ``0.10.2-0``,  ``0.10.1-1``,  ``0.10.0-1``,  ``0.9.3-1``,  ``0.9.2-2``,  ``0.9.1-2``,  ``0.9.0-2``,  ``0.8.1-2``,  ``0.8.0-2``,  ``0.8.0-1``,  ``0.8.0-0``,  ``0.7.2-0``,  ``0.7.1-0``,  ``0.7.0-0``,  ``0.6.0-0``,  ``0.5.5-0``,  ``0.5.4-0``,  ``0.5.3-0``,  ``0.5.2-0``,  ``0.5.1-0``,  ``0.5.0-0``,  ``0.4.5-0``,  ``0.4.4-0``,  ``0.4.3-0``,  ``0.3.4.1-0``
