...
.. conda:recipe:: seqkit
   ...
   :links: biotools: :biotools:`seqkit`, usegalaxy-eu: :usegalaxy-eu:`seqkit_head`, usegalaxy-eu: :usegalaxy-eu:`seqkit_stats`, usegalaxy-eu: :usegalaxy-eu:`seqkit_fx2tab`, usegalaxy-eu: :usegalaxy-eu:`seqkit_locate`, usegalaxy-eu: :usegalaxy-eu:`seqkit_translate`, usegalaxy-eu: :usegalaxy-eu:`seqkit_sort`, doi: :doi:`10.1002/imt2.191`
...
.. raw:: html
   ...
   <script>
      var package = "seqkit";
      var versions = ["2.14.0","2.13.0","2.12.0","2.12.0","2.11.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_seqkit"></div>
   <div style="width: 100%" id="platform_plot_seqkit"></div>
   <div style="width: 100%" id="cdf_plot_seqkit"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/seqkit/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_seqkit', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for seqkit
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/seqkit/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_seqkit', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for seqkit
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/seqkit/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_seqkit', spec);
            } catch (err) {
