...
.. conda:recipe:: bioconductor-flowsom
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/FlowSOM.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-flowsom
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.8.0-0</code>,  <code>2.6.0-1</code>,  <code>2.6.0-0</code>,  <code>2.2.0-2</code>,  <code>2.2.0-1</code>,  <code>2.2.0-0</code>,  <code>2.0.0-0</code>,  <code>1.22.0-2</code>,  <code>1.22.0-1</code>,  </span></summary>
      

      ``2.8.0-0``,  ``2.6.0-1``,  ``2.6.0-0``,  ``2.2.0-2``,  ``2.2.0-1``,  ``2.2.0-0``,  ``2.0.0-0``,  ``1.22.0-2``,  ``1.22.0-1``,  ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.16.0-1``,  ``1.14.1-0``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.8.0","2.6.0","2.6.0","2.2.0","2.2.0"];
    </script>
