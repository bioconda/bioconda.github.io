...
.. conda:package:: bioconductor-h5vcdata
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.17.0-0</code>,  <code>2.14.0-1</code>,  <code>2.14.0-0</code>,  <code>2.12.0-0</code>,  <code>2.10.0-1</code>,  <code>2.10.0-0</code>,  <code>2.9.0-0</code>,  <code>2.8.0-0</code>,  <code>2.6.0-0</code>,  </span></summary>
      

      ``2.17.0-0``,  ``2.14.0-1``,  ``2.14.0-0``,  ``2.12.0-0``,  ``2.10.0-1``,  ``2.10.0-0``,  ``2.9.0-0``,  ``2.8.0-0``,  ``2.6.0-0``,  ``2.4.0-1``,  ``2.4.0-0``,  ``2.2.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.17.0","2.14.0","2.14.0","2.12.0","2.10.0"];
    </script>
