...
.. conda:recipe:: bioconductor-antiprofiles
   ...
   :homepage: https://bioconductor.org/packages/3.8/bioc/html/antiProfiles.html
...
.. conda:package:: bioconductor-antiprofiles
   ...
   :depends: :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-locfit` >=1.5 :conda:package:`r-matrixstats` >=0.50.0 

   :required~by: |required_by_bioconductor-antiprofiles|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-antiprofiles


.. |required_by_bioconductor-antiprofiles| conda:required_by:: bioconductor-antiprofiles
