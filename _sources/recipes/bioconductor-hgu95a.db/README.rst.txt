...
.. conda:recipe:: bioconductor-hgu95a.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/hgu95a.db.html
...
.. conda:package:: bioconductor-hgu95a.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hgu95a.db

   and update with::

      mamba update bioconductor-hgu95a.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hgu95a.db
