...
to install globally, run::
    ...
    pixi global install biowdl-input-converter

to add into an existing workspace instead, run::

    pixi add biowdl-input-converter
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname biowdl-input-converter
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_biowdl-input-converter"></div>
   <div style="width: 100%" id="platform_plot_biowdl-input-converter"></div>
   <div style="width: 100%" id="cdf_plot_biowdl-input-converter"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for biowdl-input-converter
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/biowdl-input-converter/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_biowdl-input-converter', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for biowdl-input-converter
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/biowdl-input-converter/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_biowdl-input-converter', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for biowdl-input-converter
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/biowdl-input-converter/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_biowdl-input-converter', spec);
            } catch (err) {
