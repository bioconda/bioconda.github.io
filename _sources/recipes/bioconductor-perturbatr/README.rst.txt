...
.. conda:recipe:: bioconductor-perturbatr
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/perturbatr.html
   :license: GPL-3
...
.. conda:package:: bioconductor-perturbatr
   ...
   :versions:
      ...
      ``1.13.0-0``,  ``1.12.0-0``,  ``1.10.0-1``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-1``,  ``1.4.0-0``,  ``1.2.1-0``
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-perturbatr";
        var versions = ["1.13.0","1.12.0","1.10.0","1.10.0","1.8.0"];
    </script>
