...
.. conda:package:: pango-designation
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.2.51-0</code>,  <code>1.2.50-0</code>,  <code>1.2.47-0</code>,  <code>1.2.46-0</code>,  <code>1.2.44-0</code>,  <code>1.2.43-0</code>,  <code>1.2.42-0</code>,  <code>1.2.41-0</code>,  <code>1.2.39-0</code>,  </span></summary>
      

      ``1.2.51-0``,  ``1.2.50-0``,  ``1.2.47-0``,  ``1.2.46-0``,  ``1.2.44-0``,  ``1.2.43-0``,  ``1.2.42-0``,  ``1.2.41-0``,  ``1.2.39-0``,  ``1.2.38-0``,  ``1.2.37-0``,  ``1.2.36-0``,  ``1.2.34-0``,  ``1.2.33-0``,  ``1.2.32-0``,  ``1.2.29-0``,  ``1.2.27-0``,  ``1.2.26-0``,  ``1.2.25-0``,  ``1.2.23-0``,  ``1.2.22-0``,  ``1.2.21-0``,  ``1.2.20-0``,  ``1.2.18-0``,  ``1.2.14-0``
