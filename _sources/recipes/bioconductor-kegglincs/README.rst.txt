...
.. conda:recipe:: bioconductor-kegglincs
   ...
   :homepage: https://bioconductor.org/packages/3.8/bioc/html/KEGGlincs.html
   :license: GPL-3
...
.. conda:package:: bioconductor-kegglincs
   ...
   :depends: :conda:package:`bioconductor-annotationdbi` >=1.44.0,<1.45.0 :conda:package:`bioconductor-hgu133a.db` >=3.2.0,<3.3.0 :conda:package:`bioconductor-kegggraph` >=1.42.0,<1.43.0 :conda:package:`bioconductor-keggrest` >=1.22.0,<1.23.0 :conda:package:`bioconductor-kodata` >=1.8.0,<1.9.0 :conda:package:`bioconductor-org.hs.eg.db` >=3.7.0,<3.8.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-gtools`  :conda:package:`r-httr`  :conda:package:`r-igraph`  :conda:package:`r-plyr`  :conda:package:`r-rjsonio`  :conda:package:`r-xml`  

   :required~by: |required_by_bioconductor-kegglincs|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-kegglincs


.. |required_by_bioconductor-kegglincs| conda:required_by:: bioconductor-kegglincs
