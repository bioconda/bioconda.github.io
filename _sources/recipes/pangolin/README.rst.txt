...
.. conda:package:: pangolin
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.1.17-1</code>,  <code>3.1.17-0</code>,  <code>3.1.16-2</code>,  <code>3.1.16-1</code>,  <code>3.1.16-0</code>,  <code>3.1.15-0</code>,  <code>3.1.14-1</code>,  <code>3.1.14-0</code>,  <code>3.1.11-2</code>,  </span></summary>
      

      ``3.1.17-1``,  ``3.1.17-0``,  ``3.1.16-2``,  ``3.1.16-1``,  ``3.1.16-0``,  ``3.1.15-0``,  ``3.1.14-1``,  ``3.1.14-0``,  ``3.1.11-2``,  ``3.1.11-1``,  ``3.1.11-0``,  ``3.1.10-0``,  ``3.1.9-0``,  ``3.1.8-0``,  ``3.1.7-0``,  ``3.1.6-0``,  ``3.1.5-0``,  ``3.1.4-0``,  ``3.1.3-0``,  ``3.1.2-0``,  ``3.0.5-0``,  ``3.0.3-0``,  ``2.4.2-1``,  ``2.4.2-0``,  ``2.4-0``,  ``2.3.8-0``,  ``2.3.6-0``,  ``2.3.5-0``,  ``2.3.4-0``,  ``2.3.2-0``,  ``2.3.0-1``,  ``2.3.0-0``,  ``2.2.2-0``,  ``2.2.1-0``,  ``2.1.11-0``,  ``2.1.10-1``,  ``2.1.10-0``,  ``2.1.7-0``,  ``1.1.14-0``,  ``1.1.13-0``,  ``1.1.11-0``,  ``1.1.5-0``,  ``1.1-0``
   ...
   :depends constellations: ``>=0.0.29``
   :depends gofasta: 
   :depends joblib: ``>=0.11``
   :depends minimap2: ``>=2.16``
   :depends pandas: ``>=1.0.1``
   :depends pango-designation: ``>=1.2.109``
   :depends pangolearn: ``>=2021-11-25``
   :depends pulp: ``>=2``
   :depends pysam: ``>=0.16.0``
   :depends python: ``>=3.7``
   :depends scikit-learn: ``0.23.1``
   :depends scorpio: ``>=0.3.15``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["3.1.17","3.1.17","3.1.16","3.1.16","3.1.16"];
    </script>
