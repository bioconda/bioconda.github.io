...
.. conda:package:: pangolin
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.1.11-2</code>,  <code>3.1.11-1</code>,  <code>3.1.11-0</code>,  <code>3.1.10-0</code>,  <code>3.1.9-0</code>,  <code>3.1.8-0</code>,  <code>3.1.7-0</code>,  <code>3.1.6-0</code>,  <code>3.1.5-0</code>,  </span></summary>
      

      ``3.1.11-2``,  ``3.1.11-1``,  ``3.1.11-0``,  ``3.1.10-0``,  ``3.1.9-0``,  ``3.1.8-0``,  ``3.1.7-0``,  ``3.1.6-0``,  ``3.1.5-0``,  ``3.1.4-0``,  ``3.1.3-0``,  ``3.1.2-0``,  ``3.0.5-0``,  ``3.0.3-0``,  ``2.4.2-1``,  ``2.4.2-0``,  ``2.4-0``,  ``2.3.8-0``,  ``2.3.6-0``,  ``2.3.5-0``,  ``2.3.4-0``,  ``2.3.2-0``,  ``2.3.0-1``,  ``2.3.0-0``,  ``2.2.2-0``,  ``2.2.1-0``,  ``2.1.11-0``,  ``2.1.10-1``,  ``2.1.10-0``,  ``2.1.7-0``,  ``1.1.14-0``,  ``1.1.13-0``,  ``1.1.11-0``,  ``1.1.5-0``,  ``1.1-0``
   ...
   :depends pango-designation: ``>=1.2.76``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["3.1.11","3.1.11","3.1.11","3.1.10","3.1.9"];
    </script>
