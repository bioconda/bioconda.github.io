...
.. conda:recipe:: bioconductor-biomartgogenesets
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/BioMartGOGeneSets.html
...
to install globally, run::
    ...
    pixi global install bioconductor-biomartgogenesets

to add into an existing workspace instead, run::

    pixi add bioconductor-biomartgogenesets
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-biomartgogenesets

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-biomartgogenesets
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["0.99.11","0.99.11","0.99.11"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-biomartgogenesets"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-biomartgogenesets"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-biomartgogenesets"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-biomartgogenesets
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-biomartgogenesets/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-biomartgogenesets', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-biomartgogenesets
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-biomartgogenesets/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-biomartgogenesets', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-biomartgogenesets
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-biomartgogenesets/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-biomartgogenesets', spec);
            } catch (err) {
