...
.. conda:recipe:: bioconductor-macpet
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/MACPET.html
   :license: GPL-3
...
.. conda:package:: bioconductor-macpet
   ...
   :versions:
      ...
      ``1.12.0-0``,  ``1.10.0-2``,  ``1.10.0-1``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-1``,  ``1.2.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.12.0","1.10.0","1.10.0","1.10.0","1.8.0"];
    </script>
