...
.. conda:recipe:: bioconductor-pd.mirna.3.0
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/pd.mirna.3.0.html
...
.. conda:package:: bioconductor-pd.mirna.3.0
   ...
   :required~by: |required_by_bioconductor-pd.mirna.3.0|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-pd.mirna.3.0


.. |required_by_bioconductor-pd.mirna.3.0| conda:required_by:: bioconductor-pd.mirna.3.0
