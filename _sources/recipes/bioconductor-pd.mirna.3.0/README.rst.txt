...
.. conda:recipe:: bioconductor-pd.mirna.3.0
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/pd.mirna.3.0.html
...
.. conda:package:: bioconductor-pd.mirna.3.0
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.mirna.3.0

   and update with::

      mamba update bioconductor-pd.mirna.3.0

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.mirna.3.0
