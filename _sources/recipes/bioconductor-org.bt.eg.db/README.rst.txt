...
.. conda:recipe:: bioconductor-org.bt.eg.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/org.Bt.eg.db.html
...
.. conda:package:: bioconductor-org.bt.eg.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-org.bt.eg.db

   and update with::

      mamba update bioconductor-org.bt.eg.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-org.bt.eg.db
