...
.. conda:recipe:: bioconductor-mm24kresogen.db
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/mm24kresogen.db.html
...
.. conda:package:: bioconductor-mm24kresogen.db
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.5.0-14</code>,  <code>2.5.0-13</code>,  <code>2.5.0-12</code>,  <code>2.5.0-11</code>,  <code>2.5.0-10</code>,  <code>2.5.0-9</code>,  <code>2.5.0-8</code>,  <code>2.5.0-7</code>,  <code>2.5.0-6</code>,  </span></summary>
      

      ``2.5.0-14``,  ``2.5.0-13``,  ``2.5.0-12``,  ``2.5.0-11``,  ``2.5.0-10``,  ``2.5.0-9``,  ``2.5.0-8``,  ``2.5.0-7``,  ``2.5.0-6``,  ``2.5.0-5``,  ``2.5.0-4``,  ``2.5.0-3``,  ``2.5.0-2``,  ``2.5.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-mm24kresogen.db

to add into an existing workspace instead, run::

    pixi add bioconductor-mm24kresogen.db
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-mm24kresogen.db
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-mm24kresogen.db"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-mm24kresogen.db"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-mm24kresogen.db"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-mm24kresogen.db
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-mm24kresogen.db/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-mm24kresogen.db', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-mm24kresogen.db
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-mm24kresogen.db/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-mm24kresogen.db', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-mm24kresogen.db
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-mm24kresogen.db/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-mm24kresogen.db', spec);
            } catch (err) {
