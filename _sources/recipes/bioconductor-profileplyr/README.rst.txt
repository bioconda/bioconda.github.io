...
.. conda:recipe:: bioconductor-profileplyr
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/profileplyr.html
   :license: GPL (>= 3)
...
.. conda:package:: bioconductor-profileplyr
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.22.0-0</code>,  <code>1.18.0-0</code>,  <code>1.16.0-0</code>,  <code>1.14.0-0</code>,  <code>1.10.0-0</code>,  <code>1.8.0-0</code>,  <code>1.6.0-1</code>,  <code>1.6.0-0</code>,  <code>1.4.3-0</code>,  </span></summary>
      

      ``1.22.0-0``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-0``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.0-1``,  ``1.6.0-0``,  ``1.4.3-0``,  ``1.2.0-0``,  ``1.0.1-0``
   ...
   :depends on bioconductor-chipseeker: ``>=1.42.0,<1.43.0``
   :depends on bioconductor-complexheatmap: ``>=2.22.0,<2.23.0``
   :depends on bioconductor-enrichedheatmap: ``>=1.36.0,<1.37.0``
   ...
   :depends on bioconductor-org.hs.eg.db: ``>=3.20.0,<3.21.0``
   :depends on bioconductor-org.mm.eg.db: ``>=3.20.0,<3.21.0``
   :depends on bioconductor-rgreat: ``>=2.8.0,<2.9.0``
   ...
   :depends on bioconductor-soggi: ``>=1.38.0,<1.39.0``
   ...
   :depends on bioconductor-txdb.hsapiens.ucsc.hg38.knowngene: ``>=3.20.0,<3.21.0``
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-profileplyr"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-profileplyr"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-profileplyr"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-profileplyr
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-profileplyr/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-profileplyr', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-profileplyr
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-profileplyr/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-profileplyr', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-profileplyr
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-profileplyr/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-profileplyr', spec);
            } catch (err) {
