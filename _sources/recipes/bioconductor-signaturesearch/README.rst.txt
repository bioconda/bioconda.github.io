...
.. conda:recipe:: bioconductor-signaturesearch
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/signatureSearch.html
...
.. conda:package:: bioconductor-signaturesearch
   ...
   :versions:
      ...
      ``1.8.0-0``,  ``1.6.1-0``,  ``1.4.3-0``,  ``1.4.0-0``,  ``1.2.0-0``,  ``1.0.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.8.0","1.6.1","1.4.3","1.4.0","1.2.0"];
    </script>
