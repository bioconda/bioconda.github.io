...
.. conda:package:: bioconductor-clstutils
   ...
   :depends bioconductor-clst: ``>=1.58.0,<1.59.0``
   :depends r-ape: 
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-clstutils

   and update with::

      mamba update bioconductor-clstutils

  To create a new environment, run::

      mamba create --name myenvname bioconductor-clstutils
