...
.. conda:package:: perl-test-cleannamespaces
   ...
   :depends: :conda:package:`perl` >=5.26.2,<5.26.3.0a0 :conda:package:`perl-exporter`  :conda:package:`perl-module-runtime`  :conda:package:`perl-package-stash`  :conda:package:`perl-sub-identify`  

   :required~by: |required_by_perl-test-cleannamespaces|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/perl-test-cleannamespaces


.. |required_by_perl-test-cleannamespaces| conda:required_by:: perl-test-cleannamespaces
