...
.. conda:recipe:: bioconductor-consensusclusterplus
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/ConsensusClusterPlus.html
...
.. conda:package:: bioconductor-consensusclusterplus
   ...
   :versions:
      ...
      ``1.74.0-0``,  ``1.70.0-0``,  ``1.66.0-0``,  ``1.64.0-0``,  ``1.62.0-0``,  ``1.58.0-0``,  ``1.56.0-0``,  ``1.54.0-1``,  ``1.54.0-0``,  ``1.52.0-0``,  ``1.50.0-1``,  ``1.48.0-1``,  ``1.46.0-0``,  ``1.44.0-0``,  ``1.42.0-0``,  ``1.40.0-0``
   ...
   :depends on bioconductor-all: ``>=1.52.0,<1.53.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-consensusclusterplus

to add into an existing workspace instead, run::

    pixi add bioconductor-consensusclusterplus
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-consensusclusterplus
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-consensusclusterplus"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-consensusclusterplus"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-consensusclusterplus"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-consensusclusterplus
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-consensusclusterplus/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-consensusclusterplus', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-consensusclusterplus
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-consensusclusterplus/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-consensusclusterplus', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-consensusclusterplus
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-consensusclusterplus/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-consensusclusterplus', spec);
            } catch (err) {
