...
.. conda:recipe:: bioconductor-pd.ag
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/pd.ag.html
...
.. conda:package:: bioconductor-pd.ag
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.ag

   and update with::

      mamba update bioconductor-pd.ag

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.ag
