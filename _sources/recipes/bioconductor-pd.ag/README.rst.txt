...
.. conda:package:: bioconductor-pd.ag
   ...
   :required~by: |required_by_bioconductor-pd.ag|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-pd.ag


.. |required_by_bioconductor-pd.ag| conda:required_by:: bioconductor-pd.ag
