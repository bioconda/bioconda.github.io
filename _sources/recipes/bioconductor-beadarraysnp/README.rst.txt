...
.. conda:package:: bioconductor-beadarraysnp
   ...
   :depends: :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`bioconductor-quantsmooth` >=1.48.0,<1.49.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-beadarraysnp|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-beadarraysnp


.. |required_by_bioconductor-beadarraysnp| conda:required_by:: bioconductor-beadarraysnp
