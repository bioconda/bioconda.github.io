...
.. conda:package:: bioconductor-beadarraysnp
   ...
   :depends on bioconductor-quantsmooth: ``>=1.68.0,<1.69.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-beadarraysnp

to add into an existing workspace instead, run::

    pixi add bioconductor-beadarraysnp
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-beadarraysnp
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-beadarraysnp"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-beadarraysnp"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-beadarraysnp"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-beadarraysnp
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-beadarraysnp/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-beadarraysnp', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-beadarraysnp
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-beadarraysnp/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-beadarraysnp', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-beadarraysnp
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-beadarraysnp/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-beadarraysnp', spec);
            } catch (err) {
