...
.. conda:recipe:: bioconductor-snplocs.hsapiens.dbsnp150.grch38
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/SNPlocs.Hsapiens.dbSNP150.GRCh38.html
...
.. conda:package:: bioconductor-snplocs.hsapiens.dbsnp150.grch38
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-snplocs.hsapiens.dbsnp150.grch38

   and update with::

      mamba update bioconductor-snplocs.hsapiens.dbsnp150.grch38

  To create a new environment, run::

      mamba create --name myenvname bioconductor-snplocs.hsapiens.dbsnp150.grch38
