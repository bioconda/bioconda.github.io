...
.. conda:package:: seqfu
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.7.0-0</code>,  <code>1.6.3-0</code>,  <code>1.6.0-0</code>,  <code>1.5.2-0</code>,  <code>1.5.0-0</code>,  <code>1.4.0-0</code>,  <code>1.3.6-0</code>,  <code>1.3.3-0</code>,  <code>1.3.2-0</code>,  </span></summary>
      

      ``1.7.0-0``,  ``1.6.3-0``,  ``1.6.0-0``,  ``1.5.2-0``,  ``1.5.0-0``,  ``1.4.0-0``,  ``1.3.6-0``,  ``1.3.3-0``,  ``1.3.2-0``,  ``1.3.1-0``,  ``1.2.3-0``,  ``1.2.1-0``,  ``1.2.0-0``,  ``1.1.0-0``,  ``1.0.0-0``,  ``0.9.6-0``,  ``0.9.5-0``,  ``0.9.1-0``,  ``0.9.0-1``,  ``0.9.0-0``,  ``0.8.13-0``,  ``0.8.12-0``,  ``0.8.11-0``,  ``0.8.10-0``,  ``0.8.8-0``,  ``0.8.7-0``,  ``0.8.5-0``,  ``0.8.2-0``,  ``0.6.0-0``,  ``0.5.1-1``,  ``0.5.1-0``,  ``0.5.0-0``,  ``0.2.0-1``,  ``0.2.0-0``,  ``0.1.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "seqfu";
        var versions = ["1.7.0","1.6.3","1.6.0","1.5.2","1.5.0"];
    </script>
