...
.. conda:package:: rnalien
   ...
   :depends on locarna: ``2.0.0RC8``
   :depends on openssl: ``>=1.1.0,<=1.1.1``
   :depends on perl: 
   :depends on rnacode: ``0.3``
   :depends on rnaz: ``2.1.1``
   :depends on viennarna: ``2.4.13``
   :depends on zlib: 
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname rnalien
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_rnalien"></div>
   <div style="width: 100%" id="platform_plot_rnalien"></div>
   <div style="width: 100%" id="cdf_plot_rnalien"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/rnalien/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_rnalien', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for rnalien
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/rnalien/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_rnalien', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for rnalien
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/rnalien/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_rnalien', spec);
            } catch (err) {
