...
.. conda:package:: bioconductor-qckitfastq
   ...
   :depends bioconductor-rseqan: ``>=1.26.0,<1.27.0``
   :depends bioconductor-rseqan: ``>=1.26.0,<1.27.0a0``
   :depends bioconductor-seqtools: ``>=1.40.0,<1.41.0``
   :depends bioconductor-seqtools: ``>=1.40.0,<1.41.0a0``
