...
.. conda:recipe:: bioconductor-ecolileucine
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/ecoliLeucine.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-ecolileucine
   ...
   :depends on bioconductor-ecolicdf: ``>=2.18.0,<2.19.0``
   :depends on curl: 
...
to install globally, run::
    ...
    pixi global install bioconductor-ecolileucine

to add into an existing workspace instead, run::

    pixi add bioconductor-ecolileucine
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-ecolileucine
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-ecolileucine"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-ecolileucine"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-ecolileucine"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-ecolileucine
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ecolileucine/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-ecolileucine', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-ecolileucine
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ecolileucine/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-ecolileucine', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-ecolileucine
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ecolileucine/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-ecolileucine', spec);
            } catch (err) {
