...
.. conda:package:: r-basejump
   ...
   :versions: 0.11.12-0, 0.11.11-0, 0.11.10-0, 0.11.8-0, 0.11.7-0, 0.11.5-0, 0.10.9-1, 0.10.9-0, 0.9.11-0, 0.9.9-0, 0.7.2-1, 0.7.2-0, 0.5.9-0, 0.5.3-0, 0.1.1-0
   ...
   :depends r-brio: >=0.3.6
   :depends r-dplyr: >=0.8
   :depends r-freerange: >=0.2.4
