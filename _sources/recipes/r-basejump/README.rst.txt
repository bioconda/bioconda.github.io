...
.. conda:package:: r-basejump
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.14.23-0</code>,  <code>0.14.22-0</code>,  <code>0.14.21-0</code>,  <code>0.14.20-0</code>,  <code>0.14.19-0</code>,  <code>0.14.18-0</code>,  <code>0.14.17-2</code>,  <code>0.14.17-1</code>,  <code>0.14.17-0</code>,  </span></summary>
   ...
   :depends r-acidexperiment: ``>=0.2.1``
   :depends r-acidgenerics: ``>=0.5.20``
   :depends r-acidgenomes: ``>=0.2.18``
   :depends r-acidmarkdown: ``>=0.1.3``
   :depends r-acidplyr: ``>=0.1.22``
   :depends r-acidsinglecell: ``>=0.1.8``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.14.23","0.14.22","0.14.21","0.14.20","0.14.19"];
    </script>
