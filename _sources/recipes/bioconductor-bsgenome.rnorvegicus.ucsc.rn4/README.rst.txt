...
.. conda:recipe:: bioconductor-bsgenome.rnorvegicus.ucsc.rn4
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/BSgenome.Rnorvegicus.UCSC.rn4.html
...
.. conda:package:: bioconductor-bsgenome.rnorvegicus.ucsc.rn4
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bsgenome.rnorvegicus.ucsc.rn4

   and update with::

      mamba update bioconductor-bsgenome.rnorvegicus.ucsc.rn4

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bsgenome.rnorvegicus.ucsc.rn4
