...
.. conda:package:: perl-class-data-inheritable
   ...
   or use the docker container::
      ...
      docker pull quay.io/biocontainers/perl-class-data-inheritable:<tag>

   (see `perl-class-data-inheritable/tags`_ for valid values for ``<tag>``)
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.09","0.08","0.08","0.08"];
    </script>
