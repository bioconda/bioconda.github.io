...
.. conda:recipe:: bioconductor-turbonorm
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/TurboNorm.html
   :license: LGPL
...
.. conda:package:: bioconductor-turbonorm
   ...
   :depends on bioconductor-convert: ``>=1.86.0,<1.87.0``
   :depends on bioconductor-convert: ``>=1.86.0,<1.87.0a0``
...
to install globally, run::
    ...
    pixi global install bioconductor-turbonorm

to add into an existing workspace instead, run::

    pixi add bioconductor-turbonorm
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-turbonorm
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-turbonorm"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-turbonorm"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-turbonorm"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-turbonorm
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-turbonorm/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-turbonorm', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-turbonorm
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-turbonorm/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-turbonorm', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-turbonorm
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-turbonorm/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-turbonorm', spec);
            } catch (err) {
