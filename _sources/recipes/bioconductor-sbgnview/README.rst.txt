...
.. conda:recipe:: bioconductor-sbgnview
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/SBGNview.html
   :license: AGPL-3
...
.. conda:package:: bioconductor-sbgnview
   ...
   :versions:
      ...
      ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.1-0``,  ``1.4.0-0``,  ``1.2.0-0``,  ``1.0.0-1``
   ...
   :depends bioconductor-sbgnview.data: ``>=1.8.0,<1.9.0``
