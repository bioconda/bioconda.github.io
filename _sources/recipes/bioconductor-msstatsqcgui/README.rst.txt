...
.. conda:recipe:: bioconductor-msstatsqcgui
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/MSstatsQCgui.html
...
.. conda:package:: bioconductor-msstatsqcgui
   ...
   :depends on bioconductor-msstatsqc: ``>=2.28.0,<2.29.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-msstatsqcgui

to add into an existing workspace instead, run::

    pixi add bioconductor-msstatsqcgui
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-msstatsqcgui
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-msstatsqcgui"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-msstatsqcgui"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-msstatsqcgui"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-msstatsqcgui
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-msstatsqcgui/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-msstatsqcgui', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-msstatsqcgui
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-msstatsqcgui/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-msstatsqcgui', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-msstatsqcgui
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-msstatsqcgui/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-msstatsqcgui', spec);
            } catch (err) {
