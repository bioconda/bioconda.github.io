...
.. conda:recipe:: bioconductor-heebodata
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/experiment/html/HEEBOdata.html
   :license: LGPL
...
.. conda:package:: bioconductor-heebodata
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-heebodata

   and update with::

      mamba update bioconductor-heebodata

  To create a new environment, run::

      mamba create --name myenvname bioconductor-heebodata
