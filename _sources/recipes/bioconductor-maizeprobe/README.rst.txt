...
.. conda:recipe:: bioconductor-maizeprobe
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/maizeprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-maizeprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-maizeprobe

   and update with::

      mamba update bioconductor-maizeprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-maizeprobe
