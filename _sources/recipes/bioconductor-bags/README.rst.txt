...
.. conda:recipe:: bioconductor-bags
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/BAGS.html
...
.. conda:package:: bioconductor-bags
   ...
   :versions:
      ...
      ``2.32.0-0``,  ``2.30.0-2``,  ``2.30.0-0``,  ``2.28.0-0``,  ``2.26.0-1``,  ``2.24.0-1``,  ``2.22.0-0``

      

   
   :depends bioconductor-biobase: ``>=2.52.0,<2.53.0``
   :depends bioconductor-breastcancervdx: ``>=1.30.0,<1.31.0``
