...
.. conda:recipe:: bioconductor-bags
   ...
   :homepage: https://bioconductor.org/packages/3.11/bioc/html/BAGS.html
...
.. conda:package:: bioconductor-bags
   ...
   :versions:
      ...
      ``2.30.0-0``,  ``2.28.0-0``,  ``2.26.0-1``,  ``2.24.0-1``,  ``2.22.0-0``

      

   
   :depends bioconductor-biobase: ``>=2.50.0,<2.51.0``
   :depends bioconductor-breastcancervdx: ``>=1.27.0,<1.28.0``
