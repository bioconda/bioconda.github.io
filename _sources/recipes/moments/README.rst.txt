...
.. conda:package:: moments
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.5.0-0</code>,  <code>1.4.5-0</code>,  <code>1.4.4-0</code>,  <code>1.4.3-0</code>,  <code>1.4.2-0</code>,  <code>1.3.1-0</code>,  <code>1.1.16-4</code>,  <code>1.1.16-3</code>,  <code>1.1.16-2</code>,  </span></summary>
      

      ``1.5.0-0``,  ``1.4.5-0``,  ``1.4.4-0``,  ``1.4.3-0``,  ``1.4.2-0``,  ``1.3.1-0``,  ``1.1.16-4``,  ``1.1.16-3``,  ``1.1.16-2``,  ``1.1.16-1``,  ``1.1.16-0``,  ``1.1.14-0``,  ``1.1.13-0``,  ``1.1.12-1``,  ``1.1.12-0``,  ``1.1.10-1``,  ``1.1.10-0``,  ``1.1.9-2``,  ``1.1.9-1``,  ``1.1.9-0``,  ``1.1.8-1``,  ``1.1.8-0``,  ``1.1.7-0``,  ``1.1.6-0``,  ``1.1.5-0``,  ``1.1.4-0``,  ``1.1.3-0``,  ``1.1.2-0``,  ``1.1.1-0``,  ``1.0.9-1``,  ``1.0.9-0``,  ``1.0.8-1``,  ``1.0.8-0``,  ``1.0.7-0``,  ``1.0.6-1``,  ``1.0.6-0``
...
.. raw:: html
    ...
    <script>
        var package = "moments";
        var versions = ["1.5.0","1.4.5","1.4.4","1.4.3","1.4.2"];
    </script>
