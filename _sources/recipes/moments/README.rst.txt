...
.. conda:package:: moments
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.1.16-0</code>,  <code>1.1.14-0</code>,  <code>1.1.13-0</code>,  <code>1.1.12-1</code>,  <code>1.1.12-0</code>,  <code>1.1.10-1</code>,  <code>1.1.10-0</code>,  <code>1.1.9-2</code>,  <code>1.1.9-1</code>,  </span></summary>
      

      ``1.1.16-0``,  ``1.1.14-0``,  ``1.1.13-0``,  ``1.1.12-1``,  ``1.1.12-0``,  ``1.1.10-1``,  ``1.1.10-0``,  ``1.1.9-2``,  ``1.1.9-1``,  ``1.1.9-0``,  ``1.1.8-1``,  ``1.1.8-0``,  ``1.1.7-0``,  ``1.1.6-0``,  ``1.1.5-0``,  ``1.1.4-0``,  ``1.1.3-0``,  ``1.1.2-0``,  ``1.1.1-0``,  ``1.0.9-1``,  ``1.0.9-0``,  ``1.0.8-1``,  ``1.0.8-0``,  ``1.0.7-0``,  ``1.0.6-1``,  ``1.0.6-0``
...
.. raw:: html
    ...
    <script>
        var package = "moments";
        var versions = ["1.1.16","1.1.14","1.1.13","1.1.12","1.1.12"];
    </script>
