...
.. conda:recipe:: bioconductor-rattoxfxprobe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/rattoxfxprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-rattoxfxprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rattoxfxprobe

   and update with::

      mamba update bioconductor-rattoxfxprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rattoxfxprobe
