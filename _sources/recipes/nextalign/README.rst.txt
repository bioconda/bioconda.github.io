...
.. conda:package:: nextalign
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install nextalign

   and update with::

      mamba update nextalign

  To create a new environment, run::

      mamba create --name myenvname nextalign
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.14.0","2.14.0","2.13.1","2.13.0","2.12.0"];
    </script>
