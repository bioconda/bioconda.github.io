...
.. conda:recipe:: bioconductor-hgfocuscdf
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/hgfocuscdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-hgfocuscdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hgfocuscdf

   and update with::

      mamba update bioconductor-hgfocuscdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hgfocuscdf
