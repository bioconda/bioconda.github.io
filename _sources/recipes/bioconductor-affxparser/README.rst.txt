...
.. conda:recipe:: bioconductor-affxparser
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/affxparser.html
   :license: LGPL (>= 2)
...
.. conda:package:: bioconductor-affxparser
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.70.0-2</code>,  <code>1.70.0-1</code>,  <code>1.70.0-0</code>,  <code>1.66.0-2</code>,  <code>1.66.0-1</code>,  <code>1.66.0-0</code>,  <code>1.64.0-0</code>,  <code>1.62.0-1</code>,  <code>1.62.0-0</code>,  </span></summary>
      

      ``1.70.0-2``,  ``1.70.0-1``,  ``1.70.0-0``,  ``1.66.0-2``,  ``1.66.0-1``,  ``1.66.0-0``,  ``1.64.0-0``,  ``1.62.0-1``,  ``1.62.0-0``,  ``1.60.0-0``,  ``1.58.0-0``,  ``1.56.0-1``,  ``1.56.0-0``,  ``1.54.0-0``,  ``1.52.0-0``,  ``1.50.0-0``,  ``1.48.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.70.0","1.70.0","1.70.0","1.66.0","1.66.0"];
    </script>
