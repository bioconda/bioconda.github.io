...
.. conda:package:: vcf2maf
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.6.19-1</code>,  <code>1.6.19-0</code>,  <code>1.6.18-2</code>,  <code>1.6.18-1</code>,  <code>1.6.18-0</code>,  <code>1.6.17-2</code>,  <code>1.6.17-1</code>,  <code>1.6.17-0</code>,  <code>1.6.16-4</code>,  </span></summary>
      

      ``1.6.19-1``,  ``1.6.19-0``,  ``1.6.18-2``,  ``1.6.18-1``,  ``1.6.18-0``,  ``1.6.17-2``,  ``1.6.17-1``,  ``1.6.17-0``,  ``1.6.16-4``,  ``1.6.16-3``,  ``1.6.16-0``,  ``1.6.15-1``,  ``1.6.15-0``,  ``1.6.14-0``,  ``1.6.12-0``,  ``1.6.8-0``
