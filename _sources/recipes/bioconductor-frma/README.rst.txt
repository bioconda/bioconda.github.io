...
.. conda:recipe:: bioconductor-frma
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/frma.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-frma
   ...
   :versions:
      ...
      ``1.58.0-0``,  ``1.54.0-0``,  ``1.52.0-0``,  ``1.50.0-0``,  ``1.46.0-0``,  ``1.44.0-0``,  ``1.42.0-1``,  ``1.42.0-0``,  ``1.40.0-0``,  ``1.38.0-0``,  ``1.36.0-1``,  ``1.34.0-0``,  ``1.32.0-0``,  ``1.28.0-0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-frma

   and update with::

      mamba update bioconductor-frma

  To create a new environment, run::

      mamba create --name myenvname bioconductor-frma
