...
.. conda:recipe:: bioconductor-hgubeta7.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/hgubeta7.db.html
...
.. conda:package:: bioconductor-hgubeta7.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hgubeta7.db

   and update with::

      mamba update bioconductor-hgubeta7.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hgubeta7.db
