...
.. conda:recipe:: bioconductor-ri16cod.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/ri16cod.db.html
...
.. conda:package:: bioconductor-ri16cod.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ri16cod.db

   and update with::

      mamba update bioconductor-ri16cod.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ri16cod.db
