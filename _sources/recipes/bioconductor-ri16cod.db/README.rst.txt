...
.. conda:recipe:: bioconductor-ri16cod.db
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/ri16cod.db.html
...
to install globally, run::
    ...
    pixi global install bioconductor-ri16cod.db

to add into an existing workspace instead, run::

    pixi add bioconductor-ri16cod.db
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-ri16cod.db
...
For e.g. docker, run::
    ...
    docker pull quay.io/biocontainers/bioconductor-ri16cod.db:<tag>

(see `bioconductor-ri16cod.db/tags`_ for valid values for ``<tag>``).
...
.. _`bioconductor-ri16cod.db/tags`: https://quay.io/repository/biocontainers/bioconductor-ri16cod.db?tab=tags


.. raw:: html

   <script>
      var package = "bioconductor-ri16cod.db";
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-ri16cod.db"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-ri16cod.db"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-ri16cod.db"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-ri16cod.db
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ri16cod.db/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-ri16cod.db', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-ri16cod.db
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ri16cod.db/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-ri16cod.db', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-ri16cod.db
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ri16cod.db/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-ri16cod.db', spec);
            } catch (err) {
