...
.. conda:package:: nanocomp
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.19.3-0</code>,  <code>1.19.1-0</code>,  <code>1.19.0-0</code>,  <code>1.18.0-0</code>,  <code>1.17.0-0</code>,  <code>1.16.1-0</code>,  <code>1.16.0-0</code>,  <code>1.15.1-0</code>,  <code>1.15.0-0</code>,  </span></summary>
      

      ``1.19.3-0``,  ``1.19.1-0``,  ``1.19.0-0``,  ``1.18.0-0``,  ``1.17.0-0``,  ``1.16.1-0``,  ``1.16.0-0``,  ``1.15.1-0``,  ``1.15.0-0``,  ``1.14.1-0``,  ``1.13.1-0``,  ``1.13.0-0``,  ``1.12.0-0``,  ``1.11.3-0``,  ``1.11.2-0``,  ``1.10.1-0``,  ``1.10.0-0``,  ``1.9.2-1``,  ``1.9.2-0``,  ``1.9.1-0``,  ``1.9.0-0``,  ``1.8.0-0``,  ``1.7.0-0``,  ``1.6.0-0``,  ``1.1.0-1``,  ``1.1.0-0``,  ``1.0.0-0``,  ``0.23.1-0``,  ``0.23.0-1``,  ``0.19.0-1``,  ``0.19.0-0``,  ``0.16.0-0``,  ``0.15.0-0``,  ``0.12.4-0``,  ``0.7.0-0``,  ``0.5.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.19.3","1.19.1","1.19.0","1.18.0","1.17.0"];
    </script>
