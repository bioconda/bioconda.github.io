...
.. conda:recipe:: bioconductor-msbackendrawfilereader
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/MsBackendRawFileReader.html
   :license: GPL-3
...
.. conda:package:: bioconductor-msbackendrawfilereader
   ...
   :versions:
      ...
      ``1.16.0-0``,  ``1.8.1-0``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.0.0-0``
   ...
   :depends on bioconductor-rawrr: ``>=1.18.0,<1.19.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-msbackendrawfilereader

to add into an existing workspace instead, run::

    pixi add bioconductor-msbackendrawfilereader
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-msbackendrawfilereader
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.16.0","1.8.1","1.6.0","1.4.0","1.0.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-msbackendrawfilereader"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-msbackendrawfilereader"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-msbackendrawfilereader"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-msbackendrawfilereader
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-msbackendrawfilereader/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-msbackendrawfilereader', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-msbackendrawfilereader
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-msbackendrawfilereader/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-msbackendrawfilereader', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-msbackendrawfilereader
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-msbackendrawfilereader/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-msbackendrawfilereader', spec);
            } catch (err) {
