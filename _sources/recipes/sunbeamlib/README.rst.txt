...
.. conda:package:: sunbeamlib
   ...
   :versions:
      ...
      ``5.1.0-0``,  ``5.0.5-0``,  ``5.0.4-0``,  ``5.0.1-0``

      

   
   :depends more-itertools: ``10.7.0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install sunbeamlib

   and update with::

      mamba update sunbeamlib

  To create a new environment, run::

      mamba create --name myenvname sunbeamlib
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["5.1.0","5.0.5","5.0.4","5.0.1"];
    </script>
