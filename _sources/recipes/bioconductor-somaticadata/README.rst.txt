...
.. conda:recipe:: bioconductor-somaticadata
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/SomatiCAData.html
...
.. conda:package:: bioconductor-somaticadata
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-somaticadata

   and update with::

      mamba update bioconductor-somaticadata

  To create a new environment, run::

      mamba create --name myenvname bioconductor-somaticadata
