...
============= ===========
Home          http://bioconductor.org/packages/3.7/bioc/html/sizepower.html
Versions      1.46.0, 1.48.0, 1.50.0
License       LGPL
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes/bioconductor-sizepower
...
A Docker container is available at https://quay.io/repository/biocontainers/bioconductor-sizepower.
...
Render an |badge| badge with the following Markdown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square)](http://bioconda.github.io/recipes/bioconductor-sizepower/README.html)

.. |badge| image:: https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square
           :target: http://bioconda.github.io/recipes/bioconductor-sizepower/README.html
.. |downloads| image:: https://anaconda.org/bioconda/bioconductor-sizepower/badges/downloads.svg
               :target: https://anaconda.org/bioconda/bioconductor-sizepower
.. |docker| image:: https://quay.io/repository/biocontainers/bioconductor-sizepower/status
