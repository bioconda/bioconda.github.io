...
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes//fusion-filter/meta.yaml
...
A Docker container is available at https://quay.io/repository/biocontainers/fusion-filter.
...
Render an |badge| badge with the following Markdown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square)](http://bioconda.github.io/recipes/fusion-filter/README.html)

.. |badge| image:: https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square
           :target: http://bioconda.github.io/recipes/fusion-filter/README.html
.. |downloads| image:: https://anaconda.org/bioconda/fusion-filter/badges/downloads.svg
               :target: https://anaconda.org/bioconda/fusion-filter
.. |docker| image:: https://quay.io/repository/biocontainers/fusion-filter/status
