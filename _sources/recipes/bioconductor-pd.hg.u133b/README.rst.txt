...
.. conda:recipe:: bioconductor-pd.hg.u133b
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/pd.hg.u133b.html
...
.. conda:package:: bioconductor-pd.hg.u133b
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.hg.u133b

   and update with::

      mamba update bioconductor-pd.hg.u133b

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.hg.u133b
