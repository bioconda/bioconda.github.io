...
.. conda:package:: ucsc-fatotwobit
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>482-0</code>,  <code>480-0</code>,  <code>472-1</code>,  <code>472-0</code>,  <code>469-2</code>,  <code>469-1</code>,  <code>469-0</code>,  <code>455-2</code>,  <code>455-1</code>,  </span></summary>
      

      ``482-0``,  ``480-0``,  ``472-1``,  ``472-0``,  ``469-2``,  ``469-1``,  ``469-0``,  ``455-2``,  ``455-1``,  ``455-0``,  ``447-0``,  ``377-5``,  ``377-4``,  ``377-3``,  ``377-2``,  ``377-1``,  ``366-1``,  ``366-0``,  ``357-4``,  ``357-3``,  ``357-2``,  ``357-1``,  ``357-0``,  ``353-0``,  ``332-0``,  ``324-2``,  ``324-0``
...
to install globally, run::
    ...
    pixi global install ucsc-fatotwobit

to add into an existing workspace instead, run::

    pixi add ucsc-fatotwobit
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname ucsc-fatotwobit
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["482","480","472","472","469"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_ucsc-fatotwobit"></div>
   <div style="width: 100%" id="platform_plot_ucsc-fatotwobit"></div>
   <div style="width: 100%" id="cdf_plot_ucsc-fatotwobit"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for ucsc-fatotwobit
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/ucsc-fatotwobit/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_ucsc-fatotwobit', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for ucsc-fatotwobit
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/ucsc-fatotwobit/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_ucsc-fatotwobit', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for ucsc-fatotwobit
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/ucsc-fatotwobit/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_ucsc-fatotwobit', spec);
            } catch (err) {
