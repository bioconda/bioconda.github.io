...
.. conda:recipe:: bioconductor-pd.chicken
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/pd.chicken.html
...
.. conda:package:: bioconductor-pd.chicken
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.chicken

   and update with::

      mamba update bioconductor-pd.chicken

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.chicken
