...
.. conda:recipe:: scaffold_builder
   ...
   :homepage: https://github.com/metageni/Scaffold_builder
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["3.0.1","2.3","2.2","2.2"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_scaffold_builder"></div>
   <div style="width: 100%" id="platform_plot_scaffold_builder"></div>
   <div style="width: 100%" id="cdf_plot_scaffold_builder"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for scaffold_builder
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/scaffold_builder/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_scaffold_builder', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for scaffold_builder
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/scaffold_builder/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_scaffold_builder', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for scaffold_builder
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/scaffold_builder/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_scaffold_builder', spec);
            } catch (err) {
