...
.. conda:recipe:: bioconductor-jctseqdata
   ...
   :homepage: https://bioconductor.org/packages/3.12/data/experiment/html/JctSeqData.html
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-jctseqdata";
        var versions = ["1.20.0","1.20.0","1.19.0","1.18.0","1.16.0"];
    </script>
