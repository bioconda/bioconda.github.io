...
.. conda:recipe:: bioconductor-peacoqc
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/PeacoQC.html
   :license: GPL (>=3)
...
.. conda:package:: bioconductor-peacoqc
   ...
   :versions:
      ...
      ``1.20.0-0``,  ``1.16.0-0``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.4.0-0``,  ``1.2.0-0``,  ``0.99.25-2``,  ``0.99.25-1``
...
to install globally, run::
    ...
    pixi global install bioconductor-peacoqc

to add into an existing workspace instead, run::

    pixi add bioconductor-peacoqc
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-peacoqc
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-peacoqc"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-peacoqc"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-peacoqc"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-peacoqc
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-peacoqc/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-peacoqc', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-peacoqc
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-peacoqc/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-peacoqc', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-peacoqc
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-peacoqc/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-peacoqc', spec);
            } catch (err) {
