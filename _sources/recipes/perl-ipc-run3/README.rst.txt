...
.. conda:package:: perl-ipc-run3
   ...
   :depends: :conda:package:`perl` >=5.26.2,<5.26.3.0a0 :conda:package:`perl-time-hires`  

   :required~by: |required_by_perl-ipc-run3|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/perl-ipc-run3


.. |required_by_perl-ipc-run3| conda:required_by:: perl-ipc-run3
