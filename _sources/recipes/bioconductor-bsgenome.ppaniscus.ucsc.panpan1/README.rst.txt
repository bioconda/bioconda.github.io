...
.. conda:recipe:: bioconductor-bsgenome.ppaniscus.ucsc.panpan1
   ...
   :homepage: https://bioconductor.org/packages/3.13/data/annotation/html/BSgenome.Ppaniscus.UCSC.panPan1.html
...
.. conda:package:: bioconductor-bsgenome.ppaniscus.ucsc.panpan1
   ...
   :versions:
      ...
      ``1.4.3-3``,  ``1.4.3-2``,  ``1.4.3-1``,  ``1.4.3-0``
   ...
   and update with::
      ...
      conda update bioconductor-bsgenome.ppaniscus.ucsc.panpan1
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.4.3","1.4.3","1.4.3","1.4.3"];
    </script>
