...
.. conda:package:: clumppling
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.0.10-0</code>,  <code>2.0.7-0</code>,  <code>2.0.6-0</code>,  <code>2.0.5-0</code>,  <code>2.0.4-0</code>,  <code>2.0.1-0</code>,  <code>2.0.0-0</code>,  <code>1.5.0-0</code>,  <code>1.3.0-0</code>,  </span></summary>
      

      ``2.0.10-0``,  ``2.0.7-0``,  ``2.0.6-0``,  ``2.0.5-0``,  ``2.0.4-0``,  ``2.0.1-0``,  ``2.0.0-0``,  ``1.5.0-0``,  ``1.3.0-0``,  ``1.2.0-0``,  ``1.1.3-0``,  ``1.0.2-0``,  ``1.0.1-0``,  ``1.0.0-0``,  ``0.3.2-0``
...
to install globally, run::
    ...
    pixi global install clumppling
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install clumppling

Alternatively, to install into a new environment, run::

    conda create -n envname clumppling
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["2.0.10","2.0.7","2.0.6","2.0.5","2.0.4"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_clumppling"></div>
   <div style="width: 100%" id="platform_plot_clumppling"></div>
   <div style="width: 100%" id="cdf_plot_clumppling"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/clumppling/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_clumppling', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for clumppling
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/clumppling/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_clumppling', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for clumppling
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/clumppling/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_clumppling', spec);
            } catch (err) {
