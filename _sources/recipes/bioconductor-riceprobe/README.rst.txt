...
.. conda:recipe:: bioconductor-riceprobe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/riceprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-riceprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-riceprobe

   and update with::

      mamba update bioconductor-riceprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-riceprobe
