...
.. conda:recipe:: bioconductor-pd.rhesus
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/pd.rhesus.html
...
.. conda:package:: bioconductor-pd.rhesus
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.rhesus

   and update with::

      mamba update bioconductor-pd.rhesus

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.rhesus
