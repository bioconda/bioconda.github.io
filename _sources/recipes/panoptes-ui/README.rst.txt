...
.. conda:package:: panoptes-ui
   ...
   :versions:
      ...
      ``1.3.0-0``,  ``1.1.5-0``,  ``1.1.3-0``,  ``1.1.1-0``,  ``1.0.0-0``,  ``0.2.3-0``,  ``0.2.2-0``,  ``0.2.0-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.3.0","1.1.5","1.1.3","1.1.1","1.0.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_panoptes-ui"></div>
   <div style="width: 100%" id="platform_plot_panoptes-ui"></div>
   <div style="width: 100%" id="cdf_plot_panoptes-ui"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for panoptes-ui
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/panoptes-ui/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_panoptes-ui', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for panoptes-ui
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/panoptes-ui/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_panoptes-ui', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for panoptes-ui
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/panoptes-ui/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_panoptes-ui', spec);
            } catch (err) {
