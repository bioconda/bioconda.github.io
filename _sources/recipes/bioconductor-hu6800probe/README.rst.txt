...
.. conda:recipe:: bioconductor-hu6800probe
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/hu6800probe.html
   :license: LGPL
...
.. conda:package:: bioconductor-hu6800probe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hu6800probe

   and update with::

      mamba update bioconductor-hu6800probe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hu6800probe
