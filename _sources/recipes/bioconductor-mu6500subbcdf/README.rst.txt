...
.. conda:recipe:: bioconductor-mu6500subbcdf
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/mu6500subbcdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-mu6500subbcdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mu6500subbcdf

   and update with::

      mamba update bioconductor-mu6500subbcdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mu6500subbcdf
