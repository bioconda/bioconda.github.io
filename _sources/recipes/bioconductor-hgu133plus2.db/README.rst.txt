...
.. conda:recipe:: bioconductor-hgu133plus2.db
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/hgu133plus2.db.html
...
.. conda:package:: bioconductor-hgu133plus2.db
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.13.0-6</code>,  <code>3.13.0-5</code>,  <code>3.13.0-4</code>,  <code>3.13.0-3</code>,  <code>3.13.0-2</code>,  <code>3.13.0-1</code>,  <code>3.13.0-0</code>,  <code>3.2.3-11</code>,  <code>3.2.3-10</code>,  </span></summary>
      

      ``3.13.0-6``,  ``3.13.0-5``,  ``3.13.0-4``,  ``3.13.0-3``,  ``3.13.0-2``,  ``3.13.0-1``,  ``3.13.0-0``,  ``3.2.3-11``,  ``3.2.3-10``,  ``3.2.3-9``,  ``3.2.3-8``,  ``3.2.3-7``,  ``3.2.3-6``,  ``3.2.3-4``,  ``3.2.3-3``,  ``3.2.3-1``,  ``3.2.3-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-hgu133plus2.db

to add into an existing workspace instead, run::

    pixi add bioconductor-hgu133plus2.db
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-hgu133plus2.db
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-hgu133plus2.db"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-hgu133plus2.db"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-hgu133plus2.db"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-hgu133plus2.db
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hgu133plus2.db/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-hgu133plus2.db', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-hgu133plus2.db
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hgu133plus2.db/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-hgu133plus2.db', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-hgu133plus2.db
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hgu133plus2.db/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-hgu133plus2.db', spec);
            } catch (err) {
