...
.. conda:recipe:: bioconductor-dirichletmultinomial
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/DirichletMultinomial.html
   :license: LGPL-3
...
.. conda:package:: bioconductor-dirichletmultinomial
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.40.0-0</code>,  <code>1.36.0-3</code>,  <code>1.36.0-2</code>,  <code>1.36.0-1</code>,  <code>1.36.0-0</code>,  <code>1.34.0-0</code>,  <code>1.32.0-1</code>,  <code>1.32.0-0</code>,  <code>1.30.0-0</code>,  </span></summary>
      

      ``1.40.0-0``,  ``1.36.0-3``,  ``1.36.0-2``,  ``1.36.0-1``,  ``1.36.0-0``,  ``1.34.0-0``,  ``1.32.0-1``,  ``1.32.0-0``,  ``1.30.0-0``,  ``1.28.0-0``,  ``1.26.0-1``,  ``1.24.1-0``,  ``1.24.0-0``,  ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.16.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.40.0","1.36.0","1.36.0","1.36.0","1.36.0"];
    </script>
