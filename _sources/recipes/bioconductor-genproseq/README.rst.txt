...
.. conda:recipe:: bioconductor-genproseq
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/GenProSeq.html
...
.. conda:package:: bioconductor-genproseq
   ...
   :versions:
      ...
      ``1.14.0-0``,  ``1.10.0-0``,  ``1.6.0-0``,  ``1.4.2-0``,  ``1.2.0-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.14.0","1.10.0","1.6.0","1.4.2","1.2.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-genproseq"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-genproseq"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-genproseq"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-genproseq
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-genproseq/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-genproseq', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-genproseq
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-genproseq/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-genproseq', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-genproseq
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-genproseq/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-genproseq', spec);
            } catch (err) {
