...
.. conda:recipe:: bioconductor-genproseq
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/GenProSeq.html
...
.. conda:package:: bioconductor-genproseq
   ...
   :depends bioconductor-deeppincs: ``>=1.18.0,<1.19.0``
   :depends bioconductor-ttgsea: ``>=1.18.0,<1.19.0``
