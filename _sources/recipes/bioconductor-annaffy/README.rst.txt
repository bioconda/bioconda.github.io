...
.. conda:package:: bioconductor-annaffy
   ...
   :depends: :conda:package:`bioconductor-annotationdbi` >=1.44.0,<1.45.0 :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`bioconductor-go.db` >=3.7.0,<3.8.0 :conda:package:`bioconductor-kegg.db` >=3.2.0,<3.3.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-dbi`  

   :required~by: |required_by_bioconductor-annaffy|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-annaffy


.. |required_by_bioconductor-annaffy| conda:required_by:: bioconductor-annaffy
