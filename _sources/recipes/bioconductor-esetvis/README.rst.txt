...
.. conda:recipe:: bioconductor-esetvis
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/esetVis.html
   :license: GPL-3
...
.. conda:package:: bioconductor-esetvis
   ...
   :versions:
      ...
      ``1.18.0-0``,  ``1.16.0-1``,  ``1.16.0-0``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.0-1``,  ``1.8.0-0``,  ``1.6.3-0``,  ``1.4.0-0``

      

   
   :depends bioconductor-biobase: ``>=2.52.0,<2.53.0``
   :depends bioconductor-mlp: ``>=1.40.0,<1.41.0``
