...
.. conda:recipe:: bioconductor-cnvgsadata
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/experiment/html/cnvGSAdata.html
   :license: LGPL
...
.. conda:package:: bioconductor-cnvgsadata
   ...
   :depends bioconductor-cnvgsa: ``>=1.46.0,<1.47.0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-cnvgsadata

   and update with::

      mamba update bioconductor-cnvgsadata

  To create a new environment, run::

      mamba create --name myenvname bioconductor-cnvgsadata
