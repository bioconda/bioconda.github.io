...
.. conda:package:: bioconductor-shdz.db
   ...
   :required~by: |required_by_bioconductor-shdz.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-shdz.db


.. |required_by_bioconductor-shdz.db| conda:required_by:: bioconductor-shdz.db
