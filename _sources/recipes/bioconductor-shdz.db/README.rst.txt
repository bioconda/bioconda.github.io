...
.. conda:recipe:: bioconductor-shdz.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/SHDZ.db.html
...
.. conda:package:: bioconductor-shdz.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-shdz.db

   and update with::

      mamba update bioconductor-shdz.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-shdz.db
