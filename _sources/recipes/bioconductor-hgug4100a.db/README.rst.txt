...
.. conda:recipe:: bioconductor-hgug4100a.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/hgug4100a.db.html
...
.. conda:package:: bioconductor-hgug4100a.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hgug4100a.db

   and update with::

      mamba update bioconductor-hgug4100a.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hgug4100a.db
