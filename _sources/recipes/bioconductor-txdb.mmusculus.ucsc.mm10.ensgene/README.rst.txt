...
.. conda:recipe:: bioconductor-txdb.mmusculus.ucsc.mm10.ensgene
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/TxDb.Mmusculus.UCSC.mm10.ensGene.html
...
.. conda:package:: bioconductor-txdb.mmusculus.ucsc.mm10.ensgene
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.4.0-19</code>,  <code>3.4.0-18</code>,  <code>3.4.0-17</code>,  <code>3.4.0-16</code>,  <code>3.4.0-15</code>,  <code>3.4.0-14</code>,  <code>3.4.0-13</code>,  <code>3.4.0-12</code>,  <code>3.4.0-11</code>,  </span></summary>
      

      ``3.4.0-19``,  ``3.4.0-18``,  ``3.4.0-17``,  ``3.4.0-16``,  ``3.4.0-15``,  ``3.4.0-14``,  ``3.4.0-13``,  ``3.4.0-12``,  ``3.4.0-11``,  ``3.4.0-10``,  ``3.4.0-9``,  ``3.4.0-8``,  ``3.4.0-7``,  ``3.4.0-5``,  ``3.4.0-4``,  ``3.4.0-3``,  ``3.4.0-1``,  ``3.4.0-0``,  ``3.2.2-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-txdb.mmusculus.ucsc.mm10.ensgene

to add into an existing workspace instead, run::

    pixi add bioconductor-txdb.mmusculus.ucsc.mm10.ensgene
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-txdb.mmusculus.ucsc.mm10.ensgene
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-txdb.mmusculus.ucsc.mm10.ensgene"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-txdb.mmusculus.ucsc.mm10.ensgene"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-txdb.mmusculus.ucsc.mm10.ensgene"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-txdb.mmusculus.ucsc.mm10.ensgene
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.mmusculus.ucsc.mm10.ensgene/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-txdb.mmusculus.ucsc.mm10.ensgene', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-txdb.mmusculus.ucsc.mm10.ensgene
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.mmusculus.ucsc.mm10.ensgene/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-txdb.mmusculus.ucsc.mm10.ensgene', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-txdb.mmusculus.ucsc.mm10.ensgene
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.mmusculus.ucsc.mm10.ensgene/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-txdb.mmusculus.ucsc.mm10.ensgene', spec);
            } catch (err) {
