...
.. conda:package:: hmftools-purple
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>4.1_beta-2</code>,  <code>4.1_beta-1</code>,  <code>4.1_beta-0</code>,  <code>4.0.2-0</code>,  <code>4.0.1-0</code>,  <code>4.0-0</code>,  <code>3.7.1-0</code>,  <code>3.6-0</code>,  <code>3.5-0</code>,  </span></summary>
      

      ``4.1_beta-2``,  ``4.1_beta-1``,  ``4.1_beta-0``,  ``4.0.2-0``,  ``4.0.1-0``,  ``4.0-0``,  ``3.7.1-0``,  ``3.6-0``,  ``3.5-0``,  ``3.4-0``,  ``3.2-0``,  ``3.1-0``,  ``2.54-0``,  ``2.53-1``,  ``2.53-0``,  ``2.52-0``,  ``2.51-1``,  ``2.51-0``,  ``2.50-0``,  ``2.48-0``,  ``2.47-1``,  ``2.47-0``,  ``2.46-0``,  ``2.45-0``,  ``2.44-0``,  ``2.43-0``,  ``2.41-0``,  ``2.40-0``,  ``2.39-0``,  ``2.38-0``,  ``2.37-0``,  ``2.36-0``,  ``2.35-0``,  ``2.34-0``,  ``2.32-0``,  ``2.31-0``,  ``2.25-1``,  ``2.17-1``,  ``2.16-1``,  ``2.16-0``,  ``2.15-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["4.1_beta","4.1_beta","4.1_beta","4.0.2","4.0.1"];
    </script>
