...
.. conda:recipe:: bioconductor-piano
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/piano.html
   :license: GPL (>=2)
...
.. conda:package:: bioconductor-piano
   ...
   :versions:
      ...
      ``2.26.0-0``,  ``2.22.0-0``,  ``2.18.0-0``,  ``2.16.0-0``,  ``2.14.0-0``,  ``2.10.0-0``,  ``2.8.0-0``,  ``2.6.0-1``,  ``2.6.0-0``,  ``2.4.0-0``,  ``2.2.0-0``,  ``2.0.2-0``,  ``1.22.0-0``,  ``1.20.1-0``,  ``1.18.0-0``,  ``1.16.4-0``,  ``1.12.1-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-piano

to add into an existing workspace instead, run::

    pixi add bioconductor-piano
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-piano
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-piano"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-piano"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-piano"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-piano
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-piano/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-piano', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-piano
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-piano/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-piano', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-piano
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-piano/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-piano', spec);
            } catch (err) {
