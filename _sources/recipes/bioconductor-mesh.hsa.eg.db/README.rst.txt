...
.. conda:package:: bioconductor-mesh.hsa.eg.db
   ...
   :required~by: |required_by_bioconductor-mesh.hsa.eg.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-mesh.hsa.eg.db


.. |required_by_bioconductor-mesh.hsa.eg.db| conda:required_by:: bioconductor-mesh.hsa.eg.db
