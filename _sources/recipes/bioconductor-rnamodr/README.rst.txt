...
.. conda:recipe:: bioconductor-rnamodr
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/RNAmodR.html
...
.. conda:package:: bioconductor-rnamodr
   ...
   :versions:
      ...
      ``1.12.0-0``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.2-0``,  ``1.4.0-0``,  ``1.2.1-0``,  ``1.0.0-0``
   ...
   :depends bioconductor-modstrings: ``>=1.14.0,<1.15.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.12.0","1.8.0","1.6.0","1.4.2","1.4.0"];
    </script>
