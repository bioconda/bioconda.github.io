...
.. conda:recipe:: bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/TxDb.Hsapiens.UCSC.hg19.lincRNAsTranscripts.html
...
.. conda:package:: bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.2.2-20</code>,  <code>3.2.2-19</code>,  <code>3.2.2-18</code>,  <code>3.2.2-17</code>,  <code>3.2.2-16</code>,  <code>3.2.2-15</code>,  <code>3.2.2-14</code>,  <code>3.2.2-13</code>,  <code>3.2.2-12</code>,  </span></summary>
      

      ``3.2.2-20``,  ``3.2.2-19``,  ``3.2.2-18``,  ``3.2.2-17``,  ``3.2.2-16``,  ``3.2.2-15``,  ``3.2.2-14``,  ``3.2.2-13``,  ``3.2.2-12``,  ``3.2.2-11``,  ``3.2.2-10``,  ``3.2.2-9``,  ``3.2.2-8``,  ``3.2.2-6``,  ``3.2.2-5``,  ``3.2.2-3``,  ``3.2.2-2``
...
to install globally, run::
    ...
    pixi global install bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts

to add into an existing workspace instead, run::

    pixi add bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-txdb.hsapiens.ucsc.hg19.lincrnastranscripts', spec);
            } catch (err) {
