...
.. conda:recipe:: bioconductor-partheenmetadata.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/PartheenMetaData.db.html
...
.. conda:package:: bioconductor-partheenmetadata.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-partheenmetadata.db

   and update with::

      mamba update bioconductor-partheenmetadata.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-partheenmetadata.db
