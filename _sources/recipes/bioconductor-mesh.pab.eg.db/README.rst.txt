...
.. conda:package:: bioconductor-mesh.pab.eg.db
   ...
   :required~by: |required_by_bioconductor-mesh.pab.eg.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-mesh.pab.eg.db


.. |required_by_bioconductor-mesh.pab.eg.db| conda:required_by:: bioconductor-mesh.pab.eg.db
