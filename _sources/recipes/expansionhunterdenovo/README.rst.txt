...
.. conda:recipe:: expansionhunterdenovo
   ...
   :documentation: https://github.com/Illumina/ExpansionHunterDenovo/blob/v0.9.0/documentation/00_Introduction.md
...
.. conda:package:: expansionhunterdenovo
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.9.0-11</code>,  <code>0.9.0-10</code>,  <code>0.9.0-9</code>,  <code>0.9.0-8</code>,  <code>0.9.0-7</code>,  <code>0.9.0-6</code>,  <code>0.9.0-5</code>,  <code>0.9.0-4</code>,  <code>0.9.0-3</code>,  </span></summary>
      

      ``0.9.0-11``,  ``0.9.0-10``,  ``0.9.0-9``,  ``0.9.0-8``,  ``0.9.0-7``,  ``0.9.0-6``,  ``0.9.0-5``,  ``0.9.0-4``,  ``0.9.0-3``,  ``0.9.0-2``,  ``0.9.0-1``,  ``0.9.0-0``
...
to install globally, run::
    ...
    pixi global install expansionhunterdenovo

to add into an existing workspace instead, run::

    pixi add expansionhunterdenovo
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname expansionhunterdenovo
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_expansionhunterdenovo"></div>
   <div style="width: 100%" id="platform_plot_expansionhunterdenovo"></div>
   <div style="width: 100%" id="cdf_plot_expansionhunterdenovo"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for expansionhunterdenovo
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/expansionhunterdenovo/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_expansionhunterdenovo', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for expansionhunterdenovo
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/expansionhunterdenovo/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_expansionhunterdenovo', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for expansionhunterdenovo
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/expansionhunterdenovo/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_expansionhunterdenovo', spec);
            } catch (err) {
