...
.. conda:recipe:: bioconductor-variantexperiment
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/VariantExperiment.html
   :license: GPL-3
...
.. conda:package:: bioconductor-variantexperiment
   ...
   :depends bioconductor-delayeddataframe: ``>=1.14.0,<1.15.0``
   :depends bioconductor-gdsarray: ``>=1.18.0,<1.19.0``
