...
.. conda:recipe:: bioconductor-epitxdb.mm.mm10
   ...
   :homepage: https://bioconductor.org/packages/3.13/data/annotation/html/EpiTxDb.Mm.mm10.html
...
.. conda:package:: bioconductor-epitxdb.mm.mm10
   ...
   :versions:
      ...
      ``0.99.6-3``,  ``0.99.6-2``,  ``0.99.6-1``,  ``0.99.6-0``,  ``0.99.4-0``
   ...
   and update with::
      ...
      conda update bioconductor-epitxdb.mm.mm10
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.99.6","0.99.6","0.99.6","0.99.6","0.99.4"];
    </script>
