...
.. conda:recipe:: bioconductor-xtropicalisprobe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/xtropicalisprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-xtropicalisprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-xtropicalisprobe

   and update with::

      mamba update bioconductor-xtropicalisprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-xtropicalisprobe
