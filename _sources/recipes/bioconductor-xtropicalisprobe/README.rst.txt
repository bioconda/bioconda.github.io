...
.. conda:recipe:: bioconductor-xtropicalisprobe
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/xtropicalisprobe.html
   :license: LGPL
...
to install globally, run::
    ...
    pixi global install bioconductor-xtropicalisprobe

to add into an existing workspace instead, run::

    pixi add bioconductor-xtropicalisprobe
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-xtropicalisprobe
...
.. _`bioconductor-xtropicalisprobe/tags`: https://quay.io/repository/biocontainers/bioconductor-xtropicalisprobe?tab=tags


.. raw:: html

   <script>
      var package = "bioconductor-xtropicalisprobe";
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-xtropicalisprobe"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-xtropicalisprobe"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-xtropicalisprobe"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-xtropicalisprobe
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-xtropicalisprobe/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-xtropicalisprobe', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-xtropicalisprobe
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-xtropicalisprobe/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-xtropicalisprobe', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-xtropicalisprobe
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-xtropicalisprobe/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-xtropicalisprobe', spec);
            } catch (err) {
