...
.. conda:recipe:: bioconductor-pd.mu11ksuba
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/pd.mu11ksuba.html
...
.. conda:package:: bioconductor-pd.mu11ksuba
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.mu11ksuba

   and update with::

      mamba update bioconductor-pd.mu11ksuba

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.mu11ksuba
