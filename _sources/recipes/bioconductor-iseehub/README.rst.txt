...
.. conda:recipe:: bioconductor-iseehub
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/iSEEhub.html
...
.. conda:package:: bioconductor-iseehub
   ...
   :versions:
      ...
      ``1.12.0-0``,  ``1.8.0-0``,  ``1.4.0-0``,  ``1.1.1-0``,  ``1.0.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-iseehub

to add into an existing workspace instead, run::

    pixi add bioconductor-iseehub
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-iseehub
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.12.0","1.8.0","1.4.0","1.1.1","1.0.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-iseehub"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-iseehub"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-iseehub"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-iseehub
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-iseehub/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-iseehub', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-iseehub
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-iseehub/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-iseehub', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-iseehub
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-iseehub/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-iseehub', spec);
            } catch (err) {
