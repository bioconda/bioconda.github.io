...
.. conda:package:: python-edlib
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.3.9-3</code>,  <code>1.3.9-2</code>,  <code>1.3.9-1</code>,  <code>1.3.9-0</code>,  <code>1.3.8.post2-1</code>,  <code>1.3.8.post2-0</code>,  <code>1.3.8.post1-2</code>,  <code>1.3.8.post1-1</code>,  <code>1.3.8.post1-0</code>,  </span></summary>
      

      ``1.3.9-3``,  ``1.3.9-2``,  ``1.3.9-1``,  ``1.3.9-0``,  ``1.3.8.post2-1``,  ``1.3.8.post2-0``,  ``1.3.8.post1-2``,  ``1.3.8.post1-1``,  ``1.3.8.post1-0``,  ``1.3.7-0``,  ``1.3.6-0``,  ``1.3.5-0``,  ``1.3.4-0``,  ``1.2.4.post1-0``,  ``1.2.4-0``,  ``1.2.3.post1-0``,  ``1.2.3-1``,  ``1.2.3-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.3.9","1.3.9","1.3.9","1.3.9","1.3.8.post2"];
    </script>
