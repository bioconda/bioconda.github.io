...
.. conda:recipe:: bioconductor-go.db
   ...
   :homepage: https://bioconductor.org/packages/3.14/data/annotation/html/GO.db.html
...
.. conda:package:: bioconductor-go.db
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.16.0-0</code>,  <code>3.14.0-1</code>,  <code>3.14.0-0</code>,  <code>3.13.0-0</code>,  <code>3.12.1-1</code>,  <code>3.12.1-0</code>,  <code>3.11.4-0</code>,  <code>3.11.1-0</code>,  <code>3.10.0-0</code>,  </span></summary>
      

      ``3.16.0-0``,  ``3.14.0-1``,  ``3.14.0-0``,  ``3.13.0-0``,  ``3.12.1-1``,  ``3.12.1-0``,  ``3.11.4-0``,  ``3.11.1-0``,  ``3.10.0-0``,  ``3.8.2-1``,  ``3.7.0-0``,  ``3.6.0-0``,  ``3.5.0-1``,  ``3.5.0-0``,  ``3.4.2-0``,  ``3.4.1-0``,  ``3.4.0-0``,  ``3.3.0-0``,  ``3.2.2-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["3.16.0","3.14.0","3.14.0","3.13.0","3.12.1"];
    </script>
