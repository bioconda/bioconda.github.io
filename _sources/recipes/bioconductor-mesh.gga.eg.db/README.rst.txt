...
.. conda:package:: bioconductor-mesh.gga.eg.db
   ...
   :required~by: |required_by_bioconductor-mesh.gga.eg.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-mesh.gga.eg.db


.. |required_by_bioconductor-mesh.gga.eg.db| conda:required_by:: bioconductor-mesh.gga.eg.db
