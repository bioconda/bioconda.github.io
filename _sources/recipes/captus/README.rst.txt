...
.. conda:package:: captus
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.9.95-0</code>,  <code>0.9.93-0</code>,  <code>0.9.92-0</code>,  <code>0.9.91-2</code>,  <code>0.9.91-0</code>,  <code>0.9.90-0</code>,  <code>0.9.89-0</code>,  <code>0.9.88-1</code>,  <code>0.9.88-0</code>,  </span></summary>
      

      ``0.9.95-0``,  ``0.9.93-0``,  ``0.9.92-0``,  ``0.9.91-2``,  ``0.9.91-0``,  ``0.9.90-0``,  ``0.9.89-0``,  ``0.9.88-1``,  ``0.9.88-0``,  ``0.9.86-0``,  ``0.9.85-0``,  ``0.9.84-1``,  ``0.9.84-0``,  ``0.9.83-0``
...
.. raw:: html
    ...
    <script>
        var package = "captus";
        var versions = ["0.9.95","0.9.93","0.9.92","0.9.91","0.9.91"];
    </script>
