...
.. conda:recipe:: bioconductor-mirna10probe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/mirna10probe.html
   :license: LGPL
...
.. conda:package:: bioconductor-mirna10probe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mirna10probe

   and update with::

      mamba update bioconductor-mirna10probe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mirna10probe
