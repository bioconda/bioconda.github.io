...
.. conda:recipe:: tiddit
   ...
   :documentation: https://github.com/SciLifeLab/TIDDIT/blob/TIDDIT-3.9.7/README.md
...
.. conda:package:: tiddit
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.9.7-0</code>,  <code>3.9.6-0</code>,  <code>3.9.5-0</code>,  <code>3.9.4-0</code>,  <code>3.9.3-1</code>,  <code>3.9.3-0</code>,  <code>3.9.2-0</code>,  <code>3.9.1-0</code>,  <code>3.9.0-0</code>,  </span></summary>
...
.. raw:: html
   ...
   <script>
      var package = "tiddit";
      var versions = ["3.9.7","3.9.6","3.9.5","3.9.4","3.9.3"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_tiddit"></div>
   <div style="width: 100%" id="platform_plot_tiddit"></div>
   <div style="width: 100%" id="cdf_plot_tiddit"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/tiddit/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_tiddit', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for tiddit
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/tiddit/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_tiddit', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for tiddit
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/tiddit/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_tiddit', spec);
            } catch (err) {
