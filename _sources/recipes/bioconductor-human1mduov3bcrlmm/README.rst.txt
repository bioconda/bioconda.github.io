...
.. conda:recipe:: bioconductor-human1mduov3bcrlmm
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/human1mduov3bCrlmm.html
...
.. conda:package:: bioconductor-human1mduov3bcrlmm
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.0.4-14</code>,  <code>1.0.4-13</code>,  <code>1.0.4-12</code>,  <code>1.0.4-11</code>,  <code>1.0.4-10</code>,  <code>1.0.4-9</code>,  <code>1.0.4-8</code>,  <code>1.0.4-7</code>,  <code>1.0.4-6</code>,  </span></summary>
      

      ``1.0.4-14``,  ``1.0.4-13``,  ``1.0.4-12``,  ``1.0.4-11``,  ``1.0.4-10``,  ``1.0.4-9``,  ``1.0.4-8``,  ``1.0.4-7``,  ``1.0.4-6``,  ``1.0.4-5``,  ``1.0.4-4``,  ``1.0.4-3``,  ``1.0.4-2``,  ``1.0.4-1``,  ``1.0.4-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-human1mduov3bcrlmm

to add into an existing workspace instead, run::

    pixi add bioconductor-human1mduov3bcrlmm
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-human1mduov3bcrlmm

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-human1mduov3bcrlmm
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-human1mduov3bcrlmm"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-human1mduov3bcrlmm"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-human1mduov3bcrlmm"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-human1mduov3bcrlmm
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-human1mduov3bcrlmm/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-human1mduov3bcrlmm', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-human1mduov3bcrlmm
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-human1mduov3bcrlmm/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-human1mduov3bcrlmm', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-human1mduov3bcrlmm
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-human1mduov3bcrlmm/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-human1mduov3bcrlmm', spec);
            } catch (err) {
