...
.. conda:recipe:: bioconductor-mmagilentdesign026655.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/MmAgilentDesign026655.db.html
...
.. conda:package:: bioconductor-mmagilentdesign026655.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mmagilentdesign026655.db

   and update with::

      mamba update bioconductor-mmagilentdesign026655.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mmagilentdesign026655.db
