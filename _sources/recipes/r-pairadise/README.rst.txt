...
.. conda:package:: r-pairadise
   ...
   :depends on r-iterators: ``>=1.0.10``
   :depends on r-nloptr: ``>=1.2.1``
...
to install globally, run::
    ...
    pixi global install r-pairadise

to add into an existing workspace instead, run::

    pixi add r-pairadise
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname r-pairadise
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_r-pairadise"></div>
   <div style="width: 100%" id="platform_plot_r-pairadise"></div>
   <div style="width: 100%" id="cdf_plot_r-pairadise"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for r-pairadise
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-pairadise/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_r-pairadise', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for r-pairadise
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-pairadise/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_r-pairadise', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for r-pairadise
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-pairadise/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_r-pairadise', spec);
            } catch (err) {
