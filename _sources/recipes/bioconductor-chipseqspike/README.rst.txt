...
.. conda:recipe:: bioconductor-chipseqspike
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/ChIPSeqSpike.html
...
.. conda:package:: bioconductor-chipseqspike
   ...
   :versions:
      ...
      ``1.9.0-1``,  ``1.9.0-0``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-1``,  ``1.2.0-0``
   ...
   :depends bioconductor-seqplots: ``>=1.27.0,<1.28.0``
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-chipseqspike";
        var versions = ["1.9.0","1.9.0","1.8.0","1.6.0","1.4.0"];
    </script>
