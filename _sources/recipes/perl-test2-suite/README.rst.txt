...
.. conda:package:: perl-test2-suite
   ...
   :versions:
      ...
      ``0.000163-0``,  ``0.000145-0``,  ``0.000144-0``,  ``0.000117-0``,  ``0.000116-0``,  ``0.000115-0``,  ``0.000061-1``,  ``0.000061-0``
   ...
   :depends on perl-scope-guard: 
   :depends on perl-sub-info: 
   :depends on perl-term-table: 
...
to install globally, run::
    ...
    pixi global install perl-test2-suite

to add into an existing workspace instead, run::

    pixi add perl-test2-suite
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname perl-test2-suite
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["0.000163","0.000145","0.000144","0.000117","0.000116"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_perl-test2-suite"></div>
   <div style="width: 100%" id="platform_plot_perl-test2-suite"></div>
   <div style="width: 100%" id="cdf_plot_perl-test2-suite"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for perl-test2-suite
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-test2-suite/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_perl-test2-suite', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for perl-test2-suite
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-test2-suite/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_perl-test2-suite', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for perl-test2-suite
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-test2-suite/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_perl-test2-suite', spec);
            } catch (err) {
