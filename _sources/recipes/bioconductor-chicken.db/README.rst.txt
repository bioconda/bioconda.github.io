...
.. conda:recipe:: bioconductor-chicken.db
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/chicken.db.html
...
.. conda:package:: bioconductor-chicken.db
   ...
   :depends: :conda:package:`bioconductor-annotationdbi` >=1.44.0,<1.45.0 :conda:package:`bioconductor-org.gg.eg.db` >=3.7.0,<3.8.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`wget`  

   :required~by: |required_by_bioconductor-chicken.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-chicken.db


.. |required_by_bioconductor-chicken.db| conda:required_by:: bioconductor-chicken.db
