...
.. conda:recipe:: bioconductor-chicken.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/chicken.db.html
...
.. conda:package:: bioconductor-chicken.db
   ...
   :depends bioconductor-org.gg.eg.db: ``>=3.20.0,<3.21.0``
   :depends curl: 
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-chicken.db

   and update with::

      mamba update bioconductor-chicken.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-chicken.db
