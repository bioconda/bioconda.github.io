...
.. conda:recipe:: bioconductor-drugvsdisease
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/DrugVsDisease.html
   :license: GPL-3
...
.. conda:package:: bioconductor-drugvsdisease
   ...
   :versions:
      ...
      ``2.34.0-0``,  ``2.32.0-1``,  ``2.32.0-0``,  ``2.30.0-0``,  ``2.28.0-1``,  ``2.26.0-1``,  ``2.24.2-0``,  ``2.22.0-0``,  ``2.20.1-0``
   ...
   :depends bioconductor-arrayexpress: ``>=1.52.0,<1.53.0``
   :depends bioconductor-biocgenerics: ``>=0.38.0,<0.39.0``
   :depends bioconductor-biomart: ``>=2.48.0,<2.49.0``
   :depends bioconductor-cmap2data: ``>=1.28.0,<1.29.0``
   :depends bioconductor-drugvsdiseasedata: ``>=1.28.0,<1.29.0``
