...
.. conda:recipe:: bioconductor-drugvsdisease
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/DrugVsDisease.html
   :license: GPL-3
...
.. conda:package:: bioconductor-drugvsdisease
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.36.0-0</code>,  <code>2.34.0-0</code>,  <code>2.32.0-1</code>,  <code>2.32.0-0</code>,  <code>2.30.0-0</code>,  <code>2.28.0-1</code>,  <code>2.26.0-1</code>,  <code>2.24.2-0</code>,  <code>2.22.0-0</code>,  </span></summary>
      

      ``2.36.0-0``,  ``2.34.0-0``,  ``2.32.0-1``,  ``2.32.0-0``,  ``2.30.0-0``,  ``2.28.0-1``,  ``2.26.0-1``,  ``2.24.2-0``,  ``2.22.0-0``,  ``2.20.1-0``
   ...
   :depends bioconductor-arrayexpress: ``>=1.54.0,<1.55.0``
   :depends bioconductor-biocgenerics: ``>=0.40.0,<0.41.0``
   :depends bioconductor-biomart: ``>=2.50.0,<2.51.0``
   :depends bioconductor-cmap2data: ``>=1.30.0,<1.31.0``
   :depends bioconductor-drugvsdiseasedata: ``>=1.30.0,<1.31.0``
