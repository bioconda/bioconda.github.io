...
.. conda:recipe:: bioconductor-mi16cod.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/mi16cod.db.html
...
.. conda:package:: bioconductor-mi16cod.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mi16cod.db

   and update with::

      mamba update bioconductor-mi16cod.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mi16cod.db
