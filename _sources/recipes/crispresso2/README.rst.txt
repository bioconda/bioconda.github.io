...
.. conda:package:: crispresso2
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.3.4-0</code>,  <code>2.3.3-0</code>,  <code>2.3.2-0</code>,  <code>2.3.1-4</code>,  <code>2.3.1-3</code>,  <code>2.3.1-2</code>,  <code>2.3.1-1</code>,  <code>2.3.1-0</code>,  <code>2.3.0-1</code>,  </span></summary>
      

      ``2.3.4-0``,  ``2.3.3-0``,  ``2.3.2-0``,  ``2.3.1-4``,  ``2.3.1-3``,  ``2.3.1-2``,  ``2.3.1-1``,  ``2.3.1-0``,  ``2.3.0-1``,  ``2.3.0-0``,  ``2.2.14-0``,  ``2.2.13-0``,  ``2.2.12-1``,  ``2.2.12-0``,  ``2.2.11-0``,  ``2.2.10-2``,  ``2.2.10-1``,  ``2.2.10-0``,  ``2.2.9-1``,  ``2.2.9-0``,  ``2.2.8-0``,  ``2.2.7-1``,  ``2.2.7-0``,  ``2.2.6-1``,  ``2.2.6-0``,  ``2.2.5-0``,  ``2.2.4-0``,  ``2.2.3-0``,  ``2.2.2-0``,  ``2.2.0-0``,  ``2.1.3-0``,  ``2.1.2-0``,  ``2.1.1-0``,  ``2.1.0-1``,  ``2.1.0-0``,  ``2.0.45-1``,  ``2.0.45-0``,  ``2.0.44-0``,  ``2.0.43-0``,  ``2.0.42-0``,  ``2.0.40-0``,  ``2.0.39-0``,  ``2.0.38-0``,  ``2.0.32-0``,  ``2.0.31-0``,  ``2.0.30-0``,  ``2.0.29-0``,  ``2.0.28-0``,  ``2.0.27-3``,  ``2.0.23-1``,  ``2.0.23-0``
...
to install globally, run::
    ...
    pixi global install crispresso2

to add into an existing workspace instead, run::

    pixi add crispresso2
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname crispresso2
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["2.3.4","2.3.3","2.3.2","2.3.1","2.3.1"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_crispresso2"></div>
   <div style="width: 100%" id="platform_plot_crispresso2"></div>
   <div style="width: 100%" id="cdf_plot_crispresso2"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for crispresso2
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/crispresso2/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_crispresso2', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for crispresso2
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/crispresso2/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_crispresso2', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for crispresso2
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/crispresso2/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_crispresso2', spec);
            } catch (err) {
