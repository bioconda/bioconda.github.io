...
.. conda:recipe:: bioconductor-aneufinder
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/AneuFinder.html
...
.. conda:package:: bioconductor-aneufinder
   ...
   :versions:
      ...
      ``1.34.0-0``,  ``1.30.0-0``,  ``1.28.0-0``,  ``1.26.0-1``,  ``1.26.0-0``,  ``1.22.0-2``,  ``1.22.0-1``,  ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.0-1``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-1``,  ``1.12.0-1``,  ``1.10.1-0``
   ...
   :depends on bioconductor-aneufinderdata: ``>=1.34.0,<1.35.0``
   :depends on bioconductor-aneufinderdata: ``>=1.34.0,<1.35.0a0``
   :depends on bioconductor-bamsignals: ``>=1.38.0,<1.39.0``
   :depends on bioconductor-bamsignals: ``>=1.38.0,<1.39.0a0``
...
to install globally, run::
    ...
    pixi global install bioconductor-aneufinder

to add into an existing workspace instead, run::

    pixi add bioconductor-aneufinder
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-aneufinder
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-aneufinder"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-aneufinder"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-aneufinder"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-aneufinder
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-aneufinder/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-aneufinder', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-aneufinder
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-aneufinder/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-aneufinder', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-aneufinder
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-aneufinder/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-aneufinder', spec);
            } catch (err) {
