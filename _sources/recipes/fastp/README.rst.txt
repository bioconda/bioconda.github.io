...
.. conda:package:: fastp
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.23.4-3</code>,  <code>0.23.4-2</code>,  <code>0.23.4-1</code>,  <code>0.23.4-0</code>,  <code>0.23.3-0</code>,  <code>0.23.2-5</code>,  <code>0.23.2-4</code>,  <code>0.23.2-3</code>,  <code>0.23.2-2</code>,  </span></summary>
      

      ``0.23.4-3``,  ``0.23.4-2``,  ``0.23.4-1``,  ``0.23.4-0``,  ``0.23.3-0``,  ``0.23.2-5``,  ``0.23.2-4``,  ``0.23.2-3``,  ``0.23.2-2``,  ``0.23.2-1``,  ``0.23.2-0``,  ``0.23.1-0``,  ``0.23.0-0``,  ``0.22.0-0``,  ``0.20.1-1``,  ``0.20.1-0``,  ``0.20.0-0``,  ``0.19.7-0``,  ``0.19.6-0``,  ``0.19.5-0``,  ``0.19.4-0``,  ``0.19.3-0``,  ``0.18.0-0``,  ``0.17.1-0``,  ``0.17.0-0``,  ``0.14.1-0``,  ``0.13.1-0``,  ``0.12.5-0``,  ``0.12.4-0``,  ``0.12.3-0``,  ``0.12.2-1``,  ``0.12.2-0``
   ...
   :depends isa-l: 
   :depends libdeflate: ``>=1.18,<1.21.0a0``
...
.. raw:: html
    ...
    <script>
        var package = "fastp";
        var versions = ["0.23.4","0.23.4","0.23.4","0.23.4","0.23.3"];
    </script>
