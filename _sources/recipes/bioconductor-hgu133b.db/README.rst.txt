...
.. conda:recipe:: bioconductor-hgu133b.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/hgu133b.db.html
...
.. conda:package:: bioconductor-hgu133b.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hgu133b.db

   and update with::

      mamba update bioconductor-hgu133b.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hgu133b.db
