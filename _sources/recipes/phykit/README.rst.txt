...
.. conda:package:: phykit
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.1.5-0</code>,  <code>2.1.2-0</code>,  <code>2.0.3-0</code>,  <code>2.0.2-0</code>,  <code>2.0.1-0</code>,  <code>2.0.0-0</code>,  <code>1.20.0-0</code>,  <code>1.19.9-0</code>,  <code>1.19.8-0</code>,  </span></summary>
      

      ``2.1.5-0``,  ``2.1.2-0``,  ``2.0.3-0``,  ``2.0.2-0``,  ``2.0.1-0``,  ``2.0.0-0``,  ``1.20.0-0``,  ``1.19.9-0``,  ``1.19.8-0``,  ``1.19.6-0``,  ``1.19.5-0``,  ``1.19.4-0``,  ``1.19.3-0``,  ``1.19.2-0``,  ``1.19.1-0``,  ``1.19.0-0``,  ``1.17.0-0``,  ``1.16.0-0``,  ``1.14.0-0``,  ``1.13.1-0``,  ``1.13.0-0``,  ``1.12.5-0``,  ``1.12.4-0``,  ``1.12.3-0``,  ``1.12.2-0``,  ``1.12.0-0``,  ``1.11.16-0``,  ``1.11.15-0``,  ``1.11.14-0``,  ``1.11.13-0``,  ``1.11.12-0``,  ``1.11.10-0``,  ``1.11.7-0``,  ``1.11.5-0``
...
.. raw:: html
    ...
    <script>
        var package = "phykit";
        var versions = ["2.1.5","2.1.2","2.0.3","2.0.2","2.0.1"];
    </script>
