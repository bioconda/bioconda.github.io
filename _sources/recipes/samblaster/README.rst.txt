...
.. conda:package:: samblaster
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.1.26-4</code>,  <code>0.1.26-3</code>,  <code>0.1.26-2</code>,  <code>0.1.26-1</code>,  <code>0.1.26-0</code>,  <code>0.1.25-0</code>,  <code>0.1.24-3</code>,  <code>0.1.24-2</code>,  <code>0.1.24-1</code>,  </span></summary>
      

      ``0.1.26-4``,  ``0.1.26-3``,  ``0.1.26-2``,  ``0.1.26-1``,  ``0.1.26-0``,  ``0.1.25-0``,  ``0.1.24-3``,  ``0.1.24-2``,  ``0.1.24-1``,  ``0.1.24-0``,  ``0.1.23-0``,  ``0.1.22-0``,  ``0.1.20-4``,  ``0.1.20-3``,  ``0.1.20-2``,  ``0.1.20-1``,  ``0.1.20-0``
