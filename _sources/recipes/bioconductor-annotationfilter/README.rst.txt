...
.. conda:recipe:: bioconductor-annotationfilter
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/AnnotationFilter.html
...
.. conda:package:: bioconductor-annotationfilter
   ...
   :versions:
      ...
      ``1.30.0-0``,  ``1.26.0-0``,  ``1.24.0-0``,  ``1.22.0-0``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-1``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-1``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.0-0``,  ``1.0.0-0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-annotationfilter

   and update with::

      mamba update bioconductor-annotationfilter

  To create a new environment, run::

      mamba create --name myenvname bioconductor-annotationfilter
