...
.. conda:package:: gencove
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.0.0-0</code>,  <code>2.24.3-0</code>,  <code>2.24.2-0</code>,  <code>2.24.1-0</code>,  <code>2.24.0-0</code>,  <code>2.23.1-0</code>,  <code>2.23.0-0</code>,  <code>2.21.0-0</code>,  <code>2.20.2-0</code>,  </span></summary>
      

      ``3.0.0-0``,  ``2.24.3-0``,  ``2.24.2-0``,  ``2.24.1-0``,  ``2.24.0-0``,  ``2.23.1-0``,  ``2.23.0-0``,  ``2.21.0-0``,  ``2.20.2-0``,  ``2.20.1-0``,  ``2.20.0-0``,  ``2.19.0-0``,  ``2.18.5-0``,  ``2.18.3-0``,  ``2.18.2-0``,  ``2.18.1-0``,  ``2.18.0-0``,  ``2.17.1-0``,  ``2.8.1-0``,  ``2.8.0-0``,  ``2.7.3-0``,  ``2.7.2-0``,  ``2.7.1-0``,  ``2.7.0-0``,  ``2.6.0-0``,  ``2.5.2-0``,  ``2.5.1-0``,  ``2.5.0-0``,  ``2.4.7-0``,  ``2.4.6-0``,  ``2.4.5-0``,  ``2.4.3-0``
...
.. raw:: html
    ...
    <script>
        var package = "gencove";
        var versions = ["3.0.0","2.24.3","2.24.2","2.24.1","2.24.0"];
    </script>
