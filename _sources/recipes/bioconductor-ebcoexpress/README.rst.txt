...
.. conda:package:: bioconductor-ebcoexpress
   ...
   :depends bioconductor-ebarrays: ``>=2.74.0,<2.75.0``
   :depends bioconductor-ebarrays: ``>=2.74.0,<2.75.0a0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ebcoexpress

   and update with::

      mamba update bioconductor-ebcoexpress

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ebcoexpress
