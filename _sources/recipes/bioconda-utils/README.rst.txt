...
.. conda:package:: bioconda-utils
   ...
   :depends on conda: ``26.1.*``
   :depends on conda-build: ``26.3.*``
   :depends on conda-forge-pinning: ``2026.01.07.13.16.30.*``
   :depends on conda-index: ``0.7.*``
   :depends on conda-libmamba-solver: ``25.11.*``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["4.2.0","4.1.0","4.1.0","4.0.0","3.9.2"];
    </script>
