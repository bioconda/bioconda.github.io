...
.. conda:package:: bioconda-utils
   ...
   :depends colorlog: ``6.*``
   :depends conda: ``24.5.*``
   :depends conda-build: ``24.5.*``
   :depends conda-forge-pinning: ``2024.06.01.05.54.15.*``
   :depends conda-index: ``0.4.*``
   :depends conda-libmamba-solver: ``24.1.*``
   :depends conda-package-streaming: ``0.9.*``
   :depends diskcache: ``5.*``
   :depends findutils: 
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["3.3.2","3.3.1","3.3.0","3.2.0","3.0.0"];
    </script>
