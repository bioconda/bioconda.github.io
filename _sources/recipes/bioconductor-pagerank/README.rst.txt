...
.. conda:recipe:: bioconductor-pagerank
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/pageRank.html
   :license: GPL-2
...
.. conda:package:: bioconductor-pagerank
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pagerank

   and update with::

      mamba update bioconductor-pagerank

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pagerank
