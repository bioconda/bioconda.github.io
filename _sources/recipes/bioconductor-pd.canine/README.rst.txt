...
.. conda:recipe:: bioconductor-pd.canine
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/pd.canine.html
...
.. conda:package:: bioconductor-pd.canine
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.canine

   and update with::

      mamba update bioconductor-pd.canine

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.canine
