...
.. conda:recipe:: bioconductor-tomatoprobe
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/tomatoprobe.html
   :license: LGPL
...
to install globally, run::
    ...
    pixi global install bioconductor-tomatoprobe

to add into an existing workspace instead, run::

    pixi add bioconductor-tomatoprobe
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-tomatoprobe
...
For e.g. docker, run::
    ...
    docker pull quay.io/biocontainers/bioconductor-tomatoprobe:<tag>
...
.. raw:: html
   ...
   <script>
      var package = "bioconductor-tomatoprobe";
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-tomatoprobe"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-tomatoprobe"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-tomatoprobe"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-tomatoprobe
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-tomatoprobe/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-tomatoprobe', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-tomatoprobe
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-tomatoprobe/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-tomatoprobe', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-tomatoprobe
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-tomatoprobe/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-tomatoprobe', spec);
            } catch (err) {
