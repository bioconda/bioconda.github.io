...
.. conda:recipe:: bioconductor-tomatoprobe
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/tomatoprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-tomatoprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-tomatoprobe

   and update with::

      mamba update bioconductor-tomatoprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-tomatoprobe
