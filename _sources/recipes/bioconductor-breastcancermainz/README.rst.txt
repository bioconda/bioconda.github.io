...
.. conda:recipe:: bioconductor-breastcancermainz
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/experiment/html/breastCancerMAINZ.html
...
.. conda:package:: bioconductor-breastcancermainz
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-breastcancermainz

   and update with::

      mamba update bioconductor-breastcancermainz

  To create a new environment, run::

      mamba create --name myenvname bioconductor-breastcancermainz
