...
.. conda:recipe:: bioconductor-oppti
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/oppti.html
   :license: MIT
...
to install globally, run::
    ...
    pixi global install bioconductor-oppti

to add into an existing workspace instead, run::

    pixi add bioconductor-oppti
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-oppti
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-oppti"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-oppti"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-oppti"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-oppti
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-oppti/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-oppti', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-oppti
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-oppti/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-oppti', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-oppti
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-oppti/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-oppti', spec);
            } catch (err) {
