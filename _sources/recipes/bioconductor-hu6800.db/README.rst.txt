...
.. conda:recipe:: bioconductor-hu6800.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/hu6800.db.html
...
.. conda:package:: bioconductor-hu6800.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hu6800.db

   and update with::

      mamba update bioconductor-hu6800.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hu6800.db
