...
.. conda:recipe:: bioconductor-panelcn.mops
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/panelcn.mops.html
   :license: LGPL (>= 2.0)
...
.. conda:package:: bioconductor-panelcn.mops
   ...
   :depends bioconductor-cn.mops: ``>=1.52.0,<1.53.0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-panelcn.mops

   and update with::

      mamba update bioconductor-panelcn.mops

  To create a new environment, run::

      mamba create --name myenvname bioconductor-panelcn.mops
