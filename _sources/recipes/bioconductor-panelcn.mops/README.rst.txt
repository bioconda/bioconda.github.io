...
.. conda:recipe:: bioconductor-panelcn.mops
   ...
   :homepage: https://bioconductor.org/packages/3.8/bioc/html/panelcn.mops.html
   :license: LGPL (>= 2.0)
...
.. conda:package:: bioconductor-panelcn.mops
   ...
   :depends: :conda:package:`bioconductor-cn.mops` >=1.28.0,<1.29.0 :conda:package:`bioconductor-genomeinfodb` >=1.18.0,<1.19.0 :conda:package:`bioconductor-genomicranges` >=1.34.0,<1.35.0 :conda:package:`bioconductor-iranges` >=2.16.0,<2.17.0 :conda:package:`bioconductor-rsamtools` >=1.34.0,<1.35.0 :conda:package:`bioconductor-s4vectors` >=0.20.0,<0.21.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-panelcn.mops|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-panelcn.mops


.. |required_by_bioconductor-panelcn.mops| conda:required_by:: bioconductor-panelcn.mops
