...
.. conda:recipe:: bioconductor-breastcancervdx
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/breastCancerVDX.html
...
.. conda:package:: bioconductor-breastcancervdx
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.48.0-0</code>,  <code>1.44.0-0</code>,  <code>1.40.0-0</code>,  <code>1.38.0-0</code>,  <code>1.36.0-0</code>,  <code>1.35.0-0</code>,  <code>1.32.0-1</code>,  <code>1.32.0-0</code>,  <code>1.30.0-0</code>,  </span></summary>
      

      ``1.48.0-0``,  ``1.44.0-0``,  ``1.40.0-0``,  ``1.38.0-0``,  ``1.36.0-0``,  ``1.35.0-0``,  ``1.32.0-1``,  ``1.32.0-0``,  ``1.30.0-0``,  ``1.28.0-3``,  ``1.28.0-2``,  ``1.28.0-1``,  ``1.28.0-0``,  ``1.27.0-0``,  ``1.26.0-0``,  ``1.24.0-0``,  ``1.22.0-1``,  ``1.22.0-0``,  ``1.20.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-breastcancervdx

to add into an existing workspace instead, run::

    pixi add bioconductor-breastcancervdx
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-breastcancervdx
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-breastcancervdx"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-breastcancervdx"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-breastcancervdx"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-breastcancervdx
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-breastcancervdx/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-breastcancervdx', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-breastcancervdx
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-breastcancervdx/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-breastcancervdx', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-breastcancervdx
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-breastcancervdx/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-breastcancervdx', spec);
            } catch (err) {
