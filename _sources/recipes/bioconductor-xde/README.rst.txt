...
.. conda:recipe:: bioconductor-xde
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/XDE.html
   :license: LGPL-2
...
.. conda:package:: bioconductor-xde
   ...
   :versions:
      ...
      ``2.56.0-0``,  ``2.52.0-0``,  ``2.48.0-0``,  ``2.46.0-0``,  ``2.44.0-1``,  ``2.44.0-0``,  ``2.40.0-2``,  ``2.40.0-1``,  ``2.40.0-0``,  ``2.38.0-0``,  ``2.36.0-1``,  ``2.36.0-0``,  ``2.34.0-0``,  ``2.32.0-0``,  ``2.30.0-1``,  ``2.28.0-0``,  ``2.26.0-0``,  ``2.24.0-0``,  ``2.22.0-0``
   ...
   :depends on bioconductor-genemeta: ``>=1.82.0,<1.83.0``
   :depends on bioconductor-genemeta: ``>=1.82.0,<1.83.0a0``
   :depends on bioconductor-siggenes: ``>=1.84.0,<1.85.0``
   :depends on bioconductor-siggenes: ``>=1.84.0,<1.85.0a0``
...
to install globally, run::
    ...
    pixi global install bioconductor-xde

to add into an existing workspace instead, run::

    pixi add bioconductor-xde
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-xde
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-xde"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-xde"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-xde"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-xde
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-xde/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-xde', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-xde
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-xde/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-xde', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-xde
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-xde/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-xde', spec);
            } catch (err) {
