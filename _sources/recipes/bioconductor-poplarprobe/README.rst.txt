...
.. conda:recipe:: bioconductor-poplarprobe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/poplarprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-poplarprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-poplarprobe

   and update with::

      mamba update bioconductor-poplarprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-poplarprobe
