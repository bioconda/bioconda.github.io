...
.. conda:recipe:: bioconductor-poplarprobe
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/poplarprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-poplarprobe
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-poplarprobe:<tag>
