...
.. conda:package:: bioconductor-xcms
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.20.0-1</code>,  <code>3.20.0-0</code>,  <code>3.16.1-1</code>,  <code>3.16.1-0</code>,  <code>3.16.0-0</code>,  <code>3.14.0-0</code>,  <code>3.12.0-1</code>,  <code>3.12.0-0</code>,  <code>3.10.0-0</code>,  </span></summary>
      

      ``3.20.0-1``,  ``3.20.0-0``,  ``3.16.1-1``,  ``3.16.1-0``,  ``3.16.0-0``,  ``3.14.0-0``,  ``3.12.0-1``,  ``3.12.0-0``,  ``3.10.0-0``,  ``3.8.0-0``,  ``3.6.1-0``,  ``3.4.4-0``,  ``3.4.2-0``,  ``3.4.1-0``,  ``3.0.0-1``,  ``3.0.0-0``,  ``1.52.0-1``,  ``1.52.0-0``,  ``1.50.1-0``,  ``1.48.0-1``,  ``1.46.0-1``,  ``1.46.0-0``,  ``1.44.0-1``,  ``1.44.0-0``
   ...
   :depends bioconductor-massspecwavelet: ``>=1.64.0,<1.65.0``
   :depends bioconductor-mscoreutils: ``>=1.10.0,<1.11.0``
   :depends bioconductor-msfeatures: ``>=1.6.0,<1.7.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["3.20.0","3.20.0","3.16.1","3.16.1","3.16.0"];
    </script>
