...
.. conda:recipe:: bioconductor-xcms
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/xcms.html
...
.. conda:package:: bioconductor-xcms
   ...
   :depends on bioconductor-massspecwavelet: ``>=1.76.0,<1.77.0``
   :depends on bioconductor-massspecwavelet: ``>=1.76.0,<1.77.0a0``
   :depends on bioconductor-metabocoreutils: ``>=1.18.0,<1.19.0``
   :depends on bioconductor-metabocoreutils: ``>=1.18.1,<1.19.0a0``
   ...
   :depends on bioconductor-msexperiment: ``>=1.12.0,<1.13.0a0``
   :depends on bioconductor-msfeatures: ``>=1.18.0,<1.19.0``
   :depends on bioconductor-msfeatures: ``>=1.18.0,<1.19.0a0``
   ...
   :depends on bioconductor-spectra: ``>=1.20.1,<1.21.0a0``
...
to install globally, run::
    ...
    pixi global install bioconductor-xcms

to add into an existing workspace instead, run::

    pixi add bioconductor-xcms
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-xcms
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-xcms"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-xcms"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-xcms"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-xcms
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-xcms/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-xcms', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-xcms
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-xcms/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-xcms', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-xcms
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-xcms/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-xcms', spec);
            } catch (err) {
