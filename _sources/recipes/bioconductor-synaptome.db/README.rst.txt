...
.. conda:recipe:: bioconductor-synaptome.db
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/synaptome.db.html
...
.. conda:package:: bioconductor-synaptome.db
   ...
   :versions:
      ...
      ``0.99.17-0``,  ``0.99.16-0``,  ``0.99.15-0``,  ``0.99.12-1``,  ``0.99.12-0``,  ``0.99.8-1``,  ``0.99.8-0``
   ...
   :depends on bioconductor-synaptome.data: ``>=0.99.0,<0.100.0``
   :depends on curl: 
...
to install globally, run::
    ...
    pixi global install bioconductor-synaptome.db

to add into an existing workspace instead, run::

    pixi add bioconductor-synaptome.db
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-synaptome.db
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["0.99.17","0.99.16","0.99.15","0.99.12","0.99.12"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-synaptome.db"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-synaptome.db"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-synaptome.db"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-synaptome.db
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-synaptome.db/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-synaptome.db', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-synaptome.db
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-synaptome.db/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-synaptome.db', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-synaptome.db
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-synaptome.db/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-synaptome.db', spec);
            } catch (err) {
