...
.. conda:recipe:: biobb_pytorch
   ...
   \#\#\# Introduction
   Biobb\_pytorch is the Biobb module collection to create and train ML \& DL models. Biobb \(BioExcel building blocks\) packages are Python building blocks that create new layer of compatibility and interoperability over popular bioinformatics tools.
