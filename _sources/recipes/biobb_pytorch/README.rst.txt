...
.. conda:package:: biobb_pytorch
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>5.3.0-0</code>,  <code>5.2.3-0</code>,  <code>5.2.2-0</code>,  <code>5.2.1-0</code>,  <code>5.2.0-0</code>,  <code>5.1.0-0</code>,  <code>5.0.0-0</code>,  <code>4.2.1-0</code>,  <code>4.2.0-0</code>,  </span></summary>
      

      ``5.3.0-0``,  ``5.2.3-0``,  ``5.2.2-0``,  ``5.2.1-0``,  ``5.2.0-0``,  ``5.1.0-0``,  ``5.0.0-0``,  ``4.2.1-0``,  ``4.2.0-0``,  ``4.1.3-0``,  ``4.1.2-0``,  ``4.1.1-0``,  ``4.1.0-0``
...
to install globally, run::
    ...
    pixi global install biobb_pytorch

to add into an existing workspace instead, run::

    pixi add biobb_pytorch
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install biobb_pytorch

Alternatively, to install into a new environment, run::

    conda create -n envname biobb_pytorch
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_biobb_pytorch"></div>
   <div style="width: 100%" id="platform_plot_biobb_pytorch"></div>
   <div style="width: 100%" id="cdf_plot_biobb_pytorch"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for biobb_pytorch
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/biobb_pytorch/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_biobb_pytorch', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for biobb_pytorch
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/biobb_pytorch/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_biobb_pytorch', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for biobb_pytorch
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/biobb_pytorch/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_biobb_pytorch', spec);
            } catch (err) {
