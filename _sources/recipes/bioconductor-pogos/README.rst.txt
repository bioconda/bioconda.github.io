...
.. conda:recipe:: bioconductor-pogos
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/pogos.html
...
.. conda:package:: bioconductor-pogos
   ...
   :depends on bioconductor-ontoproc: ``>=2.4.0,<2.5.0``
   :depends on bioconductor-s4vectors: ``>=0.48.0,<0.49.0``
   :depends on r-base: ``>=4.5,<4.6.0a0``
   :depends on r-ggplot2: 
   :depends on r-httr: ``>=1.3.1``
   :depends on r-rjson: ``>=0.2.15``
   :depends on r-shiny: 
...
to install globally, run::
    ...
    pixi global install bioconductor-pogos

to add into an existing workspace instead, run::

    pixi add bioconductor-pogos
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-pogos
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-pogos"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-pogos"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-pogos"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-pogos
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pogos/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-pogos', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-pogos
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pogos/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-pogos', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-pogos
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pogos/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-pogos', spec);
            } catch (err) {
