...
.. conda:package:: bioconductor-flowbin
   ...
   :depends: :conda:package:`bioconductor-biocgenerics` >=0.28.0,<0.29.0 :conda:package:`bioconductor-flowcore` >=1.48.0,<1.49.0 :conda:package:`bioconductor-flowfp` >=1.40.0,<1.41.0 :conda:package:`bioconductor-limma` >=3.38.0,<3.39.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-class`  :conda:package:`r-snow`  

   :required~by: |required_by_bioconductor-flowbin|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-flowbin


.. |required_by_bioconductor-flowbin| conda:required_by:: bioconductor-flowbin
