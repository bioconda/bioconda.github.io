...
.. conda:package:: solvebio
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.24.1-0</code>,  <code>2.24.0-0</code>,  <code>2.21.0-0</code>,  <code>2.20.0-0</code>,  <code>2.19.0-0</code>,  <code>2.18.1-0</code>,  <code>2.18.0-0</code>,  <code>2.17.1-0</code>,  <code>2.16.0-0</code>,  </span></summary>
      

      ``2.24.1-0``,  ``2.24.0-0``,  ``2.21.0-0``,  ``2.20.0-0``,  ``2.19.0-0``,  ``2.18.1-0``,  ``2.18.0-0``,  ``2.17.1-0``,  ``2.16.0-0``,  ``2.15.0-0``,  ``2.14.1-0``,  ``2.14.0-0``,  ``2.13.1-0``,  ``2.13.0-0``,  ``2.12.0-0``,  ``2.11.0-0``,  ``2.10.1-0``,  ``2.10.0-0``,  ``2.9.0-0``,  ``2.8.9-0``,  ``2.8.8-0``,  ``2.8.7-0``,  ``2.8.6-0``,  ``2.8.5-0``,  ``2.8.4-0``,  ``2.8.0-0``,  ``2.7.0-0``,  ``2.6.1-0``,  ``2.5.1-2``,  ``2.5.1-0``,  ``2.4.6-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.24.1","2.24.0","2.21.0","2.20.0","2.19.0"];
    </script>
