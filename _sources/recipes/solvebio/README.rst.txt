...
.. conda:package:: solvebio
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.35.0-0</code>,  <code>2.34.0-0</code>,  <code>2.33.0-0</code>,  <code>2.32.0-0</code>,  <code>2.31.2-0</code>,  <code>2.31.1-0</code>,  <code>2.31.0-0</code>,  <code>2.30.1-0</code>,  <code>2.30.0-1</code>,  </span></summary>
      

      ``2.35.0-0``,  ``2.34.0-0``,  ``2.33.0-0``,  ``2.32.0-0``,  ``2.31.2-0``,  ``2.31.1-0``,  ``2.31.0-0``,  ``2.30.1-0``,  ``2.30.0-1``,  ``2.30.0-0``,  ``2.29.2-0``,  ``2.29.1-0``,  ``2.29.0-0``,  ``2.28.0-0``,  ``2.27.0-0``,  ``2.26.0-0``,  ``2.25.0-0``,  ``2.24.2-0``,  ``2.24.1-0``,  ``2.24.0-0``,  ``2.21.0-0``,  ``2.20.0-0``,  ``2.19.0-0``,  ``2.18.1-0``,  ``2.18.0-0``,  ``2.17.1-0``,  ``2.16.0-0``,  ``2.15.0-0``,  ``2.14.1-0``,  ``2.14.0-0``,  ``2.13.1-0``,  ``2.13.0-0``,  ``2.12.0-0``,  ``2.11.0-0``,  ``2.10.1-0``,  ``2.10.0-0``,  ``2.9.0-0``,  ``2.8.9-0``,  ``2.8.8-0``,  ``2.8.7-0``,  ``2.8.6-0``,  ``2.8.5-0``,  ``2.8.4-0``,  ``2.8.0-0``,  ``2.7.0-0``,  ``2.6.1-0``,  ``2.5.1-2``,  ``2.5.1-0``,  ``2.4.6-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["2.35.0","2.34.0","2.33.0","2.32.0","2.31.2"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_solvebio"></div>
   <div style="width: 100%" id="platform_plot_solvebio"></div>
   <div style="width: 100%" id="cdf_plot_solvebio"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/solvebio/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_solvebio', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for solvebio
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/solvebio/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_solvebio', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for solvebio
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/solvebio/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_solvebio', spec);
            } catch (err) {
