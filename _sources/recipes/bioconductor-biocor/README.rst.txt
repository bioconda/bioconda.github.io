...
.. conda:recipe:: bioconductor-biocor
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/BioCor.html
...
.. conda:package:: bioconductor-biocor
   ...
   :versions:
      ...
      ``1.24.0-0``,  ``1.22.0-0``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-1``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.1-0``,  ``1.6.0-0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-biocor

   and update with::

      mamba update bioconductor-biocor

  To create a new environment, run::

      mamba create --name myenvname bioconductor-biocor
