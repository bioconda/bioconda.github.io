...
.. conda:recipe:: bioconductor-polyester
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/polyester.html
...
.. conda:package:: bioconductor-polyester
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-polyester

   and update with::

      mamba update bioconductor-polyester

  To create a new environment, run::

      mamba create --name myenvname bioconductor-polyester
