...
.. conda:package:: perl-xml-libxslt
   ...
   :depends on perl-xml-libxml: ``>=2.210,<3.0a0``
...
to install globally, run::
    ...
    pixi global install perl-xml-libxslt

to add into an existing workspace instead, run::

    pixi add perl-xml-libxslt
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname perl-xml-libxslt
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_perl-xml-libxslt"></div>
   <div style="width: 100%" id="platform_plot_perl-xml-libxslt"></div>
   <div style="width: 100%" id="cdf_plot_perl-xml-libxslt"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for perl-xml-libxslt
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-xml-libxslt/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_perl-xml-libxslt', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for perl-xml-libxslt
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-xml-libxslt/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_perl-xml-libxslt', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for perl-xml-libxslt
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-xml-libxslt/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_perl-xml-libxslt', spec);
            } catch (err) {
