...
.. conda:recipe:: bioconductor-ewce
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/EWCE.html
   :license: GPL-3
...
.. conda:package:: bioconductor-ewce
   ...
   :versions:
      ...
      ``1.18.1-0``,  ``1.18.0-0``,  ``1.14.0-0``,  ``1.10.2-0``,  ``1.8.2-0``,  ``1.6.0-0``,  ``1.2.0-0``,  ``1.0.0-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.18.1","1.18.0","1.14.0","1.10.2","1.8.2"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-ewce"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-ewce"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-ewce"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-ewce
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ewce/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-ewce', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-ewce
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ewce/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-ewce', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-ewce
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ewce/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-ewce', spec);
            } catch (err) {
