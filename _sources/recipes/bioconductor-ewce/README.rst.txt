...
.. conda:package:: bioconductor-ewce
   ...
   :versions:
      ...
      ``1.14.0-0``,  ``1.10.2-0``,  ``1.8.2-0``,  ``1.6.0-0``,  ``1.2.0-0``,  ``1.0.0-0``
   ...
   :depends bioconductor-ewcedata: ``>=1.14.0,<1.15.0``
   :depends bioconductor-limma: ``>=3.62.0,<3.63.0``
   :depends bioconductor-orthogene: ``>=1.12.0,<1.13.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.14.0","1.10.2","1.8.2","1.6.0","1.2.0"];
    </script>
