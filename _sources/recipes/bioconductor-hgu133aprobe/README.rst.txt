...
.. conda:recipe:: bioconductor-hgu133aprobe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/hgu133aprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-hgu133aprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hgu133aprobe

   and update with::

      mamba update bioconductor-hgu133aprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hgu133aprobe
