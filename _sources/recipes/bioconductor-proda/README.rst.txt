...
.. conda:recipe:: bioconductor-proda
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/proDA.html
   :license: GPL-3
...
to install globally, run::
    ...
    pixi global install bioconductor-proda

to add into an existing workspace instead, run::

    pixi add bioconductor-proda
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-proda
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-proda"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-proda"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-proda"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-proda
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-proda/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-proda', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-proda
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-proda/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-proda', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-proda
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-proda/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-proda', spec);
            } catch (err) {
