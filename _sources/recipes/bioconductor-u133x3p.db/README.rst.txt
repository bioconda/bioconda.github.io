...
.. conda:recipe:: bioconductor-u133x3p.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/u133x3p.db.html
...
.. conda:package:: bioconductor-u133x3p.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-u133x3p.db

   and update with::

      mamba update bioconductor-u133x3p.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-u133x3p.db
