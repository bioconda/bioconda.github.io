...
.. conda:recipe:: bioconductor-yeast.db0
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/yeast.db0.html
...
.. conda:package:: bioconductor-yeast.db0
   ...
   :versions:
      ...
      ``3.22.0-0``,  ``3.20.0-0``,  ``3.18.0-0``,  ``3.17.0-0``,  ``3.16.0-0``,  ``3.14.0-1``,  ``3.14.0-0``,  ``3.13.0-0``,  ``3.12.0-1``,  ``3.12.0-0``,  ``3.11.2-0``,  ``3.10.1-0``,  ``3.8.2-1``,  ``3.7.1-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-yeast.db0

to add into an existing workspace instead, run::

    pixi add bioconductor-yeast.db0
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-yeast.db0
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-yeast.db0"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-yeast.db0"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-yeast.db0"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-yeast.db0
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-yeast.db0/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-yeast.db0', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-yeast.db0
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-yeast.db0/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-yeast.db0', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-yeast.db0
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-yeast.db0/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-yeast.db0', spec);
            } catch (err) {
