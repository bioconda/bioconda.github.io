...
.. conda:recipe:: bioconductor-yeast.db0
   ...
   :homepage: https://bioconductor.org/packages/3.16/data/annotation/html/yeast.db0.html
...
.. conda:package:: bioconductor-yeast.db0
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.16.0-0</code>,  <code>3.14.0-1</code>,  <code>3.14.0-0</code>,  <code>3.13.0-0</code>,  <code>3.12.0-1</code>,  <code>3.12.0-0</code>,  <code>3.11.2-0</code>,  <code>3.10.1-0</code>,  <code>3.8.2-1</code>,  </span></summary>
      

      ``3.16.0-0``,  ``3.14.0-1``,  ``3.14.0-0``,  ``3.13.0-0``,  ``3.12.0-1``,  ``3.12.0-0``,  ``3.11.2-0``,  ``3.10.1-0``,  ``3.8.2-1``,  ``3.7.1-0``
