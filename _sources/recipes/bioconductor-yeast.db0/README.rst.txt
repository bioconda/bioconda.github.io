...
.. conda:recipe:: bioconductor-yeast.db0
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/yeast.db0.html
...
.. conda:package:: bioconductor-yeast.db0
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-yeast.db0

   and update with::

      mamba update bioconductor-yeast.db0

  To create a new environment, run::

      mamba create --name myenvname bioconductor-yeast.db0
