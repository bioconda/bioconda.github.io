...
.. conda:recipe:: bioconductor-yeast.db0
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/yeast.db0.html
...
.. conda:package:: bioconductor-yeast.db0
   ...
   :required~by: |required_by_bioconductor-yeast.db0|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-yeast.db0


.. |required_by_bioconductor-yeast.db0| conda:required_by:: bioconductor-yeast.db0
