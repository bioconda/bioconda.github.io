...
.. conda:package:: bioconductor-proper
   ...
   :depends: :conda:package:`bioconductor-edger` >=3.24.0,<3.25.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-proper|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-proper


.. |required_by_bioconductor-proper| conda:required_by:: bioconductor-proper
