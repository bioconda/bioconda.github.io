...
.. conda:recipe:: bioconductor-hu35ksubdprobe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/hu35ksubdprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-hu35ksubdprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hu35ksubdprobe

   and update with::

      mamba update bioconductor-hu35ksubdprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hu35ksubdprobe
