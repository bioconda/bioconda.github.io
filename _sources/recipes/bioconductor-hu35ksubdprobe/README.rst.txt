...
.. conda:recipe:: bioconductor-hu35ksubdprobe
   :replaces_section_title:
   :noindex:

   Probe sequence data for microarrays of type hu35ksubd

   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/hu35ksubdprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-hu35ksubdprobe
...
to install globally, run::
    ...
    pixi global install bioconductor-hu35ksubdprobe

to add into an existing workspace instead, run::

    pixi add bioconductor-hu35ksubdprobe
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-hu35ksubdprobe

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-hu35ksubdprobe
...
For e.g. docker, run::
    ...
    docker pull quay.io/biocontainers/bioconductor-hu35ksubdprobe:<tag>
...
.. raw:: html
   ...
   <script>
      var package = "bioconductor-hu35ksubdprobe";
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-hu35ksubdprobe"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-hu35ksubdprobe"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-hu35ksubdprobe"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-hu35ksubdprobe
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hu35ksubdprobe/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-hu35ksubdprobe', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-hu35ksubdprobe
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hu35ksubdprobe/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-hu35ksubdprobe', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-hu35ksubdprobe
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hu35ksubdprobe/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-hu35ksubdprobe', spec);
            } catch (err) {
...
Render an |install-with-bioconda| badge with the following MarkDown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat)](http://bioconda.github.io/recipes/bioconductor-hu35ksubdprobe/README.html)
