...
.. conda:recipe:: bioconductor-rtracklayer
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/rtracklayer.html
...
.. conda:package:: bioconductor-rtracklayer
   ...
   :depends on r-curl: 
   :depends on r-httr: 
   :depends on r-restfulr: ``>=0.0.13``
   :depends on r-restfulr: ``>=0.0.16,<0.1.0a0``
   :depends on r-xml: ``>=1.98-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-rtracklayer

to add into an existing workspace instead, run::

    pixi add bioconductor-rtracklayer
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-rtracklayer
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-rtracklayer"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-rtracklayer"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-rtracklayer"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-rtracklayer
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rtracklayer/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-rtracklayer', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-rtracklayer
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rtracklayer/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-rtracklayer', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-rtracklayer
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rtracklayer/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-rtracklayer', spec);
            } catch (err) {
