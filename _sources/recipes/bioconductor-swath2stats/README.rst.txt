...
.. conda:recipe:: bioconductor-swath2stats
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/SWATH2stats.html
   :license: GPL-3
...
.. conda:package:: bioconductor-swath2stats
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.40.1-0</code>,  <code>1.36.0-0</code>,  <code>1.32.0-0</code>,  <code>1.30.1-0</code>,  <code>1.28.0-0</code>,  <code>1.24.0-0</code>,  <code>1.22.0-0</code>,  <code>1.20.0-1</code>,  <code>1.20.0-0</code>,  </span></summary>
      

      ``1.40.1-0``,  ``1.36.0-0``,  ``1.32.0-0``,  ``1.30.1-0``,  ``1.28.0-0``,  ``1.24.0-0``,  ``1.22.0-0``,  ``1.20.0-1``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-1``,  ``1.12.1-0``,  ``1.10.2-0``,  ``1.8.1-0``,  ``1.6.1-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-swath2stats

to add into an existing workspace instead, run::

    pixi add bioconductor-swath2stats
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-swath2stats
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.40.1","1.36.0","1.32.0","1.30.1","1.28.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-swath2stats"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-swath2stats"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-swath2stats"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-swath2stats
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-swath2stats/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-swath2stats', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-swath2stats
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-swath2stats/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-swath2stats', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-swath2stats
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-swath2stats/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-swath2stats', spec);
            } catch (err) {
