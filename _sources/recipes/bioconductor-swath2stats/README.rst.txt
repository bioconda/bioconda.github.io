...
.. conda:recipe:: bioconductor-swath2stats
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/SWATH2stats.html
   :license: GPL-3
...
.. conda:package:: bioconductor-swath2stats
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.22.0-0</code>,  <code>1.20.0-1</code>,  <code>1.20.0-0</code>,  <code>1.18.0-0</code>,  <code>1.16.0-0</code>,  <code>1.14.0-1</code>,  <code>1.12.1-0</code>,  <code>1.10.2-0</code>,  <code>1.8.1-0</code>,  </span></summary>
      

      ``1.22.0-0``,  ``1.20.0-1``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-1``,  ``1.12.1-0``,  ``1.10.2-0``,  ``1.8.1-0``,  ``1.6.1-0``
