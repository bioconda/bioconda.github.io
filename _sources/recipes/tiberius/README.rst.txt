...
.. conda:recipe:: tiberius
   ...
   :documentation: https://github.com/Gaius-Augustus/Tiberius/blob/v2.0.4/README.md
...
.. conda:package:: tiberius
   ...
   :versions:
      ...
      ``2.0.4-0``,  ``2.0.3-0``,  ``1.1.8-0``,  ``1.1.7-0``,  ``1.1.6-0``,  ``1.1.1-0``,  ``1.0.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.0.4","2.0.3","1.1.8","1.1.7","1.1.6"];
    </script>
