...
.. conda:recipe:: bioconductor-clariomsmousetranscriptcluster.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/clariomsmousetranscriptcluster.db.html
...
.. conda:package:: bioconductor-clariomsmousetranscriptcluster.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-clariomsmousetranscriptcluster.db

   and update with::

      mamba update bioconductor-clariomsmousetranscriptcluster.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-clariomsmousetranscriptcluster.db
