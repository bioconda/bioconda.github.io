...
.. conda:recipe:: bioconductor-geuvadistranscriptexpr
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/experiment/html/GeuvadisTranscriptExpr.html
   :license: GPL (>= 3)
...
.. conda:package:: bioconductor-geuvadistranscriptexpr
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-geuvadistranscriptexpr:<tag>
