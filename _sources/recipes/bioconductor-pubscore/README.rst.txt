...
.. conda:recipe:: bioconductor-pubscore
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/PubScore.html
...
.. conda:package:: bioconductor-pubscore
   ...
   :versions:
      ...
      ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.0-0``,  ``1.1.0-0``,  ``1.0.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-pubscore";
        var versions = ["1.6.0","1.4.0","1.2.0","1.1.0","1.0.0"];
    </script>
