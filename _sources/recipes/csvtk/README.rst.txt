...
.. conda:package:: csvtk
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.24.0-0</code>,  <code>0.23.0-0</code>,  <code>0.22.0-1</code>,  <code>0.22.0-0</code>,  <code>0.21.0-0</code>,  <code>0.20.0-0</code>,  <code>0.19.1-0</code>,  <code>0.19.0-0</code>,  <code>0.18.2-0</code>,  </span></summary>
      

      ``0.24.0-0``,  ``0.23.0-0``,  ``0.22.0-1``,  ``0.22.0-0``,  ``0.21.0-0``,  ``0.20.0-0``,  ``0.19.1-0``,  ``0.19.0-0``,  ``0.18.2-0``,  ``0.18.1-0``,  ``0.18.0-1``,  ``0.17.0-1``,  ``0.16.0-1``,  ``0.15.0-2``,  ``0.14.0-2``,  ``0.14.0-0``,  ``0.13.0-0``,  ``0.12.0-0``,  ``0.11.0-0``,  ``0.10.0-0``,  ``0.9.1-0``,  ``0.9.0-0``,  ``0.8.0-0``,  ``0.7.1-0``,  ``0.7.0-0``,  ``0.6.1-0``,  ``0.6.0-0``,  ``0.5.0-0``,  ``0.4.6-0``,  ``0.4.5-0``,  ``0.4.4-0``
...
.. raw:: html
    ...
    <script>
        var package = "csvtk";
        var versions = ["0.24.0","0.23.0","0.22.0","0.22.0","0.21.0"];
    </script>
