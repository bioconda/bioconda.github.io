...
.. conda:recipe:: bioconductor-netpathminer
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/NetPathMiner.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-netpathminer
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.34.0-1</code>,  <code>1.34.0-0</code>,  <code>1.30.0-2</code>,  <code>1.30.0-1</code>,  <code>1.30.0-0</code>,  <code>1.28.0-0</code>,  <code>1.26.0-1</code>,  <code>1.26.0-0</code>,  <code>1.24.0-0</code>,  </span></summary>
      

      ``1.34.0-1``,  ``1.34.0-0``,  ``1.30.0-2``,  ``1.30.0-1``,  ``1.30.0-0``,  ``1.28.0-0``,  ``1.26.0-1``,  ``1.26.0-0``,  ``1.24.0-0``,  ``1.22.0-0``,  ``1.20.0-1``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-0``,  ``1.12.1-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.34.0","1.34.0","1.30.0","1.30.0","1.30.0"];
    </script>
