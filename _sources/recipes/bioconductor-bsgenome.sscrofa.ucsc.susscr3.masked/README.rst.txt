...
.. conda:package:: bioconductor-bsgenome.sscrofa.ucsc.susscr3.masked
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bsgenome.sscrofa.ucsc.susscr3.masked

   and update with::

      mamba update bioconductor-bsgenome.sscrofa.ucsc.susscr3.masked

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bsgenome.sscrofa.ucsc.susscr3.masked
