...
.. conda:package:: bioconductor-txdb.rnorvegicus.ucsc.rn5.refgene
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-txdb.rnorvegicus.ucsc.rn5.refgene

   and update with::

      mamba update bioconductor-txdb.rnorvegicus.ucsc.rn5.refgene

  To create a new environment, run::

      mamba create --name myenvname bioconductor-txdb.rnorvegicus.ucsc.rn5.refgene
