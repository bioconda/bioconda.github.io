...
.. conda:recipe:: bioconductor-eatonetalchipseq
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/EatonEtAlChIPseq.html
...
.. conda:package:: bioconductor-eatonetalchipseq
   ...
   :versions:
      ...
      ``0.48.0-0``,  ``0.44.0-0``,  ``0.40.0-0``,  ``0.38.0-0``,  ``0.36.0-0``,  ``0.32.0-1``,  ``0.32.0-0``,  ``0.30.0-0``,  ``0.28.0-1``,  ``0.28.0-0``,  ``0.26.0-0``,  ``0.24.0-0``,  ``0.22.0-1``,  ``0.20.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-eatonetalchipseq

to add into an existing workspace instead, run::

    pixi add bioconductor-eatonetalchipseq
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-eatonetalchipseq
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-eatonetalchipseq"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-eatonetalchipseq"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-eatonetalchipseq"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-eatonetalchipseq
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-eatonetalchipseq/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-eatonetalchipseq', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-eatonetalchipseq
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-eatonetalchipseq/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-eatonetalchipseq', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-eatonetalchipseq
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-eatonetalchipseq/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-eatonetalchipseq', spec);
            } catch (err) {
