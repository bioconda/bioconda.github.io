...
.. conda:package:: deeptoolsintervals
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.1.9-12</code>,  <code>0.1.9-11</code>,  <code>0.1.9-10</code>,  <code>0.1.9-9</code>,  <code>0.1.9-8</code>,  <code>0.1.9-7</code>,  <code>0.1.9-6</code>,  <code>0.1.9-5</code>,  <code>0.1.9-4</code>,  </span></summary>
      

      ``0.1.9-12``,  ``0.1.9-11``,  ``0.1.9-10``,  ``0.1.9-9``,  ``0.1.9-8``,  ``0.1.9-7``,  ``0.1.9-6``,  ``0.1.9-5``,  ``0.1.9-4``,  ``0.1.9-3``,  ``0.1.9-2``,  ``0.1.9-1``,  ``0.1.9-0``,  ``0.1.8-0``,  ``0.1.7-2``,  ``0.1.7-1``,  ``0.1.7-0``
...
to install globally, run::
    ...
    pixi global install deeptoolsintervals

to add into an existing workspace instead, run::

    pixi add deeptoolsintervals
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname deeptoolsintervals
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_deeptoolsintervals"></div>
   <div style="width: 100%" id="platform_plot_deeptoolsintervals"></div>
   <div style="width: 100%" id="cdf_plot_deeptoolsintervals"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for deeptoolsintervals
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/deeptoolsintervals/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_deeptoolsintervals', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for deeptoolsintervals
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/deeptoolsintervals/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_deeptoolsintervals', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for deeptoolsintervals
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/deeptoolsintervals/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_deeptoolsintervals', spec);
            } catch (err) {
