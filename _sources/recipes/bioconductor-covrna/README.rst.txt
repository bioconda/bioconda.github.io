...
.. conda:recipe:: bioconductor-covrna
   ...
   :homepage: https://bioconductor.org/packages/3.8/bioc/html/covRNA.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-covrna
   ...
   :depends: :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`bioconductor-genefilter` >=1.64.0,<1.65.0 :conda:package:`r-ade4`  :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-covrna|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-covrna


.. |required_by_bioconductor-covrna| conda:required_by:: bioconductor-covrna
