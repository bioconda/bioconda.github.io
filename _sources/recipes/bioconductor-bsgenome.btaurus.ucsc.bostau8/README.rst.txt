...
.. conda:recipe:: bioconductor-bsgenome.btaurus.ucsc.bostau8
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/BSgenome.Btaurus.UCSC.bosTau8.html
...
.. conda:package:: bioconductor-bsgenome.btaurus.ucsc.bostau8
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bsgenome.btaurus.ucsc.bostau8

   and update with::

      mamba update bioconductor-bsgenome.btaurus.ucsc.bostau8

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bsgenome.btaurus.ucsc.bostau8
