...
.. conda:recipe:: bioconductor-flowsorted.blood.epic
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/FlowSorted.Blood.EPIC.html
   :license: GPL-3
...
.. conda:package:: bioconductor-flowsorted.blood.epic
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.14.0-0</code>,  <code>2.10.0-0</code>,  <code>2.6.0-0</code>,  <code>2.4.2-0</code>,  <code>2.2.0-0</code>,  <code>1.12.1-1</code>,  <code>1.12.1-0</code>,  <code>1.10.0-0</code>,  <code>1.8.0-1</code>,  </span></summary>
      

      ``2.14.0-0``,  ``2.10.0-0``,  ``2.6.0-0``,  ``2.4.2-0``,  ``2.2.0-0``,  ``1.12.1-1``,  ``1.12.1-0``,  ``1.10.0-0``,  ``1.8.0-1``,  ``1.8.0-0``,  ``1.6.1-0``,  ``1.4.0-0``,  ``1.2.0-1``,  ``1.0.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-flowsorted.blood.epic

to add into an existing workspace instead, run::

    pixi add bioconductor-flowsorted.blood.epic
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-flowsorted.blood.epic
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["2.14.0","2.10.0","2.6.0","2.4.2","2.2.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-flowsorted.blood.epic"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-flowsorted.blood.epic"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-flowsorted.blood.epic"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-flowsorted.blood.epic
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-flowsorted.blood.epic/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-flowsorted.blood.epic', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-flowsorted.blood.epic
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-flowsorted.blood.epic/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-flowsorted.blood.epic', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-flowsorted.blood.epic
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-flowsorted.blood.epic/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-flowsorted.blood.epic', spec);
            } catch (err) {
