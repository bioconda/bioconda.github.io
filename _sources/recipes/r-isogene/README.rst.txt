...
Versions      
License       GPL-3
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes/r-isogene
...
A Docker container is available at https://quay.io/repository/biocontainers/r-isogene.
...
Render an |badge| badge with the following Markdown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square)](http://bioconda.github.io/recipes/r-isogene/README.html)

.. |badge| image:: https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square
           :target: http://bioconda.github.io/recipes/r-isogene/README.html
.. |downloads| image:: https://anaconda.org/bioconda/r-isogene/badges/downloads.svg
               :target: https://anaconda.org/bioconda/r-isogene
.. |docker| image:: https://quay.io/repository/biocontainers/r-isogene/status
