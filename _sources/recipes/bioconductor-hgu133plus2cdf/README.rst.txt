...
.. conda:recipe:: bioconductor-hgu133plus2cdf
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/hgu133plus2cdf.html
   :license: LGPL
...
to install globally, run::
    ...
    pixi global install bioconductor-hgu133plus2cdf

to add into an existing workspace instead, run::

    pixi add bioconductor-hgu133plus2cdf
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-hgu133plus2cdf
...
For e.g. docker, run::
    ...
    docker pull quay.io/biocontainers/bioconductor-hgu133plus2cdf:<tag>

(see `bioconductor-hgu133plus2cdf/tags`_ for valid values for ``<tag>``).
...
.. _`bioconductor-hgu133plus2cdf/tags`: https://quay.io/repository/biocontainers/bioconductor-hgu133plus2cdf?tab=tags


.. raw:: html

   <script>
      var package = "bioconductor-hgu133plus2cdf";
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-hgu133plus2cdf"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-hgu133plus2cdf"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-hgu133plus2cdf"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-hgu133plus2cdf
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hgu133plus2cdf/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-hgu133plus2cdf', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-hgu133plus2cdf
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hgu133plus2cdf/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-hgu133plus2cdf', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-hgu133plus2cdf
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hgu133plus2cdf/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-hgu133plus2cdf', spec);
            } catch (err) {
