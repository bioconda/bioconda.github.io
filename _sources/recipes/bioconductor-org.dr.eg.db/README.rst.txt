...
.. conda:recipe:: bioconductor-org.dr.eg.db
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/org.Dr.eg.db.html
...
.. conda:package:: bioconductor-org.dr.eg.db
   ...
   :versions:
      ...
      ``3.22.0-0``,  ``3.20.0-0``,  ``3.18.0-0``,  ``3.17.0-0``,  ``3.16.0-0``,  ``3.14.0-1``,  ``3.14.0-0``,  ``3.13.0-0``,  ``3.12.0-1``,  ``3.12.0-0``,  ``3.11.1-0``,  ``3.10.0-0``,  ``3.8.2-1``,  ``3.7.0-1``,  ``3.7.0-0``,  ``3.6.0-0``,  ``3.5.0-1``,  ``3.5.0-0``,  ``3.4.2-0``,  ``3.4.1-1``,  ``3.4.1-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-org.dr.eg.db

to add into an existing workspace instead, run::

    pixi add bioconductor-org.dr.eg.db
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-org.dr.eg.db
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-org.dr.eg.db"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-org.dr.eg.db"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-org.dr.eg.db"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-org.dr.eg.db
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-org.dr.eg.db/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-org.dr.eg.db', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-org.dr.eg.db
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-org.dr.eg.db/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-org.dr.eg.db', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-org.dr.eg.db
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-org.dr.eg.db/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-org.dr.eg.db', spec);
            } catch (err) {
