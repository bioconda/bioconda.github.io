...
.. conda:recipe:: bioconductor-org.dr.eg.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/org.Dr.eg.db.html
...
.. conda:package:: bioconductor-org.dr.eg.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-org.dr.eg.db

   and update with::

      mamba update bioconductor-org.dr.eg.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-org.dr.eg.db
