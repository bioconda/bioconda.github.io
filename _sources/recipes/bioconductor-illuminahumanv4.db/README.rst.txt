...
.. conda:package:: bioconductor-illuminahumanv4.db
   ...
   :required~by: |required_by_bioconductor-illuminahumanv4.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-illuminahumanv4.db


.. |required_by_bioconductor-illuminahumanv4.db| conda:required_by:: bioconductor-illuminahumanv4.db
