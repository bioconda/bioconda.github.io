...
.. conda:recipe:: bioconductor-htmg430acdf
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/htmg430acdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-htmg430acdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-htmg430acdf

   and update with::

      mamba update bioconductor-htmg430acdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-htmg430acdf
