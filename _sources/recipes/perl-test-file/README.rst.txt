...
.. conda:package:: perl-test-file
   ...
   :versions:
      ...
      ``1.995-0``,  ``1.994-0``,  ``1.993-0``,  ``1.992-0``,  ``1.991-0``,  ``1.443-1``,  ``1.443-0``
...
to install globally, run::
    ...
    pixi global install perl-test-file

to add into an existing workspace instead, run::

    pixi add perl-test-file
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname perl-test-file
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.995","1.994","1.993","1.992","1.991"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_perl-test-file"></div>
   <div style="width: 100%" id="platform_plot_perl-test-file"></div>
   <div style="width: 100%" id="cdf_plot_perl-test-file"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for perl-test-file
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-test-file/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_perl-test-file', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for perl-test-file
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-test-file/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_perl-test-file', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for perl-test-file
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-test-file/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_perl-test-file', spec);
            } catch (err) {
