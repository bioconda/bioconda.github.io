...
.. conda:recipe:: bioconductor-rcwlpipelines
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/RcwlPipelines.html
   :license: GPL-2
...
.. conda:package:: bioconductor-rcwlpipelines
   ...
   :versions:
      ...
      ``1.14.0-0``,  ``1.10.0-1``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.2-0``,  ``1.6.0-0``,  ``1.4.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.14.0","1.10.0","1.10.0","1.8.0","1.6.2"];
    </script>
