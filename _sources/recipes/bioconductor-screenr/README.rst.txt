...
.. conda:recipe:: bioconductor-screenr
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/ScreenR.html
...
.. conda:package:: bioconductor-screenr
   ...
   :depends on r-ggplot2: ``>=3.3``
   :depends on r-ggvenn: ``>=0.1.9``
   :depends on r-magrittr: ``>=1.0``
   :depends on r-patchwork: ``>=1.1``
   :depends on r-purrr: ``>=0.3.4``
   :depends on r-rlang: ``>=0.4``
   :depends on r-scales: ``>=1.1.1``
   :depends on r-stringr: ``>=1.4``
   :depends on r-tibble: ``>=3.1.6``
   :depends on r-tidyr: ``>=1.2``
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-screenr"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-screenr"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-screenr"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-screenr
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-screenr/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-screenr', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-screenr
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-screenr/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-screenr', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-screenr
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-screenr/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-screenr', spec);
            } catch (err) {
