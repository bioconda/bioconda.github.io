...
.. conda:recipe:: bioconductor-rta10probeset.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/rta10probeset.db.html
...
.. conda:package:: bioconductor-rta10probeset.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rta10probeset.db

   and update with::

      mamba update bioconductor-rta10probeset.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rta10probeset.db
