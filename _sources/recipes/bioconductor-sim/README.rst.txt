...
.. conda:package:: bioconductor-sim
   ...
   :depends bioconductor-globaltest: ``>=5.64.0,<5.65.0``
   :depends bioconductor-globaltest: ``>=5.64.0,<5.65.0a0``
   :depends bioconductor-quantsmooth: ``>=1.76.0,<1.77.0``
   :depends bioconductor-quantsmooth: ``>=1.76.0,<1.77.0a0``
