...
.. conda:package:: prophyle
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.3.3.2-2</code>,  <code>0.3.3.2-1</code>,  <code>0.3.3.2-0</code>,  <code>0.3.3.1-0</code>,  <code>0.3.2.0-2</code>,  <code>0.3.2.0-1</code>,  <code>0.3.2.0-0</code>,  <code>0.3.1.0-7</code>,  <code>0.3.1.0-6</code>,  </span></summary>
      

      ``0.3.3.2-2``,  ``0.3.3.2-1``,  ``0.3.3.2-0``,  ``0.3.3.1-0``,  ``0.3.2.0-2``,  ``0.3.2.0-1``,  ``0.3.2.0-0``,  ``0.3.1.0-7``,  ``0.3.1.0-6``,  ``0.3.1.0-5``,  ``0.3.1.0-4``,  ``0.3.1.0-3``,  ``0.3.1.0-2``,  ``0.3.1.0-1``,  ``0.3.0.3-3``,  ``0.3.0.3-2``,  ``0.3.0.3-1``,  ``0.3.0.2-1``,  ``0.3.0.0-1``,  ``0.2.1.3-2``,  ``0.2.1.3-1``,  ``0.2.1.3-0``,  ``0.2.1.2-1``,  ``0.2.1.0-1``,  ``0.2.1.0-0``,  ``0.2.0.3-2``,  ``0.2.0.3-1``,  ``0.2.0.3-0``,  ``0.2.0.2-0``,  ``0.2.0-0``,  ``0.1.0.38-2``,  ``0.1.0.38-1``,  ``0.1.0.38-0``,  ``0.1.0.35-0``,  ``0.1.0.29-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.3.3.2","0.3.3.2","0.3.3.2","0.3.3.1","0.3.2.0"];
    </script>
