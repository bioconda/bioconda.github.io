...
.. conda:package:: gtotree
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.8.19-0</code>,  <code>1.8.18-0</code>,  <code>1.8.17-0</code>,  <code>1.8.16-2</code>,  <code>1.8.16-1</code>,  <code>1.8.16-0</code>,  <code>1.8.15-0</code>,  <code>1.8.14-0</code>,  <code>1.8.13-0</code>,  </span></summary>
      

      ``1.8.19-0``,  ``1.8.18-0``,  ``1.8.17-0``,  ``1.8.16-2``,  ``1.8.16-1``,  ``1.8.16-0``,  ``1.8.15-0``,  ``1.8.14-0``,  ``1.8.13-0``,  ``1.8.12-0``,  ``1.8.11-0``,  ``1.8.10-0``,  ``1.8.9-0``,  ``1.8.8-1``,  ``1.8.8-0``,  ``1.8.7-0``,  ``1.8.6-0``,  ``1.8.5-0``,  ``1.8.4-0``,  ``1.8.3-0``,  ``1.8.2-0``,  ``1.8.1-0``,  ``1.7.10-0``,  ``1.7.08-0``,  ``1.7.07-0``,  ``1.7.06-0``,  ``1.7.05-1``
   ...
   :depends on requests: ``2.34.*``
   :depends on sed: 
   :depends on tar: 
   :depends on taxonkit: 
   :depends on tqdm: ``4.68.*``
   :depends on trimal: 
...
.. raw:: html
   ...
   <script>
      var package = "gtotree";
      var versions = ["1.8.19","1.8.18","1.8.17","1.8.16","1.8.16"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_gtotree"></div>
   <div style="width: 100%" id="platform_plot_gtotree"></div>
   <div style="width: 100%" id="cdf_plot_gtotree"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/gtotree/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_gtotree', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for gtotree
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/gtotree/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_gtotree', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for gtotree
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/gtotree/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_gtotree', spec);
            } catch (err) {
