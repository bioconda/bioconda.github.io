...
.. conda:package:: bioconductor-bsgenome.hsapiens.ucsc.hg17.masked
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bsgenome.hsapiens.ucsc.hg17.masked

   and update with::

      mamba update bioconductor-bsgenome.hsapiens.ucsc.hg17.masked

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bsgenome.hsapiens.ucsc.hg17.masked
