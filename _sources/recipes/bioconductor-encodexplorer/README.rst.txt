...
.. conda:recipe:: bioconductor-encodexplorer
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/ENCODExplorer.html
...
.. conda:package:: bioconductor-encodexplorer
   ...
   :versions:
      ...
      ``2.16.0-1``,  ``2.16.0-0``,  ``2.14.0-0``,  ``2.12.0-0``,  ``2.10.0-1``,  ``2.8.0-0``,  ``2.6.0-0``,  ``2.4.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-encodexplorer";
        var versions = ["2.16.0","2.16.0","2.14.0","2.12.0","2.10.0"];
    </script>
