...
.. conda:recipe:: bioconductor-daglogo
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/dagLogo.html
   :license: GPL (>=2)
...
.. conda:package:: bioconductor-daglogo
   ...
   :versions:
      ...
      ``1.36.0-0``,  ``1.32.0-0``,  ``1.30.0-0``,  ``1.28.1-0``,  ``1.28.0-0``,  ``1.26.0-0``,  ``1.24.0-0``,  ``1.22.2-0``,  ``1.20.0-0``
   ...
   :depends bioconductor-uniprot.ws: ``>=2.38.0,<2.39.0``
