...
.. conda:recipe:: bioconductor-mouse4302frmavecs
   ...
   :homepage: https://bioconductor.org/packages/3.16/data/annotation/html/mouse4302frmavecs.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-mouse4302frmavecs
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.5.0-11</code>,  <code>1.5.0-10</code>,  <code>1.5.0-9</code>,  <code>1.5.0-8</code>,  <code>1.5.0-7</code>,  <code>1.5.0-6</code>,  <code>1.5.0-5</code>,  <code>1.5.0-4</code>,  <code>1.5.0-3</code>,  </span></summary>
      

      ``1.5.0-11``,  ``1.5.0-10``,  ``1.5.0-9``,  ``1.5.0-8``,  ``1.5.0-7``,  ``1.5.0-6``,  ``1.5.0-5``,  ``1.5.0-4``,  ``1.5.0-3``,  ``1.5.0-2``,  ``1.5.0-1``,  ``1.5.0-0``
