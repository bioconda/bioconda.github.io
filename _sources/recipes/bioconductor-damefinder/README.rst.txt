...
.. conda:recipe:: bioconductor-damefinder
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/DAMEfinder.html
...
.. conda:package:: bioconductor-damefinder
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-damefinder

   and update with::

      mamba update bioconductor-damefinder

  To create a new environment, run::

      mamba create --name myenvname bioconductor-damefinder
