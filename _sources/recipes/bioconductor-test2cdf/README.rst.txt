...
.. conda:recipe:: bioconductor-test2cdf
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/test2cdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-test2cdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-test2cdf

   and update with::

      mamba update bioconductor-test2cdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-test2cdf
