...
.. conda:package:: pyfaidx
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.9.0.4-0</code>,  <code>0.9.0.3-0</code>,  <code>0.9.0.1-0</code>,  <code>0.9.0-0</code>,  <code>0.8.2-0</code>,  <code>0.8.1.4-0</code>,  <code>0.8.1.3-0</code>,  <code>0.8.1.2-0</code>,  <code>0.8.1.1-0</code>,  </span></summary>
      

      ``0.9.0.4-0``,  ``0.9.0.3-0``,  ``0.9.0.1-0``,  ``0.9.0-0``,  ``0.8.2-0``,  ``0.8.1.4-0``,  ``0.8.1.3-0``,  ``0.8.1.2-0``,  ``0.8.1.1-0``,  ``0.8.0-0``,  ``0.7.2.2-0``,  ``0.7.2.1-1``,  ``0.7.2.1-0``,  ``0.7.1-0``,  ``0.7.0-1``,  ``0.7.0-0``,  ``0.6.4-0``,  ``0.6.3.1-1``,  ``0.6.3.1-0``,  ``0.6.2-0``,  ``0.6.1-0``,  ``0.6.0-0``,  ``0.5.9.5-0``,  ``0.5.9.4-0``,  ``0.5.9.2-0``,  ``0.5.9.1-1``,  ``0.5.9.1-0``,  ``0.5.9-1``,  ``0.5.9-0``,  ``0.5.8-1``,  ``0.5.8-0``,  ``0.5.7-0``,  ``0.5.6-0``,  ``0.5.5.2-1``,  ``0.5.5.2-0``,  ``0.5.4.1-0``,  ``0.5.3-0``,  ``0.5.1-0``,  ``0.5.0-0``,  ``0.4.9.2-0``,  ``0.4.8.1-4``,  ``0.4.8.1-3``,  ``0.4.8.1-2``,  ``0.4.8.1-0``,  ``0.4.7.1-3``,  ``0.4.7.1-2``,  ``0.4.7.1-0``,  ``0.4.4-0``
...
.. raw:: html
   ...
   <script>
      var package = "pyfaidx";
      var versions = ["0.9.0.4","0.9.0.3","0.9.0.1","0.9.0","0.8.2"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_pyfaidx"></div>
   <div style="width: 100%" id="platform_plot_pyfaidx"></div>
   <div style="width: 100%" id="cdf_plot_pyfaidx"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/pyfaidx/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_pyfaidx', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for pyfaidx
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/pyfaidx/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_pyfaidx', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for pyfaidx
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/pyfaidx/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_pyfaidx', spec);
            } catch (err) {
