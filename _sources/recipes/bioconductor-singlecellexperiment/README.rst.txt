...
.. conda:package:: bioconductor-singlecellexperiment
   ...
   :depends: :conda:package:`bioconductor-biocgenerics` >=0.28.0,<0.29.0 :conda:package:`bioconductor-s4vectors` >=0.20.0,<0.21.0 :conda:package:`bioconductor-summarizedexperiment` >=1.12.0,<1.13.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-singlecellexperiment|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-singlecellexperiment


.. |required_by_bioconductor-singlecellexperiment| conda:required_by:: bioconductor-singlecellexperiment
