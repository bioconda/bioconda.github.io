...
.. conda:package:: bioconductor-signet
   ...
   :depends: :conda:package:`bioconductor-graph` >=1.60.0,<1.61.0 :conda:package:`bioconductor-rbgl` >=1.58.0,<1.59.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-igraph`  

   :required~by: |required_by_bioconductor-signet|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-signet


.. |required_by_bioconductor-signet| conda:required_by:: bioconductor-signet
