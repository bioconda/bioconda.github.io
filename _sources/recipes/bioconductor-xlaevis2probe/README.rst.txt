...
.. conda:recipe:: bioconductor-xlaevis2probe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/xlaevis2probe.html
   :license: LGPL
...
.. conda:package:: bioconductor-xlaevis2probe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-xlaevis2probe

   and update with::

      mamba update bioconductor-xlaevis2probe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-xlaevis2probe
