...
.. conda:recipe:: bioconductor-ygs98cdf
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/ygs98cdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-ygs98cdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ygs98cdf

   and update with::

      mamba update bioconductor-ygs98cdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ygs98cdf
