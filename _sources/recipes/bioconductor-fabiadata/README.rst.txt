...
.. conda:recipe:: bioconductor-fabiadata
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/fabiaData.html
   :license: LGPL (>= 2.1)
...
.. conda:package:: bioconductor-fabiadata
   ...
   :versions:
      ...
      ``1.48.0-0``,  ``1.44.0-0``,  ``1.40.0-0``,  ``1.38.0-0``,  ``1.36.0-0``,  ``1.32.0-1``,  ``1.32.0-0``,  ``1.30.0-0``,  ``1.28.0-1``,  ``1.28.0-0``,  ``1.27.0-0``,  ``1.26.0-0``,  ``1.24.0-0``,  ``1.22.0-1``,  ``1.20.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-fabiadata

to add into an existing workspace instead, run::

    pixi add bioconductor-fabiadata
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-fabiadata
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-fabiadata"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-fabiadata"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-fabiadata"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-fabiadata
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-fabiadata/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-fabiadata', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-fabiadata
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-fabiadata/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-fabiadata', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-fabiadata
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-fabiadata/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-fabiadata', spec);
            } catch (err) {
