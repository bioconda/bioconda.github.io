...
.. conda:recipe:: bioconductor-alternativesplicingevents.hg38
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/alternativeSplicingEvents.hg38.html
...
.. conda:package:: bioconductor-alternativesplicingevents.hg38
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-alternativesplicingevents.hg38

   and update with::

      mamba update bioconductor-alternativesplicingevents.hg38

  To create a new environment, run::

      mamba create --name myenvname bioconductor-alternativesplicingevents.hg38
