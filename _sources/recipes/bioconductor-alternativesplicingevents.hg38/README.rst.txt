...
.. conda:recipe:: bioconductor-alternativesplicingevents.hg38
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/alternativeSplicingEvents.hg38.html
...
.. conda:package:: bioconductor-alternativesplicingevents.hg38
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.1.0-6</code>,  <code>1.1.0-5</code>,  <code>1.1.0-4</code>,  <code>1.1.0-3</code>,  <code>1.1.0-2</code>,  <code>1.1.0-1</code>,  <code>1.1.0-0</code>,  <code>1.0.1-8</code>,  <code>1.0.1-7</code>,  </span></summary>
      

      ``1.1.0-6``,  ``1.1.0-5``,  ``1.1.0-4``,  ``1.1.0-3``,  ``1.1.0-2``,  ``1.1.0-1``,  ``1.1.0-0``,  ``1.0.1-8``,  ``1.0.1-7``,  ``1.0.1-6``,  ``1.0.1-5``,  ``1.0.1-4``,  ``1.0.1-3``,  ``1.0.1-1``,  ``1.0.1-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-alternativesplicingevents.hg38

to add into an existing workspace instead, run::

    pixi add bioconductor-alternativesplicingevents.hg38
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-alternativesplicingevents.hg38
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-alternativesplicingevents.hg38"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-alternativesplicingevents.hg38"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-alternativesplicingevents.hg38"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-alternativesplicingevents.hg38
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-alternativesplicingevents.hg38/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-alternativesplicingevents.hg38', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-alternativesplicingevents.hg38
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-alternativesplicingevents.hg38/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-alternativesplicingevents.hg38', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-alternativesplicingevents.hg38
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-alternativesplicingevents.hg38/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-alternativesplicingevents.hg38', spec);
            } catch (err) {
