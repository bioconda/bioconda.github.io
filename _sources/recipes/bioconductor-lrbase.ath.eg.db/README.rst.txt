...
.. conda:recipe:: bioconductor-lrbase.ath.eg.db
   ...
   Ligand\-Receptor list for Arabidopsis thaliana \(Ath\, Thale cress\, Taxonomy ID\: 3702\)

   :homepage: https://bioconductor.org/packages/3.13/data/annotation/html/LRBase.Ath.eg.db.html
