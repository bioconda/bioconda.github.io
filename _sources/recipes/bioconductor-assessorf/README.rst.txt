...
.. conda:package:: bioconductor-assessorf
   ...
   :depends: :conda:package:`bioconductor-biostrings` >=2.50.0,<2.51.0 :conda:package:`bioconductor-decipher` >=2.10.0,<2.11.0 :conda:package:`bioconductor-genomicranges` >=1.34.0,<1.35.0 :conda:package:`bioconductor-iranges` >=2.16.0,<2.17.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-assessorf|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-assessorf


.. |required_by_bioconductor-assessorf| conda:required_by:: bioconductor-assessorf
