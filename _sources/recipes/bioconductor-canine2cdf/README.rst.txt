...
.. conda:recipe:: bioconductor-canine2cdf
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/canine2cdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-canine2cdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-canine2cdf

   and update with::

      mamba update bioconductor-canine2cdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-canine2cdf
