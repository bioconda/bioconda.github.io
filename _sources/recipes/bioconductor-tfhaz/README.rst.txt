...
.. conda:recipe:: bioconductor-tfhaz
   ...
   :homepage: https://bioconductor.org/packages/3.8/bioc/html/TFHAZ.html
...
.. conda:package:: bioconductor-tfhaz
   ...
   :depends: :conda:package:`bioconductor-genomicranges` >=1.34.0,<1.35.0 :conda:package:`bioconductor-iranges` >=2.16.0,<2.17.0 :conda:package:`bioconductor-s4vectors` >=0.20.0,<0.21.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-tfhaz|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-tfhaz


.. |required_by_bioconductor-tfhaz| conda:required_by:: bioconductor-tfhaz
