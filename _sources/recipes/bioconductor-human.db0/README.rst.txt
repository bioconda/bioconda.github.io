...
.. conda:recipe:: bioconductor-human.db0
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/human.db0.html
...
.. conda:package:: bioconductor-human.db0
   ...
   :required~by: |required_by_bioconductor-human.db0|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-human.db0


.. |required_by_bioconductor-human.db0| conda:required_by:: bioconductor-human.db0
