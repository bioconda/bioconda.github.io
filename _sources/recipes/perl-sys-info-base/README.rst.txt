...
.. conda:package:: perl-sys-info-base
   ...
   :depends: :conda:package:`perl` >=5.26.2,<5.26.3.0a0 :conda:package:`perl-text-template-simple`  

   :required~by: |required_by_perl-sys-info-base|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/perl-sys-info-base


.. |required_by_perl-sys-info-base| conda:required_by:: perl-sys-info-base
