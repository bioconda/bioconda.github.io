...
.. conda:recipe:: bioconductor-ctdquerier
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/CTDquerier.html
...
.. conda:package:: bioconductor-ctdquerier
   ...
   :versions:
      ...
      ``2.2.0-0``,  ``2.0.0-0``,  ``1.5.0-0``,  ``1.4.0-1``,  ``1.2.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.2.0","2.0.0","1.5.0","1.4.0","1.2.0"];
    </script>
