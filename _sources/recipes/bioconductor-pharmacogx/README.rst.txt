...
.. conda:recipe:: bioconductor-pharmacogx
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/PharmacoGx.html
   :license: GPL (>= 3)
...
.. conda:package:: bioconductor-pharmacogx
   ...
   :depends on bioconductor-coregx: ``>=2.14.0,<2.15.0a0``
...
to install globally, run::
    ...
    pixi global install bioconductor-pharmacogx

to add into an existing workspace instead, run::

    pixi add bioconductor-pharmacogx
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-pharmacogx
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-pharmacogx"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-pharmacogx"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-pharmacogx"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-pharmacogx
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pharmacogx/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-pharmacogx', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-pharmacogx
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pharmacogx/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-pharmacogx', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-pharmacogx
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pharmacogx/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-pharmacogx', spec);
            } catch (err) {
