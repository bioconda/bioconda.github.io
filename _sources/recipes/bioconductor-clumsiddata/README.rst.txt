...
.. conda:recipe:: bioconductor-clumsiddata
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/CluMSIDdata.html
...
.. conda:package:: bioconductor-clumsiddata
   ...
   :versions:
      ...
      ``1.26.0-0``,  ``1.22.0-0``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.13.0-0``,  ``1.10.0-1``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.0-1``,  ``1.6.0-0``,  ``1.5.0-0``,  ``1.4.0-0``,  ``1.2.0-0``,  ``1.0.0-1``
...
to install globally, run::
    ...
    pixi global install bioconductor-clumsiddata

to add into an existing workspace instead, run::

    pixi add bioconductor-clumsiddata
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-clumsiddata
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-clumsiddata"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-clumsiddata"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-clumsiddata"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-clumsiddata
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-clumsiddata/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-clumsiddata', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-clumsiddata
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-clumsiddata/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-clumsiddata', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-clumsiddata
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-clumsiddata/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-clumsiddata', spec);
            } catch (err) {
