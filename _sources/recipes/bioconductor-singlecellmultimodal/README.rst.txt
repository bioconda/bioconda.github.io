...
.. conda:recipe:: bioconductor-singlecellmultimodal
   ...
   :homepage: https://bioconductor.org/packages/3.14/data/experiment/html/SingleCellMultiModal.html
...
.. conda:package:: bioconductor-singlecellmultimodal
   ...
   :versions:
      ...
      ``1.10.0-0``,  ``1.6.0-1``,  ``1.6.0-0``,  ``1.4.1-0``,  ``1.2.4-0``,  ``1.1.19-0``,  ``1.0.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.10.0","1.6.0","1.6.0","1.4.1","1.2.4"];
    </script>
