...
.. conda:package:: bioconductor-bsgenome.mmusculus.ucsc.mm10
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.4.3-1</code>,  <code>1.4.3-0</code>,  <code>1.4.0-12</code>,  <code>1.4.0-11</code>,  <code>1.4.0-10</code>,  <code>1.4.0-9</code>,  <code>1.4.0-8</code>,  <code>1.4.0-7</code>,  <code>1.4.0-5</code>,  </span></summary>
      

      ``1.4.3-1``,  ``1.4.3-0``,  ``1.4.0-12``,  ``1.4.0-11``,  ``1.4.0-10``,  ``1.4.0-9``,  ``1.4.0-8``,  ``1.4.0-7``,  ``1.4.0-5``,  ``1.4.0-4``,  ``1.4.0-2``,  ``1.4.0-1``,  ``1.4.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.4.3","1.4.3","1.4.0","1.4.0","1.4.0"];
    </script>
