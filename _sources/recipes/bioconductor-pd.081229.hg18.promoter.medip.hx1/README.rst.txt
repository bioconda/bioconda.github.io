...
.. conda:package:: bioconductor-pd.081229.hg18.promoter.medip.hx1
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.081229.hg18.promoter.medip.hx1

   and update with::

      mamba update bioconductor-pd.081229.hg18.promoter.medip.hx1

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.081229.hg18.promoter.medip.hx1
