...
.. conda:recipe:: kamino
   ...
   :documentation: https://github.com/rderelle/kamino/blob/0.6.1/README.md
...
.. conda:package:: kamino
   ...
   :versions:
      ...
      ``0.6.1-0``,  ``0.6.0-0``,  ``0.5.1-0``,  ``0.5.0-0``,  ``0.4.0-0``,  ``0.3.0-0``,  ``0.2.1-0``,  ``0.2.0-0``,  ``0.1.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "kamino";
        var versions = ["0.6.1","0.6.0","0.5.1","0.5.0","0.4.0"];
    </script>
