...
.. conda:recipe:: bioconductor-hicbricks
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/HiCBricks.html
...
.. conda:package:: bioconductor-hicbricks
   ...
   :versions:
      ...
      ``1.11.0-0``,  ``1.10.0-0``,  ``1.8.0-1``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.0-1``,  ``1.0.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.11.0","1.10.0","1.8.0","1.8.0","1.6.0"];
    </script>
