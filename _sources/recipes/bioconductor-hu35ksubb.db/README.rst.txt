...
.. conda:recipe:: bioconductor-hu35ksubb.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/hu35ksubb.db.html
...
.. conda:package:: bioconductor-hu35ksubb.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hu35ksubb.db

   and update with::

      mamba update bioconductor-hu35ksubb.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hu35ksubb.db
