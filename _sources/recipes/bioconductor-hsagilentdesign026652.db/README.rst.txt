...
.. conda:recipe:: bioconductor-hsagilentdesign026652.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/HsAgilentDesign026652.db.html
...
.. conda:package:: bioconductor-hsagilentdesign026652.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hsagilentdesign026652.db

   and update with::

      mamba update bioconductor-hsagilentdesign026652.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hsagilentdesign026652.db
