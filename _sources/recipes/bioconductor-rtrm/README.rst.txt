...
.. conda:package:: bioconductor-rtrm
   ...
   :depends: :conda:package:`bioconductor-annotationdbi` >=1.44.0,<1.45.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-dbi`  :conda:package:`r-igraph` >=1.0 :conda:package:`r-rsqlite`  

   :required~by: |required_by_bioconductor-rtrm|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-rtrm


.. |required_by_bioconductor-rtrm| conda:required_by:: bioconductor-rtrm
