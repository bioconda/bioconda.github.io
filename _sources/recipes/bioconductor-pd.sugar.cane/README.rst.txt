...
.. conda:recipe:: bioconductor-pd.sugar.cane
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/pd.sugar.cane.html
...
.. conda:package:: bioconductor-pd.sugar.cane
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.sugar.cane

   and update with::

      mamba update bioconductor-pd.sugar.cane

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.sugar.cane
