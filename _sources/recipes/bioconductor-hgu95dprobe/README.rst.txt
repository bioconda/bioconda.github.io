...
.. conda:recipe:: bioconductor-hgu95dprobe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/hgu95dprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-hgu95dprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hgu95dprobe

   and update with::

      mamba update bioconductor-hgu95dprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hgu95dprobe
