...
.. conda:recipe:: bioconductor-hwgcod.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/hwgcod.db.html
...
.. conda:package:: bioconductor-hwgcod.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hwgcod.db

   and update with::

      mamba update bioconductor-hwgcod.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hwgcod.db
