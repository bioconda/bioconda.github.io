...
.. conda:package:: bioconductor-hwgcod.db
   ...
   :required~by: |required_by_bioconductor-hwgcod.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-hwgcod.db


.. |required_by_bioconductor-hwgcod.db| conda:required_by:: bioconductor-hwgcod.db
