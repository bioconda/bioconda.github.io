...
.. conda:package:: r-ichorcna
   ...
   :depends on bioconductor-bsgenome.hsapiens.ucsc.hg19: ``>=1.4.3,<1.5.0``
   :depends on bioconductor-bsgenome.hsapiens.ucsc.hg38: ``>=1.4.5,<1.5.0``
   :depends on bioconductor-genomeinfodb: ``>=1.34.9``
   :depends on bioconductor-genomicranges: ``>=1.50.2``
   :depends on bioconductor-hmmcopy: ``>=1.40``
   :depends on r-base: ``>=4.4,<4.5.0a0``
   :depends on r-data.table: ``>=1.14``
   :depends on r-domc: ``>=1.3.8``
...
to install globally, run::
    ...
    pixi global install r-ichorcna
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname r-ichorcna
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_r-ichorcna"></div>
   <div style="width: 100%" id="platform_plot_r-ichorcna"></div>
   <div style="width: 100%" id="cdf_plot_r-ichorcna"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-ichorcna/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_r-ichorcna', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for r-ichorcna
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-ichorcna/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_r-ichorcna', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for r-ichorcna
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-ichorcna/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_r-ichorcna', spec);
            } catch (err) {
