...
.. conda:recipe:: bioconductor-mgug4122a.db
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/mgug4122a.db.html
...
.. conda:package:: bioconductor-mgug4122a.db
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.2.3-19</code>,  <code>3.2.3-18</code>,  <code>3.2.3-17</code>,  <code>3.2.3-16</code>,  <code>3.2.3-15</code>,  <code>3.2.3-14</code>,  <code>3.2.3-13</code>,  <code>3.2.3-12</code>,  <code>3.2.3-11</code>,  </span></summary>
      

      ``3.2.3-19``,  ``3.2.3-18``,  ``3.2.3-17``,  ``3.2.3-16``,  ``3.2.3-15``,  ``3.2.3-14``,  ``3.2.3-13``,  ``3.2.3-12``,  ``3.2.3-11``,  ``3.2.3-10``,  ``3.2.3-9``,  ``3.2.3-8``,  ``3.2.3-7``,  ``3.2.3-5``,  ``3.2.3-4``,  ``3.2.3-2``,  ``3.2.3-1``,  ``3.2.3-0``,  ``3.2.2-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-mgug4122a.db

to add into an existing workspace instead, run::

    pixi add bioconductor-mgug4122a.db
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-mgug4122a.db
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-mgug4122a.db"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-mgug4122a.db"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-mgug4122a.db"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-mgug4122a.db
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-mgug4122a.db/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-mgug4122a.db', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-mgug4122a.db
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-mgug4122a.db/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-mgug4122a.db', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-mgug4122a.db
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-mgug4122a.db/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-mgug4122a.db', spec);
            } catch (err) {
