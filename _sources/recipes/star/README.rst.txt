...
.. conda:package:: star
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.7.10b-1</code>,  <code>2.7.10b-0</code>,  <code>2.7.10a-0</code>,  <code>2.7.9a-0</code>,  <code>2.7.8a-1</code>,  <code>2.7.8a-0</code>,  <code>2.7.7a-0</code>,  <code>2.7.6a-0</code>,  <code>2.7.5c-0</code>,  </span></summary>
      

      ``2.7.10b-1``,  ``2.7.10b-0``,  ``2.7.10a-0``,  ``2.7.9a-0``,  ``2.7.8a-1``,  ``2.7.8a-0``,  ``2.7.7a-0``,  ``2.7.6a-0``,  ``2.7.5c-0``,  ``2.7.5b-0``,  ``2.7.5a-0``,  ``2.7.4a-0``,  ``2.7.3a-0``,  ``2.7.2c-0``,  ``2.7.2b-0``,  ``2.7.2a-0``,  ``2.7.1a-0``,  ``2.7.0f-0``,  ``2.7.0e-0``,  ``2.7.0d-0``,  ``2.7.0b-0``,  ``2.6.1d-1``,  ``2.6.1d-0``,  ``2.6.1b-0``,  ``2.6.1a-1``,  ``2.6.0c-3``,  ``2.6.0c-2``,  ``2.6.0c-1``,  ``2.6.0c-0``,  ``2.6.0b-0``,  ``2.5.4a-0``,  ``2.5.3a-0``,  ``2.5.2b-0``,  ``2.5.2a-0``,  ``2.5.1b-0``,  ``2.5.0c-0``,  ``2.5.0b-0``,  ``2.5.0a-0``,  ``2.4.2a-0``,  ``2.4.0j-2``,  ``2.4.0j-1``,  ``2.4.0j-0``
...
.. raw:: html
    ...
    <script>
        var package = "star";
        var versions = ["2.7.10b","2.7.10b","2.7.10a","2.7.9a","2.7.8a"];
    </script>
