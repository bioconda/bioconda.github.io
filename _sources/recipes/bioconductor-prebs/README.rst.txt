...
.. conda:recipe:: bioconductor-prebs
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/prebs.html
...
.. conda:package:: bioconductor-prebs
   ...
   :depends on bioconductor-rpa: ``>=1.66.0,<1.67.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-prebs

to add into an existing workspace instead, run::

    pixi add bioconductor-prebs
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-prebs
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-prebs"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-prebs"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-prebs"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-prebs
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-prebs/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-prebs', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-prebs
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-prebs/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-prebs', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-prebs
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-prebs/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-prebs', spec);
            } catch (err) {
