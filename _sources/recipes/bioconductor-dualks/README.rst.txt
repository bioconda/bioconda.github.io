...
.. conda:recipe:: bioconductor-dualks
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/dualKS.html
   :license: LGPL (>= 2.0)
...
.. conda:package:: bioconductor-dualks
   ...
   :versions:
      ...
      ``1.53.0-0``,  ``1.52.0-0``,  ``1.50.0-1``,  ``1.50.0-0``,  ``1.48.0-0``,  ``1.46.0-0``,  ``1.44.0-1``,  ``1.42.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-dualks";
        var versions = ["1.53.0","1.52.0","1.50.0","1.50.0","1.48.0"];
    </script>
