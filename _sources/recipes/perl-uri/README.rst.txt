...
.. conda:package:: perl-uri
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>5.11-0</code>,  <code>5.10-0</code>,  <code>1.76-1</code>,  <code>1.76-0</code>,  <code>1.74-0</code>,  <code>1.71-3</code>,  <code>1.71-2</code>,  <code>1.71-1</code>,  <code>1.71-0</code>,  </span></summary>
      

      ``5.11-0``,  ``5.10-0``,  ``1.76-1``,  ``1.76-0``,  ``1.74-0``,  ``1.71-3``,  ``1.71-2``,  ``1.71-1``,  ``1.71-0``,  ``1.69-7``,  ``1.69-6``,  ``1.69-5``,  ``1.69-4``,  ``1.69-3``,  ``1.69-2``,  ``1.69-1``,  ``1.69-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["5.11","5.10","1.76","1.76","1.74"];
    </script>
