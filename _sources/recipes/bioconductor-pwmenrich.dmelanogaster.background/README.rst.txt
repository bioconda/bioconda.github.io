...
.. conda:recipe:: bioconductor-pwmenrich.dmelanogaster.background
   ...
   :homepage: https://bioconductor.org/packages/3.12/data/experiment/html/PWMEnrich.Dmelanogaster.background.html
   :license: GPL-3
...
.. conda:package:: bioconductor-pwmenrich.dmelanogaster.background
   ...
   :versions:
      ...
      ``4.24.0-1``,  ``4.24.0-0``,  ``4.22.0-0``,  ``4.20.0-0``,  ``4.18.0-1``,  ``4.16.0-0``

      

   
   :depends bioconductor-pwmenrich: ``>=4.26.0,<4.27.0``
