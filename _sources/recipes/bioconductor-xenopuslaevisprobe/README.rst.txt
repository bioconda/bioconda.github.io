...
.. conda:recipe:: bioconductor-xenopuslaevisprobe
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/xenopuslaevisprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-xenopuslaevisprobe
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-xenopuslaevisprobe:<tag>
