...
.. conda:recipe:: bioconductor-rgu34c.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/rgu34c.db.html
...
.. conda:package:: bioconductor-rgu34c.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rgu34c.db

   and update with::

      mamba update bioconductor-rgu34c.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rgu34c.db
