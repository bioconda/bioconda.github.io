...
.. conda:package:: moff
   ...
   :depends on pandas: ``>=0.23,<1.0.0``
   :depends on pymzml: ``>=2.0.6``
   :depends on pynumpress: 
   :depends on pyteomics: ``>=3.5``
   :depends on python: ``>=3.4,<3.7``
   :depends on scikit-learn: ``>0.19``
   :depends on scipy: ``>=1.1``
   :depends on simplejson: ``>=3.16.1``
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_moff"></div>
   <div style="width: 100%" id="platform_plot_moff"></div>
   <div style="width: 100%" id="cdf_plot_moff"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/moff/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_moff', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for moff
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/moff/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_moff', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for moff
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/moff/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_moff', spec);
            } catch (err) {
