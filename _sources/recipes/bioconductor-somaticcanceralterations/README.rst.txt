...
.. conda:recipe:: bioconductor-somaticcanceralterations
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/experiment/html/SomaticCancerAlterations.html
   :license: GPL-3
...
.. conda:package:: bioconductor-somaticcanceralterations
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-somaticcanceralterations

   and update with::

      mamba update bioconductor-somaticcanceralterations

  To create a new environment, run::

      mamba create --name myenvname bioconductor-somaticcanceralterations
