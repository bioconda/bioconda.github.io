...
.. conda:recipe:: bioconductor-drugvsdiseasedata
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/DrugVsDiseasedata.html
   :license: GPL-3
...
.. conda:package:: bioconductor-drugvsdiseasedata
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-drugvsdiseasedata

   and update with::

      mamba update bioconductor-drugvsdiseasedata

  To create a new environment, run::

      mamba create --name myenvname bioconductor-drugvsdiseasedata
