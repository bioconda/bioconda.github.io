...
.. conda:package:: bioconductor-systempiperdata
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.2.0-0</code>,  <code>1.22.3-0</code>,  <code>1.22.0-0</code>,  <code>1.20.0-0</code>,  <code>1.18.1-0</code>,  <code>1.18.0-0</code>,  <code>1.17.4-0</code>,  <code>1.16.1-0</code>,  <code>1.14.0-0</code>,  </span></summary>
      

      ``2.2.0-0``,  ``1.22.3-0``,  ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.1-0``,  ``1.18.0-0``,  ``1.17.4-0``,  ``1.16.1-0``,  ``1.14.0-0``,  ``1.12.0-1``,  ``1.10.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.2.0","1.22.3","1.22.0","1.20.0","1.18.1"];
    </script>
