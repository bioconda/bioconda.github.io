...
.. conda:package:: bioconductor-mesh.aor.db
   ...
   :required~by: |required_by_bioconductor-mesh.aor.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-mesh.aor.db


.. |required_by_bioconductor-mesh.aor.db| conda:required_by:: bioconductor-mesh.aor.db
