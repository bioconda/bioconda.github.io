...
Versions      0.9.7
License       GPL (>= 2)
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes/r-whopgenome
...
A Docker container is available at https://quay.io/repository/biocontainers/r-whopgenome.
...
Render an |badge| badge with the following Markdown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square)](http://bioconda.github.io/recipes/r-whopgenome/README.html)

.. |badge| image:: https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square
           :target: http://bioconda.github.io/recipes/r-whopgenome/README.html
.. |downloads| image:: https://anaconda.org/bioconda/r-whopgenome/badges/downloads.svg
               :target: https://anaconda.org/bioconda/r-whopgenome
.. |docker| image:: https://quay.io/repository/biocontainers/r-whopgenome/status
