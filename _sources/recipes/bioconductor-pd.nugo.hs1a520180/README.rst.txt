...
.. conda:recipe:: bioconductor-pd.nugo.hs1a520180
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/pd.nugo.hs1a520180.html
...
.. conda:package:: bioconductor-pd.nugo.hs1a520180
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.nugo.hs1a520180

   and update with::

      mamba update bioconductor-pd.nugo.hs1a520180

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.nugo.hs1a520180
