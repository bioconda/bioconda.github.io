...
.. conda:recipe:: bioconductor-pd.nugo.hs1a520180
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/pd.nugo.hs1a520180.html
...
.. conda:package:: bioconductor-pd.nugo.hs1a520180
   ...
   :versions:
      ...
      ``3.4.0-15``,  ``3.4.0-14``,  ``3.4.0-13``,  ``3.4.0-12``,  ``3.4.0-11``,  ``3.4.0-10``,  ``3.4.0-9``,  ``3.4.0-8``,  ``3.4.0-7``,  ``3.4.0-6``,  ``3.4.0-5``,  ``3.4.0-4``,  ``3.4.0-3``,  ``3.4.0-1``,  ``3.4.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-pd.nugo.hs1a520180

to add into an existing workspace instead, run::

    pixi add bioconductor-pd.nugo.hs1a520180
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-pd.nugo.hs1a520180
...
For e.g. docker, run::
    ...
    docker pull quay.io/biocontainers/bioconductor-pd.nugo.hs1a520180:<tag>

(see `bioconductor-pd.nugo.hs1a520180/tags`_ for valid values for ``<tag>``).
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-pd.nugo.hs1a520180"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-pd.nugo.hs1a520180"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-pd.nugo.hs1a520180"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-pd.nugo.hs1a520180
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pd.nugo.hs1a520180/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-pd.nugo.hs1a520180', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-pd.nugo.hs1a520180
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pd.nugo.hs1a520180/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-pd.nugo.hs1a520180', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-pd.nugo.hs1a520180
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pd.nugo.hs1a520180/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-pd.nugo.hs1a520180', spec);
            } catch (err) {
