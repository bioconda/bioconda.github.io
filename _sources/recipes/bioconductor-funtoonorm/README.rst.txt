...
.. conda:recipe:: bioconductor-funtoonorm
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/funtooNorm.html
   :license: GPL-3
...
.. conda:package:: bioconductor-funtoonorm
   ...
   :versions:
      ...
      ``1.22.0-0``,  ``1.16.0-0``,  ``1.14.0-1``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-1``,  ``1.6.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.22.0","1.16.0","1.14.0","1.14.0","1.12.0"];
    </script>
