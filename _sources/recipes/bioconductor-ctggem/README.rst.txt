...
.. conda:recipe:: bioconductor-ctggem
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/ctgGEM.html
   :license: GPL(>=2)
...
.. conda:package:: bioconductor-ctggem
   ...
   :versions:
      ...
      ``1.6.0-0``,  ``1.2.0-1``,  ``1.2.0-0``,  ``0.99.3-0``
   ...
   :depends bioconductor-sincell: ``>=1.26.0,<1.27.0``
   :depends bioconductor-summarizedexperiment: ``>=1.24.0,<1.25.0``
   :depends bioconductor-tscan: ``>=1.32.0,<1.33.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.6.0","1.2.0","1.2.0","0.99.3"];
    </script>
