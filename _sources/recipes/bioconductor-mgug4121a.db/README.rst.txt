...
.. conda:recipe:: bioconductor-mgug4121a.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/mgug4121a.db.html
...
.. conda:package:: bioconductor-mgug4121a.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mgug4121a.db

   and update with::

      mamba update bioconductor-mgug4121a.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mgug4121a.db
