...
.. title:: Package Recipe 'bioconductor-mesh.sce.s288c.eg.db'
.. highlight: bash

bioconductor-mesh.sce.s288c.eg.db
=================================

.. conda:recipe:: bioconductor-mesh.sce.s288c.eg.db
   :replaces_section_title:
   :noindex:

   Mapping table for Saccharomyces cerevisiae S288c Gene ID to MeSH

   :homepage: https://bioconductor.org/packages/3.13/data/annotation/html/MeSH.Sce.S288c.eg.db.html
...
.. conda:package:: bioconductor-mesh.sce.s288c.eg.db

   |downloads_bioconductor-mesh.sce.s288c.eg.db| |docker_bioconductor-mesh.sce.s288c.eg.db|
...
.. _`bioconductor-mesh.sce.s288c.eg.db/tags`: https://quay.io/repository/biocontainers/bioconductor-mesh.sce.s288c.eg.db?tab=tags


.. raw:: html

    <script>
        var package = "bioconductor-mesh.sce.s288c.eg.db";
...
Render an |install-with-bioconda| badge with the following MarkDown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat)](http://bioconda.github.io/recipes/bioconductor-mesh.sce.s288c.eg.db/README.html)
