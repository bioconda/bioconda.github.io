...
.. conda:package:: snakemake-interface-storage-plugins
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>4.4.1-0</code>,  <code>4.4.0-1</code>,  <code>4.4.0-0</code>,  <code>4.3.3-0</code>,  <code>4.3.2-0</code>,  <code>4.3.1-0</code>,  <code>4.2.3-0</code>,  <code>4.2.2-0</code>,  <code>4.2.1-0</code>,  </span></summary>
      

      ``4.4.1-0``,  ``4.4.0-1``,  ``4.4.0-0``,  ``4.3.3-0``,  ``4.3.2-0``,  ``4.3.1-0``,  ``4.2.3-0``,  ``4.2.2-0``,  ``4.2.1-0``,  ``4.1.0-0``,  ``3.5.0-0``,  ``3.4.0-0``,  ``3.3.0-0``,  ``3.2.4-0``,  ``3.2.3-0``,  ``3.2.2-0``,  ``3.2.0-0``,  ``3.1.1-0``,  ``3.1.0-0``,  ``3.0.0-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["4.4.1","4.4.0","4.4.0","4.3.3","4.3.2"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_snakemake-interface-storage-plugins"></div>
   <div style="width: 100%" id="platform_plot_snakemake-interface-storage-plugins"></div>
   <div style="width: 100%" id="cdf_plot_snakemake-interface-storage-plugins"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for snakemake-interface-storage-plugins
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/snakemake-interface-storage-plugins/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_snakemake-interface-storage-plugins', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for snakemake-interface-storage-plugins
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/snakemake-interface-storage-plugins/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_snakemake-interface-storage-plugins', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for snakemake-interface-storage-plugins
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/snakemake-interface-storage-plugins/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_snakemake-interface-storage-plugins', spec);
            } catch (err) {
