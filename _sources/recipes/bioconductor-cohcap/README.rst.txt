...
.. conda:recipe:: bioconductor-cohcap
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/COHCAP.html
   :license: GPL-3
...
.. conda:package:: bioconductor-cohcap
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.44.0-0</code>,  <code>1.40.0-3</code>,  <code>1.40.0-2</code>,  <code>1.40.0-1</code>,  <code>1.40.0-0</code>,  <code>1.38.0-0</code>,  <code>1.36.0-1</code>,  <code>1.36.0-0</code>,  <code>1.34.1-0</code>,  </span></summary>
      

      ``1.44.0-0``,  ``1.40.0-3``,  ``1.40.0-2``,  ``1.40.0-1``,  ``1.40.0-0``,  ``1.38.0-0``,  ``1.36.0-1``,  ``1.36.0-0``,  ``1.34.1-0``,  ``1.32.0-1``,  ``1.30.0-1``,  ``1.30.0-0``,  ``1.28.1-0``,  ``1.26.0-0``,  ``1.24.0-0``
   ...
   :depends bioconductor-cohcapanno: ``>=1.33.0,<1.34.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.44.0","1.40.0","1.40.0","1.40.0","1.40.0"];
    </script>
