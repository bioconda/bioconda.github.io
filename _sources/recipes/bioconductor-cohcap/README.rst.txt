...
.. conda:recipe:: bioconductor-cohcap
   ...
   :homepage: https://bioconductor.org/packages/3.11/bioc/html/COHCAP.html
   :license: GPL-3
...
.. conda:package:: bioconductor-cohcap
   ...
   :versions:
      ...
      ``1.36.0-0``,  ``1.34.1-0``,  ``1.32.0-1``,  ``1.30.0-1``,  ``1.30.0-0``,  ``1.28.1-0``,  ``1.26.0-0``,  ``1.24.0-0``

      

   
   :depends bioconductor-cohcapanno: ``>=1.25.0,<1.26.0``
