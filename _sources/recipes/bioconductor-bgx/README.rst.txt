...
.. conda:recipe:: bioconductor-bgx
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/bgx.html
   :license: GPL-2
...
.. conda:package:: bioconductor-bgx
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bgx

   and update with::

      mamba update bioconductor-bgx

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bgx
