...
.. conda:recipe:: bioconductor-pd.felgene.1.1.st
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/pd.felgene.1.1.st.html
...
.. conda:package:: bioconductor-pd.felgene.1.1.st
   ...
   :required~by: |required_by_bioconductor-pd.felgene.1.1.st|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-pd.felgene.1.1.st


.. |required_by_bioconductor-pd.felgene.1.1.st| conda:required_by:: bioconductor-pd.felgene.1.1.st
