...
.. conda:recipe:: bioconductor-pathnetdata
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/experiment/html/PathNetData.html
   :license: GPL-3
...
.. conda:package:: bioconductor-pathnetdata
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pathnetdata

   and update with::

      mamba update bioconductor-pathnetdata

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pathnetdata
