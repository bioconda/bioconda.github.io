...
.. conda:recipe:: bioconductor-bufferedmatrixmethods
   ...
   :homepage: https://bioconductor.org/packages/3.11/bioc/html/BufferedMatrixMethods.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-bufferedmatrixmethods
   ...
   :versions:
      ...
      ``1.54.0-0``,  ``1.52.0-0``,  ``1.50.0-0``,  ``1.48.0-1``,  ``1.48.0-0``,  ``1.46.0-0``,  ``1.44.0-0``,  ``1.42.0-0``

      

   
   :depends bioconductor-bufferedmatrix: ``>=1.54.0,<1.55.0``
