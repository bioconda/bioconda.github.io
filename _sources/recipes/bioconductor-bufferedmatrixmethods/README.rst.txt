...
.. conda:package:: bioconductor-bufferedmatrixmethods
   ...
   :depends: :conda:package:`bioconductor-bufferedmatrix` >=1.46.0,<1.47.0 :conda:package:`libgcc-ng` >=7.3.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-bufferedmatrixmethods|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-bufferedmatrixmethods


.. |required_by_bioconductor-bufferedmatrixmethods| conda:required_by:: bioconductor-bufferedmatrixmethods
