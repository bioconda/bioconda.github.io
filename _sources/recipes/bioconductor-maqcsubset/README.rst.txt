...
.. conda:recipe:: bioconductor-maqcsubset
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/experiment/html/MAQCsubset.html
...
.. conda:package:: bioconductor-maqcsubset
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-maqcsubset

   and update with::

      mamba update bioconductor-maqcsubset

  To create a new environment, run::

      mamba create --name myenvname bioconductor-maqcsubset
