...
.. conda:package:: mimseq
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.3.3-0</code>,  <code>1.3.2-0</code>,  <code>1.3-0</code>,  <code>1.2.1-0</code>,  <code>1.2-0</code>,  <code>1.1.7-0</code>,  <code>1.1.6-0</code>,  <code>1.1.4-0</code>,  <code>1.1.2-0</code>,  </span></summary>
      

      ``1.3.3-0``,  ``1.3.2-0``,  ``1.3-0``,  ``1.2.1-0``,  ``1.2-0``,  ``1.1.7-0``,  ``1.1.6-0``,  ``1.1.4-0``,  ``1.1.2-0``,  ``1.1.1-0``,  ``1.1-0``,  ``1.0.3-0``,  ``1.0.2-0``,  ``1.0.1-0``,  ``1.0-0``,  ``0.4-0``,  ``0.3.4.9-0``,  ``0.3.4.8-0``,  ``0.3.4.7-0``,  ``0.3.4.5-0``,  ``0.3.4.3-0``,  ``0.3.4.1-0``,  ``0.3.4-0``,  ``0.3.3.2-0``,  ``0.3.3-0``,  ``0.3.2-0``,  ``0.3.1-0``,  ``0.2.6-0``,  ``0.2.5.6-0``,  ``0.2.5.5-1``,  ``0.2.5.5-0``,  ``0.2.5.4-0``,  ``0.2.5.3-0``
...
.. raw:: html
    ...
    <script>
        var package = "mimseq";
        var versions = ["1.3.3","1.3.2","1.3","1.2.1","1.2"];
    </script>
