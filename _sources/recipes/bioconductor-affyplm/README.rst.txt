...
.. conda:package:: bioconductor-affyplm
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.86.0-0</code>,  <code>1.82.0-0</code>,  <code>1.78.0-0</code>,  <code>1.76.1-0</code>,  <code>1.74.0-1</code>,  <code>1.74.0-0</code>,  <code>1.70.0-2</code>,  <code>1.70.0-1</code>,  <code>1.70.0-0</code>,  </span></summary>
      

      ``1.86.0-0``,  ``1.82.0-0``,  ``1.78.0-0``,  ``1.76.1-0``,  ``1.74.0-1``,  ``1.74.0-0``,  ``1.70.0-2``,  ``1.70.0-1``,  ``1.70.0-0``,  ``1.68.0-0``,  ``1.66.0-1``,  ``1.66.0-0``,  ``1.64.0-0``,  ``1.62.0-0``,  ``1.60.0-1``,  ``1.58.0-0``,  ``1.56.0-0``,  ``1.54.0-0``
   ...
   :depends on bioconductor-gcrma: ``>=2.82.0,<2.83.0a0``
...
to install globally, run::
    ...
    pixi global install bioconductor-affyplm

to add into an existing workspace instead, run::

    pixi add bioconductor-affyplm
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-affyplm
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.86.0","1.82.0","1.78.0","1.76.1","1.74.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-affyplm"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-affyplm"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-affyplm"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-affyplm
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-affyplm/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-affyplm', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-affyplm
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-affyplm/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-affyplm', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-affyplm
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-affyplm/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-affyplm', spec);
            } catch (err) {
