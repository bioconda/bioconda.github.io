...
.. conda:package:: r-idr
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/r-idr:<tag>

   (see `r-idr/tags`_ for valid values for ``<tag>``)
...
.. _`r-idr/tags`: https://quay.io/repository/biocontainers/r-idr?tab=tags
