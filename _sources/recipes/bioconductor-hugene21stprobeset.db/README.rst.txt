...
.. conda:recipe:: bioconductor-hugene21stprobeset.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/hugene21stprobeset.db.html
...
.. conda:package:: bioconductor-hugene21stprobeset.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hugene21stprobeset.db

   and update with::

      mamba update bioconductor-hugene21stprobeset.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hugene21stprobeset.db
