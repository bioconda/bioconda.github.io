...
.. conda:recipe:: bioconductor-rjmcmcnucleosomes
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/RJMCMCNucleosomes.html
...
.. conda:package:: bioconductor-rjmcmcnucleosomes
   ...
   :depends bioconductor-consensusseeker: ``>=1.30.0,<1.31.0``
   :depends bioconductor-consensusseeker: ``>=1.30.0,<1.31.0a0``
