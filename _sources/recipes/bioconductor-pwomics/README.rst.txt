...
.. conda:recipe:: bioconductor-pwomics
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/pwOmics.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-pwomics
   ...
   :versions:
      ...
      ``1.24.0-0``,  ``1.22.0-1``,  ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.16.0-1``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.1-0``
   ...
   :depends bioconductor-rbiopaxparser: ``>=2.32.0,<2.33.0``
