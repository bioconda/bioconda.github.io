...
.. conda:recipe:: bioconductor-mu11ksubb.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/mu11ksubb.db.html
...
.. conda:package:: bioconductor-mu11ksubb.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mu11ksubb.db

   and update with::

      mamba update bioconductor-mu11ksubb.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mu11ksubb.db
