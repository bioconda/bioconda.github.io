...
.. conda:recipe:: bioconductor-dewseq
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/DEWSeq.html
   :license: LGPL (>= 3)
...
.. conda:package:: bioconductor-dewseq
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.24.0-0</code>,  <code>1.20.0-0</code>,  <code>1.16.2-0</code>,  <code>1.14.0-0</code>,  <code>1.12.0-0</code>,  <code>1.8.0-0</code>,  <code>1.6.0-0</code>,  <code>1.4.4-0</code>,  <code>1.4.0-0</code>,  </span></summary>
      

      ``1.24.0-0``,  ``1.20.0-0``,  ``1.16.2-0``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.4-0``,  ``1.4.0-0``,  ``1.2.0-0``,  ``1.0.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-dewseq

to add into an existing workspace instead, run::

    pixi add bioconductor-dewseq
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-dewseq
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.24.0","1.20.0","1.16.2","1.14.0","1.12.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-dewseq"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-dewseq"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-dewseq"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-dewseq
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-dewseq/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-dewseq', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-dewseq
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-dewseq/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-dewseq', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-dewseq
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-dewseq/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-dewseq', spec);
            } catch (err) {
