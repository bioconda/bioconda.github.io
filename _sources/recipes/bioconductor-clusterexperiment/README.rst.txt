...
.. conda:recipe:: bioconductor-clusterexperiment
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/clusterExperiment.html
...
.. conda:package:: bioconductor-clusterexperiment
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.30.0-0</code>,  <code>2.26.0-0</code>,  <code>2.22.0-1</code>,  <code>2.22.0-0</code>,  <code>2.20.0-0</code>,  <code>2.18.0-1</code>,  <code>2.18.0-0</code>,  <code>2.14.0-2</code>,  <code>2.14.0-1</code>,  </span></summary>
      

      ``2.30.0-0``,  ``2.26.0-0``,  ``2.22.0-1``,  ``2.22.0-0``,  ``2.20.0-0``,  ``2.18.0-1``,  ``2.18.0-0``,  ``2.14.0-2``,  ``2.14.0-1``,  ``2.14.0-0``,  ``2.12.0-0``,  ``2.10.1-0``,  ``2.10.0-0``,  ``2.8.0-0``,  ``2.6.0-0``,  ``2.4.4-0``,  ``2.2.0-0``
   ...
   :depends on bioconductor-mbkmeans: ``>=1.26.0,<1.27.0``
   :depends on bioconductor-mbkmeans: ``>=1.26.0,<1.27.0a0``
   ...
   :depends on bioconductor-zinbwave: ``>=1.32.0,<1.33.0``
   :depends on bioconductor-zinbwave: ``>=1.32.0,<1.33.0a0``
   :depends on libblas: ``>=3.9.0,<4.0a0``
   :depends on libcxx: ``>=19``
   :depends on liblapack: ``>=3.9.0,<4.0a0``
   :depends on liblzma: ``>=5.8.2,<6.0a0``
   :depends on libzlib: ``>=1.3.1,<2.0a0``
   :depends on r-ape: ``>=5.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-clusterexperiment

to add into an existing workspace instead, run::

    pixi add bioconductor-clusterexperiment
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-clusterexperiment
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["2.30.0","2.26.0","2.22.0","2.22.0","2.20.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-clusterexperiment"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-clusterexperiment"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-clusterexperiment"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-clusterexperiment
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-clusterexperiment/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-clusterexperiment', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-clusterexperiment
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-clusterexperiment/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-clusterexperiment', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-clusterexperiment
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-clusterexperiment/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-clusterexperiment', spec);
            } catch (err) {
