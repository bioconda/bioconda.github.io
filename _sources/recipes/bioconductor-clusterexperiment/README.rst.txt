...
.. conda:package:: bioconductor-clusterexperiment
   ...
   :versions:
      ...
      ``2.14.0-0``,  ``2.12.0-0``,  ``2.10.1-0``,  ``2.10.0-0``,  ``2.8.0-0``,  ``2.6.0-0``,  ``2.4.4-0``,  ``2.2.0-0``
   ...
   :depends bioconductor-mbkmeans: ``>=1.10.0,<1.11.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.14.0","2.12.0","2.10.1","2.10.0","2.8.0"];
    </script>
