...
.. conda:recipe:: bioconductor-agimicrorna
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/AgiMicroRna.html
   :license: GPL-3
...
.. conda:package:: bioconductor-agimicrorna
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.60.0-0</code>,  <code>2.56.0-0</code>,  <code>2.52.0-0</code>,  <code>2.50.0-0</code>,  <code>2.48.0-0</code>,  <code>2.44.0-0</code>,  <code>2.42.0-0</code>,  <code>2.40.0-1</code>,  <code>2.40.0-0</code>,  </span></summary>
      

      ``2.60.0-0``,  ``2.56.0-0``,  ``2.52.0-0``,  ``2.50.0-0``,  ``2.48.0-0``,  ``2.44.0-0``,  ``2.42.0-0``,  ``2.40.0-1``,  ``2.40.0-0``,  ``2.38.0-0``,  ``2.36.0-0``,  ``2.34.0-1``,  ``2.32.0-1``,  ``2.32.0-0``
   ...
   :depends on bioconductor-affycoretools: ``>=1.82.0,<1.83.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-agimicrorna

to add into an existing workspace instead, run::

    pixi add bioconductor-agimicrorna
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-agimicrorna
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-agimicrorna"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-agimicrorna"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-agimicrorna"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-agimicrorna
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-agimicrorna/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-agimicrorna', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-agimicrorna
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-agimicrorna/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-agimicrorna', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-agimicrorna
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-agimicrorna/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-agimicrorna', spec);
            } catch (err) {
