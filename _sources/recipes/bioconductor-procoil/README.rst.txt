...
.. conda:recipe:: bioconductor-procoil
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/procoil.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-procoil
   ...
   :versions:
      ...
      ``2.20.0-0``,  ``2.18.0-1``,  ``2.18.0-0``,  ``2.16.0-0``,  ``2.14.0-0``,  ``2.12.0-1``,  ``2.10.0-0``,  ``2.8.0-0``,  ``2.6.0-0``

      

   
   :depends bioconductor-biostrings: ``>=2.60.0,<2.61.0``
   :depends bioconductor-kebabs: ``>=1.26.0,<1.27.0``
