...
.. conda:recipe:: bioconductor-rgu34b.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/rgu34b.db.html
...
.. conda:package:: bioconductor-rgu34b.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rgu34b.db

   and update with::

      mamba update bioconductor-rgu34b.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rgu34b.db
