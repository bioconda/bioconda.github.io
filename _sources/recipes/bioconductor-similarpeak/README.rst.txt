...
.. conda:package:: bioconductor-similarpeak
   ...
   :depends: :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-r6` >=2.0 

   :required~by: |required_by_bioconductor-similarpeak|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-similarpeak


.. |required_by_bioconductor-similarpeak| conda:required_by:: bioconductor-similarpeak
