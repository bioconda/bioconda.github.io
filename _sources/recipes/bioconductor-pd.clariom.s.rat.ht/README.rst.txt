...
.. conda:recipe:: bioconductor-pd.clariom.s.rat.ht
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/pd.clariom.s.rat.ht.html
...
to install globally, run::
    ...
    pixi global install bioconductor-pd.clariom.s.rat.ht

to add into an existing workspace instead, run::

    pixi add bioconductor-pd.clariom.s.rat.ht
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-pd.clariom.s.rat.ht
...
For e.g. docker, run::
    ...
    docker pull quay.io/biocontainers/bioconductor-pd.clariom.s.rat.ht:<tag>

(see `bioconductor-pd.clariom.s.rat.ht/tags`_ for valid values for ``<tag>``).
...
.. _`bioconductor-pd.clariom.s.rat.ht/tags`: https://quay.io/repository/biocontainers/bioconductor-pd.clariom.s.rat.ht?tab=tags


.. raw:: html

   <script>
      var package = "bioconductor-pd.clariom.s.rat.ht";
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-pd.clariom.s.rat.ht"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-pd.clariom.s.rat.ht"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-pd.clariom.s.rat.ht"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-pd.clariom.s.rat.ht
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pd.clariom.s.rat.ht/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-pd.clariom.s.rat.ht', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-pd.clariom.s.rat.ht
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pd.clariom.s.rat.ht/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-pd.clariom.s.rat.ht', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-pd.clariom.s.rat.ht
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pd.clariom.s.rat.ht/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-pd.clariom.s.rat.ht', spec);
            } catch (err) {
