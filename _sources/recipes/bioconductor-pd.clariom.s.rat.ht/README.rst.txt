...
.. conda:recipe:: bioconductor-pd.clariom.s.rat.ht
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/pd.clariom.s.rat.ht.html
...
.. conda:package:: bioconductor-pd.clariom.s.rat.ht
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.clariom.s.rat.ht

   and update with::

      mamba update bioconductor-pd.clariom.s.rat.ht

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.clariom.s.rat.ht
