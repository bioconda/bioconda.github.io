...
.. conda:package:: nanopolish
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.14.0-6</code>,  <code>0.14.0-5</code>,  <code>0.14.0-4</code>,  <code>0.14.0-3</code>,  <code>0.14.0-2</code>,  <code>0.14.0-1</code>,  <code>0.14.0-0</code>,  <code>0.13.2-10</code>,  <code>0.13.2-9</code>,  </span></summary>
   ...
   :depends on ont_vbz_hdf_plugin: ``1.0.12.*``
   :depends on python: 
...
to install globally, run::
    ...
    pixi global install nanopolish
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname nanopolish
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_nanopolish"></div>
   <div style="width: 100%" id="platform_plot_nanopolish"></div>
   <div style="width: 100%" id="cdf_plot_nanopolish"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/nanopolish/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_nanopolish', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for nanopolish
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/nanopolish/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_nanopolish', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for nanopolish
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/nanopolish/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_nanopolish', spec);
            } catch (err) {
