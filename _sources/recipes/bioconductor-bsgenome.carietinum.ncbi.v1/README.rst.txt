...
.. conda:recipe:: bioconductor-bsgenome.carietinum.ncbi.v1
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/BSgenome.Carietinum.NCBI.v1.html
   :license: GPL-3
...
.. conda:package:: bioconductor-bsgenome.carietinum.ncbi.v1
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bsgenome.carietinum.ncbi.v1

   and update with::

      mamba update bioconductor-bsgenome.carietinum.ncbi.v1

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bsgenome.carietinum.ncbi.v1
