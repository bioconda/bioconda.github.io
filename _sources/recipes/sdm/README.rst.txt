...
.. conda:package:: sdm
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.27-0</code>,  <code>3.26-0</code>,  <code>3.11-0</code>,  <code>3.10-0</code>,  <code>3.08-1</code>,  <code>3.08-0</code>,  <code>2.18-0</code>,  <code>2.17-1</code>,  <code>2.17-0</code>,  </span></summary>
      

      ``3.27-0``,  ``3.26-0``,  ``3.11-0``,  ``3.10-0``,  ``3.08-1``,  ``3.08-0``,  ``2.18-0``,  ``2.17-1``,  ``2.17-0``,  ``2.14-0``,  ``2.13-0``,  ``2.11-0``,  ``2.10-0``,  ``2.09-0``,  ``2.08-2``,  ``2.08-1``,  ``2.08-0``,  ``2.06-0``,  ``2.05-0``,  ``2.02-1``,  ``2.02-0``,  ``1.94-1``,  ``1.94-0``,  ``1.93-0``,  ``1.92-0``,  ``1.90-0``,  ``1.89-0``,  ``1.87-0``,  ``1.86-0``,  ``1.85-0``,  ``1.84.1-0``,  ``1.84-0``,  ``1.83post0-0``,  ``1.83-0``,  ``1.73-2``,  ``1.73-1``,  ``1.73-0``,  ``1.47-0``
...
.. raw:: html
    ...
    <script>
        var package = "sdm";
        var versions = ["3.27","3.26","3.11","3.10","3.08"];
    </script>
