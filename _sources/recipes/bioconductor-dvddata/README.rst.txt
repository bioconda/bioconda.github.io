...
.. conda:recipe:: bioconductor-dvddata
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/experiment/html/DvDdata.html
   :license: GPL-3
...
.. conda:package:: bioconductor-dvddata
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-dvddata

   and update with::

      mamba update bioconductor-dvddata

  To create a new environment, run::

      mamba create --name myenvname bioconductor-dvddata
