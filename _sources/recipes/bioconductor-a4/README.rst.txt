...
.. conda:recipe:: bioconductor-a4
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/a4.html
   :license: GPL-3
...
.. conda:package:: bioconductor-a4
   ...
   :versions:
      ...
      ``1.58.0-0``,  ``1.54.0-0``,  ``1.50.0-0``,  ``1.48.0-0``,  ``1.46.0-0``,  ``1.42.0-0``,  ``1.40.0-0``,  ``1.38.0-1``,  ``1.38.0-0``,  ``1.36.0-0``,  ``1.34.0-0``,  ``1.32.0-1``,  ``1.30.0-0``
   ...
   :depends on bioconductor-a4base: ``>=1.58.0,<1.59.0``
   :depends on bioconductor-a4classif: ``>=1.58.0,<1.59.0``
   :depends on bioconductor-a4core: ``>=1.58.0,<1.59.0``
   :depends on bioconductor-a4preproc: ``>=1.58.0,<1.59.0``
   :depends on bioconductor-a4reporting: ``>=1.58.0,<1.59.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-a4

to add into an existing workspace instead, run::

    pixi add bioconductor-a4
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-a4
...
.. |downloads_bioconductor-a4| image:: https://img.shields.io/conda/dn/bioconda/bioconductor-a4.svg?style=flat
   :target: https://anaconda.org/bioconda/bioconductor-a4
   :alt:   (downloads)
...
.. _`bioconductor-a4/tags`: https://quay.io/repository/biocontainers/bioconductor-a4?tab=tags
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-a4"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-a4"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-a4"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-a4
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-a4/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-a4', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-a4
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-a4/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-a4', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-a4
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-a4/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-a4', spec);
            } catch (err) {
