...
.. conda:package:: bioconductor-huex.1.0.st.v2frmavecs
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-huex.1.0.st.v2frmavecs

   and update with::

      mamba update bioconductor-huex.1.0.st.v2frmavecs

  To create a new environment, run::

      mamba create --name myenvname bioconductor-huex.1.0.st.v2frmavecs
