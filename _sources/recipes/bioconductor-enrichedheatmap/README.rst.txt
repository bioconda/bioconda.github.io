...
.. conda:recipe:: bioconductor-enrichedheatmap
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/EnrichedHeatmap.html
...
.. conda:package:: bioconductor-enrichedheatmap
   ...
   :versions:
      ...
      ``1.22.0-0``,  ``1.20.0-1``,  ``1.20.0-0``,  ``1.18.2-0``,  ``1.16.0-0``,  ``1.14.0-1``,  ``1.12.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.22.0","1.20.0","1.20.0","1.18.2","1.16.0"];
    </script>
