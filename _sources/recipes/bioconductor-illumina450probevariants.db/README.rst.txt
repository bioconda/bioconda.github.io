...
.. conda:recipe:: bioconductor-illumina450probevariants.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/experiment/html/Illumina450ProbeVariants.db.html
   :license: GPL-3
...
.. conda:package:: bioconductor-illumina450probevariants.db
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.36.0-0</code>,  <code>1.34.0-0</code>,  <code>1.33.0-0</code>,  <code>1.30.0-1</code>,  <code>1.30.0-0</code>,  <code>1.28.0-0</code>,  <code>1.26.0-1</code>,  <code>1.26.0-0</code>,  <code>1.25.0-0</code>,  </span></summary>
      

      ``1.36.0-0``,  ``1.34.0-0``,  ``1.33.0-0``,  ``1.30.0-1``,  ``1.30.0-0``,  ``1.28.0-0``,  ``1.26.0-1``,  ``1.26.0-0``,  ``1.25.0-0``,  ``1.24.0-0``,  ``1.22.0-0``,  ``1.20.0-1``,  ``1.20.0-0``,  ``1.18.0-0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-illumina450probevariants.db

   and update with::

      mamba update bioconductor-illumina450probevariants.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-illumina450probevariants.db
