...
.. conda:recipe:: bioconductor-hugene11sttranscriptcluster.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/hugene11sttranscriptcluster.db.html
...
.. conda:package:: bioconductor-hugene11sttranscriptcluster.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hugene11sttranscriptcluster.db

   and update with::

      mamba update bioconductor-hugene11sttranscriptcluster.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hugene11sttranscriptcluster.db
