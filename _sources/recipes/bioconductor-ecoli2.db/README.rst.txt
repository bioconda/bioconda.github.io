...
.. conda:recipe:: bioconductor-ecoli2.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/ecoli2.db.html
...
.. conda:package:: bioconductor-ecoli2.db
   ...
   :depends bioconductor-org.eck12.eg.db: ``>=3.18.0,<3.19.0``
   :depends curl: 
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ecoli2.db

   and update with::

      mamba update bioconductor-ecoli2.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ecoli2.db
