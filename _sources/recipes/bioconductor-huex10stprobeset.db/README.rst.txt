...
.. conda:recipe:: bioconductor-huex10stprobeset.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/huex10stprobeset.db.html
...
.. conda:package:: bioconductor-huex10stprobeset.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-huex10stprobeset.db

   and update with::

      mamba update bioconductor-huex10stprobeset.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-huex10stprobeset.db
