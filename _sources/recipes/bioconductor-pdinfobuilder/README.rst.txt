...
.. conda:recipe:: bioconductor-pdinfobuilder
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/pdInfoBuilder.html
...
.. conda:package:: bioconductor-pdinfobuilder
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pdinfobuilder

   and update with::

      mamba update bioconductor-pdinfobuilder

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pdinfobuilder
