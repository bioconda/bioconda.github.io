...
.. conda:recipe:: sr2silo
   ...
   :documentation: https://github.com/cbg-ethz/sr2silo/blob/v1.1.0/README.md
...
.. conda:package:: sr2silo
   ...
   :versions:
      ...
      ``1.1.0-0``,  ``1.0.1-0``,  ``0.2.0-0``,  ``0.1.2-0``,  ``0.1.1-0``,  ``0.0.4-0``
...
.. raw:: html
    ...
    <script>
        var package = "sr2silo";
        var versions = ["1.1.0","1.0.1","0.2.0","0.1.2","0.1.1"];
    </script>
