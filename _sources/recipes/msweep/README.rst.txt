...
.. conda:package:: msweep
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.2.1-0</code>,  <code>2.2.0-0</code>,  <code>2.1.2-0</code>,  <code>2.1.1-1</code>,  <code>2.1.1-0</code>,  <code>2.1.0-0</code>,  <code>2.0.0-0</code>,  <code>1.6.3-2</code>,  <code>1.6.3-1</code>,  </span></summary>
      

      ``2.2.1-0``,  ``2.2.0-0``,  ``2.1.2-0``,  ``2.1.1-1``,  ``2.1.1-0``,  ``2.1.0-0``,  ``2.0.0-0``,  ``1.6.3-2``,  ``1.6.3-1``,  ``1.6.3-0``
...
.. raw:: html
    ...
    <script>
        var package = "msweep";
        var versions = ["2.2.1","2.2.0","2.1.2","2.1.1","2.1.1"];
    </script>
