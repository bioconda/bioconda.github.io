...
.. conda:recipe:: bioconductor-ecolik12.db0
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/ecoliK12.db0.html
...
.. conda:package:: bioconductor-ecolik12.db0
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ecolik12.db0

   and update with::

      mamba update bioconductor-ecolik12.db0

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ecolik12.db0
