...
.. conda:package:: synth-pdb
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.39.0-0</code>,  <code>1.38.1-0</code>,  <code>1.38.0-0</code>,  <code>1.37.1-0</code>,  <code>1.37.0-0</code>,  <code>1.36.0-0</code>,  <code>1.34.2-0</code>,  <code>1.30.0-0</code>,  <code>1.28.0-0</code>,  </span></summary>
      

      ``1.39.0-0``,  ``1.38.1-0``,  ``1.38.0-0``,  ``1.37.1-0``,  ``1.37.0-0``,  ``1.36.0-0``,  ``1.34.2-0``,  ``1.30.0-0``,  ``1.28.0-0``,  ``1.27.0-0``,  ``1.25.0-0``,  ``1.16.0-0``,  ``1.15.0-0``,  ``1.14.1-0``,  ``1.9.0-0``,  ``1.8.3-0``,  ``1.8.2-0``,  ``1.6.3-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.39.0","1.38.1","1.38.0","1.37.1","1.37.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_synth-pdb"></div>
   <div style="width: 100%" id="platform_plot_synth-pdb"></div>
   <div style="width: 100%" id="cdf_plot_synth-pdb"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/synth-pdb/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_synth-pdb', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for synth-pdb
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/synth-pdb/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_synth-pdb', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for synth-pdb
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/synth-pdb/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_synth-pdb', spec);
            } catch (err) {
