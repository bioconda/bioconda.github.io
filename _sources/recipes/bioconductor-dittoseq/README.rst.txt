...
.. conda:recipe:: bioconductor-dittoseq
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/dittoSeq.html
...
.. conda:package:: bioconductor-dittoseq
   ...
   :versions:
      ...
      ``1.6.0-0``,  ``1.4.1-0``,  ``1.2.5-0``,  ``1.2.0-0``,  ``1.0.1-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.6.0","1.4.1","1.2.5","1.2.0","1.0.1"];
    </script>
