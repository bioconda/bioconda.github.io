...
.. conda:recipe:: bioconductor-netdx
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/netDx.html
...
.. conda:package:: bioconductor-netdx
   ...
   :versions:
      ...
      ``1.12.0-0``,  ``1.9.0-0``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.2-0``,  ``1.2.0-0``,  ``1.0.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.12.0","1.9.0","1.6.0","1.4.0","1.2.2"];
    </script>
