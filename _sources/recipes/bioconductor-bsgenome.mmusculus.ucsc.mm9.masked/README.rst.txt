...
.. conda:recipe:: bioconductor-bsgenome.mmusculus.ucsc.mm9.masked
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/BSgenome.Mmusculus.UCSC.mm9.masked.html
...
.. conda:package:: bioconductor-bsgenome.mmusculus.ucsc.mm9.masked
   ...
   :depends: :conda:package:`bioconductor-bsgenome` >=1.50.0,<1.51.0 :conda:package:`bioconductor-bsgenome.mmusculus.ucsc.mm9` >=1.4.0,<1.5.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`wget`  

   :required~by: |required_by_bioconductor-bsgenome.mmusculus.ucsc.mm9.masked|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-bsgenome.mmusculus.ucsc.mm9.masked


.. |required_by_bioconductor-bsgenome.mmusculus.ucsc.mm9.masked| conda:required_by:: bioconductor-bsgenome.mmusculus.ucsc.mm9.masked
