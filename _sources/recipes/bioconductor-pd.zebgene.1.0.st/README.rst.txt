...
.. conda:recipe:: bioconductor-pd.zebgene.1.0.st
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/pd.zebgene.1.0.st.html
...
.. conda:package:: bioconductor-pd.zebgene.1.0.st
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.zebgene.1.0.st

   and update with::

      mamba update bioconductor-pd.zebgene.1.0.st

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.zebgene.1.0.st
