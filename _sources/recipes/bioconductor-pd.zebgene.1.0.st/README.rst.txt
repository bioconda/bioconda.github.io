...
.. conda:recipe:: bioconductor-pd.zebgene.1.0.st
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/pd.zebgene.1.0.st.html
...
.. conda:package:: bioconductor-pd.zebgene.1.0.st
   ...
   :required~by: |required_by_bioconductor-pd.zebgene.1.0.st|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-pd.zebgene.1.0.st


.. |required_by_bioconductor-pd.zebgene.1.0.st| conda:required_by:: bioconductor-pd.zebgene.1.0.st
