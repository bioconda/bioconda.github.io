...
.. conda:recipe:: bioconductor-txdb.mmusculus.ucsc.mm39.knowngene
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/TxDb.Mmusculus.UCSC.mm39.knownGene.html
...
.. conda:package:: bioconductor-txdb.mmusculus.ucsc.mm39.knowngene
   ...
   :versions:
      ...
      ``3.22.0-0``,  ``3.20.0-0``,  ``3.18.0-0``,  ``3.17.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-txdb.mmusculus.ucsc.mm39.knowngene

to add into an existing workspace instead, run::

    pixi add bioconductor-txdb.mmusculus.ucsc.mm39.knowngene
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-txdb.mmusculus.ucsc.mm39.knowngene

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-txdb.mmusculus.ucsc.mm39.knowngene
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["3.22.0","3.20.0","3.18.0","3.17.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-txdb.mmusculus.ucsc.mm39.knowngene"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-txdb.mmusculus.ucsc.mm39.knowngene"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-txdb.mmusculus.ucsc.mm39.knowngene"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-txdb.mmusculus.ucsc.mm39.knowngene
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.mmusculus.ucsc.mm39.knowngene/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-txdb.mmusculus.ucsc.mm39.knowngene', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-txdb.mmusculus.ucsc.mm39.knowngene
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.mmusculus.ucsc.mm39.knowngene/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-txdb.mmusculus.ucsc.mm39.knowngene', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-txdb.mmusculus.ucsc.mm39.knowngene
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-txdb.mmusculus.ucsc.mm39.knowngene/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-txdb.mmusculus.ucsc.mm39.knowngene', spec);
            } catch (err) {
