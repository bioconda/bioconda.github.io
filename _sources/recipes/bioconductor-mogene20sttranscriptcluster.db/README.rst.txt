...
.. conda:recipe:: bioconductor-mogene20sttranscriptcluster.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/mogene20sttranscriptcluster.db.html
...
.. conda:package:: bioconductor-mogene20sttranscriptcluster.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mogene20sttranscriptcluster.db

   and update with::

      mamba update bioconductor-mogene20sttranscriptcluster.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mogene20sttranscriptcluster.db
