...
.. conda:package:: bioconductor-feast
   ...
   :depends bioconductor-sc3: ``>=1.38.0,<1.39.0``
   :depends bioconductor-sc3: ``>=1.38.0,<1.39.0a0``
   ...
   :depends bioconductor-tscan: ``>=1.48.0,<1.49.0``
   :depends bioconductor-tscan: ``>=1.48.0,<1.49.0a0``
