...
.. conda:recipe:: bioconductor-biomvcclass
   ...
   :homepage: https://bioconductor.org/packages/3.11/bioc/html/BioMVCClass.html
   :license: LGPL
...
.. conda:package:: bioconductor-biomvcclass
   ...
   :versions:
      ...
      ``1.58.0-0``,  ``1.56.0-0``,  ``1.54.0-0``,  ``1.52.0-1``,  ``1.50.0-0``,  ``1.48.0-0``,  ``1.46.0-0``
   ...
   :depends bioconductor-mvcclass: ``>=1.64.0,<1.65.0``
