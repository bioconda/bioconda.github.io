...
.. conda:recipe:: bioconductor-cmap
   ...
   :homepage: https://bioconductor.org/packages/3.14/data/annotation/html/cMAP.html
   :license: LGPL
...
.. conda:package:: bioconductor-cmap
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.15.1-12</code>,  <code>1.15.1-11</code>,  <code>1.15.1-10</code>,  <code>1.15.1-9</code>,  <code>1.15.1-8</code>,  <code>1.15.1-7</code>,  <code>1.15.1-6</code>,  <code>1.15.1-5</code>,  <code>1.15.1-4</code>,  </span></summary>
      

      ``1.15.1-12``,  ``1.15.1-11``,  ``1.15.1-10``,  ``1.15.1-9``,  ``1.15.1-8``,  ``1.15.1-7``,  ``1.15.1-6``,  ``1.15.1-5``,  ``1.15.1-4``,  ``1.15.1-3``,  ``1.15.1-2``,  ``1.15.1-0``
