...
.. conda:package:: r-pipette
   ...
   :depends r-goalie: ``>=0.6.11``
   :depends r-httr2: ``>=0.2.3``
   :depends r-jsonlite: ``>=1.8.7``
   :depends r-matrix: ``>=1.6.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.11.2","0.11.1","0.11.0","0.10.10","0.10.10"];
    </script>
