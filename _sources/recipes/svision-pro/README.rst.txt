...
.. conda:recipe:: svision-pro
   ...
   :documentation: https://github.com/songbowang125/SVision-pro/blob/v2.5/README.md
...
.. conda:package:: svision-pro
   ...
   :versions:
      ...
      ``2.5-0``,  ``2.4-1``,  ``2.4-0``,  ``2.3-0``,  ``2.2-0``,  ``2.1-0``,  ``2.0-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["2.5","2.4","2.4","2.3","2.2"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_svision-pro"></div>
   <div style="width: 100%" id="platform_plot_svision-pro"></div>
   <div style="width: 100%" id="cdf_plot_svision-pro"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for svision-pro
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/svision-pro/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_svision-pro', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for svision-pro
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/svision-pro/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_svision-pro', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for svision-pro
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/svision-pro/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_svision-pro', spec);
            } catch (err) {
