...
.. conda:package:: r-dynamictreecut
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/r-dynamictreecut:<tag>

   (see `r-dynamictreecut/tags`_ for valid values for ``<tag>``)
...
.. _`r-dynamictreecut/tags`: https://quay.io/repository/biocontainers/r-dynamictreecut?tab=tags
