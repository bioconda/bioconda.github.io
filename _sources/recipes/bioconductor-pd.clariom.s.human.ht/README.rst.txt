...
.. conda:recipe:: bioconductor-pd.clariom.s.human.ht
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/pd.clariom.s.human.ht.html
...
.. conda:package:: bioconductor-pd.clariom.s.human.ht
   ...
   :required~by: |required_by_bioconductor-pd.clariom.s.human.ht|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-pd.clariom.s.human.ht


.. |required_by_bioconductor-pd.clariom.s.human.ht| conda:required_by:: bioconductor-pd.clariom.s.human.ht
