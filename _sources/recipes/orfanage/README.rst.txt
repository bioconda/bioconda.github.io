...
.. conda:package:: orfanage
   ...
   :versions:
      ...
      ``1.2.0-2``,  ``1.2.0-1``,  ``1.2.0-0``,  ``1.1.0-0``,  ``1.0.4_9f713d2-0``,  ``1.0.4-0``
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname orfanage
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.2.0","1.2.0","1.2.0","1.1.0","1.0.4_9f713d2"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_orfanage"></div>
   <div style="width: 100%" id="platform_plot_orfanage"></div>
   <div style="width: 100%" id="cdf_plot_orfanage"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/orfanage/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_orfanage', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for orfanage
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/orfanage/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_orfanage', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for orfanage
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/orfanage/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_orfanage', spec);
            } catch (err) {
