...
.. conda:package:: cancerit-allelecount
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>4.3.0-9</code>,  <code>4.3.0-7</code>,  <code>4.3.0-6</code>,  <code>4.3.0-5</code>,  <code>4.3.0-4</code>,  <code>4.3.0-3</code>,  <code>4.3.0-2</code>,  <code>4.3.0-1</code>,  <code>4.3.0-0</code>,  </span></summary>
      

      ``4.3.0-9``,  ``4.3.0-7``,  ``4.3.0-6``,  ``4.3.0-5``,  ``4.3.0-4``,  ``4.3.0-3``,  ``4.3.0-2``,  ``4.3.0-1``,  ``4.3.0-0``,  ``4.2.1-1``,  ``4.2.1-0``,  ``4.2.0-0``,  ``4.0.2-2``,  ``4.0.2-1``,  ``2.1.2-3``,  ``2.1.2-2``,  ``2.1.2-1``,  ``2.1.2-0``
...
to install globally, run::
    ...
    pixi global install cancerit-allelecount

to add into an existing workspace instead, run::

    pixi add cancerit-allelecount
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname cancerit-allelecount
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_cancerit-allelecount"></div>
   <div style="width: 100%" id="platform_plot_cancerit-allelecount"></div>
   <div style="width: 100%" id="cdf_plot_cancerit-allelecount"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for cancerit-allelecount
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/cancerit-allelecount/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_cancerit-allelecount', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for cancerit-allelecount
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/cancerit-allelecount/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_cancerit-allelecount', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for cancerit-allelecount
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/cancerit-allelecount/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_cancerit-allelecount', spec);
            } catch (err) {
