...
.. conda:recipe:: bioconductor-flowvs
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/flowVS.html
...
.. conda:package:: bioconductor-flowvs
   ...
   :depends on bioconductor-flowstats: ``>=4.22.0,<4.23.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-flowvs

to add into an existing workspace instead, run::

    pixi add bioconductor-flowvs
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-flowvs
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-flowvs"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-flowvs"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-flowvs"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-flowvs
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-flowvs/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-flowvs', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-flowvs
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-flowvs/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-flowvs', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-flowvs
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-flowvs/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-flowvs', spec);
            } catch (err) {
