...
.. conda:package:: ms-entropy
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.3.4-0</code>,  <code>1.3.3-1</code>,  <code>1.3.3-0</code>,  <code>1.2.0-1</code>,  <code>1.2.0-0</code>,  <code>1.1.3-0</code>,  <code>1.1.2-0</code>,  <code>1.1.1-0</code>,  <code>1.0.4-0</code>,  </span></summary>
      

      ``1.3.4-0``,  ``1.3.3-1``,  ``1.3.3-0``,  ``1.2.0-1``,  ``1.2.0-0``,  ``1.1.3-0``,  ``1.1.2-0``,  ``1.1.1-0``,  ``1.0.4-0``,  ``1.0.2-0``,  ``1.0.1-0``,  ``1.0.0-0``,  ``0.9.12-0``,  ``0.9.11-0``
...
to install globally, run::
    ...
    pixi global install ms-entropy
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname ms-entropy
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.3.4","1.3.3","1.3.3","1.2.0","1.2.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_ms-entropy"></div>
   <div style="width: 100%" id="platform_plot_ms-entropy"></div>
   <div style="width: 100%" id="cdf_plot_ms-entropy"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/ms-entropy/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_ms-entropy', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for ms-entropy
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/ms-entropy/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_ms-entropy', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for ms-entropy
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/ms-entropy/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_ms-entropy', spec);
            } catch (err) {
