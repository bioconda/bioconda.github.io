...
.. conda:recipe:: bioconductor-rcyjs
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/RCyjs.html
...
.. conda:package:: bioconductor-rcyjs
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rcyjs

   and update with::

      mamba update bioconductor-rcyjs

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rcyjs
