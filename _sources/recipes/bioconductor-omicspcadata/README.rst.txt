...
.. conda:recipe:: bioconductor-omicspcadata
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/experiment/html/OMICsPCAdata.html
   :license: GPL-3
...
.. conda:package:: bioconductor-omicspcadata
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-omicspcadata

   and update with::

      mamba update bioconductor-omicspcadata

  To create a new environment, run::

      mamba create --name myenvname bioconductor-omicspcadata
