...
.. conda:package:: conduit-assembler
   ...
   :depends on htslib: ``>=1.12,<1.25.0a0``
...
to install globally, run::
    ...
    pixi global install conduit-assembler

to add into an existing workspace instead, run::

    pixi add conduit-assembler
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname conduit-assembler
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_conduit-assembler"></div>
   <div style="width: 100%" id="platform_plot_conduit-assembler"></div>
   <div style="width: 100%" id="cdf_plot_conduit-assembler"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for conduit-assembler
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/conduit-assembler/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_conduit-assembler', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for conduit-assembler
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/conduit-assembler/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_conduit-assembler', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for conduit-assembler
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/conduit-assembler/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_conduit-assembler', spec);
            } catch (err) {
