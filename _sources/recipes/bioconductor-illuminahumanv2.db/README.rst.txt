...
.. conda:recipe:: bioconductor-illuminahumanv2.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/illuminaHumanv2.db.html
...
.. conda:package:: bioconductor-illuminahumanv2.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-illuminahumanv2.db

   and update with::

      mamba update bioconductor-illuminahumanv2.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-illuminahumanv2.db
