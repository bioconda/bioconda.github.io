...
.. conda:package:: bioconductor-mbpcr
   ...
   :depends: :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`bioconductor-oligoclasses` >=1.44.0,<1.45.0 :conda:package:`bioconductor-snpchip` >=2.28.0,<2.29.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-mbpcr|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-mbpcr


.. |required_by_bioconductor-mbpcr| conda:required_by:: bioconductor-mbpcr
