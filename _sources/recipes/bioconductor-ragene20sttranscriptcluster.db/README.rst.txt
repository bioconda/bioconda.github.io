...
.. conda:recipe:: bioconductor-ragene20sttranscriptcluster.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/ragene20sttranscriptcluster.db.html
...
.. conda:package:: bioconductor-ragene20sttranscriptcluster.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ragene20sttranscriptcluster.db

   and update with::

      mamba update bioconductor-ragene20sttranscriptcluster.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ragene20sttranscriptcluster.db
