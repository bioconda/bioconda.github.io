...
.. conda:package:: kipoi
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.6.35-0</code>,  <code>0.6.34-0</code>,  <code>0.6.33-0</code>,  <code>0.6.31-0</code>,  <code>0.6.30-0</code>,  <code>0.6.29-0</code>,  <code>0.6.25-1</code>,  <code>0.6.25-0</code>,  <code>0.6.24-1</code>,  </span></summary>
      

      ``0.6.35-0``,  ``0.6.34-0``,  ``0.6.33-0``,  ``0.6.31-0``,  ``0.6.30-0``,  ``0.6.29-0``,  ``0.6.25-1``,  ``0.6.25-0``,  ``0.6.24-1``,  ``0.6.24-0``,  ``0.6.17-0``,  ``0.6.16-0``,  ``0.6.14-0``,  ``0.6.13-0``,  ``0.6.12-0``,  ``0.6.5-0``,  ``0.6.3-0``,  ``0.6.0-0``,  ``0.5.7-0``,  ``0.3.6-1``,  ``0.3.6-0``
...
.. raw:: html
    ...
    <script>
        var package = "kipoi";
        var versions = ["0.6.35","0.6.34","0.6.33","0.6.31","0.6.30"];
    </script>
