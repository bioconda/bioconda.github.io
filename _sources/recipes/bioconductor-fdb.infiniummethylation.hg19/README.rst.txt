...
.. conda:recipe:: bioconductor-fdb.infiniummethylation.hg19
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/FDb.InfiniumMethylation.hg19.html
...
.. conda:package:: bioconductor-fdb.infiniummethylation.hg19
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.2.0-18</code>,  <code>2.2.0-17</code>,  <code>2.2.0-16</code>,  <code>2.2.0-15</code>,  <code>2.2.0-14</code>,  <code>2.2.0-13</code>,  <code>2.2.0-12</code>,  <code>2.2.0-11</code>,  <code>2.2.0-10</code>,  </span></summary>
      

      ``2.2.0-18``,  ``2.2.0-17``,  ``2.2.0-16``,  ``2.2.0-15``,  ``2.2.0-14``,  ``2.2.0-13``,  ``2.2.0-12``,  ``2.2.0-11``,  ``2.2.0-10``,  ``2.2.0-9``,  ``2.2.0-8``,  ``2.2.0-7``,  ``2.2.0-6``,  ``2.2.0-4``,  ``2.2.0-3``,  ``2.2.0-1``,  ``2.2.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-fdb.infiniummethylation.hg19

to add into an existing workspace instead, run::

    pixi add bioconductor-fdb.infiniummethylation.hg19
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-fdb.infiniummethylation.hg19
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-fdb.infiniummethylation.hg19"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-fdb.infiniummethylation.hg19"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-fdb.infiniummethylation.hg19"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-fdb.infiniummethylation.hg19
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-fdb.infiniummethylation.hg19/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-fdb.infiniummethylation.hg19', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-fdb.infiniummethylation.hg19
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-fdb.infiniummethylation.hg19/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-fdb.infiniummethylation.hg19', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-fdb.infiniummethylation.hg19
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-fdb.infiniummethylation.hg19/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-fdb.infiniummethylation.hg19', spec);
            } catch (err) {
