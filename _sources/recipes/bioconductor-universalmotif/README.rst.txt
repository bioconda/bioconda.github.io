...
.. conda:recipe:: bioconductor-universalmotif
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/universalmotif.html
   :license: GPL-3
...
.. conda:package:: bioconductor-universalmotif
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.28.0-0</code>,  <code>1.24.0-1</code>,  <code>1.24.0-0</code>,  <code>1.20.0-0</code>,  <code>1.18.1-0</code>,  <code>1.16.0-1</code>,  <code>1.16.0-0</code>,  <code>1.12.4-0</code>,  <code>1.12.3-0</code>,  </span></summary>
      

      ``1.28.0-0``,  ``1.24.0-1``,  ``1.24.0-0``,  ``1.20.0-0``,  ``1.18.1-0``,  ``1.16.0-1``,  ``1.16.0-0``,  ``1.12.4-0``,  ``1.12.3-0``,  ``1.12.1-0``,  ``1.10.1-0``,  ``1.8.3-0``,  ``1.8.0-0``,  ``1.6.3-0``,  ``1.4.0-0``,  ``1.2.1-0``,  ``1.0.12-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-universalmotif

to add into an existing workspace instead, run::

    pixi add bioconductor-universalmotif
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-universalmotif
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.28.0","1.24.0","1.24.0","1.20.0","1.18.1"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-universalmotif"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-universalmotif"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-universalmotif"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-universalmotif
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-universalmotif/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-universalmotif', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-universalmotif
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-universalmotif/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-universalmotif', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-universalmotif
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-universalmotif/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-universalmotif', spec);
            } catch (err) {
