...
.. conda:recipe:: bioconductor-ggmsa
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/ggmsa.html
...
.. conda:package:: bioconductor-ggmsa
   ...
   :depends on bioconductor-r4rna: ``>=1.38.0,<1.39.0``
   :depends on r-aplot: 
   :depends on r-base: ``>=4.5,<4.6.0a0``
   :depends on r-dplyr: 
   :depends on r-ggforce: 
   :depends on r-ggfun: ``>=0.2.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-ggmsa

to add into an existing workspace instead, run::

    pixi add bioconductor-ggmsa
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-ggmsa
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-ggmsa"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-ggmsa"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-ggmsa"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-ggmsa
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ggmsa/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-ggmsa', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-ggmsa
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ggmsa/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-ggmsa', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-ggmsa
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ggmsa/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-ggmsa', spec);
            } catch (err) {
