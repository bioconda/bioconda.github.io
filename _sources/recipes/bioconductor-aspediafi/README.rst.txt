...
.. conda:recipe:: bioconductor-aspediafi
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/ASpediaFI.html
   :license: GPL-3
...
.. conda:package:: bioconductor-aspediafi
   ...
   :versions:
      ...
      ``1.11.0-0``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-1``,  ``1.4.0-0``,  ``1.2.0-0``,  ``1.0.0-0``
   ...
   :depends bioconductor-ivas: ``>=2.18.0,<2.19.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.11.0","1.8.0","1.6.0","1.4.0","1.4.0"];
    </script>
