...
.. conda:package:: genometools-genometools
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.6.6-1</code>,  <code>1.6.6-0</code>,  <code>1.6.5-4</code>,  <code>1.6.5-3</code>,  <code>1.6.5-2</code>,  <code>1.6.5-1</code>,  <code>1.6.5-0</code>,  <code>1.6.4-0</code>,  <code>1.6.3-0</code>,  </span></summary>
      

      ``1.6.6-1``,  ``1.6.6-0``,  ``1.6.5-4``,  ``1.6.5-3``,  ``1.6.5-2``,  ``1.6.5-1``,  ``1.6.5-0``,  ``1.6.4-0``,  ``1.6.3-0``,  ``1.6.2-6``,  ``1.6.2-4``,  ``1.6.2-3``,  ``1.6.2-2``,  ``1.6.2-1``,  ``1.6.2-0``,  ``1.6.1-2``,  ``1.6.1-1``,  ``1.6.1-0``,  ``1.6.0-0``,  ``1.5.10-3``,  ``1.5.10-2``
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_genometools-genometools"></div>
   <div style="width: 100%" id="platform_plot_genometools-genometools"></div>
   <div style="width: 100%" id="cdf_plot_genometools-genometools"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for genometools-genometools
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/genometools-genometools/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_genometools-genometools', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for genometools-genometools
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/genometools-genometools/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_genometools-genometools', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for genometools-genometools
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/genometools-genometools/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_genometools-genometools', spec);
            } catch (err) {
