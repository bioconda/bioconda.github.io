...
.. conda:recipe:: bioconductor-ecoliprobe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/ecoliprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-ecoliprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ecoliprobe

   and update with::

      mamba update bioconductor-ecoliprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ecoliprobe
