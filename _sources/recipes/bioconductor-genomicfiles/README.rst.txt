...
.. conda:recipe:: bioconductor-genomicfiles
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/GenomicFiles.html
...
.. conda:package:: bioconductor-genomicfiles
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-genomicfiles

   and update with::

      mamba update bioconductor-genomicfiles

  To create a new environment, run::

      mamba create --name myenvname bioconductor-genomicfiles
