...
.. conda:recipe:: bioconductor-apalyzer
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/APAlyzer.html
   :license: LGPL-3
...
.. conda:package:: bioconductor-apalyzer
   ...
   :versions:
      ...
      ``1.14.0-0``,  ``1.12.0-0``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.2.0-0``,  ``1.0.0-0``
   ...
   :depends bioconductor-hybridmtest: ``>=1.44.0,<1.45.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.14.0","1.12.0","1.8.0","1.6.0","1.2.0"];
    </script>
