...
.. conda:package:: perl-html-treebuilder-xpath
   ...
   :depends on perl-xml-xpathengine: 
...
to install globally, run::
    ...
    pixi global install perl-html-treebuilder-xpath

to add into an existing workspace instead, run::

    pixi add perl-html-treebuilder-xpath
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname perl-html-treebuilder-xpath
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_perl-html-treebuilder-xpath"></div>
   <div style="width: 100%" id="platform_plot_perl-html-treebuilder-xpath"></div>
   <div style="width: 100%" id="cdf_plot_perl-html-treebuilder-xpath"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for perl-html-treebuilder-xpath
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-html-treebuilder-xpath/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_perl-html-treebuilder-xpath', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for perl-html-treebuilder-xpath
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-html-treebuilder-xpath/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_perl-html-treebuilder-xpath', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for perl-html-treebuilder-xpath
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-html-treebuilder-xpath/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_perl-html-treebuilder-xpath', spec);
            } catch (err) {
