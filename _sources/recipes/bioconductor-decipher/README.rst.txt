...
.. conda:recipe:: bioconductor-decipher
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/DECIPHER.html
   :license: GPL-3
...
.. conda:package:: bioconductor-decipher
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.22.0-0</code>,  <code>2.20.0-0</code>,  <code>2.18.1-0</code>,  <code>2.18.0-0</code>,  <code>2.16.0-0</code>,  <code>2.14.0-0</code>,  <code>2.12.0-1</code>,  <code>2.10.0-0</code>,  <code>2.8.1-0</code>,  </span></summary>
      

      ``2.22.0-0``,  ``2.20.0-0``,  ``2.18.1-0``,  ``2.18.0-0``,  ``2.16.0-0``,  ``2.14.0-0``,  ``2.12.0-1``,  ``2.10.0-0``,  ``2.8.1-0``,  ``2.6.0-1``,  ``2.6.0-0``
