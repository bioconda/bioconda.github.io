...
.. conda:recipe:: bioconductor-bsgenome.hsapiens.ucsc.hg19.masked
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/BSgenome.Hsapiens.UCSC.hg19.masked.html
...
.. conda:package:: bioconductor-bsgenome.hsapiens.ucsc.hg19.masked
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.3.993-10</code>,  <code>1.3.993-9</code>,  <code>1.3.993-8</code>,  <code>1.3.993-7</code>,  <code>1.3.993-6</code>,  <code>1.3.993-5</code>,  <code>1.3.993-4</code>,  <code>1.3.993-3</code>,  <code>1.3.993-2</code>,  </span></summary>
      

      ``1.3.993-10``,  ``1.3.993-9``,  ``1.3.993-8``,  ``1.3.993-7``,  ``1.3.993-6``,  ``1.3.993-5``,  ``1.3.993-4``,  ``1.3.993-3``,  ``1.3.993-2``,  ``1.3.993-1``,  ``1.3.993-0``,  ``1.3.99-3``,  ``1.3.99-2``,  ``1.3.99-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-bsgenome.hsapiens.ucsc.hg19.masked

to add into an existing workspace instead, run::

    pixi add bioconductor-bsgenome.hsapiens.ucsc.hg19.masked
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-bsgenome.hsapiens.ucsc.hg19.masked
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-bsgenome.hsapiens.ucsc.hg19.masked"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-bsgenome.hsapiens.ucsc.hg19.masked"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-bsgenome.hsapiens.ucsc.hg19.masked"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-bsgenome.hsapiens.ucsc.hg19.masked
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.hsapiens.ucsc.hg19.masked/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-bsgenome.hsapiens.ucsc.hg19.masked', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-bsgenome.hsapiens.ucsc.hg19.masked
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.hsapiens.ucsc.hg19.masked/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-bsgenome.hsapiens.ucsc.hg19.masked', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-bsgenome.hsapiens.ucsc.hg19.masked
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.hsapiens.ucsc.hg19.masked/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-bsgenome.hsapiens.ucsc.hg19.masked', spec);
            } catch (err) {
