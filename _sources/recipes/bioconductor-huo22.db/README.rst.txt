...
.. conda:recipe:: bioconductor-huo22.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/HuO22.db.html
...
.. conda:package:: bioconductor-huo22.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-huo22.db

   and update with::

      mamba update bioconductor-huo22.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-huo22.db
