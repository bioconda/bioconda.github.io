...
.. conda:package:: perl-namespace-autoclean
   ...
   :depends: :conda:package:`perl` 5.22.0* :conda:package:`perl-b-hooks-endofscope`  :conda:package:`perl-list-util`  :conda:package:`perl-namespace-clean`  :conda:package:`perl-sub-identify`  

   :required~by: |required_by_perl-namespace-autoclean|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/perl-namespace-autoclean


.. |required_by_perl-namespace-autoclean| conda:required_by:: perl-namespace-autoclean
