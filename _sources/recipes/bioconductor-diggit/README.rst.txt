...
.. conda:package:: bioconductor-diggit
   ...
   :depends: :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`bioconductor-viper` >=1.16.0,<1.17.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-ks`  

   :required~by: |required_by_bioconductor-diggit|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-diggit


.. |required_by_bioconductor-diggit| conda:required_by:: bioconductor-diggit
