...
.. conda:recipe:: bioconductor-hthgu133pluspmprobe
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/hthgu133pluspmprobe.html
   :license: LGPL
...
to install globally, run::
    ...
    pixi global install bioconductor-hthgu133pluspmprobe

to add into an existing workspace instead, run::

    pixi add bioconductor-hthgu133pluspmprobe
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-hthgu133pluspmprobe
...
For e.g. docker, run::
    ...
    docker pull quay.io/biocontainers/bioconductor-hthgu133pluspmprobe:<tag>

(see `bioconductor-hthgu133pluspmprobe/tags`_ for valid values for ``<tag>``).
...
.. _`bioconductor-hthgu133pluspmprobe/tags`: https://quay.io/repository/biocontainers/bioconductor-hthgu133pluspmprobe?tab=tags


.. raw:: html

   <script>
      var package = "bioconductor-hthgu133pluspmprobe";
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-hthgu133pluspmprobe"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-hthgu133pluspmprobe"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-hthgu133pluspmprobe"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-hthgu133pluspmprobe
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hthgu133pluspmprobe/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-hthgu133pluspmprobe', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-hthgu133pluspmprobe
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hthgu133pluspmprobe/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-hthgu133pluspmprobe', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-hthgu133pluspmprobe
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hthgu133pluspmprobe/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-hthgu133pluspmprobe', spec);
            } catch (err) {
