...
.. conda:recipe:: bioconductor-genomicstate
   ...
   :homepage: https://bioconductor.org/packages/3.14/data/annotation/html/GenomicState.html
...
.. conda:package:: bioconductor-genomicstate
   ...
   :versions:
      ...
      ``0.99.15-2``,  ``0.99.15-1``,  ``0.99.15-0``,  ``0.99.9-3``,  ``0.99.9-2``,  ``0.99.9-1``,  ``0.99.9-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.99.15","0.99.15","0.99.15","0.99.9","0.99.9"];
    </script>
