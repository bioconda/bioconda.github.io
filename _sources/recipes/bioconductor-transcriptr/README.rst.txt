...
.. conda:package:: bioconductor-transcriptr
   ...
   :depends: :conda:package:`bioconductor-biocgenerics` >=0.28.0,<0.29.0 :conda:package:`bioconductor-chipseq` >=1.32.0,<1.33.0 :conda:package:`bioconductor-genomeinfodb` >=1.18.0,<1.19.0 :conda:package:`bioconductor-genomicalignments` >=1.18.0,<1.19.0 :conda:package:`bioconductor-genomicfeatures` >=1.34.0,<1.35.0 :conda:package:`bioconductor-genomicranges` >=1.34.0,<1.35.0 :conda:package:`bioconductor-iranges` >=2.16.0,<2.17.0 :conda:package:`bioconductor-rsamtools` >=1.34.0,<1.35.0 :conda:package:`bioconductor-rtracklayer` >=1.42.0,<1.43.0 :conda:package:`bioconductor-s4vectors` >=0.20.0,<0.21.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-caret`  :conda:package:`r-e1071`  :conda:package:`r-ggplot2`  :conda:package:`r-proc`  :conda:package:`r-reshape2`  

   :required~by: |required_by_bioconductor-transcriptr|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-transcriptr


.. |required_by_bioconductor-transcriptr| conda:required_by:: bioconductor-transcriptr
