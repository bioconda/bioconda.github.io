...
.. conda:recipe:: bioconductor-spikein
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/SpikeIn.html
...
.. conda:package:: bioconductor-spikein
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-spikein

   and update with::

      mamba update bioconductor-spikein

  To create a new environment, run::

      mamba create --name myenvname bioconductor-spikein
