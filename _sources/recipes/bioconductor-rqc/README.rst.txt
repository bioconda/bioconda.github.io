...
.. conda:package:: bioconductor-rqc
   ...
   :depends bioconductor-biovizbase: ``>=1.58.0,<1.59.0``
   :depends bioconductor-biovizbase: ``>=1.58.0,<1.59.0a0``
   ...
   :depends bioconductor-genomicfiles: ``>=1.46.0,<1.47.0a0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rqc

   and update with::

      mamba update bioconductor-rqc

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rqc
