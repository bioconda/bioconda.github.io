...
.. conda:package:: pcaone
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.3.2-0</code>,  <code>0.3.1-0</code>,  <code>0.2.1-0</code>,  <code>0.2.0-0</code>,  <code>0.1.9-0</code>,  <code>0.1.8-1</code>,  <code>0.1.8-0</code>,  <code>0.1.7-1</code>,  <code>0.1.7-0</code>,  </span></summary>
      

      ``0.3.2-0``,  ``0.3.1-0``,  ``0.2.1-0``,  ``0.2.0-0``,  ``0.1.9-0``,  ``0.1.8-1``,  ``0.1.8-0``,  ``0.1.7-1``,  ``0.1.7-0``,  ``0.0.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "pcaone";
        var versions = ["0.3.2","0.3.1","0.2.1","0.2.0","0.1.9"];
    </script>
