...
.. conda:recipe:: bioconductor-prostatecancergrasso
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/prostateCancerGrasso.html
...
.. conda:package:: bioconductor-prostatecancergrasso
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-prostatecancergrasso

   and update with::

      mamba update bioconductor-prostatecancergrasso

  To create a new environment, run::

      mamba create --name myenvname bioconductor-prostatecancergrasso
