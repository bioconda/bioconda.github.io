...
============= ===========
Home          https://bioconductor.org/packages/3.8/bioc/html/MultiDataSet.html
Versions      1.8.0, 1.6.0, 1.4.0
License       file LICENSE
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes//home/circleci/project/docs/bioconda-recipes/recipes/bioconductor-multidataset/meta.yaml
...
A Docker container is available at https://quay.io/repository/biocontainers/bioconductor-multidataset.
...
Render an |badge| badge with the following Markdown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square)](http://bioconda.github.io/recipes/bioconductor-multidataset/README.html)

.. |badge| image:: https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square
           :target: http://bioconda.github.io/recipes/bioconductor-multidataset/README.html
.. |downloads| image:: https://anaconda.org/bioconda/bioconductor-multidataset/badges/downloads.svg
               :target: https://anaconda.org/bioconda/bioconductor-multidataset
.. |docker| image:: https://quay.io/repository/biocontainers/bioconductor-multidataset/status
