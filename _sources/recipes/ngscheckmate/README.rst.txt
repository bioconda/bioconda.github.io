...
.. conda:package:: ngscheckmate
   ...
   :depends on bcftools: ``>=1.23,<2.0a0``
   :depends on bowtie: ``>=1.3.1,<1.4.0a0``
   :depends on libzlib: ``>=1.3.1,<2.0a0``
   :depends on perl: 
   :depends on python: ``>=3.10,<3.11.0a0``
   :depends on python_abi: ``3.10.* *_cp310``
   :depends on r-base: 
   :depends on samtools: ``>=1.23,<2.0a0``
...
to install globally, run::
    ...
    pixi global install ngscheckmate

to add into an existing workspace instead, run::

    pixi add ngscheckmate
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname ngscheckmate
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_ngscheckmate"></div>
   <div style="width: 100%" id="platform_plot_ngscheckmate"></div>
   <div style="width: 100%" id="cdf_plot_ngscheckmate"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for ngscheckmate
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/ngscheckmate/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_ngscheckmate', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for ngscheckmate
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/ngscheckmate/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_ngscheckmate', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for ngscheckmate
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/ngscheckmate/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_ngscheckmate', spec);
            } catch (err) {
