...
.. conda:recipe:: bioconductor-sushi
   ...
   :homepage: https://bioconductor.org/packages/3.8/bioc/html/Sushi.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-sushi
   ...
   :depends: :conda:package:`bioconductor-biomart` >=2.38.0,<2.39.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-zoo`  

   :required~by: |required_by_bioconductor-sushi|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-sushi


.. |required_by_bioconductor-sushi| conda:required_by:: bioconductor-sushi
