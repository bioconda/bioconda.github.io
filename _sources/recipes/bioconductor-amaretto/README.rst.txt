...
.. conda:recipe:: bioconductor-amaretto
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/AMARETTO.html
...
.. conda:package:: bioconductor-amaretto
   ...
   :versions:
      ...
      ``1.8.0-0``,  ``1.6.0-1``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.1.1-1``,  ``1.0.0-1``
   ...
   :depends bioconductor-curatedtcgadata: ``>=1.14.0,<1.15.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.8.0","1.6.0","1.6.0","1.4.0","1.1.1"];
    </script>
