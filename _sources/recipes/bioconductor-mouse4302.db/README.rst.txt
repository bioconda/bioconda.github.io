...
.. conda:recipe:: bioconductor-mouse4302.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/mouse4302.db.html
...
.. conda:package:: bioconductor-mouse4302.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mouse4302.db

   and update with::

      mamba update bioconductor-mouse4302.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mouse4302.db
