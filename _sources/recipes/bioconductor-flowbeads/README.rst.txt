...
.. conda:recipe:: bioconductor-flowbeads
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/flowBeads.html
...
.. conda:package:: bioconductor-flowbeads
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-flowbeads

   and update with::

      mamba update bioconductor-flowbeads

  To create a new environment, run::

      mamba create --name myenvname bioconductor-flowbeads
