...
.. conda:recipe:: mehari
   ...
   :documentation: https://github.com/varfish-org/mehari/blob/v0.37.1/README.md
...
.. raw:: html
    ...
    <script>
        var package = "mehari";
        var versions = ["0.37.1","0.37.0","0.36.3","0.36.2","0.36.1"];
    </script>
