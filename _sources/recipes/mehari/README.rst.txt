...
.. conda:recipe:: mehari
   ...
   :documentation: https://github.com/varfish-org/mehari/blob/v0.40.0/README.md
...
.. raw:: html
    ...
    <script>
        var package = "mehari";
        var versions = ["0.40.0","0.39.0","0.38.1","0.38.0","0.37.1"];
    </script>
