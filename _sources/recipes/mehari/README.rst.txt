...
.. conda:recipe:: mehari
   ...
   :documentation: https://github.com/varfish-org/mehari/blob/v0.36.1/README.md
...
.. raw:: html
    ...
    <script>
        var package = "mehari";
        var versions = ["0.36.1","0.36.0","0.35.1","0.35.0","0.28.1"];
    </script>
