...
.. conda:package:: mehari
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.21.0-0</code>,  <code>0.20.0-0</code>,  <code>0.18.1-0</code>,  <code>0.18.0-0</code>,  <code>0.17.1-0</code>,  <code>0.17.0-0</code>,  <code>0.16.0-0</code>,  <code>0.15.2-0</code>,  <code>0.15.1-0</code>,  </span></summary>
      

      ``0.21.0-0``,  ``0.20.0-0``,  ``0.18.1-0``,  ``0.18.0-0``,  ``0.17.1-0``,  ``0.17.0-0``,  ``0.16.0-0``,  ``0.15.2-0``,  ``0.15.1-0``,  ``0.15.0-0``,  ``0.14.3-0``,  ``0.14.2-0``,  ``0.14.1-0``,  ``0.14.0-0``,  ``0.13.0-0``,  ``0.12.0-0``,  ``0.11.0-0``,  ``0.10.0-0``,  ``0.8.0-0``,  ``0.7.0-0``,  ``0.6.2-0``,  ``0.6.1-0``,  ``0.6.0-0``,  ``0.5.7-0``,  ``0.5.6-0``,  ``0.5.0-0``,  ``0.4.1-0``,  ``0.4.0-0``,  ``0.3.1-2``,  ``0.3.1-1``,  ``0.3.1-0``,  ``0.2.1-0``,  ``0.2.0-0``,  ``0.1.1-0``
   ...
   :depends libsqlite: ``>=3.44.0,<4.0a0``
...
.. raw:: html
    ...
    <script>
        var package = "mehari";
        var versions = ["0.21.0","0.20.0","0.18.1","0.18.0","0.17.1"];
    </script>
