...
.. conda:package:: dxpy
   ...
   :depends certifi: 
   :depends crc32c: ``>=2.7.1``
   :depends psutil: ``>=5.9.3``
   :depends python: ``>=3.8``
   :depends python-dateutil: ``>=2.5``
   :depends urllib3: ``>=1.25,<2.2``
   :depends websocket-client: ``>=1.6.0,<1.8.0``
   :requirements:
...
.. raw:: html
    ...
    <script>
        var package = "dxpy";
        var versions = ["0.399.1","0.399.0","0.398.0","0.397.0","0.396.0"];
    </script>
