...
.. conda:package:: dxpy
   ...
   :depends on argcomplete: ``>=3.5.2``
   :depends on awscrt: ``>=0.23.4``
   :depends on certifi: ``>=2024.7.4``
   :depends on crc32c: ``>=2.7.1``
   :depends on psutil: ``>=5.9.3``
   :depends on python: ``>=3.8``
   :depends on python-dateutil: ``>=2.5``
   :depends on urllib3: ``>=1.25,<2.8.0``
   :depends on websocket-client: ``>=1.6.0,<=1.9.0``
...
.. raw:: html
   ...
   <script>
      var package = "dxpy";
      var versions = ["0.415.0","0.414.0","0.413.0","0.412.0","0.411.0"];
   </script>
