...
.. conda:recipe:: bioconductor-twilight
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/twilight.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-twilight
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.78.0-0</code>,  <code>1.76.0-0</code>,  <code>1.74.0-1</code>,  <code>1.74.0-0</code>,  <code>1.70.0-2</code>,  <code>1.70.0-1</code>,  <code>1.70.0-0</code>,  <code>1.68.0-0</code>,  <code>1.66.0-1</code>,  </span></summary>
      

      ``1.78.0-0``,  ``1.76.0-0``,  ``1.74.0-1``,  ``1.74.0-0``,  ``1.70.0-2``,  ``1.70.0-1``,  ``1.70.0-0``,  ``1.68.0-0``,  ``1.66.0-1``,  ``1.66.0-0``,  ``1.64.0-0``,  ``1.62.0-0``,  ``1.60.0-1``,  ``1.58.0-1``,  ``1.58.0-0``,  ``1.56.0-0``,  ``1.54.0-0``,  ``1.52.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.78.0","1.76.0","1.74.0","1.74.0","1.70.0"];
    </script>
