...
License       GPL (>= 2)
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes//home/circleci/project/docs/bioconda-recipes/recipes/r-phytools/meta.yaml
...
A Docker container is available at https://quay.io/repository/biocontainers/r-phytools.
...
Render an |badge| badge with the following Markdown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square)](http://bioconda.github.io/recipes/r-phytools/README.html)

.. |badge| image:: https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square
           :target: http://bioconda.github.io/recipes/r-phytools/README.html
.. |downloads| image:: https://anaconda.org/bioconda/r-phytools/badges/downloads.svg
               :target: https://anaconda.org/bioconda/r-phytools
.. |docker| image:: https://quay.io/repository/biocontainers/r-phytools/status
