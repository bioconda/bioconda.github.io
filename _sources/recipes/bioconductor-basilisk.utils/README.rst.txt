...
.. conda:recipe:: bioconductor-basilisk.utils
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/basilisk.utils.html
   :license: GPL-3
...
.. conda:package:: bioconductor-basilisk.utils
   ...
   :versions:
      ...
      ``1.12.1-0``,  ``1.10.0-0``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.2-0``,  ``1.2.0-0``,  ``1.0.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.12.1","1.10.0","1.6.0","1.4.0","1.2.2"];
    </script>
