...
.. conda:recipe:: bioconductor-porcineprobe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/porcineprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-porcineprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-porcineprobe

   and update with::

      mamba update bioconductor-porcineprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-porcineprobe
