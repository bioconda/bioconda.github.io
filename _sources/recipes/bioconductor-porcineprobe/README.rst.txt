...
.. conda:recipe:: bioconductor-porcineprobe
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/porcineprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-porcineprobe
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-porcineprobe:<tag>
