...
.. conda:recipe:: bioconductor-mu19ksubbcdf
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/mu19ksubbcdf.html
   :license: LGPL
...
to install globally, run::
    ...
    pixi global install bioconductor-mu19ksubbcdf

to add into an existing workspace instead, run::

    pixi add bioconductor-mu19ksubbcdf
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-mu19ksubbcdf
...
.. |downloads_bioconductor-mu19ksubbcdf| image:: https://img.shields.io/conda/dn/bioconda/bioconductor-mu19ksubbcdf.svg?style=flat
   :target: https://anaconda.org/bioconda/bioconductor-mu19ksubbcdf
   :alt:   (downloads)
...
.. raw:: html
   ...
   <script>
      var package = "bioconductor-mu19ksubbcdf";
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-mu19ksubbcdf"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-mu19ksubbcdf"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-mu19ksubbcdf"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-mu19ksubbcdf
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-mu19ksubbcdf/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-mu19ksubbcdf', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-mu19ksubbcdf
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-mu19ksubbcdf/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-mu19ksubbcdf', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-mu19ksubbcdf
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-mu19ksubbcdf/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-mu19ksubbcdf', spec);
            } catch (err) {
