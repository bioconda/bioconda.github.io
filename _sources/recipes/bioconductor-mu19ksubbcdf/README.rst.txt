...
.. conda:recipe:: bioconductor-mu19ksubbcdf
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/mu19ksubbcdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-mu19ksubbcdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mu19ksubbcdf

   and update with::

      mamba update bioconductor-mu19ksubbcdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mu19ksubbcdf
