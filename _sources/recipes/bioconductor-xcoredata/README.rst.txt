...
.. conda:recipe:: bioconductor-xcoredata
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/experiment/html/xcoredata.html
   :license: GPL-2
...
.. conda:package:: bioconductor-xcoredata
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-xcoredata

   and update with::

      mamba update bioconductor-xcoredata

  To create a new environment, run::

      mamba create --name myenvname bioconductor-xcoredata
