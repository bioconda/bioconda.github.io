...
.. conda:package:: vpt-segmentation-packing
   ...
   :depends on mapbox_earcut: ``>=1.0.1``
...
to install globally, run::
    ...
    pixi global install vpt-segmentation-packing

to add into an existing workspace instead, run::

    pixi add vpt-segmentation-packing
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install vpt-segmentation-packing

Alternatively, to install into a new environment, run::

    conda create -n envname vpt-segmentation-packing
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_vpt-segmentation-packing"></div>
   <div style="width: 100%" id="platform_plot_vpt-segmentation-packing"></div>
   <div style="width: 100%" id="cdf_plot_vpt-segmentation-packing"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for vpt-segmentation-packing
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/vpt-segmentation-packing/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_vpt-segmentation-packing', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for vpt-segmentation-packing
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/vpt-segmentation-packing/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_vpt-segmentation-packing', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for vpt-segmentation-packing
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/vpt-segmentation-packing/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_vpt-segmentation-packing', spec);
            } catch (err) {
