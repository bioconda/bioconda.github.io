...
.. conda:package:: metaplatanus
   ...
   :depends on racon: ``>=1.4.20``
   :depends on samtools: ``>=1.9``
   :depends on seqkit: ``>=0.16.1``
   :depends on tgsgapcloser: ``>=1.0.3``
   :depends on zlib: 
...
to install globally, run::
    ...
    pixi global install metaplatanus

to add into an existing workspace instead, run::

    pixi add metaplatanus
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname metaplatanus
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_metaplatanus"></div>
   <div style="width: 100%" id="platform_plot_metaplatanus"></div>
   <div style="width: 100%" id="cdf_plot_metaplatanus"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for metaplatanus
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/metaplatanus/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_metaplatanus', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for metaplatanus
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/metaplatanus/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_metaplatanus', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for metaplatanus
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/metaplatanus/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_metaplatanus', spec);
            } catch (err) {
