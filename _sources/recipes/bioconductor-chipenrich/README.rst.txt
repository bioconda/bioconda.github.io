...
.. conda:recipe:: bioconductor-chipenrich
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/chipenrich.html
   :license: GPL-3
...
.. conda:package:: bioconductor-chipenrich
   ...
   :depends on bioconductor-chipenrich.data: ``>=2.34.0,<2.35.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-chipenrich

to add into an existing workspace instead, run::

    pixi add bioconductor-chipenrich
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-chipenrich
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-chipenrich"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-chipenrich"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-chipenrich"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-chipenrich
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-chipenrich/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-chipenrich', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-chipenrich
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-chipenrich/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-chipenrich', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-chipenrich
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-chipenrich/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-chipenrich', spec);
            } catch (err) {
