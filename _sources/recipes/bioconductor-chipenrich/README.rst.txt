...
.. conda:package:: bioconductor-chipenrich
   ...
   :versions:
      ...
      ``2.18.0-0``,  ``2.16.0-0``,  ``2.14.0-1``,  ``2.14.0-0``,  ``2.12.0-0``,  ``2.10.0-1``,  ``2.8.0-1``,  ``2.6.0-0``
   ...
   :depends bioconductor-chipenrich.data: ``>=2.18.0,<2.19.0``
   :depends bioconductor-genomeinfodb: ``>=1.30.0,<1.31.0``
   :depends bioconductor-genomicranges: ``>=1.46.0,<1.47.0``
   :depends bioconductor-iranges: ``>=2.28.0,<2.29.0``
   :depends bioconductor-org.dm.eg.db: ``>=3.14.0,<3.15.0``
   :depends bioconductor-org.dr.eg.db: ``>=3.14.0,<3.15.0``
