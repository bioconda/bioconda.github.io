...
.. conda:recipe:: bioconductor-pd.rta.1.0
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/pd.rta.1.0.html
...
.. conda:package:: bioconductor-pd.rta.1.0
   ...
   :required~by: |required_by_bioconductor-pd.rta.1.0|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-pd.rta.1.0


.. |required_by_bioconductor-pd.rta.1.0| conda:required_by:: bioconductor-pd.rta.1.0
