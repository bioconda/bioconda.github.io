...
.. conda:recipe:: bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/IlluminaHumanMethylation450kanno.ilmn12.hg19.html
...
.. conda:package:: bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.6.1-4</code>,  <code>0.6.1-3</code>,  <code>0.6.1-2</code>,  <code>0.6.1-1</code>,  <code>0.6.1-0</code>,  <code>0.6.0-14</code>,  <code>0.6.0-13</code>,  <code>0.6.0-12</code>,  <code>0.6.0-11</code>,  </span></summary>
      

      ``0.6.1-4``,  ``0.6.1-3``,  ``0.6.1-2``,  ``0.6.1-1``,  ``0.6.1-0``,  ``0.6.0-14``,  ``0.6.0-13``,  ``0.6.0-12``,  ``0.6.0-11``,  ``0.6.0-10``,  ``0.6.0-9``,  ``0.6.0-8``,  ``0.6.0-7``,  ``0.6.0-5``,  ``0.6.0-4``,  ``0.6.0-2``,  ``0.6.0-1``,  ``0.6.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19

to add into an existing workspace instead, run::

    pixi add bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-illuminahumanmethylation450kanno.ilmn12.hg19', spec);
            } catch (err) {
