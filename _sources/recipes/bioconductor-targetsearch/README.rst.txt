...
.. conda:recipe:: bioconductor-targetsearch
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/TargetSearch.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-targetsearch
   ...
   :versions:
      ...
      ``1.50.0-0``,  ``1.48.0-0``,  ``1.46.3-0``,  ``1.46.0-0``,  ``1.44.0-0``,  ``1.42.0-0``,  ``1.40.2-0``,  ``1.40.0-0``,  ``1.38.1-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.50.0","1.48.0","1.46.3","1.46.0","1.44.0"];
    </script>
