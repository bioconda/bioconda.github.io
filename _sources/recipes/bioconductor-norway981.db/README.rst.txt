...
.. conda:recipe:: bioconductor-norway981.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/Norway981.db.html
...
.. conda:package:: bioconductor-norway981.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-norway981.db

   and update with::

      mamba update bioconductor-norway981.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-norway981.db
