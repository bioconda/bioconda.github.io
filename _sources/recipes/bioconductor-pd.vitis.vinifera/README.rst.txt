...
.. conda:recipe:: bioconductor-pd.vitis.vinifera
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/pd.vitis.vinifera.html
...
.. conda:package:: bioconductor-pd.vitis.vinifera
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.vitis.vinifera

   and update with::

      mamba update bioconductor-pd.vitis.vinifera

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.vitis.vinifera
