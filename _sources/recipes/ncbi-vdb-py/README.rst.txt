...
.. conda:package:: ncbi-vdb-py
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.4.1-0</code>,  <code>3.2.1-0</code>,  <code>3.2.0-0</code>,  <code>3.1.1-0</code>,  <code>3.1.0-0</code>,  <code>3.0.10-0</code>,  <code>3.0.9-0</code>,  <code>3.0.8-0</code>,  <code>3.0.7-0</code>,  </span></summary>
      

      ``3.4.1-0``,  ``3.2.1-0``,  ``3.2.0-0``,  ``3.1.1-0``,  ``3.1.0-0``,  ``3.0.10-0``,  ``3.0.9-0``,  ``3.0.8-0``,  ``3.0.7-0``,  ``3.0.6-0``,  ``3.0.5-0``,  ``3.0.2-0``,  ``3.0.0-0``,  ``2.11.0-0``,  ``2.10.9-0``,  ``2.10.8-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["3.4.1","3.2.1","3.2.0","3.1.1","3.1.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_ncbi-vdb-py"></div>
   <div style="width: 100%" id="platform_plot_ncbi-vdb-py"></div>
   <div style="width: 100%" id="cdf_plot_ncbi-vdb-py"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for ncbi-vdb-py
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/ncbi-vdb-py/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_ncbi-vdb-py', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for ncbi-vdb-py
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/ncbi-vdb-py/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_ncbi-vdb-py', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for ncbi-vdb-py
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/ncbi-vdb-py/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_ncbi-vdb-py', spec);
            } catch (err) {
