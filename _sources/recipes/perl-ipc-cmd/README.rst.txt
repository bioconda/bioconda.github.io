...
.. conda:package:: perl-ipc-cmd
   ...
   :versions:
      ...
      ``1.04-1``,  ``1.04-0``,  ``1.02-1``,  ``1.02-0``,  ``1.00-1``,  ``1.00-0``
...
to install globally, run::
    ...
    pixi global install perl-ipc-cmd

to add into an existing workspace instead, run::

    pixi add perl-ipc-cmd
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname perl-ipc-cmd
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.04","1.04","1.02","1.02","1.00"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_perl-ipc-cmd"></div>
   <div style="width: 100%" id="platform_plot_perl-ipc-cmd"></div>
   <div style="width: 100%" id="cdf_plot_perl-ipc-cmd"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for perl-ipc-cmd
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-ipc-cmd/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_perl-ipc-cmd', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for perl-ipc-cmd
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-ipc-cmd/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_perl-ipc-cmd', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for perl-ipc-cmd
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-ipc-cmd/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_perl-ipc-cmd', spec);
            } catch (err) {
