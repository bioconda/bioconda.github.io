...
.. conda:package:: r-acidplyr
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.4.2-0</code>,  <code>0.4.1-0</code>,  <code>0.3.11-0</code>,  <code>0.3.10-2</code>,  <code>0.3.10-1</code>,  <code>0.3.10-0</code>,  <code>0.3.9-1</code>,  <code>0.3.9-0</code>,  <code>0.3.8-0</code>,  </span></summary>
      

      ``0.4.2-0``,  ``0.4.1-0``,  ``0.3.11-0``,  ``0.3.10-2``,  ``0.3.10-1``,  ``0.3.10-0``,  ``0.3.9-1``,  ``0.3.9-0``,  ``0.3.8-0``,  ``0.3.7-1``,  ``0.3.7-0``,  ``0.3.6-0``,  ``0.3.5-0``,  ``0.3.4-0``,  ``0.3.3-0``,  ``0.3.2-1``,  ``0.3.2-0``,  ``0.2.0-1``,  ``0.2.0-0``,  ``0.1.22-0``,  ``0.1.21-0``,  ``0.1.20-0``,  ``0.1.18-2``,  ``0.1.18-1``,  ``0.1.18-0``,  ``0.1.17-1``,  ``0.1.17-0``,  ``0.1.4-1``,  ``0.1.4-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.4.2","0.4.1","0.3.11","0.3.10","0.3.10"];
    </script>
