...
.. conda:recipe:: bioconductor-ahensdbs
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/AHEnsDbs.html
...
.. conda:package:: bioconductor-ahensdbs
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.7.0-0</code>,  <code>1.1.10-0</code>,  <code>1.1.8-1</code>,  <code>1.1.8-0</code>,  <code>1.1.4-1</code>,  <code>1.1.2-0</code>,  <code>1.0.18-1</code>,  <code>1.0.18-0</code>,  <code>1.0.15-0</code>,  </span></summary>
      

      ``1.7.0-0``,  ``1.1.10-0``,  ``1.1.8-1``,  ``1.1.8-0``,  ``1.1.4-1``,  ``1.1.2-0``,  ``1.0.18-1``,  ``1.0.18-0``,  ``1.0.15-0``,  ``1.0.14-0``,  ``1.0.12-0``,  ``1.0.9-1``,  ``1.0.8-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-ahensdbs

to add into an existing workspace instead, run::

    pixi add bioconductor-ahensdbs
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-ahensdbs
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.7.0","1.1.10","1.1.8","1.1.8","1.1.4"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-ahensdbs"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-ahensdbs"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-ahensdbs"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-ahensdbs
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ahensdbs/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-ahensdbs', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-ahensdbs
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ahensdbs/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-ahensdbs', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-ahensdbs
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ahensdbs/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-ahensdbs', spec);
            } catch (err) {
