...
.. conda:recipe:: bioconductor-glimma
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/Glimma.html
   :license: GPL-3
...
.. conda:package:: bioconductor-glimma
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.2.0-0</code>,  <code>2.0.0-1</code>,  <code>2.0.0-0</code>,  <code>1.16.0-0</code>,  <code>1.14.0-0</code>,  <code>1.12.0-1</code>,  <code>1.10.1-0</code>,  <code>1.10.0-0</code>,  <code>1.8.2-0</code>,  </span></summary>
      

      ``2.2.0-0``,  ``2.0.0-1``,  ``2.0.0-0``,  ``1.16.0-0``,  ``1.14.0-0``,  ``1.12.0-1``,  ``1.10.1-0``,  ``1.10.0-0``,  ``1.8.2-0``,  ``1.6.0-0``
