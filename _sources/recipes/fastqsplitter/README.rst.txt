...
.. conda:package:: fastqsplitter
   ...
   :versions:
      ...
      ``1.2.0-9``,  ``1.2.0-8``,  ``1.2.0-7``,  ``1.2.0-6``,  ``1.2.0-5``,  ``1.2.0-4``,  ``1.2.0-3``,  ``1.2.0-2``,  ``1.2.0-1``,  ``1.2.0-0``,  ``1.1.0-1``,  ``1.1.0-0``,  ``1.0.0-0``
...
to install globally, run::
    ...
    pixi global install fastqsplitter

to add into an existing workspace instead, run::

    pixi add fastqsplitter
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname fastqsplitter
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_fastqsplitter"></div>
   <div style="width: 100%" id="platform_plot_fastqsplitter"></div>
   <div style="width: 100%" id="cdf_plot_fastqsplitter"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for fastqsplitter
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/fastqsplitter/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_fastqsplitter', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for fastqsplitter
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/fastqsplitter/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_fastqsplitter', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for fastqsplitter
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/fastqsplitter/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_fastqsplitter', spec);
            } catch (err) {
