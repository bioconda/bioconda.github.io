...
.. conda:recipe:: bioconductor-lungexpression
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/lungExpression.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-lungexpression
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-lungexpression

   and update with::

      mamba update bioconductor-lungexpression

  To create a new environment, run::

      mamba create --name myenvname bioconductor-lungexpression
