...
.. conda:recipe:: bioconductor-txdb.rnorvegicus.ucsc.rn4.ensgene
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/TxDb.Rnorvegicus.UCSC.rn4.ensGene.html
...
.. conda:package:: bioconductor-txdb.rnorvegicus.ucsc.rn4.ensgene
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-txdb.rnorvegicus.ucsc.rn4.ensgene

   and update with::

      mamba update bioconductor-txdb.rnorvegicus.ucsc.rn4.ensgene

  To create a new environment, run::

      mamba create --name myenvname bioconductor-txdb.rnorvegicus.ucsc.rn4.ensgene
