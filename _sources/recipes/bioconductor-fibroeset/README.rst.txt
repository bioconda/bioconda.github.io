...
.. conda:recipe:: bioconductor-fibroeset
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/fibroEset.html
   :license: LGPL
...
.. conda:package:: bioconductor-fibroeset
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-fibroeset

   and update with::

      mamba update bioconductor-fibroeset

  To create a new environment, run::

      mamba create --name myenvname bioconductor-fibroeset
