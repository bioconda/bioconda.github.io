...
.. conda:recipe:: bioconductor-h20kcod.db
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/h20kcod.db.html
...
.. conda:package:: bioconductor-h20kcod.db
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.4.0-14</code>,  <code>3.4.0-13</code>,  <code>3.4.0-12</code>,  <code>3.4.0-11</code>,  <code>3.4.0-10</code>,  <code>3.4.0-9</code>,  <code>3.4.0-8</code>,  <code>3.4.0-7</code>,  <code>3.4.0-5</code>,  </span></summary>
      

      ``3.4.0-14``,  ``3.4.0-13``,  ``3.4.0-12``,  ``3.4.0-11``,  ``3.4.0-10``,  ``3.4.0-9``,  ``3.4.0-8``,  ``3.4.0-7``,  ``3.4.0-5``,  ``3.4.0-4``,  ``3.4.0-3``,  ``3.4.0-2``,  ``3.4.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-h20kcod.db

to add into an existing workspace instead, run::

    pixi add bioconductor-h20kcod.db
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-h20kcod.db
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-h20kcod.db"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-h20kcod.db"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-h20kcod.db"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-h20kcod.db
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-h20kcod.db/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-h20kcod.db', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-h20kcod.db
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-h20kcod.db/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-h20kcod.db', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-h20kcod.db
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-h20kcod.db/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-h20kcod.db', spec);
            } catch (err) {
