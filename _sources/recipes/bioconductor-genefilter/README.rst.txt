...
.. conda:recipe:: bioconductor-genefilter
   ...
   :homepage: https://bioconductor.org/packages/3.11/bioc/html/genefilter.html
...
.. conda:package:: bioconductor-genefilter
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.70.0-0</code>,  <code>1.68.0-0</code>,  <code>1.66.0-1</code>,  <code>1.64.0-1</code>,  <code>1.64.0-0</code>,  <code>1.62.0-0</code>,  <code>1.60.0-0</code>,  <code>1.58.1-0</code>,  <code>1.56.0-0</code>,  </span></summary>
      

      ``1.70.0-0``,  ``1.68.0-0``,  ``1.66.0-1``,  ``1.64.0-1``,  ``1.64.0-0``,  ``1.62.0-0``,  ``1.60.0-0``,  ``1.58.1-0``,  ``1.56.0-0``,  ``1.54.2-0``,  ``1.52.1-0``,  ``1.52.0-0``,  ``1.51.0-0``,  ``1.50.0-0``
