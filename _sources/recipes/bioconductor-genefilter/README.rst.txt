...
.. conda:recipe:: bioconductor-genefilter
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/genefilter.html
...
.. conda:package:: bioconductor-genefilter
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.92.0-0</code>,  <code>1.88.0-1</code>,  <code>1.88.0-0</code>,  <code>1.84.0-1</code>,  <code>1.84.0-0</code>,  <code>1.82.1-0</code>,  <code>1.80.0-1</code>,  <code>1.80.0-0</code>,  <code>1.76.0-2</code>,  </span></summary>
      

      ``1.92.0-0``,  ``1.88.0-1``,  ``1.88.0-0``,  ``1.84.0-1``,  ``1.84.0-0``,  ``1.82.1-0``,  ``1.80.0-1``,  ``1.80.0-0``,  ``1.76.0-2``,  ``1.76.0-1``,  ``1.76.0-0``,  ``1.74.0-0``,  ``1.72.1-0``,  ``1.72.0-0``,  ``1.70.0-0``,  ``1.68.0-0``,  ``1.66.0-1``,  ``1.64.0-1``,  ``1.64.0-0``,  ``1.62.0-0``,  ``1.60.0-0``,  ``1.58.1-0``,  ``1.56.0-0``,  ``1.54.2-0``,  ``1.52.1-0``,  ``1.52.0-0``,  ``1.51.0-0``,  ``1.50.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-genefilter

to add into an existing workspace instead, run::

    pixi add bioconductor-genefilter
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-genefilter
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.92.0","1.88.0","1.88.0","1.84.0","1.84.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-genefilter"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-genefilter"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-genefilter"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-genefilter
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-genefilter/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-genefilter', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-genefilter
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-genefilter/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-genefilter', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-genefilter
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-genefilter/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-genefilter', spec);
            } catch (err) {
