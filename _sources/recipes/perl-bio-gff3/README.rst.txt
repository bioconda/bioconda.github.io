...
.. conda:package:: perl-bio-gff3
   ...
   :depends: :conda:package:`perl-extutils-makemaker`  :conda:package:`perl-file-readbackwards`  :conda:package:`perl-io-string`  :conda:package:`perl-list-moreutils`  :conda:package:`perl-pathtools`  :conda:package:`perl-scalar-list-utils`  :conda:package:`perl-test-simple`  :conda:package:`perl-threaded`  :conda:package:`perl-uri`  

   :required~by: |required_by_perl-bio-gff3|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/perl-bio-gff3


.. |required_by_perl-bio-gff3| conda:required_by:: perl-bio-gff3
