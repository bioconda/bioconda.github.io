...
.. conda:package:: shortstack
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>4.0.2-0</code>,  <code>4.0.1-0</code>,  <code>4.0.0-0</code>,  <code>3.8.5-4</code>,  <code>3.8.5-3</code>,  <code>3.8.5-2</code>,  <code>3.8.5-1</code>,  <code>3.8.5-0</code>,  <code>3.8.3-0</code>,  </span></summary>
      

      ``4.0.2-0``,  ``4.0.1-0``,  ``4.0.0-0``,  ``3.8.5-4``,  ``3.8.5-3``,  ``3.8.5-2``,  ``3.8.5-1``,  ``3.8.5-0``,  ``3.8.3-0``,  ``3.6-1``,  ``3.6-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["4.0.2","4.0.1","4.0.0","3.8.5","3.8.5"];
    </script>
