...
.. conda:package:: trnascan-se
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.0.13-0</code>,  <code>2.0.12-2</code>,  <code>2.0.12-1</code>,  <code>2.0.12-0</code>,  <code>2.0.11-1</code>,  <code>2.0.11-0</code>,  <code>2.0.9-3</code>,  <code>2.0.9-2</code>,  <code>2.0.9-1</code>,  </span></summary>
      

      ``2.0.13-0``,  ``2.0.12-2``,  ``2.0.12-1``,  ``2.0.12-0``,  ``2.0.11-1``,  ``2.0.11-0``,  ``2.0.9-3``,  ``2.0.9-2``,  ``2.0.9-1``,  ``2.0.9-0``,  ``2.0.7-1``,  ``2.0.7-0``,  ``2.0.6-0``,  ``2.0.5-0``,  ``2.0.3-0``,  ``2.0-1``,  ``2.0-0``,  ``1.3.1-10``,  ``1.3.1-9``,  ``1.3.1-8``,  ``1.3.1-7``,  ``1.3.1-6``,  ``1.3.1-5``,  ``1.3.1-4``,  ``1.3.1-3``,  ``1.3.1-2``,  ``1.3.1-1``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["2.0.13","2.0.12","2.0.12","2.0.12","2.0.11"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_trnascan-se"></div>
   <div style="width: 100%" id="platform_plot_trnascan-se"></div>
   <div style="width: 100%" id="cdf_plot_trnascan-se"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for trnascan-se
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/trnascan-se/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_trnascan-se', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for trnascan-se
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/trnascan-se/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_trnascan-se', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for trnascan-se
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/trnascan-se/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_trnascan-se', spec);
            } catch (err) {
