...
.. conda:package:: python-crypt4gh
   ...
   :versions:
      ...
      ``1.8.6-1``,  ``1.8.6-0``,  ``1.8-0``,  ``1.7-0``,  ``1.6-0``,  ``1.5-0``
...
to install globally, run::
    ...
    pixi global install python-crypt4gh

to add into an existing workspace instead, run::

    pixi add python-crypt4gh
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname python-crypt4gh
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.8.6","1.8.6","1.8","1.7","1.6"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_python-crypt4gh"></div>
   <div style="width: 100%" id="platform_plot_python-crypt4gh"></div>
   <div style="width: 100%" id="cdf_plot_python-crypt4gh"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for python-crypt4gh
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/python-crypt4gh/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_python-crypt4gh', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for python-crypt4gh
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/python-crypt4gh/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_python-crypt4gh', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for python-crypt4gh
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/python-crypt4gh/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_python-crypt4gh', spec);
            } catch (err) {
