...
.. conda:recipe:: bioconductor-comet
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/coMET.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-comet
   ...
   :depends on bioconductor-gviz: ``>=1.46.0,<1.47.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-comet

to add into an existing workspace instead, run::

    pixi add bioconductor-comet
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-comet
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-comet"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-comet"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-comet"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-comet
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-comet/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-comet', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-comet
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-comet/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-comet', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-comet
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-comet/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-comet', spec);
            } catch (err) {
