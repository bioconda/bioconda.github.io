...
.. conda:recipe:: bioconductor-agilp
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/agilp.html
   :license: GPL-3
...
.. conda:package:: bioconductor-agilp
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.22.0-1</code>,  <code>3.22.0-0</code>,  <code>3.20.0-0</code>,  <code>3.18.0-0</code>,  <code>3.16.0-1</code>,  <code>3.16.0-0</code>,  <code>3.14.0-0</code>,  <code>3.12.0-0</code>,  <code>3.10.0-0</code>,  </span></summary>
      

      ``3.22.0-1``,  ``3.22.0-0``,  ``3.20.0-0``,  ``3.18.0-0``,  ``3.16.0-1``,  ``3.16.0-0``,  ``3.14.0-0``,  ``3.12.0-0``,  ``3.10.0-0``,  ``3.8.0-0``
