...
.. conda:package:: varfish-server-worker
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.17.3-1</code>,  <code>0.17.3-0</code>,  <code>0.17.2-0</code>,  <code>0.13.0-1</code>,  <code>0.13.0-0</code>,  <code>0.12.0-0</code>,  <code>0.11.0-0</code>,  <code>0.10.2-1</code>,  <code>0.10.2-0</code>,  </span></summary>
      

      ``0.17.3-1``,  ``0.17.3-0``,  ``0.17.2-0``,  ``0.13.0-1``,  ``0.13.0-0``,  ``0.12.0-0``,  ``0.11.0-0``,  ``0.10.2-1``,  ``0.10.2-0``,  ``0.10.1-0``,  ``0.10.0-0``,  ``0.9.0-0``,  ``0.8.0-0``,  ``0.7.0-0``,  ``0.6.1-2``,  ``0.6.1-1``,  ``0.6.1-0``,  ``0.6.0-0``,  ``0.5.1-0``,  ``0.5.0-0``,  ``0.4.0-0``,  ``0.3.0-0``,  ``0.2.1-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["0.17.3","0.17.3","0.17.2","0.13.0","0.13.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_varfish-server-worker"></div>
   <div style="width: 100%" id="platform_plot_varfish-server-worker"></div>
   <div style="width: 100%" id="cdf_plot_varfish-server-worker"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for varfish-server-worker
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/varfish-server-worker/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_varfish-server-worker', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for varfish-server-worker
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/varfish-server-worker/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_varfish-server-worker', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for varfish-server-worker
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/varfish-server-worker/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_varfish-server-worker', spec);
            } catch (err) {
