...
.. conda:recipe:: bioconductor-prostatecancerstockholm
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/prostateCancerStockholm.html
...
.. conda:package:: bioconductor-prostatecancerstockholm
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-prostatecancerstockholm

   and update with::

      mamba update bioconductor-prostatecancerstockholm

  To create a new environment, run::

      mamba create --name myenvname bioconductor-prostatecancerstockholm
