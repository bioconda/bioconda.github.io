...
Versions      1.8.1
License       GPL-3
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes//bioconductor-desubs/meta.yaml
...
A Docker container is available at https://quay.io/repository/biocontainers/bioconductor-desubs.
...
Render an |badge| badge with the following Markdown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square)](http://bioconda.github.io/recipes/bioconductor-desubs/README.html)

.. |badge| image:: https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square
           :target: http://bioconda.github.io/recipes/bioconductor-desubs/README.html
.. |downloads| image:: https://anaconda.org/bioconda/bioconductor-desubs/badges/downloads.svg
               :target: https://anaconda.org/bioconda/bioconductor-desubs
.. |docker| image:: https://quay.io/repository/biocontainers/bioconductor-desubs/status
