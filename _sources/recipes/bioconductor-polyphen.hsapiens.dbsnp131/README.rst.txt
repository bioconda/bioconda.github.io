...
.. conda:recipe:: bioconductor-polyphen.hsapiens.dbsnp131
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/PolyPhen.Hsapiens.dbSNP131.html
...
.. conda:package:: bioconductor-polyphen.hsapiens.dbsnp131
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-polyphen.hsapiens.dbsnp131

   and update with::

      mamba update bioconductor-polyphen.hsapiens.dbsnp131

  To create a new environment, run::

      mamba create --name myenvname bioconductor-polyphen.hsapiens.dbsnp131
