...
.. conda:recipe:: bioconductor-indeed
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/INDEED.html
...
.. conda:package:: bioconductor-indeed
   ...
   :versions:
      ...
      ``2.24.0-0``,  ``2.20.0-0``,  ``2.16.0-0``,  ``2.14.0-0``,  ``2.12.0-0``,  ``2.8.0-0``,  ``2.6.0-0``,  ``2.4.0-1``,  ``2.4.0-0``,  ``2.2.0-0``,  ``2.0.0-0``,  ``1.2.0-1``,  ``1.2.0-0``,  ``1.0.1-0``
   ...
   :depends on r-devtools: ``>=1.13.0``
   :depends on r-glasso: ``>=1.8``
   :depends on r-igraph: ``>=1.2.4``
   :depends on r-visnetwork: ``>=2.0.6``
...
to install globally, run::
    ...
    pixi global install bioconductor-indeed

to add into an existing workspace instead, run::

    pixi add bioconductor-indeed
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-indeed
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-indeed"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-indeed"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-indeed"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-indeed
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-indeed/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-indeed', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-indeed
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-indeed/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-indeed', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-indeed
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-indeed/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-indeed', spec);
            } catch (err) {
