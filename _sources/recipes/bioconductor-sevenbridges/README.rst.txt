...
.. conda:recipe:: bioconductor-sevenbridges
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/sevenbridges.html
...
.. conda:package:: bioconductor-sevenbridges
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.36.0-0</code>,  <code>1.32.0-0</code>,  <code>1.30.0-0</code>,  <code>1.28.0-0</code>,  <code>1.24.0-0</code>,  <code>1.22.0-0</code>,  <code>1.20.1-0</code>,  <code>1.20.0-0</code>,  <code>1.18.0-0</code>,  </span></summary>
      

      ``1.36.0-0``,  ``1.32.0-0``,  ``1.30.0-0``,  ``1.28.0-0``,  ``1.24.0-0``,  ``1.22.0-0``,  ``1.20.1-0``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.1-0``,  ``1.12.5-0``,  ``1.12.3-0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-sevenbridges

   and update with::

      mamba update bioconductor-sevenbridges

  To create a new environment, run::

      mamba create --name myenvname bioconductor-sevenbridges
