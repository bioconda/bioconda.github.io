...
.. conda:recipe:: bioconductor-gsri
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/GSRI.html
   :license: GPL-3
...
.. conda:package:: bioconductor-gsri
   ...
   :versions:
      ...
      ``2.58.0-0``,  ``2.54.0-0``,  ``2.50.0-0``,  ``2.48.0-0``,  ``2.46.0-0``,  ``2.42.0-0``,  ``2.40.0-0``,  ``2.38.0-1``,  ``2.38.0-0``,  ``2.36.0-0``,  ``2.34.0-0``,  ``2.32.0-1``,  ``2.30.0-0``,  ``2.28.0-0``,  ``2.26.0-0``
   ...
   :depends on bioconductor-les: ``>=1.60.0,<1.61.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-gsri

to add into an existing workspace instead, run::

    pixi add bioconductor-gsri
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-gsri
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-gsri"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-gsri"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-gsri"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-gsri
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-gsri/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-gsri', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-gsri
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-gsri/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-gsri', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-gsri
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-gsri/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-gsri', spec);
            } catch (err) {
