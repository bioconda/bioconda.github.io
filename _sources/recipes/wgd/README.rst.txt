...
.. conda:package:: wgd
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.0.34-0</code>,  <code>2.0.33-0</code>,  <code>2.0.32-0</code>,  <code>2.0.31-0</code>,  <code>2.0.30-0</code>,  <code>2.0.29-0</code>,  <code>2.0.28-0</code>,  <code>2.0.27-0</code>,  <code>2.0.26-0</code>,  </span></summary>
      

      ``2.0.34-0``,  ``2.0.33-0``,  ``2.0.32-0``,  ``2.0.31-0``,  ``2.0.30-0``,  ``2.0.29-0``,  ``2.0.28-0``,  ``2.0.27-0``,  ``2.0.26-0``,  ``2.0.25-0``,  ``2.0.24-0``,  ``2.0.23-0``,  ``2.0.22-0``,  ``2.0.21-0``,  ``2.0.20-0``,  ``2.0.19-0``,  ``2.0.18-0``,  ``2.0.16-0``,  ``2.0.15-0``,  ``2.0.12-0``
...
.. raw:: html
    ...
    <script>
        var package = "wgd";
        var versions = ["2.0.34","2.0.33","2.0.32","2.0.31","2.0.30"];
    </script>
