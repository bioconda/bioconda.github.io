...
.. conda:package:: bioconductor-mesh.laf.eg.db
   ...
   :required~by: |required_by_bioconductor-mesh.laf.eg.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-mesh.laf.eg.db


.. |required_by_bioconductor-mesh.laf.eg.db| conda:required_by:: bioconductor-mesh.laf.eg.db
