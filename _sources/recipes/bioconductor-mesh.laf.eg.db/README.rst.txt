...
.. conda:recipe:: bioconductor-mesh.laf.eg.db
   ...
   Mapping table for Loxodonta africana Gene ID to MeSH

   :homepage: https://bioconductor.org/packages/3.13/data/annotation/html/MeSH.Laf.eg.db.html
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-mesh.laf.eg.db";
