...
.. conda:recipe:: bioconductor-copywriter
   ...
   :homepage: https://bioconductor.org/packages/3.11/bioc/html/CopywriteR.html
   :license: GPL-2
...
.. conda:package:: bioconductor-copywriter
   ...
   :versions:
      ...
      ``2.22.0-0``,  ``2.20.0-0``,  ``2.18.0-1``,  ``2.16.0-1``,  ``2.14.0-0``,  ``2.12.0-0``,  ``2.10.0-0``
   ...
   :depends bioconductor-copyhelper: ``>=1.22.0,<1.23.0``
