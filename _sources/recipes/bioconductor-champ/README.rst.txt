...
.. conda:package:: bioconductor-champ
   ...
   :versions: 2.16.0-1, 2.14.0-1, 2.12.2-0
   
   :depends bioconductor-bumphunter: >=1.28.0,<1.29.0
   :depends bioconductor-champdata: >=2.18.0,<2.19.0
   :depends bioconductor-dmrcate: >=2.0.0,<2.1.0
   :depends bioconductor-dnacopy: >=1.60.0,<1.61.0
   :depends bioconductor-fem: >=3.14.0,<3.15.0
   :depends bioconductor-genomicranges: >=1.38.0,<1.39.0
   :depends bioconductor-globaltest: >=5.40.0,<5.41.0
   :depends bioconductor-goseq: >=1.38.0,<1.39.0
   :depends bioconductor-illumina450probevariants.db: >=1.22.0,<1.23.0
