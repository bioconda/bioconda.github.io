...
.. conda:recipe:: bioconductor-sharedobject
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/SharedObject.html
   :license: GPL-3
...
.. conda:package:: bioconductor-sharedobject
   ...
   :versions:
      ...
      ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-1``,  ``1.4.0-0``,  ``1.2.2-0``,  ``1.0.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.8.0","1.6.0","1.4.0","1.4.0","1.2.2"];
    </script>
