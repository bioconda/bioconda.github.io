...
.. conda:package:: bioconductor-neve2006
   ...
   :depends: :conda:package:`bioconductor-annotate` >=1.60.0,<1.61.0 :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`bioconductor-hgu133a.db` >=3.2.0,<3.3.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`wget`  

   :required~by: |required_by_bioconductor-neve2006|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-neve2006


.. |required_by_bioconductor-neve2006| conda:required_by:: bioconductor-neve2006
