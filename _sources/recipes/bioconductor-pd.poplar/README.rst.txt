...
.. conda:recipe:: bioconductor-pd.poplar
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/pd.poplar.html
...
.. conda:package:: bioconductor-pd.poplar
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.poplar

   and update with::

      mamba update bioconductor-pd.poplar

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.poplar
