...
.. conda:recipe:: bioconductor-hgu133bprobe
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/hgu133bprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-hgu133bprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hgu133bprobe

   and update with::

      mamba update bioconductor-hgu133bprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hgu133bprobe
