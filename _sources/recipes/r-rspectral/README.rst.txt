...
.. conda:package:: r-rspectral
   ...
   :versions:
      ...
      ``1.0.0.14-1``,  ``1.0.0.14-0``,  ``1.0.0.10-3``,  ``1.0.0.10-2``,  ``1.0.0.10-1``,  ``1.0.0.10-0``,  ``1.0.0.9-0``
   ...
   :depends on r-rcpparmadillo: ``>=0.11.2.0.0``
   :depends on r-rdpack: 
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.0.0.14","1.0.0.14","1.0.0.10","1.0.0.10","1.0.0.10"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_r-rspectral"></div>
   <div style="width: 100%" id="platform_plot_r-rspectral"></div>
   <div style="width: 100%" id="cdf_plot_r-rspectral"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for r-rspectral
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-rspectral/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_r-rspectral', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for r-rspectral
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-rspectral/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_r-rspectral', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for r-rspectral
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/r-rspectral/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_r-rspectral', spec);
            } catch (err) {
