...
.. conda:package:: clair3
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.0.0-0</code>,  <code>0.1.12-6</code>,  <code>0.1.12-5</code>,  <code>0.1.12-4</code>,  <code>0.1.12-2</code>,  <code>0.1.12-1</code>,  <code>0.1.12-0</code>,  <code>0.1.11-6</code>,  <code>0.1.11-5</code>,  </span></summary>
      

      ``1.0.0-0``,  ``0.1.12-6``,  ``0.1.12-5``,  ``0.1.12-4``,  ``0.1.12-2``,  ``0.1.12-1``,  ``0.1.12-0``,  ``0.1.11-6``,  ``0.1.11-5``,  ``0.1.11-4``,  ``0.1.11-3``,  ``0.1.11-2``,  ``0.1.11-1``,  ``0.1.11-0``,  ``0.1.10-0``,  ``0.1.9-0``,  ``0.1.8-0``,  ``0.1.7-0``,  ``0.1.6-0``,  ``0.1.5-0``,  ``0.1.4.2-0``,  ``0.1.4.1-0``,  ``0.1.4-0``
...
.. raw:: html
    ...
    <script>
        var package = "clair3";
        var versions = ["1.0.0","0.1.12","0.1.12","0.1.12","0.1.12"];
    </script>
