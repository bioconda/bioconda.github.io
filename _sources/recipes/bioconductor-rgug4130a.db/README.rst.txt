...
.. conda:recipe:: bioconductor-rgug4130a.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/rgug4130a.db.html
...
.. conda:package:: bioconductor-rgug4130a.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rgug4130a.db

   and update with::

      mamba update bioconductor-rgug4130a.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rgug4130a.db
