...
.. conda:recipe:: bioconductor-biobase
   ...
   :homepage: https://bioconductor.org/packages/3.11/bioc/html/Biobase.html
...
.. conda:package:: bioconductor-biobase
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.50.0-0</code>,  <code>2.48.0-0</code>,  <code>2.46.0-0</code>,  <code>2.44.0-1</code>,  <code>2.42.0-1</code>,  <code>2.42.0-0</code>,  <code>2.40.0-1</code>,  <code>2.40.0-0</code>,  <code>2.38.0-1</code>,  </span></summary>
      

      ``2.50.0-0``,  ``2.48.0-0``,  ``2.46.0-0``,  ``2.44.0-1``,  ``2.42.0-1``,  ``2.42.0-0``,  ``2.40.0-1``,  ``2.40.0-0``,  ``2.38.0-1``,  ``2.38.0-0``,  ``2.36.2-0``,  ``2.34.0-0``,  ``2.32.0-0``,  ``2.30.0-0``
