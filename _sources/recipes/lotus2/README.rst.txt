...
.. conda:package:: lotus2
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.32-1</code>,  <code>2.32-0</code>,  <code>2.31-0</code>,  <code>2.30-1</code>,  <code>2.30-0</code>,  <code>2.28.1-1</code>,  <code>2.28.1-0</code>,  <code>2.28-0</code>,  <code>2.25-0</code>,  </span></summary>
      

      ``2.32-1``,  ``2.32-0``,  ``2.31-0``,  ``2.30-1``,  ``2.30-0``,  ``2.28.1-1``,  ``2.28.1-0``,  ``2.28-0``,  ``2.25-0``,  ``2.24-0``,  ``2.23-0``,  ``2.22-0``,  ``2.21-0``,  ``2.19-0``,  ``2.17-0``,  ``2.16-0``,  ``2.14-0``,  ``2.12-1``,  ``2.12-0``,  ``2.11-0``,  ``2.09.2-0``,  ``2.09.1-0``,  ``2.09-0``,  ``2.08-0``,  ``2.07-0``,  ``2.06-0``,  ``2.05.1-0``,  ``2.04-1``,  ``2.04-0``,  ``2.02-0``,  ``2.01-1``,  ``2.01-0``
...
.. raw:: html
    ...
    <script>
        var package = "lotus2";
        var versions = ["2.32","2.32","2.31","2.30","2.30"];
    </script>
