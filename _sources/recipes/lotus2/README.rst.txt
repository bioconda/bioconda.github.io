...
.. conda:package:: lotus2
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.17-0</code>,  <code>2.16-0</code>,  <code>2.14-0</code>,  <code>2.12-1</code>,  <code>2.12-0</code>,  <code>2.11-0</code>,  <code>2.09.2-0</code>,  <code>2.09.1-0</code>,  <code>2.09-0</code>,  </span></summary>
      

      ``2.17-0``,  ``2.16-0``,  ``2.14-0``,  ``2.12-1``,  ``2.12-0``,  ``2.11-0``,  ``2.09.2-0``,  ``2.09.1-0``,  ``2.09-0``,  ``2.08-0``,  ``2.07-0``,  ``2.06-0``,  ``2.05.1-0``,  ``2.04-1``,  ``2.04-0``,  ``2.02-0``,  ``2.01-1``,  ``2.01-0``
...
.. raw:: html
    ...
    <script>
        var package = "lotus2";
        var versions = ["2.17","2.16","2.14","2.12","2.12"];
    </script>
