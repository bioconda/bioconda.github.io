...
.. conda:recipe:: bioconductor-txdb.hsapiens.ucsc.hg38.knowngene
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/TxDb.Hsapiens.UCSC.hg38.knownGene.html
...
.. conda:package:: bioconductor-txdb.hsapiens.ucsc.hg38.knowngene
   ...
   :depends: :conda:package:`bioconductor-annotationdbi`  :conda:package:`bioconductor-genomicfeatures` >=1.25.18 :conda:package:`r-base` 3.3.2* :conda:package:`wget`  

   :required~by: |required_by_bioconductor-txdb.hsapiens.ucsc.hg38.knowngene|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-txdb.hsapiens.ucsc.hg38.knowngene


.. |required_by_bioconductor-txdb.hsapiens.ucsc.hg38.knowngene| conda:required_by:: bioconductor-txdb.hsapiens.ucsc.hg38.knowngene
