...
.. conda:package:: bioconductor-txdb.hsapiens.ucsc.hg38.knowngene
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.13.0-0</code>,  <code>3.10.0-3</code>,  <code>3.10.0-2</code>,  <code>3.10.0-1</code>,  <code>3.10.0-0</code>,  <code>3.4.6-1</code>,  <code>3.4.0-4</code>,  <code>3.4.0-3</code>,  <code>3.4.0-1</code>,  </span></summary>
      

      ``3.13.0-0``,  ``3.10.0-3``,  ``3.10.0-2``,  ``3.10.0-1``,  ``3.10.0-0``,  ``3.4.6-1``,  ``3.4.0-4``,  ``3.4.0-3``,  ``3.4.0-1``,  ``3.4.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["3.13.0","3.10.0","3.10.0","3.10.0","3.10.0"];
    </script>
