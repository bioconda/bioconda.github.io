...
.. conda:recipe:: bioconductor-pd.rice
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/pd.rice.html
...
.. conda:package:: bioconductor-pd.rice
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.rice

   and update with::

      mamba update bioconductor-pd.rice

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.rice
