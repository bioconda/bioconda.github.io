...
.. conda:recipe:: bioconductor-abaenrichment
   ...
   :homepage: https://bioconductor.org/packages/3.11/bioc/html/ABAEnrichment.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-abaenrichment
   ...
   :versions:
      ...
      ``1.20.0-0``,  ``1.18.0-0``,  ``1.16.0-1``,  ``1.14.0-1``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-0``

      

   
   :depends bioconductor-abadata: ``>=1.19.0,<1.20.0``
   :depends bioconductor-gofuncr: ``>=1.10.0,<1.11.0``
