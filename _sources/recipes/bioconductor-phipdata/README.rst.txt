...
.. conda:recipe:: bioconductor-phipdata
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/PhIPData.html
...
.. conda:package:: bioconductor-phipdata
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-phipdata

   and update with::

      mamba update bioconductor-phipdata

  To create a new environment, run::

      mamba create --name myenvname bioconductor-phipdata
