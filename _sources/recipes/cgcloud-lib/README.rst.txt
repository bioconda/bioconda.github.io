...
.. conda:package:: cgcloud-lib
   ...
   :depends: :conda:package:`bd2k-python-lib`  :conda:package:`boto` ==2.38.0 :conda:package:`python` 2.7* 

   :required~by: |required_by_cgcloud-lib|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/cgcloud-lib


.. |required_by_cgcloud-lib| conda:required_by:: cgcloud-lib
