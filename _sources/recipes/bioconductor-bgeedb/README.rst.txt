...
.. conda:package:: bioconductor-bgeedb
   ...
   :depends: :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`bioconductor-graph` >=1.60.0,<1.61.0 :conda:package:`bioconductor-topgo` >=2.34.0,<2.35.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-data.table`  :conda:package:`r-digest`  :conda:package:`r-dplyr`  :conda:package:`r-rcurl`  :conda:package:`r-tidyr`  

   :required~by: |required_by_bioconductor-bgeedb|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-bgeedb


.. |required_by_bioconductor-bgeedb| conda:required_by:: bioconductor-bgeedb
