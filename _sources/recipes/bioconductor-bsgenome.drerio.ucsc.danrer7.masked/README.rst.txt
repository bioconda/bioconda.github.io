...
.. conda:recipe:: bioconductor-bsgenome.drerio.ucsc.danrer7.masked
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/BSgenome.Drerio.UCSC.danRer7.masked.html
...
.. conda:package:: bioconductor-bsgenome.drerio.ucsc.danrer7.masked
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bsgenome.drerio.ucsc.danrer7.masked

   and update with::

      mamba update bioconductor-bsgenome.drerio.ucsc.danrer7.masked

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bsgenome.drerio.ucsc.danrer7.masked
