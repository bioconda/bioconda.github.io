...
.. conda:package:: bioconductor-multisight
   ...
   :depends on bioconductor-biosigner: ``>=1.28.0,<1.29.0``
   :depends on bioconductor-clusterprofiler: ``>=4.8.0,<4.9.0``
   :depends on bioconductor-deseq2: ``>=1.40.0,<1.41.0``
   :depends on bioconductor-enrichplot: ``>=1.20.0,<1.21.0``
   :depends on bioconductor-mixomics: ``>=6.24.0,<6.25.0``
   :depends on bioconductor-reactomepa: ``>=1.44.0,<1.45.0``
   :depends on bioconductor-rwikipathways: ``>=1.20.0,<1.21.0``
   :depends on r-anylib: 
...
to install globally, run::
    ...
    pixi global install bioconductor-multisight

to add into an existing workspace instead, run::

    pixi add bioconductor-multisight
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-multisight
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-multisight"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-multisight"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-multisight"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-multisight
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-multisight/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-multisight', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-multisight
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-multisight/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-multisight', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-multisight
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-multisight/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-multisight', spec);
            } catch (err) {
