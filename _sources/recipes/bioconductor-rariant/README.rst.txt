...
.. conda:package:: bioconductor-rariant
   ...
   :versions:
      ...
      ``1.25.0-1``,  ``1.25.0-0``,  ``1.24.0-0``,  ``1.22.0-0``,  ``1.20.0-1``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-0``
   ...
   :depends bioconductor-somaticsignatures: ``>=2.26.0,<2.27.0``
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-rariant";
        var versions = ["1.25.0","1.25.0","1.24.0","1.22.0","1.20.0"];
    </script>
