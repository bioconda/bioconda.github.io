...
.. conda:package:: anvio
   ...
   :versions: 6-0, 5.5.0-0, 5.4.0-0, 5.3.0-0, 5.2.0-0, 5.1.0-1, 5.0.0-1, 4.0.0-2, 4.0.0-1, 4.0.0-0, 3.0.0-1, 3.0.0-0, 2.4.0-2, 2.4.0-1, 2.4.0-0, 2.3.2-0, 2.1.0-0
   
   :depends anvio-minimal: 6
   :depends blast: 
   :depends bowtie2: 
   :depends bwa: 
   :depends centrifuge: 
