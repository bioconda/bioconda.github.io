...
.. conda:recipe:: bioconductor-celegans.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/celegans.db.html
...
.. conda:package:: bioconductor-celegans.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-celegans.db

   and update with::

      mamba update bioconductor-celegans.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-celegans.db
