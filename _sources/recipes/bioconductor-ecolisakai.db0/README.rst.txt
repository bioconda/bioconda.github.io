...
.. conda:recipe:: bioconductor-ecolisakai.db0
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/ecoliSakai.db0.html
...
.. conda:package:: bioconductor-ecolisakai.db0
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-ecolisakai.db0

   and update with::

      mamba update bioconductor-ecolisakai.db0

  To create a new environment, run::

      mamba create --name myenvname bioconductor-ecolisakai.db0
