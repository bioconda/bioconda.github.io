...
.. conda:recipe:: bioconductor-isoformswitchanalyzer
   ...
   :homepage: https://bioconductor.org/packages/3.23/bioc/html/IsoformSwitchAnalyzeR.html
...
.. conda:package:: bioconductor-isoformswitchanalyzer
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.12.0-0</code>,  <code>2.10.0-0</code>,  <code>2.6.0-0</code>,  <code>2.2.0-0</code>,  <code>2.0.1-0</code>,  <code>1.20.0-1</code>,  <code>1.20.0-0</code>,  <code>1.16.0-2</code>,  <code>1.16.0-1</code>,  </span></summary>
      

      ``2.12.0-0``,  ``2.10.0-0``,  ``2.6.0-0``,  ``2.2.0-0``,  ``2.0.1-0``,  ``1.20.0-1``,  ``1.20.0-0``,  ``1.16.0-2``,  ``1.16.0-1``,  ``1.16.0-0``,  ``1.14.0-0``,  ``1.12.0-1``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.0-1``,  ``1.4.0-0``,  ``1.2.0-0``,  ``1.0.0-0``
   ...
   :depends on bioconductor-biocparallel: ``>=1.38.0``
   :depends on bioconductor-biocparallel: ``>=1.44.0,<1.45.0a0``
   :depends on bioconductor-biostrings: ``>=2.72.0``
   :depends on bioconductor-biostrings: ``>=2.78.0,<2.79.0a0``
   :depends on bioconductor-bsgenome: ``>=1.72.0``
   :depends on bioconductor-bsgenome: ``>=1.78.0,<1.79.0a0``
   :depends on bioconductor-dexseq: ``>=1.50.0``
   :depends on bioconductor-dexseq: ``>=1.56.0,<1.57.0a0``
   :depends on bioconductor-edger: ``>=4.2.0``
   :depends on bioconductor-edger: ``>=4.8.2,<4.9.0a0``
   :depends on bioconductor-genomicranges: ``>=1.56.0``
   :depends on bioconductor-genomicranges: ``>=1.62.1,<1.63.0a0``
   :depends on bioconductor-iranges: ``>=2.38.0``
   :depends on bioconductor-iranges: ``>=2.44.0,<2.45.0a0``
   :depends on bioconductor-limma: ``>=3.60.0``
   :depends on bioconductor-limma: ``>=3.66.0,<3.67.0a0``
   :depends on bioconductor-pfamanalyzer: ``>=1.10.0,<1.11.0a0``
   :depends on bioconductor-pfamanalyzer: ``>=1.4.0``
   :depends on bioconductor-pwalign: ``>=1.0.0``
   :depends on bioconductor-pwalign: ``>=1.6.0,<1.7.0a0``
   :depends on bioconductor-rtracklayer: ``>=1.64.0``
   :depends on bioconductor-rtracklayer: ``>=1.70.1,<1.71.0a0``
   :depends on bioconductor-s4vectors: ``>=0.42.0``
   :depends on bioconductor-s4vectors: ``>=0.48.0,<0.49.0a0``
   :depends on bioconductor-saturn: ``>=1.12.0``
   :depends on bioconductor-saturn: ``>=1.18.0,<1.19.0a0``
   :depends on bioconductor-seqinfo: ``>=1.0.0,<1.1.0a0``
   :depends on bioconductor-summarizedexperiment: ``>=1.34.0``
   :depends on bioconductor-summarizedexperiment: ``>=1.40.0,<1.41.0a0``
   :depends on bioconductor-sva: ``>=3.52.0``
   :depends on bioconductor-sva: ``>=3.58.0,<3.59.0a0``
   :depends on bioconductor-tximeta: ``>=1.22.0``
   :depends on bioconductor-tximeta: ``>=1.28.2,<1.29.0a0``
   :depends on bioconductor-tximport: ``>=1.32.0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["2.12.0","2.10.0","2.6.0","2.2.0","2.0.1"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-isoformswitchanalyzer"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-isoformswitchanalyzer"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-isoformswitchanalyzer"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-isoformswitchanalyzer
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-isoformswitchanalyzer/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-isoformswitchanalyzer', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-isoformswitchanalyzer
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-isoformswitchanalyzer/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-isoformswitchanalyzer', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-isoformswitchanalyzer
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-isoformswitchanalyzer/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-isoformswitchanalyzer', spec);
            } catch (err) {
