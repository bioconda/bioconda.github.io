...
.. conda:recipe:: bioconductor-illuminahumanv3.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/illuminaHumanv3.db.html
...
.. conda:package:: bioconductor-illuminahumanv3.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-illuminahumanv3.db

   and update with::

      mamba update bioconductor-illuminahumanv3.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-illuminahumanv3.db
