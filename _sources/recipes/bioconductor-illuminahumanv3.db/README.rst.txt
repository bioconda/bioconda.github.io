...
.. conda:recipe:: bioconductor-illuminahumanv3.db
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/illuminaHumanv3.db.html
...
.. conda:package:: bioconductor-illuminahumanv3.db
   ...
   :required~by: |required_by_bioconductor-illuminahumanv3.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-illuminahumanv3.db


.. |required_by_bioconductor-illuminahumanv3.db| conda:required_by:: bioconductor-illuminahumanv3.db
