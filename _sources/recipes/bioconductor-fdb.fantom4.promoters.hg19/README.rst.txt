...
.. conda:recipe:: bioconductor-fdb.fantom4.promoters.hg19
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/FDb.FANTOM4.promoters.hg19.html
...
.. conda:package:: bioconductor-fdb.fantom4.promoters.hg19
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-fdb.fantom4.promoters.hg19

   and update with::

      mamba update bioconductor-fdb.fantom4.promoters.hg19

  To create a new environment, run::

      mamba create --name myenvname bioconductor-fdb.fantom4.promoters.hg19
