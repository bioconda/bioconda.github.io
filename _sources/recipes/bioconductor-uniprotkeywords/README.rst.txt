...
.. conda:recipe:: bioconductor-uniprotkeywords
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/UniProtKeywords.html
...
.. conda:package:: bioconductor-uniprotkeywords
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-uniprotkeywords

   and update with::

      mamba update bioconductor-uniprotkeywords

  To create a new environment, run::

      mamba create --name myenvname bioconductor-uniprotkeywords
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.99.7","0.99.4","0.99.4"];
    </script>
