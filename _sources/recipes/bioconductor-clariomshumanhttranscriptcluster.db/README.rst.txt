...
.. conda:recipe:: bioconductor-clariomshumanhttranscriptcluster.db
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/clariomshumanhttranscriptcluster.db.html
...
.. conda:package:: bioconductor-clariomshumanhttranscriptcluster.db
   ...
   :required~by: |required_by_bioconductor-clariomshumanhttranscriptcluster.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-clariomshumanhttranscriptcluster.db


.. |required_by_bioconductor-clariomshumanhttranscriptcluster.db| conda:required_by:: bioconductor-clariomshumanhttranscriptcluster.db
