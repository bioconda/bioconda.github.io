...
to install globally, run::
    ...
    pixi global install diamondonpy

to add into an existing workspace instead, run::

    pixi add diamondonpy
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install diamondonpy

Alternatively, to install into a new environment, run::

    conda create -n envname diamondonpy
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_diamondonpy"></div>
   <div style="width: 100%" id="platform_plot_diamondonpy"></div>
   <div style="width: 100%" id="cdf_plot_diamondonpy"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for diamondonpy
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/diamondonpy/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_diamondonpy', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for diamondonpy
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/diamondonpy/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_diamondonpy', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for diamondonpy
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/diamondonpy/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_diamondonpy', spec);
            } catch (err) {
