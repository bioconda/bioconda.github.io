...
.. conda:recipe:: bioconductor-ashkenazimsonchr21
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/AshkenazimSonChr21.html
...
.. conda:package:: bioconductor-ashkenazimsonchr21
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.40.0-0</code>,  <code>1.36.0-0</code>,  <code>1.32.0-0</code>,  <code>1.30.0-0</code>,  <code>1.28.0-0</code>,  <code>1.24.0-1</code>,  <code>1.24.0-0</code>,  <code>1.22.0-0</code>,  <code>1.20.0-1</code>,  </span></summary>
      

      ``1.40.0-0``,  ``1.36.0-0``,  ``1.32.0-0``,  ``1.30.0-0``,  ``1.28.0-0``,  ``1.24.0-1``,  ``1.24.0-0``,  ``1.22.0-0``,  ``1.20.0-1``,  ``1.20.0-0``,  ``1.19.0-0``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-1``,  ``1.14.0-0``,  ``1.12.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-ashkenazimsonchr21

to add into an existing workspace instead, run::

    pixi add bioconductor-ashkenazimsonchr21
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-ashkenazimsonchr21

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-ashkenazimsonchr21
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-ashkenazimsonchr21"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-ashkenazimsonchr21"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-ashkenazimsonchr21"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-ashkenazimsonchr21
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ashkenazimsonchr21/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-ashkenazimsonchr21', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-ashkenazimsonchr21
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ashkenazimsonchr21/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-ashkenazimsonchr21', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-ashkenazimsonchr21
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ashkenazimsonchr21/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-ashkenazimsonchr21', spec);
            } catch (err) {
