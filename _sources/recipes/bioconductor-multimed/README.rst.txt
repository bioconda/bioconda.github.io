...
.. conda:recipe:: bioconductor-multimed
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/MultiMed.html
...
.. conda:package:: bioconductor-multimed
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.12.0-1</code>,  <code>2.12.0-0</code>,  <code>2.10.0-0</code>,  <code>2.8.0-0</code>,  <code>2.6.0-1</code>,  <code>2.6.0-0</code>,  <code>2.4.0-0</code>,  <code>2.2.0-0</code>,  <code>1.12.0-0</code>,  </span></summary>
      

      ``2.12.0-1``,  ``2.12.0-0``,  ``2.10.0-0``,  ``2.8.0-0``,  ``2.6.0-1``,  ``2.6.0-0``,  ``2.4.0-0``,  ``2.2.0-0``,  ``1.12.0-0``,  ``1.10.0-0``
