...
.. conda:package:: bioconductor-flagme
   ...
   :depends bioconductor-camera: ``>=1.66.0,<1.67.0a0``
   :depends bioconductor-gcspikelite: ``>=1.48.0,<1.49.0``
   :depends bioconductor-gcspikelite: ``>=1.48.0,<1.49.0a0``
   :depends bioconductor-xcms: ``>=4.8.0,<4.9.0``
   :depends bioconductor-xcms: ``>=4.8.0,<4.9.0a0``
