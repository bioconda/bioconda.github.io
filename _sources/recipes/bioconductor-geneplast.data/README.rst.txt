...
.. conda:recipe:: bioconductor-geneplast.data
   ...
   :homepage: https://bioconductor.org/packages/3.13/data/annotation/html/geneplast.data.html
...
.. conda:package:: bioconductor-geneplast.data
   ...
   :versions:
      ...
      ``0.99.4-0``,  ``0.99.2-2``,  ``0.99.2-1``,  ``0.99.2-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.99.4","0.99.2","0.99.2","0.99.2"];
    </script>
