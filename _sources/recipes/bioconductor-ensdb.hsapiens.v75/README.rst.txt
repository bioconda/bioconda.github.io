...
.. conda:recipe:: bioconductor-ensdb.hsapiens.v75
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/EnsDb.Hsapiens.v75.html
...
.. conda:package:: bioconductor-ensdb.hsapiens.v75
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.99.0-17</code>,  <code>2.99.0-16</code>,  <code>2.99.0-15</code>,  <code>2.99.0-14</code>,  <code>2.99.0-13</code>,  <code>2.99.0-12</code>,  <code>2.99.0-11</code>,  <code>2.99.0-10</code>,  <code>2.99.0-9</code>,  </span></summary>
      

      ``2.99.0-17``,  ``2.99.0-16``,  ``2.99.0-15``,  ``2.99.0-14``,  ``2.99.0-13``,  ``2.99.0-12``,  ``2.99.0-11``,  ``2.99.0-10``,  ``2.99.0-9``,  ``2.99.0-8``,  ``2.99.0-7``,  ``2.99.0-6``,  ``2.99.0-5``,  ``2.99.0-3``,  ``2.99.0-2``,  ``2.99.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-ensdb.hsapiens.v75

to add into an existing workspace instead, run::

    pixi add bioconductor-ensdb.hsapiens.v75
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-ensdb.hsapiens.v75
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-ensdb.hsapiens.v75"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-ensdb.hsapiens.v75"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-ensdb.hsapiens.v75"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-ensdb.hsapiens.v75
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ensdb.hsapiens.v75/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-ensdb.hsapiens.v75', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-ensdb.hsapiens.v75
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ensdb.hsapiens.v75/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-ensdb.hsapiens.v75', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-ensdb.hsapiens.v75
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-ensdb.hsapiens.v75/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-ensdb.hsapiens.v75', spec);
            } catch (err) {
