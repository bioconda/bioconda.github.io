...
.. conda:recipe:: bioconductor-delayedarray
   ...
   :homepage: https://bioconductor.org/packages/3.23/bioc/html/DelayedArray.html
...
.. conda:package:: bioconductor-delayedarray
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.38.2-0</code>,  <code>0.36.1-0</code>,  <code>0.36.0-0</code>,  <code>0.32.0-1</code>,  <code>0.32.0-0</code>,  <code>0.28.0-2</code>,  <code>0.28.0-1</code>,  <code>0.28.0-0</code>,  <code>0.26.6-0</code>,  </span></summary>
      

      ``0.38.2-0``,  ``0.36.1-0``,  ``0.36.0-0``,  ``0.32.0-1``,  ``0.32.0-0``,  ``0.28.0-2``,  ``0.28.0-1``,  ``0.28.0-0``,  ``0.26.6-0``,  ``0.24.0-1``,  ``0.24.0-0``,  ``0.20.0-2``,  ``0.20.0-1``,  ``0.20.0-0``,  ``0.18.0-0``,  ``0.16.3-0``,  ``0.16.0-0``,  ``0.14.0-0``,  ``0.12.0-0``,  ``0.10.0-1``,  ``0.8.0-0``,  ``0.6.6-0``,  ``0.4.1-0``,  ``0.2.7-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["0.38.2","0.36.1","0.36.0","0.32.0","0.32.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-delayedarray"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-delayedarray"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-delayedarray"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-delayedarray
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-delayedarray/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-delayedarray', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-delayedarray
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-delayedarray/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-delayedarray', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-delayedarray
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-delayedarray/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-delayedarray', spec);
            } catch (err) {
