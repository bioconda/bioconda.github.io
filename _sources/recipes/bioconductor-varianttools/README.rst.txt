...
.. conda:recipe:: bioconductor-varianttools
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/VariantTools.html
...
.. conda:package:: bioconductor-varianttools
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-varianttools

   and update with::

      mamba update bioconductor-varianttools

  To create a new environment, run::

      mamba create --name myenvname bioconductor-varianttools
