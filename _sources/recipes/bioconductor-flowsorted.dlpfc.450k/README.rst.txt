...
.. conda:recipe:: bioconductor-flowsorted.dlpfc.450k
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/experiment/html/FlowSorted.DLPFC.450k.html
...
.. conda:package:: bioconductor-flowsorted.dlpfc.450k
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-flowsorted.dlpfc.450k

   and update with::

      mamba update bioconductor-flowsorted.dlpfc.450k

  To create a new environment, run::

      mamba create --name myenvname bioconductor-flowsorted.dlpfc.450k
