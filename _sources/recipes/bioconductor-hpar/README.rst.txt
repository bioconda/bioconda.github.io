...
.. conda:recipe:: bioconductor-hpar
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/hpar.html
...
.. conda:package:: bioconductor-hpar
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hpar

   and update with::

      mamba update bioconductor-hpar

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hpar
