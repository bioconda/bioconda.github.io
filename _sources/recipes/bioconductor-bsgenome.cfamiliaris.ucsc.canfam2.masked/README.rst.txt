...
.. conda:recipe:: bioconductor-bsgenome.cfamiliaris.ucsc.canfam2.masked
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/BSgenome.Cfamiliaris.UCSC.canFam2.masked.html
...
.. conda:package:: bioconductor-bsgenome.cfamiliaris.ucsc.canfam2.masked
   ...
   :depends bioconductor-bsgenome.cfamiliaris.ucsc.canfam2: ``>=1.4.0,<1.5.0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bsgenome.cfamiliaris.ucsc.canfam2.masked

   and update with::

      mamba update bioconductor-bsgenome.cfamiliaris.ucsc.canfam2.masked

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bsgenome.cfamiliaris.ucsc.canfam2.masked
