...
.. conda:package:: augur
   ...
   :depends bcbio-gff: ``>=0.7.0,<0.8``
   :depends biopython: ``>=1.73,!=1.77,!=1.78``
   ...
   :depends pyfastx: ``>=0.8.4,<0.9``
   :depends python: ``>=3.8``
   :depends raxml: 
   :depends scipy: ``>=1.0.0,<2``
   :depends treetime: ``>=0.10.0,<0.12``
   :depends vcftools: 
   :depends xopen: ``>=1.7.0,<2``
   :requirements:
...
.. raw:: html
    ...
    <script>
        var package = "augur";
        var versions = ["23.1.0","23.0.0","22.4.0","22.3.0","22.2.0"];
    </script>
