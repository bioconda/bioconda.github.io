...
.. conda:package:: augur
   ...
   :depends biopython: ``>=1.73,!=1.77,!=1.78,<=1.80``
...
.. raw:: html
    ...
    <script>
        var package = "augur";
        var versions = ["21.1.0","21.0.1","21.0.1","21.0.0","21.0.0"];
    </script>
