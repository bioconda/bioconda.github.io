...
.. conda:package:: augur
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>10.0.2-0</code>,  <code>10.0.0-1</code>,  <code>10.0.0-0</code>,  <code>9.0.0-1</code>,  <code>9.0.0-0</code>,  <code>8.0.0-0</code>,  <code>7.0.2-0</code>,  <code>6.4.3-0</code>,  <code>6.4.2-0</code>,  </span></summary>
      

      ``10.0.2-0``,  ``10.0.0-1``,  ``10.0.0-0``,  ``9.0.0-1``,  ``9.0.0-0``,  ``8.0.0-0``,  ``7.0.2-0``,  ``6.4.3-0``,  ``6.4.2-0``,  ``6.4.1-0``,  ``6.4.0-0``,  ``6.3.0-0``,  ``6.2.0-0``,  ``6.1.1-0``,  ``6.1.0-0``,  ``6.0.0-0``,  ``5.4.1-0``,  ``5.4.0-0``,  ``5.3.0-0``,  ``5.2.1-0``,  ``5.2.0-0``,  ``5.1.1-0``,  ``5.1.0-0``,  ``4.0.0-0``,  ``3.1.5-1``,  ``3.1.5-0``
