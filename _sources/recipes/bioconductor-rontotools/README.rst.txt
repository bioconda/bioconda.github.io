...
.. conda:recipe:: bioconductor-rontotools
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/ROntoTools.html
...
.. conda:package:: bioconductor-rontotools
   ...
   :versions:
      ...
      ``2.38.0-0``,  ``2.34.0-0``,  ``2.30.0-0``,  ``2.28.0-0``,  ``2.26.0-0``,  ``2.22.0-0``,  ``2.20.0-0``,  ``2.18.0-1``,  ``2.18.0-0``,  ``2.16.0-0``,  ``2.14.0-0``,  ``2.12.0-1``,  ``2.10.0-0``,  ``2.8.0-0``,  ``2.6.0-0``,  ``2.4.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-rontotools

to add into an existing workspace instead, run::

    pixi add bioconductor-rontotools
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-rontotools
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-rontotools"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-rontotools"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-rontotools"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-rontotools
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rontotools/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-rontotools', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-rontotools
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rontotools/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-rontotools', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-rontotools
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rontotools/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-rontotools', spec);
            } catch (err) {
