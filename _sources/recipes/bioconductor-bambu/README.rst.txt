...
.. conda:package:: bioconductor-bambu
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.12.1-1</code>,  <code>3.12.1-0</code>,  <code>3.8.3-0</code>,  <code>3.4.0-1</code>,  <code>3.4.0-0</code>,  <code>3.2.4-0</code>,  <code>3.0.8-1</code>,  <code>3.0.8-0</code>,  <code>3.0.6-0</code>,  </span></summary>
      

      ``3.12.1-1``,  ``3.12.1-0``,  ``3.8.3-0``,  ``3.4.0-1``,  ``3.4.0-0``,  ``3.2.4-0``,  ``3.0.8-1``,  ``3.0.8-0``,  ``3.0.6-0``,  ``3.0.5-0``,  ``3.0.1-0``,  ``2.0.6-1``,  ``2.0.6-0``,  ``2.0.5-0``,  ``2.0.3-0``,  ``2.0.0-0``,  ``1.2.0-0``,  ``1.0.2-1``,  ``1.0.2-0``,  ``1.0.0-2``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["3.12.1","3.12.1","3.8.3","3.4.0","3.4.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-bambu"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-bambu"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-bambu"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-bambu
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bambu/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-bambu', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-bambu
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bambu/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-bambu', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-bambu
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bambu/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-bambu', spec);
            } catch (err) {
