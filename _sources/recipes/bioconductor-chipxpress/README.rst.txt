...
.. conda:recipe:: bioconductor-chipxpress
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/ChIPXpress.html
   :license: GPL(>=2)
...
.. conda:package:: bioconductor-chipxpress
   ...
   :depends on bioconductor-affy: ``>=1.76.0,<1.77.0``
   :depends on bioconductor-biobase: ``>=2.58.0,<2.59.0``
   :depends on bioconductor-chipxpressdata: ``>=1.36.0,<1.37.0``
   :depends on bioconductor-frma: ``>=1.50.0,<1.51.0``
   :depends on bioconductor-geoquery: ``>=2.66.0,<2.67.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-chipxpress

to add into an existing workspace instead, run::

    pixi add bioconductor-chipxpress
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-chipxpress
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-chipxpress"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-chipxpress"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-chipxpress"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-chipxpress
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-chipxpress/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-chipxpress', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-chipxpress
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-chipxpress/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-chipxpress', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-chipxpress
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-chipxpress/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-chipxpress', spec);
            } catch (err) {
