...
.. conda:recipe:: bioconductor-chipxpress
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/ChIPXpress.html
   :license: GPL(>=2)
...
.. conda:package:: bioconductor-chipxpress
   ...
   :versions:
      ...
      ``1.36.0-0``,  ``1.34.0-0``,  ``1.30.0-1``,  ``1.28.0-1``,  ``1.26.0-0``,  ``1.24.0-0``,  ``1.22.0-0``
   ...
   :depends bioconductor-chipxpressdata: ``>=1.30.0,<1.31.0``
