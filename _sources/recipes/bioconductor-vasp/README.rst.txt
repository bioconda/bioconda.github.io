...
.. conda:recipe:: bioconductor-vasp
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/VaSP.html
   :license: GPL (>= 2.0)
...
.. conda:package:: bioconductor-vasp
   ...
   :versions:
      ...
      ``1.12.0-0``,  ``1.10.0-0``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.4-0``,  ``1.2.0-0``,  ``1.0.0-0``

      

   
   :depends bioconductor-ballgown: ``>=2.32.0,<2.33.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.12.0","1.10.0","1.6.0","1.4.0","1.2.4"];
    </script>
