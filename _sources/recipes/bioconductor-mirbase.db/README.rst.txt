...
.. conda:package:: bioconductor-mirbase.db
   ...
   :required~by: |required_by_bioconductor-mirbase.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-mirbase.db


.. |required_by_bioconductor-mirbase.db| conda:required_by:: bioconductor-mirbase.db
