...
============= ===========
Home          http://bioconductor.org/packages/3.7/bioc/html/mosaics.html
Versions      2.10.0, 2.14.0, 2.16.0, 2.18.0, 2.4.1
License       GPL (>= 2)
...
A Docker container is available at https://quay.io/repository/biocontainers/bioconductor-mosaics.
...
.. |docker| image:: https://quay.io/repository/biocontainers/bioconductor-mosaics/status
