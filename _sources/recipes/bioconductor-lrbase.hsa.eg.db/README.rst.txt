...
.. conda:package:: bioconductor-lrbase.hsa.eg.db
   ...
   :required~by: |required_by_bioconductor-lrbase.hsa.eg.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-lrbase.hsa.eg.db


.. |required_by_bioconductor-lrbase.hsa.eg.db| conda:required_by:: bioconductor-lrbase.hsa.eg.db
