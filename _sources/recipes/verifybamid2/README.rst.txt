...
.. conda:package:: verifybamid2
   ...
   :depends: :conda:package:`bzip2` 1.0* :conda:package:`curl`  :conda:package:`libgcc`  :conda:package:`openssl`  :conda:package:`zlib` 1.2.11* 

   :required~by: |required_by_verifybamid2|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/verifybamid2


.. |required_by_verifybamid2| conda:required_by:: verifybamid2
