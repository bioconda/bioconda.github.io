...
.. conda:package:: bioconductor-lrbase.dre.eg.db
   ...
   or use the docker container::
      ...
      docker pull quay.io/biocontainers/bioconductor-lrbase.dre.eg.db:<tag>

   (see `bioconductor-lrbase.dre.eg.db/tags`_ for valid values for ``<tag>``)
...
.. _`bioconductor-lrbase.dre.eg.db/tags`: https://quay.io/repository/biocontainers/bioconductor-lrbase.dre.eg.db?tab=tags


.. raw:: html

    <script>
        var package = "bioconductor-lrbase.dre.eg.db";
