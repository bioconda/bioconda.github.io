...
.. conda:recipe:: bioconductor-breastcancernki
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/experiment/html/breastCancerNKI.html
...
.. conda:package:: bioconductor-breastcancernki
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-breastcancernki

   and update with::

      mamba update bioconductor-breastcancernki

  To create a new environment, run::

      mamba create --name myenvname bioconductor-breastcancernki
