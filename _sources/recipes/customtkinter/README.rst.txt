...
.. conda:package:: customtkinter
   ...
   :versions:
      ...
      ``6.0.0-0``,  ``5.2.2-0``,  ``5.2.1-0``,  ``5.2.0-0``
...
to install globally, run::
    ...
    pixi global install customtkinter

to add into an existing workspace instead, run::

    pixi add customtkinter
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname customtkinter
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["6.0.0","5.2.2","5.2.1","5.2.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_customtkinter"></div>
   <div style="width: 100%" id="platform_plot_customtkinter"></div>
   <div style="width: 100%" id="cdf_plot_customtkinter"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for customtkinter
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/customtkinter/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_customtkinter', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for customtkinter
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/customtkinter/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_customtkinter', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for customtkinter
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/customtkinter/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_customtkinter', spec);
            } catch (err) {
