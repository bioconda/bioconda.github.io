...
.. conda:recipe:: bioconductor-bsgenome.drerio.ucsc.danrer7
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/BSgenome.Drerio.UCSC.danRer7.html
...
.. conda:package:: bioconductor-bsgenome.drerio.ucsc.danrer7
   ...
   :versions:
      ...
      ``1.4.0-18``,  ``1.4.0-17``,  ``1.4.0-16``,  ``1.4.0-15``,  ``1.4.0-14``,  ``1.4.0-13``,  ``1.4.0-12``,  ``1.4.0-11``,  ``1.4.0-10``,  ``1.4.0-9``,  ``1.4.0-8``,  ``1.4.0-7``,  ``1.4.0-6``,  ``1.4.0-3``,  ``1.4.0-2``,  ``1.4.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-bsgenome.drerio.ucsc.danrer7

to add into an existing workspace instead, run::

    pixi add bioconductor-bsgenome.drerio.ucsc.danrer7
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-bsgenome.drerio.ucsc.danrer7

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-bsgenome.drerio.ucsc.danrer7
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-bsgenome.drerio.ucsc.danrer7"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-bsgenome.drerio.ucsc.danrer7"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-bsgenome.drerio.ucsc.danrer7"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-bsgenome.drerio.ucsc.danrer7
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.drerio.ucsc.danrer7/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-bsgenome.drerio.ucsc.danrer7', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-bsgenome.drerio.ucsc.danrer7
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.drerio.ucsc.danrer7/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-bsgenome.drerio.ucsc.danrer7', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-bsgenome.drerio.ucsc.danrer7
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.drerio.ucsc.danrer7/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-bsgenome.drerio.ucsc.danrer7', spec);
            } catch (err) {
