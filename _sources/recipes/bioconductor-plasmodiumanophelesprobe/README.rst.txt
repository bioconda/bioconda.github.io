...
.. conda:recipe:: bioconductor-plasmodiumanophelesprobe
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/plasmodiumanophelesprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-plasmodiumanophelesprobe
   ...
   :required~by: |required_by_bioconductor-plasmodiumanophelesprobe|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-plasmodiumanophelesprobe


.. |required_by_bioconductor-plasmodiumanophelesprobe| conda:required_by:: bioconductor-plasmodiumanophelesprobe
