...
.. conda:recipe:: bioconductor-illuminaio
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/illuminaio.html
   :license: GPL-2
...
.. conda:package:: bioconductor-illuminaio
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.40.0-0</code>,  <code>0.36.0-2</code>,  <code>0.36.0-1</code>,  <code>0.36.0-0</code>,  <code>0.34.0-0</code>,  <code>0.32.0-1</code>,  <code>0.32.0-0</code>,  <code>0.30.0-0</code>,  <code>0.28.0-0</code>,  </span></summary>
      

      ``0.40.0-0``,  ``0.36.0-2``,  ``0.36.0-1``,  ``0.36.0-0``,  ``0.34.0-0``,  ``0.32.0-1``,  ``0.32.0-0``,  ``0.30.0-0``,  ``0.28.0-0``,  ``0.26.0-1``,  ``0.26.0-0``,  ``0.24.0-0``,  ``0.22.0-0``,  ``0.20.0-0``,  ``0.18.0-0``,  ``0.14.0-0``,  ``0.12.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.40.0","0.36.0","0.36.0","0.36.0","0.34.0"];
    </script>
