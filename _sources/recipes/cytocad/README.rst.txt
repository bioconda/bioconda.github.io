...
.. conda:package:: cytocad
   ...
   :depends on ruptures: ``>=1.1.3``
   :depends on samtools: ``>=1.3``
   :depends on scipy: ``>=1.2.1``
   :depends on tagore: ``>=1.1.0``
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname cytocad
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_cytocad"></div>
   <div style="width: 100%" id="platform_plot_cytocad"></div>
   <div style="width: 100%" id="cdf_plot_cytocad"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/cytocad/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_cytocad', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for cytocad
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/cytocad/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_cytocad', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for cytocad
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/cytocad/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_cytocad', spec);
            } catch (err) {
