...
.. conda:recipe:: bioconductor-gwas.bayes
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/GWAS.BAYES.html
   :license: GPL-2 | GPL-3
...
.. conda:package:: bioconductor-gwas.bayes
   ...
   :versions:
      ...
      ``1.8.0-0``,  ``1.4.0-2``,  ``1.4.0-1``,  ``1.4.0-0``,  ``1.1.0-0``,  ``1.0.0-2``,  ``1.0.0-1``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.8.0","1.4.0","1.4.0","1.4.0","1.1.0"];
    </script>
