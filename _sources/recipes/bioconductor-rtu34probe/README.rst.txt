...
.. conda:recipe:: bioconductor-rtu34probe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/rtu34probe.html
   :license: LGPL
...
.. conda:package:: bioconductor-rtu34probe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rtu34probe

   and update with::

      mamba update bioconductor-rtu34probe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rtu34probe
