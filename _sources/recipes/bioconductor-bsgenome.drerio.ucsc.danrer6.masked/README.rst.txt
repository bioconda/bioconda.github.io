...
.. conda:recipe:: bioconductor-bsgenome.drerio.ucsc.danrer6.masked
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/BSgenome.Drerio.UCSC.danRer6.masked.html
...
.. conda:package:: bioconductor-bsgenome.drerio.ucsc.danrer6.masked
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bsgenome.drerio.ucsc.danrer6.masked

   and update with::

      mamba update bioconductor-bsgenome.drerio.ucsc.danrer6.masked

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bsgenome.drerio.ucsc.danrer6.masked
