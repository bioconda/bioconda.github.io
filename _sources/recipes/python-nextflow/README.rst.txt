...
.. conda:package:: python-nextflow
   ...
   :versions:
      ...
      ``0.7.1-0``,  ``0.7-0``,  ``0.6.1-0``,  ``0.6-0``,  ``0.5-0``,  ``0.4.2-0``,  ``0.4-1``,  ``0.4-0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install python-nextflow

   and update with::

      mamba update python-nextflow

  To create a new environment, run::

      mamba create --name myenvname python-nextflow
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["0.7.1","0.7","0.6.1","0.6","0.5"];
    </script>
