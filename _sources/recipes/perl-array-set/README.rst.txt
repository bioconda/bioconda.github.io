...
.. conda:package:: perl-array-set
   ...
   :depends: :conda:package:`perl` >=5.26.2,<5.26.3.0a0 :conda:package:`perl-tie-ixhash`  

   :required~by: |required_by_perl-array-set|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/perl-array-set


.. |required_by_perl-array-set| conda:required_by:: perl-array-set
