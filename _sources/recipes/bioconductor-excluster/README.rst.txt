...
.. conda:package:: bioconductor-excluster
   ...
   :depends: :conda:package:`bioconductor-genomicranges` >=1.34.0,<1.35.0 :conda:package:`bioconductor-iranges` >=2.16.0,<2.17.0 :conda:package:`bioconductor-rsubread` >=1.32.0,<1.33.0 :conda:package:`bioconductor-rtracklayer` >=1.42.0,<1.43.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-matrixstats`  

   :required~by: |required_by_bioconductor-excluster|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-excluster


.. |required_by_bioconductor-excluster| conda:required_by:: bioconductor-excluster
