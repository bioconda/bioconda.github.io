...
.. conda:recipe:: bioconductor-plyranges
   ...
   :homepage: https://bioconductor.org/packages/3.8/bioc/html/plyranges.html
...
.. conda:package:: bioconductor-plyranges
   ...
   :depends: :conda:package:`bioconductor-biocgenerics` >=0.28.0,<0.29.0 :conda:package:`bioconductor-genomeinfodb` >=1.18.0,<1.19.0 :conda:package:`bioconductor-genomicalignments` >=1.18.0,<1.19.0 :conda:package:`bioconductor-genomicranges` >=1.34.0,<1.35.0 :conda:package:`bioconductor-iranges` >=2.16.0,<2.17.0 :conda:package:`bioconductor-rsamtools` >=1.34.0,<1.35.0 :conda:package:`bioconductor-rtracklayer` >=1.42.0,<1.43.0 :conda:package:`bioconductor-s4vectors` >=0.20.0,<0.21.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-dplyr`  :conda:package:`r-magrittr`  :conda:package:`r-rlang` >=0.2.0 :conda:package:`r-tidyr`  :conda:package:`r-tidyselect`  

   :required~by: |required_by_bioconductor-plyranges|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-plyranges


.. |required_by_bioconductor-plyranges| conda:required_by:: bioconductor-plyranges
