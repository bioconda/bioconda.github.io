...
.. conda:recipe:: bioconductor-sugarcanecdf
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/sugarcanecdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-sugarcanecdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-sugarcanecdf

   and update with::

      mamba update bioconductor-sugarcanecdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-sugarcanecdf
