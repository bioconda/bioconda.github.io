...
.. conda:recipe:: bioconductor-crcl18
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/experiment/html/CRCL18.html
   :license: GPL-2
...
.. conda:package:: bioconductor-crcl18
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-crcl18

   and update with::

      mamba update bioconductor-crcl18

  To create a new environment, run::

      mamba create --name myenvname bioconductor-crcl18
