...
.. conda:recipe:: bioconductor-discorhythm
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/DiscoRhythm.html
   :license: GPL-3
...
.. conda:package:: bioconductor-discorhythm
   ...
   :versions:
      ...
      ``1.8.0-0``,  ``1.6.0-1``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.0.0-1``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.8.0","1.6.0","1.6.0","1.4.0","1.0.0"];
    </script>
