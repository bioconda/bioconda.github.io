...
.. conda:recipe:: bioconductor-operonhumanv3.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/OperonHumanV3.db.html
...
.. conda:package:: bioconductor-operonhumanv3.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-operonhumanv3.db

   and update with::

      mamba update bioconductor-operonhumanv3.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-operonhumanv3.db
