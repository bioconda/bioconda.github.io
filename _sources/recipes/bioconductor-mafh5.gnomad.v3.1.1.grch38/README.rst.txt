...
.. conda:package:: bioconductor-mafh5.gnomad.v3.1.1.grch38
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mafh5.gnomad.v3.1.1.grch38

   and update with::

      mamba update bioconductor-mafh5.gnomad.v3.1.1.grch38

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mafh5.gnomad.v3.1.1.grch38
