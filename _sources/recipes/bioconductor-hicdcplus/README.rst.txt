...
.. conda:recipe:: bioconductor-hicdcplus
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/HiCDCPlus.html
   :license: GPL-3
...
.. conda:package:: bioconductor-hicdcplus
   ...
   :versions:
      ...
      ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.0-1``,  ``1.6.0-0``,  ``1.2.1-1``,  ``1.2.1-0``,  ``1.2.0-0``,  ``1.0.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.10.0","1.8.0","1.6.0","1.6.0","1.2.1"];
    </script>
