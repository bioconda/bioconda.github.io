...
.. conda:recipe:: bioconductor-porcine.db
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/porcine.db.html
...
.. conda:package:: bioconductor-porcine.db
   ...
   :depends on bioconductor-org.ss.eg.db: ``>=3.22.0,<3.23.0``
   :depends on curl: 
...
to install globally, run::
    ...
    pixi global install bioconductor-porcine.db

to add into an existing workspace instead, run::

    pixi add bioconductor-porcine.db
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-porcine.db
...
.. raw:: html
   ...
   <script>
      var package = "bioconductor-porcine.db";
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-porcine.db"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-porcine.db"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-porcine.db"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-porcine.db
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-porcine.db/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-porcine.db', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-porcine.db
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-porcine.db/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-porcine.db', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-porcine.db
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-porcine.db/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-porcine.db', spec);
            } catch (err) {
