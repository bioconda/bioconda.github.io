...
.. conda:recipe:: bioconductor-porcine.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/porcine.db.html
...
.. conda:package:: bioconductor-porcine.db
   ...
   :depends bioconductor-org.ss.eg.db: ``>=3.20.0,<3.21.0``
   :depends curl: 
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-porcine.db

   and update with::

      mamba update bioconductor-porcine.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-porcine.db
