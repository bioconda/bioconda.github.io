...
.. conda:package:: primer3
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.6.1-2</code>,  <code>2.6.1-1</code>,  <code>2.6.1-0</code>,  <code>2.6.0-1</code>,  <code>2.6.0-0</code>,  <code>2.5.0-1</code>,  <code>2.5.0-0</code>,  <code>2.4.1a-2</code>,  <code>2.4.1a-1</code>,  </span></summary>
      

      ``2.6.1-2``,  ``2.6.1-1``,  ``2.6.1-0``,  ``2.6.0-1``,  ``2.6.0-0``,  ``2.5.0-1``,  ``2.5.0-0``,  ``2.4.1a-2``,  ``2.4.1a-1``,  ``2.4.1a-0``,  ``2.4.0-0``,  ``2.3.7-1``,  ``2.3.7-0``,  ``2.0.0a-5``,  ``2.0.0a-4``,  ``2.0.0a-3``,  ``2.0.0a-2``,  ``2.0.0a-1``,  ``2.0.0a-0``,  ``1.1.4-4``,  ``1.1.4-3``,  ``1.1.4-2``,  ``1.1.4-1``,  ``1.1.4-0``,  ``v2.5.0-0``
