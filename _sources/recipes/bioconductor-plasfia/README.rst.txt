...
.. conda:recipe:: bioconductor-plasfia
   ...
   :homepage: https://bioconductor.org/packages/3.16/data/experiment/html/plasFIA.html
   :license: LGPL
...
.. conda:package:: bioconductor-plasfia
   ...
   :depends bioconductor-profia: ``>=1.23.0,<1.24.0``
   :depends curl: 
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-plasfia";
