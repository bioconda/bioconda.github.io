...
.. conda:recipe:: bioconductor-reqon
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/ReQON.html
   :license: GPL-2
...
.. conda:package:: bioconductor-reqon
   ...
   :versions:
      ...
      ``1.38.0-0``,  ``1.36.0-1``,  ``1.36.0-0``,  ``1.32.0-0``,  ``1.30.0-1``,  ``1.28.0-0``

      

   
   :depends bioconductor-rsamtools: ``>=2.8.0,<2.9.0``
   :depends bioconductor-seqbias: ``>=1.40.0,<1.41.0``
   :depends openjdk: 
