...
.. conda:recipe:: bioconductor-interactionset
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/InteractionSet.html
   :license: GPL-3
...
.. conda:package:: bioconductor-interactionset
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.28.1-0</code>,  <code>1.26.0-1</code>,  <code>1.26.0-0</code>,  <code>1.22.0-2</code>,  <code>1.22.0-1</code>,  <code>1.22.0-0</code>,  <code>1.20.0-0</code>,  <code>1.18.0-1</code>,  <code>1.18.0-0</code>,  </span></summary>
      

      ``1.28.1-0``,  ``1.26.0-1``,  ``1.26.0-0``,  ``1.22.0-2``,  ``1.22.0-1``,  ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.0-1``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-0``,  ``1.12.0-1``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.28.1","1.26.0","1.26.0","1.22.0","1.22.0"];
    </script>
