...
.. conda:recipe:: bioconductor-wheatprobe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/wheatprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-wheatprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-wheatprobe

   and update with::

      mamba update bioconductor-wheatprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-wheatprobe
