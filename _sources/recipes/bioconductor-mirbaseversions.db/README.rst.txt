...
.. conda:recipe:: bioconductor-mirbaseversions.db
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/miRBaseVersions.db.html
...
.. conda:package:: bioconductor-mirbaseversions.db
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.1.0-15</code>,  <code>1.1.0-14</code>,  <code>1.1.0-13</code>,  <code>1.1.0-12</code>,  <code>1.1.0-11</code>,  <code>1.1.0-10</code>,  <code>1.1.0-9</code>,  <code>1.1.0-8</code>,  <code>1.1.0-7</code>,  </span></summary>
      

      ``1.1.0-15``,  ``1.1.0-14``,  ``1.1.0-13``,  ``1.1.0-12``,  ``1.1.0-11``,  ``1.1.0-10``,  ``1.1.0-9``,  ``1.1.0-8``,  ``1.1.0-7``,  ``1.1.0-6``,  ``1.1.0-5``,  ``1.1.0-4``,  ``1.1.0-3``,  ``1.1.0-1``,  ``1.1.0-0``,  ``0.99.5-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-mirbaseversions.db

to add into an existing workspace instead, run::

    pixi add bioconductor-mirbaseversions.db
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-mirbaseversions.db
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-mirbaseversions.db"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-mirbaseversions.db"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-mirbaseversions.db"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-mirbaseversions.db
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-mirbaseversions.db/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-mirbaseversions.db', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-mirbaseversions.db
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-mirbaseversions.db/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-mirbaseversions.db', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-mirbaseversions.db
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-mirbaseversions.db/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-mirbaseversions.db', spec);
            } catch (err) {
