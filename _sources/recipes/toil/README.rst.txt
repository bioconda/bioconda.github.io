...
.. conda:package:: toil
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>5.7.1-0</code>,  <code>5.6.0-0</code>,  <code>5.5.0-1</code>,  <code>5.5.0-0</code>,  <code>5.4.0-0</code>,  <code>5.3.0-0</code>,  <code>5.2.0-0</code>,  <code>5.1.0-0</code>,  <code>5.0.0-0</code>,  </span></summary>
      

      ``5.7.1-0``,  ``5.6.0-0``,  ``5.5.0-1``,  ``5.5.0-0``,  ``5.4.0-0``,  ``5.3.0-0``,  ``5.2.0-0``,  ``5.1.0-0``,  ``5.0.0-0``,  ``4.2.0-0``,  ``4.1.0-0``,  ``4.0.0-0``,  ``3.24.0-0``,  ``3.23.1-0``,  ``3.21.0-0``,  ``3.20.0-0``,  ``3.14.0-2``,  ``3.14.0-1``,  ``3.14.0-0``,  ``3.13.0a1-0``,  ``3.11.0-1``,  ``3.11.0-0``,  ``3.11.0a1-1``,  ``3.11.0a1-0``,  ``3.10.0-0``,  ``3.10.0a1-1``,  ``3.10.0a1-0``,  ``3.9.0a1-0``,  ``3.8.0a1-1``,  ``3.8.0a1-0``,  ``3.7.0a-1``,  ``3.7.0a-0``,  ``3.6.0-0``,  ``3.5.0a1-3``,  ``3.5.0a1-2``,  ``3.5.0a1-1``,  ``3.5.0a1-0``,  ``3.4.0a1-3``,  ``3.4.0a1-2``,  ``3.4.0a1-1``,  ``3.4.0a1-0``,  ``3.3.0a1-0``,  ``3.2.0a2-2``,  ``3.2.0a2-0``
   ...
   :depends cwltool: ``3.1.20220628170238``
   :depends dill: ``>=0.3.2,<0.4``
   :depends docker-py: ``>=3.7.2,<6``
   :depends galaxy-tool-util: 
   :depends google-cloud-storage: ``>=1.6.0,<2``
   :depends idna: ``>=2``
   :depends networkx: ``>=2,<2.8.5``
   :depends psutil: ``>=3.0.1,<6``
   :depends pynacl: ``>=1.4.0,<2``
   :depends python: ``>=3.7``
   :depends python-dateutil: 
   :depends python-htcondor: ``>=8.6.0,<9``
...
.. raw:: html
    ...
    <script>
        var package = "toil";
        var versions = ["5.7.1","5.6.0","5.5.0","5.5.0","5.4.0"];
    </script>
