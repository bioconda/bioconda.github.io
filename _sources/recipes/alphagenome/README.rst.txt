...
.. conda:package:: alphagenome
   ...
   :versions:
      ...
      ``0.9.0-0``,  ``0.8.0-0``,  ``0.7.0-0``,  ``0.6.1-0``,  ``0.6.0-0``,  ``0.5.1-0``
   ...
   :depends on absl-py: 
   :depends on anndata: 
   :depends on grpcio: ``>=1.67.1``
   :depends on immutabledict: 
   :depends on intervaltree: 
   :depends on jaxtyping: 
   :depends on matplotlib-base: 
   :depends on ml_dtypes: 
   :depends on numpy: 
   :depends on pandas: 
   :depends on protobuf: ``>=5.28.3``
   :depends on pyarrow: 
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["0.9.0","0.8.0","0.7.0","0.6.1","0.6.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_alphagenome"></div>
   <div style="width: 100%" id="platform_plot_alphagenome"></div>
   <div style="width: 100%" id="cdf_plot_alphagenome"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for alphagenome
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/alphagenome/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_alphagenome', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for alphagenome
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/alphagenome/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_alphagenome', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for alphagenome
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/alphagenome/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_alphagenome', spec);
            } catch (err) {
