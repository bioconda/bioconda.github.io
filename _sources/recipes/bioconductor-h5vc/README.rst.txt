...
.. conda:package:: bioconductor-h5vc
   ...
   :versions:
      ...
      ``2.26.1-0``,  ``2.24.0-1``,  ``2.24.0-0``,  ``2.22.0-0``,  ``2.20.0-1``,  ``2.18.0-1``,  ``2.16.0-0``
   ...
   :depends bioconductor-h5vcdata: ``>=2.12.0,<2.13.0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.26.1","2.24.0","2.24.0","2.22.0","2.20.0"];
    </script>
