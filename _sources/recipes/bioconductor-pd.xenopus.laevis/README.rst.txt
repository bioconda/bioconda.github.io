...
.. conda:recipe:: bioconductor-pd.xenopus.laevis
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/pd.xenopus.laevis.html
...
.. conda:package:: bioconductor-pd.xenopus.laevis
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.xenopus.laevis

   and update with::

      mamba update bioconductor-pd.xenopus.laevis

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.xenopus.laevis
