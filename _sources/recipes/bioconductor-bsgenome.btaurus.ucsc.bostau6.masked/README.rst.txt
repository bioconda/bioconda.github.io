...
.. conda:recipe:: bioconductor-bsgenome.btaurus.ucsc.bostau6.masked
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/BSgenome.Btaurus.UCSC.bosTau6.masked.html
...
.. conda:package:: bioconductor-bsgenome.btaurus.ucsc.bostau6.masked
   ...
   :depends on bioconductor-bsgenome.btaurus.ucsc.bostau6: ``>=1.4.0,<1.5.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-bsgenome.btaurus.ucsc.bostau6.masked

to add into an existing workspace instead, run::

    pixi add bioconductor-bsgenome.btaurus.ucsc.bostau6.masked
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-bsgenome.btaurus.ucsc.bostau6.masked
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-bsgenome.btaurus.ucsc.bostau6.masked"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-bsgenome.btaurus.ucsc.bostau6.masked"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-bsgenome.btaurus.ucsc.bostau6.masked"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-bsgenome.btaurus.ucsc.bostau6.masked
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.btaurus.ucsc.bostau6.masked/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-bsgenome.btaurus.ucsc.bostau6.masked', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-bsgenome.btaurus.ucsc.bostau6.masked
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.btaurus.ucsc.bostau6.masked/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-bsgenome.btaurus.ucsc.bostau6.masked', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-bsgenome.btaurus.ucsc.bostau6.masked
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bsgenome.btaurus.ucsc.bostau6.masked/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-bsgenome.btaurus.ucsc.bostau6.masked', spec);
            } catch (err) {
