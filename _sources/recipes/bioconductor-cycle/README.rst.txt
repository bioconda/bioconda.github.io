...
.. conda:recipe:: bioconductor-cycle
   :replaces_section_title:
   :noindex:

   Significance of periodic expression pattern in time\-series data

   :homepage: https://bioconductor.org/packages/3.22/bioc/html/cycle.html
   :license: GPL-2
...
.. conda:package:: bioconductor-cycle
...
to install globally, run::
    ...
    pixi global install bioconductor-cycle

to add into an existing workspace instead, run::

    pixi add bioconductor-cycle
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-cycle
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-cycle"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-cycle"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-cycle"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-cycle
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-cycle/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-cycle', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-cycle
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-cycle/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-cycle', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-cycle
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-cycle/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-cycle', spec);
            } catch (err) {
...
Render an |install-with-bioconda| badge with the following MarkDown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat)](http://bioconda.github.io/recipes/bioconductor-cycle/README.html)
