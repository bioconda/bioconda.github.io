...
.. conda:package:: bioconductor-mesh.dmo.eg.db
   ...
   :required~by: |required_by_bioconductor-mesh.dmo.eg.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-mesh.dmo.eg.db


.. |required_by_bioconductor-mesh.dmo.eg.db| conda:required_by:: bioconductor-mesh.dmo.eg.db
