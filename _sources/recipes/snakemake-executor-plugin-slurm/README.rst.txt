...
.. conda:package:: snakemake-executor-plugin-slurm
   ...
   :depends numpy: ``>=1.26.4,<3.0``
   :depends pandas: ``>=2.2.3,<3.0``
   :depends python: ``>=3.11.0,<4.0.0``
   :depends pyyaml: 
   :depends snakemake-executor-plugin-slurm-jobstep: ``>=0.4.0,<0.5.0``
   :depends snakemake-interface-common: ``>=1.21.0,<2.0.0``
   :depends snakemake-interface-executor-plugins: ``>=9.3.9,<10.0.0``
