...
.. conda:recipe:: bioconductor-mu19ksubc.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/mu19ksubc.db.html
...
.. conda:package:: bioconductor-mu19ksubc.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mu19ksubc.db

   and update with::

      mamba update bioconductor-mu19ksubc.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mu19ksubc.db
