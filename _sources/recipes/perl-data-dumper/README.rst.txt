...
.. conda:package:: perl-data-dumper
   ...
   :versions:
      ...
      ``2.183-1``,  ``2.183-0``,  ``2.173-1``,  ``2.173-0``,  ``2.161-2``,  ``2.161-1``,  ``2.161-0``
   ...
   or use the docker container::
      ...
      docker pull quay.io/biocontainers/perl-data-dumper:<tag>

   (see `perl-data-dumper/tags`_ for valid values for ``<tag>``)
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.183","2.183","2.173","2.173","2.161"];
    </script>
