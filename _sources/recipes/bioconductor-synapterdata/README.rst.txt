...
.. conda:recipe:: bioconductor-synapterdata
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/experiment/html/synapterdata.html
   :license: GPL-2
...
.. conda:package:: bioconductor-synapterdata
   ...
   :depends bioconductor-synapter: ``>=2.30.0,<2.31.0``
   :depends curl: 
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-synapterdata

   and update with::

      mamba update bioconductor-synapterdata

  To create a new environment, run::

      mamba create --name myenvname bioconductor-synapterdata
