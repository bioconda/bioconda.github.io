...
.. conda:recipe:: bioconductor-qpgraph
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/qpgraph.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-qpgraph
   ...
   :versions:
      ...
      ``2.26.0-0``,  ``2.24.3-0``,  ``2.24.0-0``,  ``2.22.0-0``,  ``2.20.0-0``,  ``2.18.0-1``,  ``2.16.0-0``,  ``2.14.0-0``,  ``2.12.0-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["2.26.0","2.24.3","2.24.0","2.22.0","2.20.0"];
    </script>
