...
.. conda:recipe:: bioconductor-cytolib
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/cytolib.html
...
.. conda:package:: bioconductor-cytolib
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-cytolib

   and update with::

      mamba update bioconductor-cytolib

  To create a new environment, run::

      mamba create --name myenvname bioconductor-cytolib
