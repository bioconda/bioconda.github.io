...
============= ===========
Home          http://bioconductor.org/packages/3.7/bioc/html/SNPediaR.html
Versions      1.2.0, 1.4.0, 1.6.0
License       GPL-2
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes/bioconductor-snpediar
...
A Docker container is available at https://quay.io/repository/biocontainers/bioconductor-snpediar.
...
Render an |badge| badge with the following Markdown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square)](http://bioconda.github.io/recipes/bioconductor-snpediar/README.html)

.. |badge| image:: https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square
           :target: http://bioconda.github.io/recipes/bioconductor-snpediar/README.html
.. |downloads| image:: https://anaconda.org/bioconda/bioconductor-snpediar/badges/downloads.svg
               :target: https://anaconda.org/bioconda/bioconductor-snpediar
.. |docker| image:: https://quay.io/repository/biocontainers/bioconductor-snpediar/status
