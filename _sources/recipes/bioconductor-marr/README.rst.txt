...
.. conda:recipe:: bioconductor-marr
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/marr.html
   :license: GPL (>= 3)
...
.. conda:package:: bioconductor-marr
   ...
   :versions:
      ...
      ``1.4.0-2``,  ``1.4.0-1``,  ``1.4.0-0``,  ``1.2.0-0``,  ``1.00.02-0``,  ``1.0.0-1``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.4.0","1.4.0","1.4.0","1.2.0","1.00.02"];
    </script>
