...
.. conda:recipe:: bioconductor-sampleclassifier
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/sampleClassifier.html
...
.. conda:package:: bioconductor-sampleclassifier
   ...
   :versions:
      ...
      ``1.18.0-0``,  ``1.16.0-0``,  ``1.11.0-0``,  ``1.10.0-0``,  ``1.8.0-1``,  ``1.6.0-0``

      

   
   :depends bioconductor-annotate: ``>=1.72.0,<1.73.0``
   :depends bioconductor-mgfm: ``>=1.28.0,<1.29.0``
   :depends bioconductor-mgfr: ``>=1.20.0,<1.21.0``
