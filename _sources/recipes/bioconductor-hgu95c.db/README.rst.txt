...
.. conda:recipe:: bioconductor-hgu95c.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/hgu95c.db.html
...
.. conda:package:: bioconductor-hgu95c.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hgu95c.db

   and update with::

      mamba update bioconductor-hgu95c.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hgu95c.db
