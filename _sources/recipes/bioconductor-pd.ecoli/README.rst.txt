...
.. conda:recipe:: bioconductor-pd.ecoli
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/pd.ecoli.html
...
.. conda:package:: bioconductor-pd.ecoli
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.ecoli

   and update with::

      mamba update bioconductor-pd.ecoli

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.ecoli
