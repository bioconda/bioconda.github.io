...
.. conda:package:: bioconductor-hom.dm.inp.db
   ...
   :required~by: |required_by_bioconductor-hom.dm.inp.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-hom.dm.inp.db


.. |required_by_bioconductor-hom.dm.inp.db| conda:required_by:: bioconductor-hom.dm.inp.db
