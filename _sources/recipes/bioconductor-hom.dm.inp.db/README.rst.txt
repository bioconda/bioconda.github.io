...
.. conda:recipe:: bioconductor-hom.dm.inp.db
   ...
   Homology information for Drosophila melanogaster from Inparanoid

   :homepage: https://bioconductor.org/packages/3.12/data/annotation/html/hom.Dm.inp.db.html
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-hom.dm.inp.db";
