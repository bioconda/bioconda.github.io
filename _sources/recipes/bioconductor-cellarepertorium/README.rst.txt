...
.. conda:recipe:: bioconductor-cellarepertorium
   ...
   :homepage: https://bioconductor.org/packages/3.18/bioc/html/CellaRepertorium.html
   :license: GPL-3
...
to install globally, run::
    ...
    pixi global install bioconductor-cellarepertorium

to add into an existing workspace instead, run::

    pixi add bioconductor-cellarepertorium
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-cellarepertorium
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-cellarepertorium"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-cellarepertorium"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-cellarepertorium"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-cellarepertorium
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-cellarepertorium/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-cellarepertorium', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-cellarepertorium
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-cellarepertorium/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-cellarepertorium', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-cellarepertorium
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-cellarepertorium/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-cellarepertorium', spec);
            } catch (err) {
