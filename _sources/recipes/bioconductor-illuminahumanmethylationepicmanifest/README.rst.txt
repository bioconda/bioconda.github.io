...
.. conda:recipe:: bioconductor-illuminahumanmethylationepicmanifest
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/IlluminaHumanMethylationEPICmanifest.html
...
.. conda:package:: bioconductor-illuminahumanmethylationepicmanifest
   ...
   :versions: 0.3.0-3, 0.3.0-2, 0.3.0-0
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-illuminahumanmethylationepicmanifest:<tag>
