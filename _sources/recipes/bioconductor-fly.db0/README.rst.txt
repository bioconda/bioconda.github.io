...
.. conda:recipe:: bioconductor-fly.db0
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/fly.db0.html
...
.. conda:package:: bioconductor-fly.db0
   ...
   :required~by: |required_by_bioconductor-fly.db0|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-fly.db0


.. |required_by_bioconductor-fly.db0| conda:required_by:: bioconductor-fly.db0
