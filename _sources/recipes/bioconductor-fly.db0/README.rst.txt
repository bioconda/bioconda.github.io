...
.. conda:recipe:: bioconductor-fly.db0
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/fly.db0.html
...
.. conda:package:: bioconductor-fly.db0
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-fly.db0

   and update with::

      mamba update bioconductor-fly.db0

  To create a new environment, run::

      mamba create --name myenvname bioconductor-fly.db0
