...
.. conda:recipe:: bioconductor-txreginfra
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/TxRegInfra.html
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-txreginfra";
        var versions = ["1.10.0","1.10.0","1.8.0","1.6.0","1.4.0"];
    </script>
