...
.. conda:recipe:: bioconductor-rae230a.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/rae230a.db.html
...
.. conda:package:: bioconductor-rae230a.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rae230a.db

   and update with::

      mamba update bioconductor-rae230a.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rae230a.db
