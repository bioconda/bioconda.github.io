...
.. conda:recipe:: bioconductor-splinetimer
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/splineTimeR.html
   :license: GPL-3
...
.. conda:package:: bioconductor-splinetimer
   ...
   :versions:
      ...
      ``1.38.0-0``,  ``1.34.0-0``,  ``1.30.0-0``,  ``1.28.0-0``,  ``1.26.0-0``,  ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.0-1``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-1``,  ``1.12.0-1``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.0-0``
   ...
   :depends on bioconductor-fis: ``>=1.38.0,<1.39.0``
   :depends on bioconductor-gseabase: ``>=1.72.0,<1.73.0``
   :depends on bioconductor-limma: ``>=3.66.0,<3.67.0``
   :depends on r-base: ``>=4.5,<4.6.0a0``
   :depends on r-genenet: ``>=1.2.13``
   :depends on r-gtools: 
   :depends on r-igraph: 
   :depends on r-longitudinal: ``>=1.1.12``
...
to install globally, run::
    ...
    pixi global install bioconductor-splinetimer

to add into an existing workspace instead, run::

    pixi add bioconductor-splinetimer
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-splinetimer
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-splinetimer"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-splinetimer"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-splinetimer"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-splinetimer
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-splinetimer/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-splinetimer', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-splinetimer
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-splinetimer/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-splinetimer', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-splinetimer
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-splinetimer/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-splinetimer', spec);
            } catch (err) {
