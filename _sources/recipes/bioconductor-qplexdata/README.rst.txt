...
.. conda:recipe:: bioconductor-qplexdata
   ...
   :homepage: https://bioconductor.org/packages/3.12/data/experiment/html/qPLEXdata.html
   :license: GPL-2
...
.. conda:package:: bioconductor-qplexdata
   ...
   :versions:
      ...
      ``1.10.0-0``,  ``1.8.0-1``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.2.0-1``,  ``1.0.1-0``

      

   
   :depends bioconductor-msnbase: ``>=2.18.0,<2.19.0``
   :depends bioconductor-qplexanalyzer: ``>=1.10.0,<1.11.0``
