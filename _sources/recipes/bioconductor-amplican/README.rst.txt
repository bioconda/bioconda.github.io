...
.. conda:recipe:: bioconductor-amplican
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/amplican.html
   :license: GPL-3
...
.. conda:package:: bioconductor-amplican
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.32.1-0</code>,  <code>1.28.0-0</code>,  <code>1.24.0-1</code>,  <code>1.24.0-0</code>,  <code>1.22.1-0</code>,  <code>1.20.0-1</code>,  <code>1.20.0-0</code>,  <code>1.16.0-2</code>,  <code>1.16.0-1</code>,  </span></summary>
      

      ``1.32.1-0``,  ``1.28.0-0``,  ``1.24.0-1``,  ``1.24.0-0``,  ``1.22.1-0``,  ``1.20.0-1``,  ``1.20.0-0``,  ``1.16.0-2``,  ``1.16.0-1``,  ``1.16.0-0``,  ``1.14.0-0``,  ``1.12.0-1``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.2-0``,  ``1.4.0-0``
   ...
   :depends on r-cluster: ``>=2.1.4``
   :depends on r-data.table: ``>=1.10.4-3``
   :depends on r-dplyr: ``>=0.7.2``
   :depends on r-ggplot2: ``>=3.3.4``
   :depends on r-ggthemes: ``>=3.4.0``
   :depends on r-gridextra: ``>=2.2.1``
   :depends on r-gtable: ``>=0.2.0``
   :depends on r-knitr: ``>=1.16``
   :depends on r-matrix: ``>=1.2-10``
   :depends on r-matrixstats: ``>=0.52.2``
   :depends on r-rcpp: 
   :depends on r-rmarkdown: ``>=1.6``
...
to install globally, run::
    ...
    pixi global install bioconductor-amplican

to add into an existing workspace instead, run::

    pixi add bioconductor-amplican
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-amplican
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.32.1","1.28.0","1.24.0","1.24.0","1.22.1"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-amplican"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-amplican"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-amplican"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-amplican
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-amplican/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-amplican', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-amplican
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-amplican/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-amplican', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-amplican
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-amplican/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-amplican', spec);
            } catch (err) {
