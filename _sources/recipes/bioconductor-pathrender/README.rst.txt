...
.. conda:recipe:: bioconductor-pathrender
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/pathRender.html
   :license: LGPL
...
.. conda:package:: bioconductor-pathrender
   ...
   :depends on bioconductor-cmap: ``>=1.15.0,<1.16.0``
...
to install globally, run::
    ...
    pixi global install bioconductor-pathrender

to add into an existing workspace instead, run::

    pixi add bioconductor-pathrender
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-pathrender
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-pathrender"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-pathrender"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-pathrender"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-pathrender
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pathrender/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-pathrender', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-pathrender
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pathrender/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-pathrender', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-pathrender
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-pathrender/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-pathrender', spec);
            } catch (err) {
