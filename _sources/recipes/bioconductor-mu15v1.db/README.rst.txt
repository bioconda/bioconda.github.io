...
.. conda:recipe:: bioconductor-mu15v1.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/Mu15v1.db.html
...
.. conda:package:: bioconductor-mu15v1.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mu15v1.db

   and update with::

      mamba update bioconductor-mu15v1.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mu15v1.db
