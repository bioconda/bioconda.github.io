...
.. conda:recipe:: bioconductor-ularcirc
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/Ularcirc.html
...
.. conda:package:: bioconductor-ularcirc
   ...
   :depends bioconductor-organism.dplyr: ``>=1.26.0,<1.27.0``
   :depends bioconductor-plotgardener: ``>=1.4.0,<1.5.0``
