...
.. conda:package:: salmon
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.10.3-5</code>,  <code>1.10.3-4</code>,  <code>1.10.3-3</code>,  <code>1.10.3-2</code>,  <code>1.10.3-1</code>,  <code>1.10.3-0</code>,  <code>1.10.2-0</code>,  <code>1.10.1-2</code>,  <code>1.10.1-1</code>,  </span></summary>
      

      ``1.10.3-5``,  ``1.10.3-4``,  ``1.10.3-3``,  ``1.10.3-2``,  ``1.10.3-1``,  ``1.10.3-0``,  ``1.10.2-0``,  ``1.10.1-2``,  ``1.10.1-1``,  ``1.10.1-0``,  ``1.10.0-0``,  ``1.9.0-1``,  ``1.9.0-0``,  ``1.8.0-1``,  ``1.8.0-0``,  ``1.7.0-1``,  ``1.7.0-0``,  ``1.6.0-0``,  ``1.5.2-0``,  ``1.5.1-0``,  ``1.5.0-0``,  ``1.4.0-1``,  ``1.4.0-0``,  ``1.3.0-0``,  ``1.2.1-0``,  ``1.2.0-0``,  ``1.1.0-0``,  ``1.0.0-0``,  ``0.15.0-0``,  ``0.14.2-1``,  ``0.14.2-0``,  ``0.14.1-2``,  ``0.14.1-1``,  ``0.14.1-0``,  ``0.14.0-1``,  ``0.14.0-0``,  ``0.13.1-0``,  ``0.13.0-2``,  ``0.13.0-1``,  ``0.12.0-1``,  ``0.11.3-2``,  ``0.11.3-1``,  ``0.11.2-0``,  ``0.11.1-0``,  ``0.11.0-0``,  ``0.10.2-3``,  ``0.10.2-1``,  ``0.10.1-1``,  ``0.10.0-1``,  ``0.9.1-1``,  ``0.9.1-0``,  ``0.9.0-0``,  ``0.8.2-1``,  ``0.8.2-0``,  ``0.8.1-0``,  ``0.8.0-0``,  ``0.7.2-3``,  ``0.7.2-2``,  ``0.6.0-2``,  ``0.6.0-1``,  ``0.6.0-0``,  ``0.5.1-0``
   ...
   :depends libgcc: ``>=13``
   :depends libgff: ``>=2.0.0,<3.0a0``
   :depends libiconv: ``>=1.18,<2.0a0``
   :depends libjemalloc: ``>=5.3.0``
   :depends liblzma: ``>=5.8.1,<6.0a0``
   :depends libstdcxx: ``>=13``
   :depends libzlib: ``>=1.3.1,<2.0a0``
   :depends staden_io_lib: ``>=1.15.0``
   :depends staden_io_lib: ``>=1.15.0,<2.0a0``
   :depends tbb: ``>=2022.1.0``
...
.. raw:: html
    ...
    <script>
        var package = "salmon";
        var versions = ["1.10.3","1.10.3","1.10.3","1.10.3","1.10.3"];
    </script>
