...
.. conda:package:: bioconductor-snm
   ...
   :depends: :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-corpcor`  :conda:package:`r-lme4` >=1.0 

   :required~by: |required_by_bioconductor-snm|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-snm


.. |required_by_bioconductor-snm| conda:required_by:: bioconductor-snm
