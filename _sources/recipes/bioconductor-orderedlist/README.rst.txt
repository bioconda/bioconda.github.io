...
.. conda:recipe:: bioconductor-orderedlist
   ...
   :homepage: https://bioconductor.org/packages/3.11/bioc/html/OrderedList.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-orderedlist
   ...
   :versions:
      ...
      ``1.62.0-0``,  ``1.59.1-0``,  ``1.58.0-0``,  ``1.56.0-1``,  ``1.54.0-1``,  ``1.54.0-0``,  ``1.52.0-0``,  ``1.50.0-0``

      

   
   :depends bioconductor-biobase: ``>=2.50.0,<2.51.0``
   :depends bioconductor-twilight: ``>=1.66.0,<1.67.0``
