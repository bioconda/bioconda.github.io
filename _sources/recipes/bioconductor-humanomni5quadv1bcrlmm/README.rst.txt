...
.. conda:recipe:: bioconductor-humanomni5quadv1bcrlmm
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/humanomni5quadv1bCrlmm.html
...
.. conda:package:: bioconductor-humanomni5quadv1bcrlmm
   ...
   :versions:
      ...
      ``1.0.0-14``,  ``1.0.0-13``,  ``1.0.0-12``,  ``1.0.0-11``,  ``1.0.0-10``,  ``1.0.0-9``,  ``1.0.0-8``,  ``1.0.0-7``,  ``1.0.0-6``,  ``1.0.0-5``,  ``1.0.0-4``,  ``1.0.0-3``,  ``1.0.0-2``,  ``1.0.0-1``,  ``1.0.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-humanomni5quadv1bcrlmm

to add into an existing workspace instead, run::

    pixi add bioconductor-humanomni5quadv1bcrlmm
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-humanomni5quadv1bcrlmm

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-humanomni5quadv1bcrlmm
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-humanomni5quadv1bcrlmm"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-humanomni5quadv1bcrlmm"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-humanomni5quadv1bcrlmm"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-humanomni5quadv1bcrlmm
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-humanomni5quadv1bcrlmm/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-humanomni5quadv1bcrlmm', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-humanomni5quadv1bcrlmm
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-humanomni5quadv1bcrlmm/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-humanomni5quadv1bcrlmm', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-humanomni5quadv1bcrlmm
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-humanomni5quadv1bcrlmm/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-humanomni5quadv1bcrlmm', spec);
            } catch (err) {
