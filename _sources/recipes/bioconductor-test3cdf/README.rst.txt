...
.. conda:recipe:: bioconductor-test3cdf
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/test3cdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-test3cdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-test3cdf

   and update with::

      mamba update bioconductor-test3cdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-test3cdf
