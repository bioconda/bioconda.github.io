...
.. conda:recipe:: regain-cli
   ...
   Bayesian\-network pipeline for resistance\/virulence gene co\-occurrence analysis.
...
.. conda:package:: regain-cli
   ...
   :versions:
      ...
      ``1.8.0-0``,  ``1.7.1-0``,  ``1.6.3-0``,  ``1.6.2-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.8.0","1.7.1","1.6.3","1.6.2"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_regain-cli"></div>
   <div style="width: 100%" id="platform_plot_regain-cli"></div>
   <div style="width: 100%" id="cdf_plot_regain-cli"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/regain-cli/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_regain-cli', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for regain-cli
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/regain-cli/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_regain-cli', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for regain-cli
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/regain-cli/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_regain-cli', spec);
            } catch (err) {
