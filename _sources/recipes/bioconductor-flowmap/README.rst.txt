...
============= ===========
Home          https://bioconductor.org/packages/3.8/bioc/html/flowMap.html
Versions      1.18.0, 1.14.0
License       GPL (>=2)
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes//home/circleci/project/docs/bioconda-recipes/recipes/bioconductor-flowmap/meta.yaml
...
A Docker container is available at https://quay.io/repository/biocontainers/bioconductor-flowmap.
...
Render an |badge| badge with the following Markdown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square)](http://bioconda.github.io/recipes/bioconductor-flowmap/README.html)

.. |badge| image:: https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square
           :target: http://bioconda.github.io/recipes/bioconductor-flowmap/README.html
.. |downloads| image:: https://anaconda.org/bioconda/bioconductor-flowmap/badges/downloads.svg
               :target: https://anaconda.org/bioconda/bioconductor-flowmap
.. |docker| image:: https://quay.io/repository/biocontainers/bioconductor-flowmap/status
