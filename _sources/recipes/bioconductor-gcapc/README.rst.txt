...
.. conda:recipe:: bioconductor-gcapc
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/gcapc.html
   :license: GPL-3
...
.. conda:package:: bioconductor-gcapc
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-gcapc

   and update with::

      mamba update bioconductor-gcapc

  To create a new environment, run::

      mamba create --name myenvname bioconductor-gcapc
