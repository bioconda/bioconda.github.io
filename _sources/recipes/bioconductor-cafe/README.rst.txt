...
.. conda:recipe:: bioconductor-cafe
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/CAFE.html
   :license: GPL-3
...
.. conda:package:: bioconductor-cafe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-cafe

   and update with::

      mamba update bioconductor-cafe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-cafe
