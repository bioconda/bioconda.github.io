...
.. conda:recipe:: bioconductor-rnaprobr
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/RNAprobR.html
   :license: GPL (>=2)
...
.. conda:package:: bioconductor-rnaprobr
   ...
   :versions:
      ...
      ``1.22.0-1``,  ``1.22.0-0``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.16.0-1``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.9.0-0``,  ``1.8.0-0``
...
.. raw:: html
    ...
    <script>
        var package = "bioconductor-rnaprobr";
        var versions = ["1.22.0","1.22.0","1.20.0","1.18.0","1.16.0"];
    </script>
