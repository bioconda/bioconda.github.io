...
.. conda:recipe:: bioconductor-rattoxfxcdf
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/rattoxfxcdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-rattoxfxcdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-rattoxfxcdf

   and update with::

      mamba update bioconductor-rattoxfxcdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-rattoxfxcdf
