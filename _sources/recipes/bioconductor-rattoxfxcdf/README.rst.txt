...
.. conda:recipe:: bioconductor-rattoxfxcdf
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/rattoxfxcdf.html
   :license: LGPL
...
to install globally, run::
    ...
    pixi global install bioconductor-rattoxfxcdf

to add into an existing workspace instead, run::

    pixi add bioconductor-rattoxfxcdf
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-rattoxfxcdf
...
.. raw:: html
   ...
   <script>
      var package = "bioconductor-rattoxfxcdf";
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-rattoxfxcdf"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-rattoxfxcdf"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-rattoxfxcdf"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-rattoxfxcdf
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rattoxfxcdf/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-rattoxfxcdf', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-rattoxfxcdf
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rattoxfxcdf/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-rattoxfxcdf', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-rattoxfxcdf
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-rattoxfxcdf/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-rattoxfxcdf', spec);
            } catch (err) {
