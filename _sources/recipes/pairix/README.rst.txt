...
.. conda:package:: pairix
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.3.8-3</code>,  <code>0.3.8-2</code>,  <code>0.3.8-1</code>,  <code>0.3.8-0</code>,  <code>0.3.7-5</code>,  <code>0.3.7-4</code>,  <code>0.3.7-3</code>,  <code>0.3.7-2</code>,  <code>0.3.7-1</code>,  </span></summary>
      

      ``0.3.8-3``,  ``0.3.8-2``,  ``0.3.8-1``,  ``0.3.8-0``,  ``0.3.7-5``,  ``0.3.7-4``,  ``0.3.7-3``,  ``0.3.7-2``,  ``0.3.7-1``,  ``0.3.7-0``,  ``0.3.6-4``,  ``0.3.6-2``,  ``0.3.6-1``,  ``0.3.6-0``,  ``0.3.5-0``,  ``0.3.3-0``,  ``0.3.2-0``,  ``0.3.1-0``,  ``0.3.0-0``,  ``0.2.5-0``,  ``0.2.4-0``,  ``0.1.6-0``
...
.. raw:: html
    ...
    <script>
        var package = "pairix";
        var versions = ["0.3.8","0.3.8","0.3.8","0.3.8","0.3.7"];
    </script>
