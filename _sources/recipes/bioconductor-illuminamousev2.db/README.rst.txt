...
.. conda:recipe:: bioconductor-illuminamousev2.db
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/illuminaMousev2.db.html
...
.. conda:package:: bioconductor-illuminamousev2.db
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.26.0-19</code>,  <code>1.26.0-18</code>,  <code>1.26.0-17</code>,  <code>1.26.0-16</code>,  <code>1.26.0-15</code>,  <code>1.26.0-14</code>,  <code>1.26.0-13</code>,  <code>1.26.0-12</code>,  <code>1.26.0-11</code>,  </span></summary>
      

      ``1.26.0-19``,  ``1.26.0-18``,  ``1.26.0-17``,  ``1.26.0-16``,  ``1.26.0-15``,  ``1.26.0-14``,  ``1.26.0-13``,  ``1.26.0-12``,  ``1.26.0-11``,  ``1.26.0-10``,  ``1.26.0-9``,  ``1.26.0-8``,  ``1.26.0-7``,  ``1.26.0-5``,  ``1.26.0-4``,  ``1.26.0-2``,  ``1.26.0-1``,  ``1.26.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-illuminamousev2.db

to add into an existing workspace instead, run::

    pixi add bioconductor-illuminamousev2.db
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-illuminamousev2.db
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-illuminamousev2.db"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-illuminamousev2.db"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-illuminamousev2.db"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-illuminamousev2.db
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-illuminamousev2.db/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-illuminamousev2.db', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-illuminamousev2.db
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-illuminamousev2.db/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-illuminamousev2.db', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-illuminamousev2.db
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-illuminamousev2.db/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-illuminamousev2.db', spec);
            } catch (err) {
