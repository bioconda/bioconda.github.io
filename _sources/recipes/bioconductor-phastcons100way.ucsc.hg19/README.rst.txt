...
.. conda:recipe:: bioconductor-phastcons100way.ucsc.hg19
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/phastCons100way.UCSC.hg19.html
...
.. conda:package:: bioconductor-phastcons100way.ucsc.hg19
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.7.2-16</code>,  <code>3.7.2-15</code>,  <code>3.7.2-14</code>,  <code>3.7.2-13</code>,  <code>3.7.2-12</code>,  <code>3.7.2-11</code>,  <code>3.7.2-10</code>,  <code>3.7.2-9</code>,  <code>3.7.2-8</code>,  </span></summary>
      

      ``3.7.2-16``,  ``3.7.2-15``,  ``3.7.2-14``,  ``3.7.2-13``,  ``3.7.2-12``,  ``3.7.2-11``,  ``3.7.2-10``,  ``3.7.2-9``,  ``3.7.2-8``,  ``3.7.2-7``,  ``3.7.2-6``,  ``3.7.2-5``,  ``3.7.2-4``,  ``3.7.2-2``,  ``3.7.2-1``,  ``3.7.2-0``,  ``3.6.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-phastcons100way.ucsc.hg19

to add into an existing workspace instead, run::

    pixi add bioconductor-phastcons100way.ucsc.hg19
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-phastcons100way.ucsc.hg19
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-phastcons100way.ucsc.hg19"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-phastcons100way.ucsc.hg19"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-phastcons100way.ucsc.hg19"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-phastcons100way.ucsc.hg19
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-phastcons100way.ucsc.hg19/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-phastcons100way.ucsc.hg19', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-phastcons100way.ucsc.hg19
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-phastcons100way.ucsc.hg19/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-phastcons100way.ucsc.hg19', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-phastcons100way.ucsc.hg19
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-phastcons100way.ucsc.hg19/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-phastcons100way.ucsc.hg19', spec);
            } catch (err) {
