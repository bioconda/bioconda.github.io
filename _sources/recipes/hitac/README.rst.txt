...
.. conda:package:: hitac
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.2.2-0</code>,  <code>2.2.1-0</code>,  <code>2.2.0-0</code>,  <code>2.1.1-0</code>,  <code>2.1.0-0</code>,  <code>2.0.30-0</code>,  <code>2.0.29-0</code>,  <code>2.0.28-0</code>,  <code>2.0.23-0</code>,  </span></summary>
      

      ``2.2.2-0``,  ``2.2.1-0``,  ``2.2.0-0``,  ``2.1.1-0``,  ``2.1.0-0``,  ``2.0.30-0``,  ``2.0.29-0``,  ``2.0.28-0``,  ``2.0.23-0``,  ``2.0.22-0``,  ``2.0.21-1``,  ``2.0.21-0``,  ``2.0.20-1``,  ``2.0.20-0``,  ``2.0.19-0``,  ``2.0.16-0``,  ``2.0.15-0``,  ``2.0.10-1``,  ``2.0.10-0``,  ``2.0.9-1``,  ``2.0.9-0``,  ``2.0.8-0``,  ``2.0.6-0``,  ``2.0.5-0``,  ``2.0.4-0``,  ``1.5.9-0``,  ``1.5.8-0``,  ``1.5.4-0``,  ``1.5.1-0``,  ``1.4-0``,  ``1.3-0``,  ``1.1-0``
...
.. raw:: html
    ...
    <script>
        var package = "hitac";
        var versions = ["2.2.2","2.2.1","2.2.0","2.1.1","2.1.0"];
    </script>
