...
.. conda:package:: perl-extutils-cppguess
   ...
   :depends on perl-extutils-manifest: ``>=1.75,<2.0a0``
...
to install globally, run::
    ...
    pixi global install perl-extutils-cppguess

to add into an existing workspace instead, run::

    pixi add perl-extutils-cppguess
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname perl-extutils-cppguess
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_perl-extutils-cppguess"></div>
   <div style="width: 100%" id="platform_plot_perl-extutils-cppguess"></div>
   <div style="width: 100%" id="cdf_plot_perl-extutils-cppguess"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for perl-extutils-cppguess
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-extutils-cppguess/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_perl-extutils-cppguess', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for perl-extutils-cppguess
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-extutils-cppguess/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_perl-extutils-cppguess', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for perl-extutils-cppguess
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/perl-extutils-cppguess/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_perl-extutils-cppguess', spec);
            } catch (err) {
