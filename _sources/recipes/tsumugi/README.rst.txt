...
.. conda:recipe:: tsumugi
   ...
   :documentation: https://github.com/akikuno/TSUMUGI-dev/blob/1.1.0/README.md
...
.. conda:package:: tsumugi
   ...
   :versions:
      ...
      ``1.1.0-0``,  ``1.0.2-0``,  ``1.0.1-0``,  ``1.0.0-0``,  ``0.5.0-0``
...
.. raw:: html
   ...
   <script>
      var package = "tsumugi";
      var versions = ["1.1.0","1.0.2","1.0.1","1.0.0","0.5.0"];
   </script>
