...
.. conda:recipe:: bioconductor-hguatlas13k.db
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/hguatlas13k.db.html
...
.. conda:package:: bioconductor-hguatlas13k.db
   ...
   :versions:
      ...
      ``3.2.3-13``,  ``3.2.3-12``,  ``3.2.3-11``,  ``3.2.3-10``,  ``3.2.3-9``,  ``3.2.3-8``,  ``3.2.3-7``,  ``3.2.3-6``,  ``3.2.3-5``,  ``3.2.3-4``,  ``3.2.3-3``,  ``3.2.3-1``,  ``3.2.3-0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hguatlas13k.db

   and update with::

      mamba update bioconductor-hguatlas13k.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hguatlas13k.db
