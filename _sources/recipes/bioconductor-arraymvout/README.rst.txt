...
.. conda:recipe:: bioconductor-arraymvout
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/arrayMvout.html
...
.. conda:package:: bioconductor-arraymvout
   ...
   :versions:
      ...
      ``1.56.0-0``,  ``1.52.0-0``,  ``1.50.0-0``,  ``1.48.0-1``,  ``1.48.0-0``,  ``1.46.0-0``,  ``1.44.0-0``,  ``1.42.0-1``,  ``1.40.0-0``

      

   
   :depends bioconductor-affy: ``>=1.76.0,<1.77.0``
   :depends bioconductor-affycontam: ``>=1.56.0,<1.57.0``
   :depends bioconductor-biobase: ``>=2.58.0,<2.59.0``
   :depends bioconductor-lumi: ``>=2.50.0,<2.51.0``
   :depends bioconductor-mdqc: ``>=1.60.0,<1.61.0``
   :depends bioconductor-parody: ``>=1.56.0,<1.57.0``
