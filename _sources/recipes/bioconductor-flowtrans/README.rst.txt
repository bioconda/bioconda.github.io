...
.. conda:recipe:: bioconductor-flowtrans
   ...
   :homepage: https://bioconductor.org/packages/3.8/bioc/html/flowTrans.html
...
.. conda:package:: bioconductor-flowtrans
   ...
   :depends: :conda:package:`bioconductor-flowclust` >=3.20.0,<3.21.0 :conda:package:`bioconductor-flowcore` >=1.48.0,<1.49.0 :conda:package:`bioconductor-flowviz` >=1.46.0,<1.47.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-flowtrans|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-flowtrans


.. |required_by_bioconductor-flowtrans| conda:required_by:: bioconductor-flowtrans
