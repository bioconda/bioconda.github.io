...
.. conda:recipe:: bioconductor-annotationdbi
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/AnnotationDbi.html
...
.. conda:package:: bioconductor-annotationdbi
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.62.2-0</code>,  <code>1.60.0-0</code>,  <code>1.56.2-0</code>,  <code>1.56.1-0</code>,  <code>1.54.0-0</code>,  <code>1.52.0-1</code>,  <code>1.52.0-0</code>,  <code>1.50.0-0</code>,  <code>1.48.0-0</code>,  </span></summary>
      

      ``1.62.2-0``,  ``1.60.0-0``,  ``1.56.2-0``,  ``1.56.1-0``,  ``1.54.0-0``,  ``1.52.0-1``,  ``1.52.0-0``,  ``1.50.0-0``,  ``1.48.0-0``,  ``1.46.0-1``,  ``1.44.0-0``,  ``1.42.1-0``,  ``1.40.0-0``,  ``1.38.2-0``,  ``1.38.0-0``,  ``1.36.2-0``,  ``1.36.0-1``,  ``1.34.4-1``,  ``1.34.4-0``,  ``1.32.3-0``,  ``1.32.2-0``,  ``1.32.0-0``,  ``1.30.1-0``
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
   ...
   and update with::
      ...
      mamba update bioconductor-annotationdbi

  To create a new environment, run::

      mamba create --name myenvname bioconductor-annotationdbi
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.62.2","1.60.0","1.56.2","1.56.1","1.54.0"];
    </script>
