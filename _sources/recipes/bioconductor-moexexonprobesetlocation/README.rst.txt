...
.. conda:recipe:: bioconductor-moexexonprobesetlocation
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/MoExExonProbesetLocation.html
   :license: LGPL
...
.. conda:package:: bioconductor-moexexonprobesetlocation
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.15.0-14</code>,  <code>1.15.0-13</code>,  <code>1.15.0-12</code>,  <code>1.15.0-11</code>,  <code>1.15.0-10</code>,  <code>1.15.0-9</code>,  <code>1.15.0-8</code>,  <code>1.15.0-7</code>,  <code>1.15.0-6</code>,  </span></summary>
      

      ``1.15.0-14``,  ``1.15.0-13``,  ``1.15.0-12``,  ``1.15.0-11``,  ``1.15.0-10``,  ``1.15.0-9``,  ``1.15.0-8``,  ``1.15.0-7``,  ``1.15.0-6``,  ``1.15.0-5``,  ``1.15.0-4``,  ``1.15.0-3``,  ``1.15.0-2``,  ``1.15.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-moexexonprobesetlocation

to add into an existing workspace instead, run::

    pixi add bioconductor-moexexonprobesetlocation
...
With conda_ installed and the Bioconda channel set up (see :ref:`bioconda_setup`), to install into an existing and activated environment, run::
    ...
    conda install bioconductor-moexexonprobesetlocation

Alternatively, to install into a new environment, run::

    conda create -n envname bioconductor-moexexonprobesetlocation
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-moexexonprobesetlocation"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-moexexonprobesetlocation"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-moexexonprobesetlocation"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-moexexonprobesetlocation
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-moexexonprobesetlocation/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-moexexonprobesetlocation', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-moexexonprobesetlocation
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-moexexonprobesetlocation/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-moexexonprobesetlocation', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-moexexonprobesetlocation
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-moexexonprobesetlocation/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-moexexonprobesetlocation', spec);
            } catch (err) {
