...
.. conda:recipe:: bioconductor-rmmquant
   ...
   :homepage: https://bioconductor.org/packages/3.13/bioc/html/Rmmquant.html
   :license: GPL-3
...
.. conda:package:: bioconductor-rmmquant
   ...
   :versions:
      ...
      ``1.10.0-0``,  ``1.8.1-0``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-1``,  ``1.2.0-1``,  ``1.0.0-0``
   ...
   :depends bioconductor-tbx20bamsubset: ``>=1.28.0,<1.29.0``
