...
.. conda:recipe:: bioconductor-omadb
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/OmaDB.html
   :license: GPL-3
...
.. conda:package:: bioconductor-omadb
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.26.0-0</code>,  <code>2.22.0-0</code>,  <code>2.18.0-0</code>,  <code>2.16.0-0</code>,  <code>2.14.0-0</code>,  <code>2.10.0-0</code>,  <code>2.8.0-0</code>,  <code>2.6.1-0</code>,  <code>2.6.0-0</code>,  </span></summary>
      

      ``2.26.0-0``,  ``2.22.0-0``,  ``2.18.0-0``,  ``2.16.0-0``,  ``2.14.0-0``,  ``2.10.0-0``,  ``2.8.0-0``,  ``2.6.1-0``,  ``2.6.0-0``,  ``2.5.0-0``,  ``2.4.0-0``,  ``2.2.0-0``,  ``2.0.0-1``,  ``1.2.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-omadb

to add into an existing workspace instead, run::

    pixi add bioconductor-omadb
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-omadb
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-omadb"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-omadb"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-omadb"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-omadb
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-omadb/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-omadb', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-omadb
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-omadb/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-omadb', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-omadb
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-omadb/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-omadb', spec);
            } catch (err) {
