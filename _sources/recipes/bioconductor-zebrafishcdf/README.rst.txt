...
.. conda:recipe:: bioconductor-zebrafishcdf
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/zebrafishcdf.html
   :license: LGPL
...
.. conda:package:: bioconductor-zebrafishcdf
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-zebrafishcdf

   and update with::

      mamba update bioconductor-zebrafishcdf

  To create a new environment, run::

      mamba create --name myenvname bioconductor-zebrafishcdf
