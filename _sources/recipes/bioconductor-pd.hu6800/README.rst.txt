...
.. conda:recipe:: bioconductor-pd.hu6800
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/pd.hu6800.html
...
.. conda:package:: bioconductor-pd.hu6800
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.hu6800

   and update with::

      mamba update bioconductor-pd.hu6800

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.hu6800
