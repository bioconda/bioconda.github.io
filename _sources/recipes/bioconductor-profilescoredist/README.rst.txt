...
.. conda:recipe:: bioconductor-profilescoredist
   ...
   :homepage: https://bioconductor.org/packages/3.20/bioc/html/profileScoreDist.html
...
.. conda:package:: bioconductor-profilescoredist
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-profilescoredist

   and update with::

      mamba update bioconductor-profilescoredist

  To create a new environment, run::

      mamba create --name myenvname bioconductor-profilescoredist
