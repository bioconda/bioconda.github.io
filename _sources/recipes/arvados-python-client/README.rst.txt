...
.. conda:package:: arvados-python-client
   ...
   :versions: 1.3.0.20190205182514, 1.3.0.20181130020805, 1.2.1, 1.2.0.20181121194423, 1.2.0.20181109162613, 1.2.0.20181108215719, 1.2.0.20180905185317, 0.1.20171211211613, 0.1.20171010180436, 0.1.20170818194607, 0.1.20161123074954, 0.1.20161031135838, 0.1.20160517202250, 0.1.20160412193510, 0.1.20160331153549, 0.1.20160318153100, 0.1.20160301181511

   :depends: :conda:package:`ciso8601` >=1.0.6,<2.0.0 :conda:package:`future`  :conda:package:`google-api-python-client` <1.7,>=1.6.2 :conda:package:`httplib2`  :conda:package:`pycurl` >=7.19.5.1 :conda:package:`python` <3.7 :conda:package:`ruamel.yaml` >=0.15.54 :conda:package:`setuptools`  :conda:package:`subprocess32`  :conda:package:`ws4py` >=0.4.2 
