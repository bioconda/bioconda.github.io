...
.. conda:recipe:: bioconductor-bovineprobe
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/bovineprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-bovineprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bovineprobe

   and update with::

      mamba update bioconductor-bovineprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bovineprobe
