...
.. conda:recipe:: bioconductor-bsgenome.tguttata.ucsc.taegut2
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/BSgenome.Tguttata.UCSC.taeGut2.html
...
.. conda:package:: bioconductor-bsgenome.tguttata.ucsc.taegut2
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-bsgenome.tguttata.ucsc.taegut2

   and update with::

      mamba update bioconductor-bsgenome.tguttata.ucsc.taegut2

  To create a new environment, run::

      mamba create --name myenvname bioconductor-bsgenome.tguttata.ucsc.taegut2
