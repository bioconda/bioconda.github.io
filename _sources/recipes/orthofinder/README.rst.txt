...
.. conda:package:: orthofinder
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>3.1.1-0</code>,  <code>3.1.0-1</code>,  <code>3.1.0-0</code>,  <code>3.0.1b1-0</code>,  <code>2.5.5-2</code>,  <code>2.5.5-1</code>,  <code>2.5.5-0</code>,  <code>2.5.4-0</code>,  <code>2.5.3-0</code>,  </span></summary>
      

      ``3.1.1-0``,  ``3.1.0-1``,  ``3.1.0-0``,  ``3.0.1b1-0``,  ``2.5.5-2``,  ``2.5.5-1``,  ``2.5.5-0``,  ``2.5.4-0``,  ``2.5.3-0``,  ``2.5.2-1``,  ``2.5.2-0``,  ``2.5.1-0``,  ``2.4.1-1``,  ``2.4.1-0``,  ``2.4.0-1``,  ``2.4.0-0``,  ``2.3.12-0``,  ``2.3.11-1``,  ``2.3.11-0``,  ``2.3.10-0``,  ``2.3.8-2``,  ``2.3.8-1``,  ``2.3.8-0``,  ``2.3.3-1``,  ``2.3.3-0``,  ``2.2.7-0``,  ``2.2.6-0``,  ``2.2.1-0``,  ``2.2.0-0``,  ``2.1.2-1``,  ``2.1.2-0``,  ``1.1.10-0``,  ``1.1.8-0``,  ``1.1.4-0``,  ``1.1.2-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["3.1.1","3.1.0","3.1.0","3.0.1b1","2.5.5"];
    </script>
