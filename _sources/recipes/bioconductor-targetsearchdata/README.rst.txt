...
.. conda:recipe:: bioconductor-targetsearchdata
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/TargetSearchData.html
   :license: GPL (>= 2)
...
.. conda:package:: bioconductor-targetsearchdata
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.48.0-0</code>,  <code>1.44.0-0</code>,  <code>1.40.0-0</code>,  <code>1.38.0-0</code>,  <code>1.35.2-0</code>,  <code>1.32.0-1</code>,  <code>1.32.0-0</code>,  <code>1.30.0-0</code>,  <code>1.28.0-1</code>,  </span></summary>
      

      ``1.48.0-0``,  ``1.44.0-0``,  ``1.40.0-0``,  ``1.38.0-0``,  ``1.35.2-0``,  ``1.32.0-1``,  ``1.32.0-0``,  ``1.30.0-0``,  ``1.28.0-1``,  ``1.28.0-0``,  ``1.27.0-0``,  ``1.26.0-0``,  ``1.24.0-0``,  ``1.22.0-1``,  ``1.22.0-0``,  ``1.20.0-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-targetsearchdata

to add into an existing workspace instead, run::

    pixi add bioconductor-targetsearchdata
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-targetsearchdata
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.48.0","1.44.0","1.40.0","1.38.0","1.35.2"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-targetsearchdata"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-targetsearchdata"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-targetsearchdata"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-targetsearchdata
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-targetsearchdata/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-targetsearchdata', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-targetsearchdata
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-targetsearchdata/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-targetsearchdata', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-targetsearchdata
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-targetsearchdata/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-targetsearchdata', spec);
            } catch (err) {
