...
.. conda:recipe:: deeplc
   ...
   :documentation: https://github.com/compomics/DeepLC/blob/v3.1.10/README.md
...
.. raw:: html
    ...
    <script>
        var package = "deeplc";
        var versions = ["3.1.10","3.1.9","3.1.8","3.1.7","3.1.5"];
    </script>
