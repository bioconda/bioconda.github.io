...
.. conda:package:: deeplc
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>0.1.34-0</code>,  <code>0.1.33-0</code>,  <code>0.1.31-0</code>,  <code>0.1.30-0</code>,  <code>0.1.29-0</code>,  <code>0.1.16-0</code>,  <code>0.1.15-0</code>,  <code>0.1.14-0</code>,  <code>0.1.13-0</code>,  </span></summary>
      

      ``0.1.34-0``,  ``0.1.33-0``,  ``0.1.31-0``,  ``0.1.30-0``,  ``0.1.29-0``,  ``0.1.16-0``,  ``0.1.15-0``,  ``0.1.14-0``,  ``0.1.13-0``,  ``0.1.12-0``,  ``0.1.11-0``,  ``0.1.10-0``,  ``0.1.7-0``,  ``0.1.6-0``,  ``0.1.4-0``,  ``0.1.2-0``,  ``0.1.1-0``
