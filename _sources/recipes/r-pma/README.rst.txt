...
Versions      1.0.11
License       GPL (>= 2)
Recipe        https://github.com/bioconda/bioconda-recipes/tree/master/recipes//r-pma/meta.yaml
...
A Docker container is available at https://quay.io/repository/biocontainers/r-pma.
...
Render an |badge| badge with the following Markdown::
   ...
   [![install with bioconda](https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square)](http://bioconda.github.io/recipes/r-pma/README.html)

.. |badge| image:: https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?style=flat-square
           :target: http://bioconda.github.io/recipes/r-pma/README.html
.. |downloads| image:: https://anaconda.org/bioconda/r-pma/badges/downloads.svg
               :target: https://anaconda.org/bioconda/r-pma
.. |docker| image:: https://quay.io/repository/biocontainers/r-pma/status
