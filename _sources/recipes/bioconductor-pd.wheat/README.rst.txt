...
.. conda:recipe:: bioconductor-pd.wheat
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/pd.wheat.html
...
.. conda:package:: bioconductor-pd.wheat
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.wheat

   and update with::

      mamba update bioconductor-pd.wheat

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.wheat
