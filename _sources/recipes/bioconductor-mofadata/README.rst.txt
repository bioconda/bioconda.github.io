...
.. conda:recipe:: bioconductor-mofadata
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/MOFAdata.html
   :license: LGPL-3
...
.. conda:package:: bioconductor-mofadata
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mofadata

   and update with::

      mamba update bioconductor-mofadata

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mofadata
