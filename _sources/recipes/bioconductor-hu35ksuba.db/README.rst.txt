...
.. conda:recipe:: bioconductor-hu35ksuba.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/hu35ksuba.db.html
...
.. conda:package:: bioconductor-hu35ksuba.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hu35ksuba.db

   and update with::

      mamba update bioconductor-hu35ksuba.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hu35ksuba.db
