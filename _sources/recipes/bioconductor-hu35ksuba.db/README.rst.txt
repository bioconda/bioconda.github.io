...
.. conda:recipe:: bioconductor-hu35ksuba.db
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/annotation/html/hu35ksuba.db.html
...
to install globally, run::
    ...
    pixi global install bioconductor-hu35ksuba.db

to add into an existing workspace instead, run::

    pixi add bioconductor-hu35ksuba.db
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-hu35ksuba.db
...
For e.g. docker, run::
    ...
    docker pull quay.io/biocontainers/bioconductor-hu35ksuba.db:<tag>
...
.. |downloads_bioconductor-hu35ksuba.db| image:: https://img.shields.io/conda/dn/bioconda/bioconductor-hu35ksuba.db.svg?style=flat
   :target: https://anaconda.org/bioconda/bioconductor-hu35ksuba.db
   :alt:   (downloads)
...
.. raw:: html
   ...
   <script>
      var package = "bioconductor-hu35ksuba.db";
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-hu35ksuba.db"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-hu35ksuba.db"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-hu35ksuba.db"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-hu35ksuba.db
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hu35ksuba.db/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-hu35ksuba.db', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-hu35ksuba.db
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hu35ksuba.db/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-hu35ksuba.db', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-hu35ksuba.db
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hu35ksuba.db/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-hu35ksuba.db', spec);
            } catch (err) {
