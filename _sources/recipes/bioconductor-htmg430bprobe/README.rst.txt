...
.. conda:recipe:: bioconductor-htmg430bprobe
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/htmg430bprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-htmg430bprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-htmg430bprobe

   and update with::

      mamba update bioconductor-htmg430bprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-htmg430bprobe
