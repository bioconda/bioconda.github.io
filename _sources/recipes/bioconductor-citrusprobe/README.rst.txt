...
.. conda:recipe:: bioconductor-citrusprobe
   ...
   :homepage: https://bioconductor.org/packages/3.18/data/annotation/html/citrusprobe.html
   :license: LGPL
...
.. conda:package:: bioconductor-citrusprobe
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-citrusprobe

   and update with::

      mamba update bioconductor-citrusprobe

  To create a new environment, run::

      mamba create --name myenvname bioconductor-citrusprobe
