...
.. conda:package:: bioconductor-mesh.cin.eg.db
   ...
   :required~by: |required_by_bioconductor-mesh.cin.eg.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-mesh.cin.eg.db


.. |required_by_bioconductor-mesh.cin.eg.db| conda:required_by:: bioconductor-mesh.cin.eg.db
