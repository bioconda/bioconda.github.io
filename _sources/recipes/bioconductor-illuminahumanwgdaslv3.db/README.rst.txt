...
.. conda:recipe:: bioconductor-illuminahumanwgdaslv3.db
   ...
   :homepage: https://bioconductor.org/packages/3.8/data/annotation/html/illuminaHumanWGDASLv3.db.html
...
.. conda:package:: bioconductor-illuminahumanwgdaslv3.db
   ...
   :required~by: |required_by_bioconductor-illuminahumanwgdaslv3.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-illuminahumanwgdaslv3.db


.. |required_by_bioconductor-illuminahumanwgdaslv3.db| conda:required_by:: bioconductor-illuminahumanwgdaslv3.db
