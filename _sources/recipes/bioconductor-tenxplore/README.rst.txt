...
.. conda:recipe:: bioconductor-tenxplore
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/tenXplore.html
...
.. conda:package:: bioconductor-tenxplore
   ...
   :depends bioconductor-ontoproc: ``>=1.20.0,<1.21.0``
   :depends bioconductor-org.mm.eg.db: ``>=3.16.0,<3.17.0``
   :depends bioconductor-restfulse: ``>=1.20.0,<1.21.0``
