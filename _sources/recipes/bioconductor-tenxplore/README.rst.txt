...
.. conda:recipe:: bioconductor-tenxplore
   ...
   :homepage: https://bioconductor.org/packages/3.17/bioc/html/tenXplore.html
...
.. conda:package:: bioconductor-tenxplore
   ...
   :depends bioconductor-ontoproc: ``>=1.24.0,<1.25.0``
   :depends bioconductor-org.mm.eg.db: ``>=3.18.0,<3.19.0``
   :depends bioconductor-restfulse: ``>=1.24.0,<1.25.0``
