...
.. conda:package:: bioconductor-padog
   ...
   :depends: :conda:package:`bioconductor-annotationdbi` >=1.44.0,<1.45.0 :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`bioconductor-hgu133a.db` >=3.2.0,<3.3.0 :conda:package:`bioconductor-hgu133plus2.db` >=3.2.0,<3.3.0 :conda:package:`bioconductor-kegg.db` >=3.2.0,<3.3.0 :conda:package:`bioconductor-keggdzpathwaysgeo` >=1.20.0,<1.21.0 :conda:package:`bioconductor-limma` >=3.38.0,<3.39.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-dorng`  :conda:package:`r-foreach`  :conda:package:`r-gsa`  :conda:package:`r-nlme`  

   :required~by: |required_by_bioconductor-padog|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-padog


.. |required_by_bioconductor-padog| conda:required_by:: bioconductor-padog
