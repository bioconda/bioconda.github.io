...
.. conda:recipe:: bioconductor-msmstests
   ...
   :homepage: https://bioconductor.org/packages/3.16/bioc/html/msmsTests.html
   :license: GPL-2
...
.. conda:package:: bioconductor-msmstests
   ...
   :versions:
      ...
      ``1.36.0-0``,  ``1.32.0-0``,  ``1.30.0-0``,  ``1.28.0-1``,  ``1.28.0-0``,  ``1.26.0-0``,  ``1.24.0-0``,  ``1.22.0-1``,  ``1.20.1-0``

      

   
   :depends bioconductor-edger: ``>=3.40.0,<3.41.0``
   :depends bioconductor-msmseda: ``>=1.36.0,<1.37.0``
