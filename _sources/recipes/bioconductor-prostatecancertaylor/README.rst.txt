...
.. conda:recipe:: bioconductor-prostatecancertaylor
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/experiment/html/prostateCancerTaylor.html
...
.. conda:package:: bioconductor-prostatecancertaylor
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-prostatecancertaylor

   and update with::

      mamba update bioconductor-prostatecancertaylor

  To create a new environment, run::

      mamba create --name myenvname bioconductor-prostatecancertaylor
