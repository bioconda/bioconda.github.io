...
.. conda:recipe:: bioconductor-scatac.explorer
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/scATAC.Explorer.html
...
.. conda:package:: bioconductor-scatac.explorer
   ...
   :versions:
      ...
      ``1.16.0-0``,  ``1.12.1-0``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-0``,  ``1.0.1-1``,  ``1.0.0-0``
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.16.0","1.12.1","1.8.0","1.6.0","1.4.0"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-scatac.explorer"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-scatac.explorer"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-scatac.explorer"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-scatac.explorer
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-scatac.explorer/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-scatac.explorer', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-scatac.explorer
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-scatac.explorer/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-scatac.explorer', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-scatac.explorer
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-scatac.explorer/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-scatac.explorer', spec);
            } catch (err) {
