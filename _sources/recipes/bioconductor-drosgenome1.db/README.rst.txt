...
.. conda:recipe:: bioconductor-drosgenome1.db
   ...
   Affymetrix Drosophila Genome Array annotation data \(chip drosgenome1\)

   :homepage: https://bioconductor.org/packages/3.13/data/annotation/html/drosgenome1.db.html
