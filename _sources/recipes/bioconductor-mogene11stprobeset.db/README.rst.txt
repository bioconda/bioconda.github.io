...
.. conda:recipe:: bioconductor-mogene11stprobeset.db
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/mogene11stprobeset.db.html
...
.. conda:package:: bioconductor-mogene11stprobeset.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-mogene11stprobeset.db

   and update with::

      mamba update bioconductor-mogene11stprobeset.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-mogene11stprobeset.db
