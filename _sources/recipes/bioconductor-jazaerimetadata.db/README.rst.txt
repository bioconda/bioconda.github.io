...
.. conda:package:: bioconductor-jazaerimetadata.db
   ...
   :required~by: |required_by_bioconductor-jazaerimetadata.db|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-jazaerimetadata.db


.. |required_by_bioconductor-jazaerimetadata.db| conda:required_by:: bioconductor-jazaerimetadata.db
