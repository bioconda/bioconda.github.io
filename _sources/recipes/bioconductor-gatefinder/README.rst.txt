...
.. conda:recipe:: bioconductor-gatefinder
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/GateFinder.html
...
.. conda:package:: bioconductor-gatefinder
   ...
   :depends on bioconductor-flowfp: ``>=1.68.0,<1.69.0``
   :depends on r-base: ``>=4.5,<4.6.0a0``
   :depends on r-diptest: 
   :depends on r-mvoutlier: 
   :depends on r-splancs: 
...
to install globally, run::
    ...
    pixi global install bioconductor-gatefinder

to add into an existing workspace instead, run::

    pixi add bioconductor-gatefinder
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-gatefinder
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-gatefinder"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-gatefinder"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-gatefinder"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-gatefinder
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-gatefinder/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-gatefinder', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-gatefinder
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-gatefinder/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-gatefinder', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-gatefinder
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-gatefinder/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-gatefinder', spec);
            } catch (err) {
