...
.. conda:recipe:: bioconductor-illuminamousev1.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/illuminaMousev1.db.html
...
.. conda:package:: bioconductor-illuminamousev1.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-illuminamousev1.db

   and update with::

      mamba update bioconductor-illuminamousev1.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-illuminamousev1.db
