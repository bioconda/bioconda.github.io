...
.. conda:recipe:: bioconductor-metaseq
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/metaSeq.html
...
.. conda:package:: bioconductor-metaseq
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>1.32.0-0</code>,  <code>1.30.0-1</code>,  <code>1.30.0-0</code>,  <code>1.28.0-0</code>,  <code>1.26.0-0</code>,  <code>1.24.0-1</code>,  <code>1.22.1-0</code>,  <code>1.20.0-0</code>,  <code>1.18.0-0</code>,  </span></summary>
      

      ``1.32.0-0``,  ``1.30.0-1``,  ``1.30.0-0``,  ``1.28.0-0``,  ``1.26.0-0``,  ``1.24.0-1``,  ``1.22.1-0``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.16.0-0``
   ...
   :depends bioconductor-noiseq: ``>=2.36.0,<2.37.0``
