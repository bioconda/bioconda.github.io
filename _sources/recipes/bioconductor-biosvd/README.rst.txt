...
.. conda:package:: bioconductor-biosvd
   ...
   :depends: :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`bioconductor-biocgenerics` >=0.28.0,<0.29.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-nmf`  

   :required~by: |required_by_bioconductor-biosvd|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-biosvd


.. |required_by_bioconductor-biosvd| conda:required_by:: bioconductor-biosvd
