...
.. conda:recipe:: bioconductor-rtreemix
   ...
   :homepage: https://bioconductor.org/packages/3.8/bioc/html/Rtreemix.html
   :license: LGPL
...
.. conda:package:: bioconductor-rtreemix
   ...
   :depends: :conda:package:`bioconductor-biobase` >=2.42.0,<2.43.0 :conda:package:`bioconductor-graph` >=1.60.0,<1.61.0 :conda:package:`libcxx` >=4.0.1 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 :conda:package:`r-hmisc`  
