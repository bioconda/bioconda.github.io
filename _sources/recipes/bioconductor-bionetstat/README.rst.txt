...
.. conda:recipe:: bioconductor-bionetstat
   ...
   :homepage: https://bioconductor.org/packages/3.14/bioc/html/BioNetStat.html
   :license: GPL (>= 3)
...
.. conda:package:: bioconductor-bionetstat
   ...
   :versions:
      ...
      ``1.18.0-0``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.2-0``,  ``1.10.0-0``,  ``1.8.0-0``,  ``1.6.0-0``,  ``1.4.0-1``,  ``1.2.2-0``
...
.. raw:: html
    ...
    <script>
        ...
        var versions = ["1.18.0","1.14.0","1.12.0","1.10.2","1.10.0"];
    </script>
