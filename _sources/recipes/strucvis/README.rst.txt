...
.. conda:package:: strucvis
   ...
   :versions:
      ...
      ``1.0.1-0``,  ``1.0-0``,  ``0.9-0``,  ``0.8-0``,  ``0.7-1``,  ``0.7-0``,  ``0.6-0``
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname strucvis
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["1.0.1","1.0","0.9","0.8","0.7"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_strucvis"></div>
   <div style="width: 100%" id="platform_plot_strucvis"></div>
   <div style="width: 100%" id="cdf_plot_strucvis"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/strucvis/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_strucvis', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for strucvis
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/strucvis/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_strucvis', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for strucvis
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/strucvis/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_strucvis', spec);
            } catch (err) {
