...
.. conda:recipe:: bioconductor-pd.citrus
   ...
   :homepage: https://bioconductor.org/packages/3.17/data/annotation/html/pd.citrus.html
...
.. conda:package:: bioconductor-pd.citrus
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-pd.citrus

   and update with::

      mamba update bioconductor-pd.citrus

  To create a new environment, run::

      mamba create --name myenvname bioconductor-pd.citrus
