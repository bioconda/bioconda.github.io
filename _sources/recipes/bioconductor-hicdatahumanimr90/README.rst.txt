...
.. conda:recipe:: bioconductor-hicdatahumanimr90
   ...
   :homepage: https://bioconductor.org/packages/3.22/data/experiment/html/HiCDataHumanIMR90.html
   :license: GPL-3
...
to install globally, run::
    ...
    pixi global install bioconductor-hicdatahumanimr90

to add into an existing workspace instead, run::

    pixi add bioconductor-hicdatahumanimr90
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-hicdatahumanimr90
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-hicdatahumanimr90"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-hicdatahumanimr90"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-hicdatahumanimr90"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-hicdatahumanimr90
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hicdatahumanimr90/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-hicdatahumanimr90', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-hicdatahumanimr90
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hicdatahumanimr90/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-hicdatahumanimr90', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-hicdatahumanimr90
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-hicdatahumanimr90/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-hicdatahumanimr90', spec);
            } catch (err) {
