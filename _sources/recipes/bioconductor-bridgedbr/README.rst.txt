...
.. conda:recipe:: bioconductor-bridgedbr
   ...
   :homepage: https://bioconductor.org/packages/3.22/bioc/html/BridgeDbR.html
   :license: AGPL-3
...
.. conda:package:: bioconductor-bridgedbr
   ...
   :versions:
      ...
      .. raw:: html
         ...
         <details><summary><span class="truncated-version-list"><code>2.20.0-0</code>,  <code>2.16.0-0</code>,  <code>2.12.0-0</code>,  <code>2.10.0-0</code>,  <code>2.8.0-0</code>,  <code>2.4.0-0</code>,  <code>2.2.1-0</code>,  <code>2.0.0-1</code>,  <code>2.0.0-0</code>,  </span></summary>
      

      ``2.20.0-0``,  ``2.16.0-0``,  ``2.12.0-0``,  ``2.10.0-0``,  ``2.8.0-0``,  ``2.4.0-0``,  ``2.2.1-0``,  ``2.0.0-1``,  ``2.0.0-0``,  ``1.20.0-0``,  ``1.18.0-1``,  ``1.18.0-0``,  ``1.16.1-0``
...
to install globally, run::
    ...
    pixi global install bioconductor-bridgedbr

to add into an existing workspace instead, run::

    pixi add bioconductor-bridgedbr
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname bioconductor-bridgedbr
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_bioconductor-bridgedbr"></div>
   <div style="width: 100%" id="platform_plot_bioconductor-bridgedbr"></div>
   <div style="width: 100%" id="cdf_plot_bioconductor-bridgedbr"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for bioconductor-bridgedbr
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bridgedbr/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_bioconductor-bridgedbr', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for bioconductor-bridgedbr
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bridgedbr/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_bioconductor-bridgedbr', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for bioconductor-bridgedbr
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/bioconductor-bridgedbr/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_bioconductor-bridgedbr', spec);
            } catch (err) {
