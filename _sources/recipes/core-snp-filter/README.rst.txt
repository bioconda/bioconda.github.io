...
.. conda:package:: core-snp-filter
   ...
   :versions:
      ...
      ``0.2.0-2``,  ``0.2.0-1``,  ``0.2.0-0``,  ``0.1.1-1``,  ``0.1.1-0``
...
to install globally, run::
    ...
    pixi global install core-snp-filter

to add into an existing workspace instead, run::

    pixi add core-snp-filter
...
Alternatively, to install into a new environment, run::
    ...
    conda create -n envname core-snp-filter
...
.. raw:: html
   ...
   <script>
      ...
      var versions = ["0.2.0","0.2.0","0.2.0","0.1.1","0.1.1"];
   </script>
...
.. raw:: html
   ...
   <div style="width: 100%" id="download_plot_core-snp-filter"></div>
   <div style="width: 100%" id="platform_plot_core-snp-filter"></div>
   <div style="width: 100%" id="cdf_plot_core-snp-filter"></div>
   ...
   <script>
      window.onload = async function() {
            ...
            // Build cdf plot for core-snp-filter
            try {
               ...
               const point_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/core-snp-filter/cdf.json`)
               ...
               vegaEmbed('#cdf_plot_core-snp-filter', cdf_spec);
            } catch (err) {
               console.error("An error occurred while building CDF plot: ", err)
            }
    
            // Build download plot for core-snp-filter
            try {
               ...
               const version_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/core-snp-filter/versions.json`)
               if (!version_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${version_data_resp.status}.`);
               }
               const plot_data = await version_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#download_plot_core-snp-filter', spec);
            } catch (err) {
               console.error("An error occurred while building downloads plot: ", err)
            }
   
            // Build platform download plot for core-snp-filter
            try {
               ...
               const spec = await spec_resp.json();
               const platform_data_resp = await fetch(`https://raw.githubusercontent.com/bioconda/bioconda-plots/main/plots/core-snp-filter/platforms.json`)
               if (!platform_data_resp.ok) {
                   throw new Error(`Fetching failed with HTTP code ${platform_data_resp.status}.`);
               }
               const plot_data = await platform_data_resp.json();
               spec.data.values = plot_data;
               vegaEmbed('#platform_plot_core-snp-filter', spec);
            } catch (err) {
