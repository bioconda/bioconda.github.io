...
.. conda:package:: bioconductor-gcatest
   ...
   :depends: :conda:package:`bioconductor-lfa` >=1.12.0,<1.13.0 :conda:package:`libgcc-ng` >=7.3.0 :conda:package:`r-base` >=3.5.1,<3.5.2.0a0 

   :required~by: |required_by_bioconductor-gcatest|
   ...
   or use the docker container::
      ...
      docker pull quay.io/repository/biocontainers/bioconductor-gcatest


.. |required_by_bioconductor-gcatest| conda:required_by:: bioconductor-gcatest
