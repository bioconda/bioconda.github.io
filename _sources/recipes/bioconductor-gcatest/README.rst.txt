...
.. conda:recipe:: bioconductor-gcatest
   ...
   :homepage: https://bioconductor.org/packages/3.12/bioc/html/gcatest.html
   :license: GPL-3
...
.. conda:package:: bioconductor-gcatest
   ...
   :versions:
      ...
      ``1.20.0-1``,  ``1.20.0-0``,  ``1.18.0-0``,  ``1.16.0-0``,  ``1.14.0-1``,  ``1.14.0-0``,  ``1.12.0-0``,  ``1.10.0-0``,  ``1.8.0-0``

      

   
   :depends bioconductor-lfa: ``>=1.20.0,<1.21.0``
