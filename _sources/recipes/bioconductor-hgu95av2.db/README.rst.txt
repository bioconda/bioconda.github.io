...
.. conda:recipe:: bioconductor-hgu95av2.db
   ...
   :homepage: https://bioconductor.org/packages/3.20/data/annotation/html/hgu95av2.db.html
...
.. conda:package:: bioconductor-hgu95av2.db
  ...
  Given that you already have a conda environment in which you want to have this package, install with::
      ...
      mamba install bioconductor-hgu95av2.db

   and update with::

      mamba update bioconductor-hgu95av2.db

  To create a new environment, run::

      mamba create --name myenvname bioconductor-hgu95av2.db
